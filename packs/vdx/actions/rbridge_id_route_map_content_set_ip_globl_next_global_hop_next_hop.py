...
def rbridge_id_route_map_content_set_ip_globl_next_global_hop_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ip_globl_next_global_hop_next_hop_act(Action):
    def run(self, next_hop, rbridge_id, delete_set, delete_next_hop, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_globl, delete_name, delete_next_global_hop, delete_rbridge_id, delete_ip, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_ip_globl_next_global_hop_next_hop(delete_instance=delete_instance, delete_route_map=delete_route_map, delete_next_global_hop=delete_next_global_hop, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_globl=delete_globl, delete_ip=delete_ip, name=name, password=password, delete_next_hop=delete_next_hop, delete_content=delete_content, delete_set=delete_set, instance=instance, delete_name=delete_name, host=host, delete_rbridge_id=delete_rbridge_id, next_hop=next_hop, callback=_callback, mgr=mgr)
        return 0
