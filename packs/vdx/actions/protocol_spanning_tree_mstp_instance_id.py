...
def protocol_spanning_tree_mstp_instance_id(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_instance_id_act(Action):
    def run(self, delete_mstp, delete_protocol, delete_instance, delete_spanning_tree, delete_id, id, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_instance_id(delete_instance=delete_instance, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, delete_mstp=delete_mstp, host=host, id=id, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
