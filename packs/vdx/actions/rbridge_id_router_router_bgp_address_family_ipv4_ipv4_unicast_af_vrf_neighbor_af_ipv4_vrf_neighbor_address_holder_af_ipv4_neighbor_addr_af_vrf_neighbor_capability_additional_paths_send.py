...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_additional_paths_send(**kwargs):
    """Auto Generated Code
    """
    ...
    send = ET.SubElement(additional_paths, "send")
    if kwargs.pop('delete_send', False) is True:
        delete_send = config.find('.//*send')
        delete_send.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_additional_paths_send_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_send, delete_af_vrf_neighbor_capability, delete_rbridge_id, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_additional_paths_send(delete_additional_paths=delete_additional_paths, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_router=delete_router, delete_af_vrf_neighbor_capability=delete_af_vrf_neighbor_capability, host=host, delete_address_family=delete_address_family, delete_send=delete_send, password=password, callback=_callback, mgr=mgr)
        return 0
