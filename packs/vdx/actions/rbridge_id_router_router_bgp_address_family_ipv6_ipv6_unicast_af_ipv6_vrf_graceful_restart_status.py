...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_graceful_restart_status(**kwargs):
    """Auto Generated Code
    """
    ...
    graceful_restart_status = ET.SubElement(af_ipv6_vrf, "graceful-restart-status")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_graceful_restart_status_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_graceful_restart_status, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_graceful_restart_status(delete_router_bgp=delete_router_bgp, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_graceful_restart_status=delete_graceful_restart_status, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
