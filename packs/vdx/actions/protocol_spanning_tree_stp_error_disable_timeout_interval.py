...
def protocol_spanning_tree_stp_error_disable_agtimeout_interval(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_stp_error_disable_agtimeout_interval_act(Action):
    def run(self, delete_error_disable_agtimeout, delete_protocol, interval, delete_interval, delete_stp, delete_spanning_tree, host, username, password):
