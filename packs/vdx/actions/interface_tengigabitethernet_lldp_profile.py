...
def interface_tengigabitethernet_lldp_profile(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_lldp_profile_act(Action):
    def run(self, profile, name, delete_lldp, delete_interface, delete_name, delete_tengigabitethernet, delete_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_lldp_profile(profile=profile, name=name, delete_name=delete_name, delete_lldp=delete_lldp, delete_profile=delete_profile, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
