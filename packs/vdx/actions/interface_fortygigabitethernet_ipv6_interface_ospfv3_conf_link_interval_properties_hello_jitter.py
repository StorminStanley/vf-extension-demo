...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_jitter(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_jitter_act(Action):
    def run(self, name, delete_hello_jitter, delete_fortygigabitethernet, hello_jitter, delete_interface, delete_name, delete_link_interval_properties, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_jitter(name=name, delete_name=delete_name, delete_link_interval_properties=delete_link_interval_properties, host=host, hello_jitter=hello_jitter, delete_hello_jitter=delete_hello_jitter, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
