...
def interface_gigabitethernet_vrrp_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_enable_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, version, delete_enable, delete_interface, delete_name, delete_vrrp, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_enable(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_enable=delete_enable, version=version, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
