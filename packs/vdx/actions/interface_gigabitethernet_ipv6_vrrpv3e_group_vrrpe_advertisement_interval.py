...
def interface_gigabitethernet_ipv6_vrrpv3e_group_vrrpe_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_vrrpe_advertisement_interval_act(Action):
    def run(self, name, delete_vrid, vrid, delete_interface, delete_name, delete_vrrpe_advertisement_interval, vrrpe_advertisement_interval, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_vrrpv3e_group_vrrpe_advertisement_interval(delete_vrid=delete_vrid, delete_vrrpe_advertisement_interval=delete_vrrpe_advertisement_interval, name=name, delete_name=delete_name, vrrpe_advertisement_interval=vrrpe_advertisement_interval, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
