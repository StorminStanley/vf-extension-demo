...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_network_network_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_network_network_route_map_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_network, network_route_map, delete_network_route_map, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_network_network_route_map(delete_router_bgp=delete_router_bgp, username=username, delete_router=delete_router, rbridge_id=rbridge_id, network_route_map=network_route_map, delete_network_route_map=delete_network_route_map, host=host, delete_network=delete_network, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
