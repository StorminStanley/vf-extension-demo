...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_attempts(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_attempts_act(Action):
    def run(self, name, delete_fortygigabitethernet, attempts, delete_dad, delete_name, delete_attempts, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_attempts(attempts=attempts, name=name, delete_name=delete_name, delete_dad=delete_dad, delete_nd=delete_nd, host=host, delete_attempts=delete_attempts, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
