...
def rbridge_id_router_ospf_permit_redistribute_redist_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_permit_redistribute_redist_value_act(Action):
