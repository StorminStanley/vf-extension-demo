...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_flag(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_suppress_ra_flag', False) is True:
        delete_suppress_ra_flag = config.find('.//*suppress-ra-flag')
        delete_suppress_ra_flag.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_flag_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_suppress_ra, delete_name, delete_suppress_ra_flag, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_flag(name=name, delete_name=delete_name, delete_suppress_ra_flag=delete_suppress_ra_flag, host=host, delete_nd=delete_nd, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_suppress_ra=delete_suppress_ra, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
