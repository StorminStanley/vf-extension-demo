...
def interface_management_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_management_name_act(Action):
    def run(self, delete_management, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_name(name=name, delete_name=delete_name, delete_management=delete_management, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
