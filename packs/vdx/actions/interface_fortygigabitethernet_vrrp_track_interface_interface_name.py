...
def interface_fortygigabitethernet_vrrp_track_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_track_interface_interface_name_act(Action):
