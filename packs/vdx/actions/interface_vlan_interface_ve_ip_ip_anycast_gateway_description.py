...
def interface_vlan_interface_ve_ip_ip_anycast_gateway_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ip_ip_anycast_gateway_description_act(Action):
    def run(self, delete_description, gve_name, delete_ip, delete_interface_vlan, delete_ip_anycast_gateway, ip_gw_id, delete_ve, delete_interface, description, delete_ip_gw_id, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ip_ip_anycast_gateway_description(delete_ip_anycast_gateway=delete_ip_anycast_gateway, gve_name=gve_name, delete_gve_name=delete_gve_name, description=description, delete_ip_gw_id=delete_ip_gw_id, delete_ip=delete_ip, delete_description=delete_description, ip_gw_id=ip_gw_id, host=host, delete_interface_vlan=delete_interface_vlan, delete_interface=delete_interface, username=username, password=password, delete_ve=delete_ve, callback=_callback, mgr=mgr)
        return 0
