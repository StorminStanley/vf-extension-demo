...
def interface_fortygigabitethernet_ip_icmp_unreachable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_icmp_unreachable_act(Action):
    def run(self, delete_unreachable, name, delete_ip, delete_fortygigabitethernet, delete_icmp, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_icmp_unreachable(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_icmp=delete_icmp, delete_ip=delete_ip, delete_unreachable=delete_unreachable, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
