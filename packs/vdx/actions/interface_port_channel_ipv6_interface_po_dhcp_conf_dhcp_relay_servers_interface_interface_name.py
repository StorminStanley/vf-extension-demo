...
def interface_port_channel_ipv6_interface_po_dhcp_conf_dhcp_relay_servers_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_po_dhcp_conf_dhcp_relay_servers_interface_interface_name_act(Action):
    def run(self, relay_ip_addr, delete_interface_name, name, delete_port_channel, delete_interface_po_dhcp_conf, delete_servers, delete_dhcp, delete_relay, delete_interface, delete_name, interface_name, delete_relay_ip_addr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_interface_po_dhcp_conf_dhcp_relay_servers_interface_interface_name(relay_ip_addr=relay_ip_addr, name=name, delete_name=delete_name, delete_relay=delete_relay, username=username, interface_name=interface_name, delete_dhcp=delete_dhcp, delete_port_channel=delete_port_channel, delete_interface_po_dhcp_conf=delete_interface_po_dhcp_conf, host=host, delete_interface_name=delete_interface_name, delete_interface=delete_interface, delete_servers=delete_servers, delete_relay_ip_addr=delete_relay_ip_addr, password=password, callback=_callback, mgr=mgr)
        return 0
