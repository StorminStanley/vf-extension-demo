...
def interface_gigabitethernet_qos_rcv_queue_cos_threshold_cos7_threshold(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_qos_rcv_queue_cos_threshold_cos7_threshold_act(Action):
