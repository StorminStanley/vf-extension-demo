...
def rbridge_id_router_hide_pim_holder_pim_rp_address_prefix_list(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_hide_pim_holder_pim_rp_address_prefix_list_act(Action):
    def run(self, delete_pim, rbridge_id, delete_hide_pim_holder, delete_rp_ip_addr, rp_ip_addr, delete_prefix_list, delete_rbridge_id, prefix_list, delete_rp_address, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_hide_pim_holder_pim_rp_address_prefix_list(delete_prefix_list=delete_prefix_list, username=username, delete_pim=delete_pim, delete_router=delete_router, rbridge_id=rbridge_id, delete_rp_ip_addr=delete_rp_ip_addr, delete_hide_pim_holder=delete_hide_pim_holder, prefix_list=prefix_list, delete_rp_address=delete_rp_address, rp_ip_addr=rp_ip_addr, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
