...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_network_network_weight(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_network_network_weight_act(Action):
    def run(self, delete_address_family, network_weight, delete_router_bgp, rbridge_id, delete_network, delete_network_weight, delete_default_vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_network_network_weight(delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, network_weight=network_weight, delete_network_weight=delete_network_weight, host=host, delete_network=delete_network, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
