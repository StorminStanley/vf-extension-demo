...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_unsuppress_map_map_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_unsuppress_map_map_name_act(Action):
    def run(self, delete_address_family, delete_map_name, delete_router_bgp, rbridge_id, delete_unsuppress_map, delete_default_vrf, map_name, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_unsuppress_map_map_name(delete_map_name=delete_map_name, username=username, map_name=map_name, delete_unsuppress_map=delete_unsuppress_map, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, password=password, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_default_vrf=delete_default_vrf, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
