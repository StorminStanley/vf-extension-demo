...
def interface_gigabitethernet_qos_drop_monitor_drop_monitor_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_qos_drop_monitor_drop_monitor_enable_act(Action):
    def run(self, delete_qos, name, delete_drop_monitor_enable, delete_interface, delete_name, delete_gigabitethernet, delete_drop_monitor, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_qos_drop_monitor_drop_monitor_enable(delete_qos=delete_qos, delete_name=delete_name, delete_drop_monitor=delete_drop_monitor, username=username, name=name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, delete_drop_monitor_enable=delete_drop_monitor_enable, password=password, callback=_callback, mgr=mgr)
        return 0
