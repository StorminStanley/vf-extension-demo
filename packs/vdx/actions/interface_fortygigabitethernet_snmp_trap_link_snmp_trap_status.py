...
def interface_fortygigabitethernet_snmp_trap_link_snmp_trap_status(**kwargs):
    """Auto Generated Code
    """
    ...
    snmp = ET.SubElement(fortygigabitethernet, "snmp")
...
class interface_fortygigabitethernet_snmp_trap_link_snmp_trap_status_act(Action):
    def run(self, name, delete_trap, delete_fortygigabitethernet, delete_link_snmp_trap_status, delete_interface, delete_name, delete_snmp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_snmp_trap_link_snmp_trap_status(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_link_snmp_trap_status=delete_link_snmp_trap_status, delete_snmp=delete_snmp, delete_trap=delete_trap, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
