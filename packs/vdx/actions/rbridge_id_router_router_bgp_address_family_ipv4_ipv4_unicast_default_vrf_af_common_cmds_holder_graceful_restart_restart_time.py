...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_graceful_restart_restart_time(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_restart_time', False) is True:
        delete_restart_time = config.find('.//*restart-time')
        delete_restart_time.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_graceful_restart_restart_time_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_graceful_restart, restart_time, delete_af_common_cmds_holder, delete_default_vrf, delete_restart_time, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_graceful_restart_restart_time(delete_router_bgp=delete_router_bgp, restart_time=restart_time, username=username, delete_graceful_restart=delete_graceful_restart, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_af_common_cmds_holder=delete_af_common_cmds_holder, delete_restart_time=delete_restart_time, host=host, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
