...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_aggregate_ipv6_address_advertise_map(**kwargs):
    """Auto Generated Code
    """
    ...
    aggregate_ipv6_address = ET.SubElement(default_vrf, "aggregate-ipv6-address")
    ...
    if kwargs.pop('delete_advertise_map', False) is True:
        delete_advertise_map = config.find('.//*advertise-map')
        delete_advertise_map.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_aggregate_ipv6_address_advertise_map_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, advertise_map, delete_advertise_map, delete_default_vrf, delete_aggregate_ip_prefix, delete_rbridge_id, delete_router, aggregate_ip_prefix, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_aggregate_ipv6_address_advertise_map(aggregate_ip_prefix=aggregate_ip_prefix, delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_advertise_map=delete_advertise_map, advertise_map=advertise_map, delete_aggregate_ip_prefix=delete_aggregate_ip_prefix, delete_address_family=delete_address_family, host=host, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
