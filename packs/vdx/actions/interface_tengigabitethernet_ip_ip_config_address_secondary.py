...
def interface_tengigabitethernet_ip_ip_config_address_secondary(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_ip_config_address_secondary_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_secondary, delete_interface, delete_name, address, delete_tengigabitethernet, delete_address, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_ip_config_address_secondary(name=name, delete_name=delete_name, address=address, delete_ip_config=delete_ip_config, delete_ip=delete_ip, delete_address=delete_address, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_secondary=delete_secondary, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
