...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_priority_act(Action):
    def run(self, name, priority, delete_priority, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_priority(name=name, delete_name=delete_name, username=username, priority=priority, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
