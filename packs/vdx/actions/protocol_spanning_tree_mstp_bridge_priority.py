...
def protocol_spanning_tree_mstp_bridge_priority(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_bridge_priority_act(Action):
    def run(self, bridge_priority, delete_mstp, delete_bridge_priority, delete_spanning_tree, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_bridge_priority(username=username, delete_spanning_tree=delete_spanning_tree, delete_bridge_priority=delete_bridge_priority, delete_protocol=delete_protocol, delete_mstp=delete_mstp, host=host, bridge_priority=bridge_priority, password=password, callback=_callback, mgr=mgr)
        return 0
