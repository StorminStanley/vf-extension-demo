...
def interface_fortygigabitethernet_switchport_access_mac_group_vlan_classification_access_vlan_access_mac_group(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_access_mac_group_vlan_classification_access_vlan_access_mac_group_act(Action):
    def run(self, delete_switchport, delete_vlan, access_mac_group, delete_access_vlan_id, name, delete_access_mac_group, delete_access_mac_group_vlan_classification, delete_fortygigabitethernet, delete_access, access_vlan_id, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_access_mac_group_vlan_classification_access_vlan_access_mac_group(delete_access=delete_access, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, delete_switchport=delete_switchport, delete_access_mac_group_vlan_classification=delete_access_mac_group_vlan_classification, access_vlan_id=access_vlan_id, delete_access_vlan_id=delete_access_vlan_id, delete_vlan=delete_vlan, host=host, delete_access_mac_group=delete_access_mac_group, delete_name=delete_name, delete_interface=delete_interface, access_mac_group=access_mac_group, password=password, callback=_callback, mgr=mgr)
        return 0
