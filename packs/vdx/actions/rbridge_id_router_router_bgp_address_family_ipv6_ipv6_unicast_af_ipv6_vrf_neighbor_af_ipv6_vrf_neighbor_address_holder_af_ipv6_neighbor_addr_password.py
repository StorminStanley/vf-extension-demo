...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_password(**kwargs):
    """Auto Generated Code
    """
    ...
    password = ET.SubElement(af_ipv6_neighbor_addr, "password")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_password_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_password, delete_rbridge_id, password, delete_neighbor, delete_router, host, username, password):
