...
def interface_hundredgigabitethernet_ip_ip_config_address_ospf_ignore(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_ip_config_address_ospf_ignore_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_ospf_ignore, delete_interface, delete_name, address, delete_hundredgigabitethernet, delete_address, host, username, password):
