...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_auth_change_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_auth_change_wait_time_act(Action):
    def run(self, auth_change_wait_time, name, delete_ip, delete_auth_change_wait_time, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_auth_change_wait_time(name=name, delete_name=delete_name, username=username, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, auth_change_wait_time=auth_change_wait_time, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_ve=delete_ve, password=password, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, delete_auth_change_wait_time=delete_auth_change_wait_time, callback=_callback, mgr=mgr)
        return 0
