...
def interface_vlan_interface_ve_ip_ip_anycast_gateway_ipv4_gateway_address(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ipv4_gateway_address', False) is True:
        delete_ipv4_gateway_address = config.find('.//*ipv4-gateway-address')
        delete_ipv4_gateway_address.set('operation', 'delete')
...
class interface_vlan_interface_ve_ip_ip_anycast_gateway_ipv4_gateway_address_act(Action):
    def run(self, gve_name, delete_ip, delete_interface_vlan, delete_ip_anycast_gateway, ip_gw_id, delete_ve, delete_interface, delete_ip_gw_id, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ip_ip_anycast_gateway_ipv4_gateway_address(delete_ip_anycast_gateway=delete_ip_anycast_gateway, delete_ip_gw_id=delete_ip_gw_id, delete_gve_name=delete_gve_name, delete_ip=delete_ip, gve_name=gve_name, delete_interface_vlan=delete_interface_vlan, host=host, ip_gw_id=ip_gw_id, delete_interface=delete_interface, username=username, password=password, delete_ve=delete_ve, callback=_callback, mgr=mgr)
        return 0
