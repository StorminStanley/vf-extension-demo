...
def interface_tengigabitethernet_lacp_std_port_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_lacp_std_port_priority_act(Action):
    def run(self, delete_std_port_priority, name, delete_lacp, std_port_priority, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_lacp_std_port_priority(delete_std_port_priority=delete_std_port_priority, name=name, delete_name=delete_name, delete_lacp=delete_lacp, host=host, std_port_priority=std_port_priority, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
