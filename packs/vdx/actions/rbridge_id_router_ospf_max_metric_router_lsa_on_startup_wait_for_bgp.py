...
def rbridge_id_router_ospf_max_metric_router_lsa_on_startup_wait_for_bgp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_max_metric_router_lsa_on_startup_wait_for_bgp_act(Action):
