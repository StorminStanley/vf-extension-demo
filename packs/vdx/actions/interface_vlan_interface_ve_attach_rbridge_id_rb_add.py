...
def interface_vlan_interface_ve_attach_rbridge_id_rb_add(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_attach_rbridge_id_rb_add_act(Action):
    def run(self, delete_rb_add, gve_name, delete_attach, delete_interface_vlan, delete_ve, delete_interface, rb_add, delete_rbridge_id, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_attach_rbridge_id_rb_add(delete_gve_name=delete_gve_name, rb_add=rb_add, username=username, delete_rbridge_id=delete_rbridge_id, gve_name=gve_name, delete_rb_add=delete_rb_add, host=host, delete_interface_vlan=delete_interface_vlan, delete_interface=delete_interface, delete_attach=delete_attach, password=password, delete_ve=delete_ve, callback=_callback, mgr=mgr)
        return 0
