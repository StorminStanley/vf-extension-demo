...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_link_local_next_hop(**kwargs):
    """Auto Generated Code
    """
    ...
    link_local_next_hop = ET.SubElement(link_local_static_route_nh_vrf, "link-local-next-hop")
    ...
    link_local_next_hop.text = kwargs.pop('link_local_next_hop')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_link_local_next_hop_act(Action):
