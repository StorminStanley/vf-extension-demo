...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_min(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_min_act(Action):
    def run(self, name, delete_ra_interval, delete_min, min, delete_interface, delete_name, delete_nd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_min(name=name, delete_name=delete_name, username=username, delete_ra_interval=delete_ra_interval, min=min, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, delete_min=delete_min, password=password, callback=_callback, mgr=mgr)
        return 0
