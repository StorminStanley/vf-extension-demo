...
def rbridge_id_interface_ve_vrrpe_track_network_network_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_track_network_network_address_act(Action):
    def run(self, name, delete_network_address, delete_vrid, vrid, network_address, delete_network, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, delete_track, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_track_network_network_address(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_track=delete_track, delete_vrrpe=delete_vrrpe, username=username, rbridge_id=rbridge_id, delete_network_address=delete_network_address, delete_network=delete_network, delete_ve=delete_ve, vrid=vrid, network_address=network_address, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
