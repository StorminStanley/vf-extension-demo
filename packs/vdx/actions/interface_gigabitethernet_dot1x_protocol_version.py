...
def interface_gigabitethernet_dot1x_protocol_version(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_protocol_version_act(Action):
    def run(self, name, delete_interface, delete_name, protocol_version, delete_protocol_version, delete_gigabitethernet, host, username, password):
