...
def interface_hundredgigabitethernet_bfd_interval_min_rx(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_bfd_interval_min_rx_act(Action):
    def run(self, name, delete_interval, delete_interface, delete_name, delete_min_rx, delete_hundredgigabitethernet, delete_bfd, min_rx, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_bfd_interval_min_rx(delete_interval=delete_interval, delete_min_rx=delete_min_rx, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_bfd=delete_bfd, host=host, password=password, delete_interface=delete_interface, username=username, min_rx=min_rx, callback=_callback, mgr=mgr)
        return 0
