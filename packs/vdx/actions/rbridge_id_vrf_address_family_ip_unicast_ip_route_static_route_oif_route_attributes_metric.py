...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_route_attributes_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_route_attributes_metric_act(Action):
    def run(self, delete_static_route_oif, delete_address_family, static_route_oif_type, rbridge_id, delete_ip, delete_route, delete_vrf, metric, delete_static_route_oif_name, delete_route_attributes, delete_static_route_oif_type, delete_static_route_dest, vrf_name, static_route_dest, static_route_oif_name, delete_rbridge_id, delete_unicast, delete_metric, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_route_attributes_metric(delete_route_attributes=delete_route_attributes, delete_static_route_oif_name=delete_static_route_oif_name, delete_ip=delete_ip, delete_static_route_oif=delete_static_route_oif, delete_address_family=delete_address_family, static_route_dest=static_route_dest, rbridge_id=rbridge_id, vrf_name=vrf_name, metric=metric, delete_static_route_oif_type=delete_static_route_oif_type, static_route_oif_name=static_route_oif_name, delete_rbridge_id=delete_rbridge_id, password=password, delete_route=delete_route, delete_vrf_name=delete_vrf_name, delete_vrf=delete_vrf, delete_metric=delete_metric, username=username, delete_static_route_dest=delete_static_route_dest, host=host, static_route_oif_type=static_route_oif_type, delete_unicast=delete_unicast, callback=_callback, mgr=mgr)
        return 0
