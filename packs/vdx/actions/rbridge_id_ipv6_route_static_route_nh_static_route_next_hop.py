...
def rbridge_id_ipv6_route_static_route_nh_static_route_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_route_nh_static_route_next_hop_act(Action):
    def run(self, delete_static_route_next_hop, rbridge_id, delete_route, delete_static_route_nh, delete_static_route_dest, static_route_dest, delete_rbridge_id, static_route_next_hop, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_static_route_nh_static_route_next_hop(delete_route=delete_route, delete_static_route_dest=delete_static_route_dest, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_static_route_next_hop=delete_static_route_next_hop, static_route_next_hop=static_route_next_hop, host=host, static_route_dest=static_route_dest, delete_static_route_nh=delete_static_route_nh, password=password, callback=_callback, mgr=mgr)
        return 0
