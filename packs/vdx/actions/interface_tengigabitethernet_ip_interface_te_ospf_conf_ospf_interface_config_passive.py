...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_passive(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_passive_act(Action):
    def run(self, delete_interface_te_ospf_conf, name, delete_ip, delete_passive, delete_interface, delete_name, delete_tengigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_passive(name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_passive=delete_passive, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, password=password, callback=_callback, mgr=mgr)
        return 0
