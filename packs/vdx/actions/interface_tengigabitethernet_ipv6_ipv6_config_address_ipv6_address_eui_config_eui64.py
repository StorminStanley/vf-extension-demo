...
def interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui64(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui64_act(Action):
    def run(self, name, delete_interface, delete_name, address, delete_address, delete_tengigabitethernet, delete_eui_config, host, username, password):
