...
def interface_gigabitethernet_vrrp_track_interface_track_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_track_interface_track_priority_act(Action):
    def run(self, delete_track_priority, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_version, delete_interface_type, version, delete_interface, delete_name, track_priority, delete_vrrp, interface_name, delete_track, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_track_interface_track_priority(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_track=delete_track, username=username, interface_name=interface_name, delete_track_priority=delete_track_priority, version=version, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, vrid=vrid, interface_type=interface_type, delete_name=delete_name, delete_interface=delete_interface, delete_gigabitethernet=delete_gigabitethernet, track_priority=track_priority, password=password, callback=_callback, mgr=mgr)
        return 0
