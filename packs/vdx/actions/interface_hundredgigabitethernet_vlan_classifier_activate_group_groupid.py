...
def interface_hundredgigabitethernet_vlan_classifier_activate_group_groupid(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vlan_classifier_activate_group_groupid_act(Action):
    def run(self, delete_vlan, delete_classifier, name, delete_group, delete_activate, delete_interface, delete_name, delete_groupid, delete_hundredgigabitethernet, groupid, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_vlan_classifier_activate_group_groupid(delete_activate=delete_activate, name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_groupid=delete_groupid, delete_classifier=delete_classifier, groupid=groupid, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_group=delete_group, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
