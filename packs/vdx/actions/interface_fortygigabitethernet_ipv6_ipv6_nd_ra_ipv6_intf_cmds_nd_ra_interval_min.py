...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_min(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_min', False) is True:
        delete_min = config.find('.//*min')
        delete_min.set('operation', 'delete')
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_min_act(Action):
    def run(self, min, name, delete_ra_interval, delete_min, delete_fortygigabitethernet, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_min(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, delete_ra_interval=delete_ra_interval, min=min, host=host, delete_nd=delete_nd, delete_name=delete_name, delete_interface=delete_interface, delete_min=delete_min, password=password, callback=_callback, mgr=mgr)
        return 0
