...
def interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_act(Action):
    def run(self, name, esp, delete_ipsec_auth_key_config, delete_ca_esp_algorithm, delete_esp, delete_authentication, delete_name, delete_hundredgigabitethernet, delete_ch_algorithm, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp(delete_ca_esp_algorithm=delete_ca_esp_algorithm, delete_esp=delete_esp, name=name, esp=esp, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_authentication=delete_authentication, host=host, delete_ch_algorithm=delete_ch_algorithm, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
