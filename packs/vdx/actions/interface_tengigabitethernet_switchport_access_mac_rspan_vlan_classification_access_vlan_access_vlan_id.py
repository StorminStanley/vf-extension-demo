...
def interface_tengigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_access_vlan_id, name, delete_access_mac_rspan_vlan_classification, delete_access, delete_access_mac_address, access_mac_address, delete_interface, delete_name, access_vlan_id, delete_tengigabitethernet, host, username, password):
