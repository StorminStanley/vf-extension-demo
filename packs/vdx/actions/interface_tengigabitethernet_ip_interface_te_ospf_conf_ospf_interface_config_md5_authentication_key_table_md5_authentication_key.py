...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key_act(Action):
    def run(self, delete_interface_te_ospf_conf, name, delete_ip, delete_key_table, delete_interface, delete_name, delete_tengigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key(name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_key_table=delete_key_table, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, password=password, callback=_callback, mgr=mgr)
        return 0
