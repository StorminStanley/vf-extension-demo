...
def rbridge_id_route_map_content_set_automatic_tag_tag_empty(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_automatic_tag_tag_empty_act(Action):
    def run(self, rbridge_id, delete_set, delete_automatic_tag, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_tag_empty, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_automatic_tag_tag_empty(delete_instance=delete_instance, delete_tag_empty=delete_tag_empty, name=name, action_rm=action_rm, delete_name=delete_name, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_automatic_tag=delete_automatic_tag, host=host, delete_set=delete_set, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
