...
def rbridge_id_interface_ve_bfd_interval_min_tx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_bfd_interval_min_tx_act(Action):
    def run(self, name, delete_min_tx, delete_interval, delete_ve, delete_interface, delete_name, min_tx, delete_rbridge_id, delete_bfd, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_bfd_interval_min_tx(delete_interval=delete_interval, name=name, delete_name=delete_name, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_bfd=delete_bfd, min_tx=min_tx, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_min_tx=delete_min_tx, password=password, callback=_callback, mgr=mgr)
        return 0
