...
def interface_hundredgigabitethernet_ipv6_vrrpv3_group_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3_group_hold_time_act(Action):
    def run(self, name, delete_vrid, delete_hold_time, vrid, delete_interface, delete_name, delete_hundredgigabitethernet, hold_time, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_vrrpv3_group_hold_time(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, vrid=vrid, hold_time=hold_time, delete_interface=delete_interface, username=username, delete_hold_time=delete_hold_time, password=password, callback=_callback, mgr=mgr)
        return 0
