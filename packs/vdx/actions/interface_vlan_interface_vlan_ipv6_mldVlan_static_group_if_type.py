...
def interface_vlan_interface_vlan_ipv6_mldVlan_static_group_if_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ipv6_mldVlan_static_group_if_type_act(Action):
    def run(self, delete_vlan, name, delete_mcast_address, delete_interface_vlan, mcast_address, value, delete_mldVlan, delete_if_type, delete_interface, delete_name, if_type, interface, delete_static_group, delete_value, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ipv6_mldVlan_static_group_if_type(mcast_address=mcast_address, name=name, delete_mldVlan=delete_mldVlan, delete_value=delete_value, username=username, delete_vlan=delete_vlan, if_type=if_type, delete_name=delete_name, delete_static_group=delete_static_group, value=value, host=host, interface=interface, delete_interface_vlan=delete_interface_vlan, delete_mcast_address=delete_mcast_address, delete_if_type=delete_if_type, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
