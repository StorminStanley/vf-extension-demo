...
def rbridge_id_ipv6_route_static_route_oif_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_route_oif_static_route_dest_act(Action):
    def run(self, delete_static_route_oif, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_static_route_dest, delete_static_route_oif_name, static_route_dest, static_route_oif_name, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_static_route_oif_static_route_dest(delete_route=delete_route, delete_static_route_dest=delete_static_route_dest, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_static_route_oif=delete_static_route_oif, delete_static_route_oif_type=delete_static_route_oif_type, host=host, static_route_oif_type=static_route_oif_type, static_route_oif_name=static_route_oif_name, delete_static_route_oif_name=delete_static_route_oif_name, static_route_dest=static_route_dest, password=password, callback=_callback, mgr=mgr)
        return 0
