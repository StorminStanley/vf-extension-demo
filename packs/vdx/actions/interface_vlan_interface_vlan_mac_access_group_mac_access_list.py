...
def interface_vlan_interface_vlan_mac_access_group_mac_access_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_mac_access_group_mac_access_list_act(Action):
