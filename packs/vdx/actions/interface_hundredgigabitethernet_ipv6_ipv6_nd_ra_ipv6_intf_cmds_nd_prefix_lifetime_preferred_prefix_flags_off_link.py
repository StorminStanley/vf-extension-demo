...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_off_link(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_off_link', False) is True:
        delete_off_link = config.find('.//*off-link')
        delete_off_link.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_off_link_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_off_link, delete_interface, delete_name, delete_prefix_flags, delete_hundredgigabitethernet, delete_lifetime, delete_nd, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_off_link(delete_prefix_flags=delete_prefix_flags, name=name, delete_name=delete_name, delete_off_link=delete_off_link, delete_lifetime=delete_lifetime, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_preferred=delete_preferred, delete_nd=delete_nd, delete_prefix=delete_prefix, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
