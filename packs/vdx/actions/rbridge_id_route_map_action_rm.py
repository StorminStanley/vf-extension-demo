...
def rbridge_id_route_map_action_rm(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_action_rm_act(Action):
    def run(self, rbridge_id, delete_route_map, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_action_rm(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_route_map=delete_route_map, host=host, password=password, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
