...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, delete_ethernet_interface, delete_update_source, router_bgp_neighbor_peer_grp, delete_ch_update_source, delete_router_bgp_attributes, delete_ethernet, delete_neighbor_peer_grp, ethernet, delete_rbridge_id, delete_peer_grps, delete_ca_eth, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet(delete_ethernet_interface=delete_ethernet_interface, delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router_bgp=delete_router_bgp, ethernet=ethernet, username=username, delete_ethernet=delete_ethernet, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, password=password, delete_neighbor=delete_neighbor, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, delete_ca_eth=delete_ca_eth, delete_peer_grps=delete_peer_grps, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_ch_update_source=delete_ch_update_source, host=host, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
