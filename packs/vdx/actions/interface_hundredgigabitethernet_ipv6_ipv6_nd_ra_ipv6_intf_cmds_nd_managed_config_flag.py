...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_managed_config_flag(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_managed_config_flag_act(Action):
    def run(self, name, delete_managed_config_flag, delete_interface, delete_name, delete_hundredgigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_managed_config_flag(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, delete_managed_config_flag=delete_managed_config_flag, password=password, callback=_callback, mgr=mgr)
        return 0
