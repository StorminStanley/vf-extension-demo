...
def interface_hundredgigabitethernet_vrrp_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_preempt_mode_act(Action):
    def run(self, name, delete_vrid, vrid, delete_preempt_mode, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_vrrp_preempt_mode(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, version=version, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
