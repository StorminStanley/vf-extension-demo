...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_local_ip_gw_id(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_local_ip_gw_id_act(Action):
    def run(self, name, delete_ip, delete_ip_local_anycast_gateway, delete_ve, delete_interface, delete_name, delete_rbridge_id, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
