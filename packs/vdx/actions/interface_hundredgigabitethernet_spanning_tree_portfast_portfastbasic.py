...
def interface_hundredgigabitethernet_spanning_tree_portfast_portfastbasic(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_portfast_portfastbasic_act(Action):
    def run(self, delete_portfast, name, delete_portfastbasic, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_portfast_portfastbasic(name=name, delete_name=delete_name, delete_portfastbasic=delete_portfastbasic, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_spanning_tree=delete_spanning_tree, host=host, delete_portfast=delete_portfast, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
