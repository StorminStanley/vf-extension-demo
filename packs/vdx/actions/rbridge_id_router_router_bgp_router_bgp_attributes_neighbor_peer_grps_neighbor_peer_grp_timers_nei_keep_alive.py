...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_timers_nei_keep_alive(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_timers_nei_keep_alive_act(Action):
    def run(self, nei_keep_alive, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, router_bgp_neighbor_peer_grp, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_timers, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, delete_nei_keep_alive, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_timers_nei_keep_alive(delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router=delete_router, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_timers=delete_timers, rbridge_id=rbridge_id, nei_keep_alive=nei_keep_alive, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_nei_keep_alive=delete_nei_keep_alive, delete_rbridge_id=delete_rbridge_id, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_peer_grps=delete_peer_grps, callback=_callback, mgr=mgr)
        return 0
