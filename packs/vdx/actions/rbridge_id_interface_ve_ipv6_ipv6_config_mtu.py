...
def rbridge_id_interface_ve_ipv6_ipv6_config_mtu(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ipv6_ipv6_config_mtu_act(Action):
    def run(self, name, delete_mtu, mtu, delete_ve, delete_interface, delete_name, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ipv6_ipv6_config_mtu(mtu=mtu, name=name, delete_name=delete_name, username=username, rbridge_id=rbridge_id, delete_mtu=delete_mtu, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
