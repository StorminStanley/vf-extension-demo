...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_maximum_prefix(**kwargs):
    """Auto Generated Code
    """
    ...
    maximum_prefix = ET.SubElement(evpn_peer_group, "maximum-prefix")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_maximum_prefix_act(Action):
    def run(self, delete_evpn_neighbor_peergroup_name, delete_address_family, delete_router_bgp, rbridge_id, delete_evpn, evpn_neighbor_peergroup_name, maximum_prefix, delete_evpn_peer_group, delete_rbridge_id, delete_maximum_prefix, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_maximum_prefix(delete_address_family=delete_address_family, username=username, delete_evpn=delete_evpn, evpn_neighbor_peergroup_name=evpn_neighbor_peergroup_name, rbridge_id=rbridge_id, delete_router=delete_router, delete_maximum_prefix=delete_maximum_prefix, delete_neighbor=delete_neighbor, host=host, password=password, delete_evpn_peer_group=delete_evpn_peer_group, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, delete_evpn_neighbor_peergroup_name=delete_evpn_neighbor_peergroup_name, maximum_prefix=maximum_prefix, callback=_callback, mgr=mgr)
        return 0
