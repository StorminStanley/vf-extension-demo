...
def interface_fortygigabitethernet_switchport_mode_private_vlan_promiscuous(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_mode_private_vlan_promiscuous_act(Action):
    def run(self, delete_switchport, name, delete_fortygigabitethernet, delete_private_vlan, delete_interface, delete_name, delete_promiscuous, delete_mode, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_mode_private_vlan_promiscuous(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_promiscuous=delete_promiscuous, delete_switchport=delete_switchport, delete_mode=delete_mode, host=host, delete_private_vlan=delete_private_vlan, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
