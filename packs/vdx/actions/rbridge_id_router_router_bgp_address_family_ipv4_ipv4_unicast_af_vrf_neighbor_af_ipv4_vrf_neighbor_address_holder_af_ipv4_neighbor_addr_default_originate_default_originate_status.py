...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_default_originate_default_originate_status(**kwargs):
    """Auto Generated Code
    """
    ...
    default_originate = ET.SubElement(af_ipv4_neighbor_addr, "default-originate")
    ...
    if kwargs.pop('delete_default_originate_status', False) is True:
        delete_default_originate_status = config.find('.//*default-originate-status')
        delete_default_originate_status.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_default_originate_default_originate_status_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_default_originate_status, delete_default_originate, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_default_originate_default_originate_status(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_default_originate_status=delete_default_originate_status, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_default_originate=delete_default_originate, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
