...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_static_route_dest_act(Action):
    def run(self, delete_static_route_oif, delete_address_family, static_route_oif_type, rbridge_id, delete_ip, delete_route, delete_vrf, delete_static_route_dest, delete_static_route_oif_type, delete_static_route_oif_name, vrf_name, static_route_dest, static_route_oif_name, delete_rbridge_id, delete_unicast, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_static_route_dest(delete_address_family=delete_address_family, delete_static_route_dest=delete_static_route_dest, delete_route=delete_route, vrf_name=vrf_name, username=username, delete_vrf=delete_vrf, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_static_route_oif=delete_static_route_oif, delete_static_route_oif_type=delete_static_route_oif_type, host=host, delete_vrf_name=delete_vrf_name, static_route_oif_type=static_route_oif_type, static_route_oif_name=static_route_oif_name, delete_static_route_oif_name=delete_static_route_oif_name, delete_rbridge_id=delete_rbridge_id, static_route_dest=static_route_dest, delete_unicast=delete_unicast, password=password, callback=_callback, mgr=mgr)
        return 0
