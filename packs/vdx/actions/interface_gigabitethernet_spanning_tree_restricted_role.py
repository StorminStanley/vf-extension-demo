...
def interface_gigabitethernet_spanning_tree_restricted_role(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_restricted_role_act(Action):
    def run(self, name, delete_interface, delete_name, delete_restricted_role, delete_spanning_tree, delete_gigabitethernet, host, username, password):
