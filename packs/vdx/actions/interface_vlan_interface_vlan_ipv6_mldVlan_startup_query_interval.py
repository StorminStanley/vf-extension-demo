...
def interface_vlan_interface_vlan_ipv6_mldVlan_startup_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ipv6_mldVlan_startup_query_interval_act(Action):
    def run(self, delete_vlan, startup_query_interval, name, delete_interface_vlan, delete_mldVlan, delete_interface, delete_name, delete_startup_query_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ipv6_mldVlan_startup_query_interval(name=name, delete_mldVlan=delete_mldVlan, delete_vlan=delete_vlan, startup_query_interval=startup_query_interval, delete_startup_query_interval=delete_startup_query_interval, delete_interface_vlan=delete_interface_vlan, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
