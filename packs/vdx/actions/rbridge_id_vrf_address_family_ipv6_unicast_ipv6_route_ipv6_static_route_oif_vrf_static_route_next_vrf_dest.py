...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_ipv6_static_route_oif_vrf_static_route_next_vrf_dest(**kwargs):
    """Auto Generated Code
    """
    ...
    static_route_next_vrf_dest = ET.SubElement(ipv6_static_route_oif_vrf, "static-route-next-vrf-dest")
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_ipv6_static_route_oif_vrf_static_route_next_vrf_dest_act(Action):
    def run(self, delete_address_family, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_vrf, delete_next_hop_vrf, delete_static_route_next_vrf_dest, static_route_next_vrf_dest, delete_static_route_oif_name, vrf_name, next_hop_vrf, delete_rbridge_id, delete_unicast, static_route_oif_name, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_ipv6_static_route_oif_vrf_static_route_next_vrf_dest(delete_address_family=delete_address_family, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, username=username, static_route_next_vrf_dest=static_route_next_vrf_dest, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, delete_static_route_oif_type=delete_static_route_oif_type, host=host, delete_vrf_name=delete_vrf_name, static_route_oif_type=static_route_oif_type, delete_next_hop_vrf=delete_next_hop_vrf, delete_unicast=delete_unicast, static_route_oif_name=static_route_oif_name, delete_rbridge_id=delete_rbridge_id, next_hop_vrf=next_hop_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
