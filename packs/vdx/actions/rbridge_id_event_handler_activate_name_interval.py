...
def rbridge_id_event_handler_activate_name_interval(**kwargs):
    """Auto Generated Code
    """
    ...
    interval = ET.SubElement(name, "interval")
...
class rbridge_id_event_handler_activate_name_interval_act(Action):
    def run(self, delete_interval, rbridge_id, delete_event_handler, interval, delete_activate, delete_name, delete_rbridge_id, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_event_handler_activate_name_interval(delete_interval=delete_interval, delete_activate=delete_activate, name=name, delete_name=delete_name, username=username, rbridge_id=rbridge_id, interval=interval, host=host, delete_event_handler=delete_event_handler, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
