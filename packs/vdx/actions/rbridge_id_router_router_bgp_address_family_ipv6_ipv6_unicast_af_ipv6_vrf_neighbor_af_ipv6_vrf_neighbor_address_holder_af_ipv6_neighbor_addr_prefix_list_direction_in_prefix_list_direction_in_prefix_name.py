...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_prefix_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_prefix_name_act(Action):
    def run(self, delete_direction_in, delete_address_family, delete_router_bgp, rbridge_id, prefix_list_direction_in_prefix_name, delete_prefix_list_direction_in_prefix_name, delete_prefix_list, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_prefix_name(prefix_list_direction_in_prefix_name=prefix_list_direction_in_prefix_name, delete_prefix_list=delete_prefix_list, delete_router_bgp=delete_router_bgp, delete_direction_in=delete_direction_in, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, password=password, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_prefix_list_direction_in_prefix_name=delete_prefix_list_direction_in_prefix_name, callback=_callback, mgr=mgr)
        return 0
