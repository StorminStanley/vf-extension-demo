...
def rbridge_id_route_map_content_match_route_type_route_type_rmm(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_route_type_route_type_rmm_act(Action):
    def run(self, rbridge_id, route_type_rmm, delete_match, delete_route_map, delete_content, delete_route_type, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_route_type_rmm, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_route_type_route_type_rmm(delete_route_type=delete_route_type, delete_instance=delete_instance, route_type_rmm=route_type_rmm, action_rm=action_rm, username=username, delete_action_rm=delete_action_rm, delete_route_type_rmm=delete_route_type_rmm, rbridge_id=rbridge_id, name=name, delete_route_map=delete_route_map, delete_content=delete_content, host=host, password=password, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
