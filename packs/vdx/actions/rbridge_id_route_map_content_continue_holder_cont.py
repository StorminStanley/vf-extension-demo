...
def rbridge_id_route_map_content_continue_holder_cont(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_continue_holder_cont_act(Action):
    def run(self, delete_continue_holder, rbridge_id, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_cont, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_continue_holder_cont(delete_instance=delete_instance, name=name, action_rm=action_rm, username=username, delete_action_rm=delete_action_rm, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_route_map=delete_route_map, delete_content=delete_content, host=host, password=password, delete_cont=delete_cont, delete_name=delete_name, delete_continue_holder=delete_continue_holder, instance=instance, callback=_callback, mgr=mgr)
        return 0
