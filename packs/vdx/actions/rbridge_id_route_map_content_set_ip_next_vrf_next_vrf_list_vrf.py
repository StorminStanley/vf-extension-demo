...
def rbridge_id_route_map_content_set_ip_next_vrf_next_vrf_list_vrf(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ip_next_vrf_next_vrf_list_vrf_act(Action):
    def run(self, next_hop, rbridge_id, delete_set, delete_next_vrf, delete_next_hop, delete_vrf, delete_route_map, delete_content, instance, delete_instance, action_rm, vrf, delete_name, delete_next_vrf_list, delete_rbridge_id, delete_ip, delete_action_rm, name, host, username, password):
