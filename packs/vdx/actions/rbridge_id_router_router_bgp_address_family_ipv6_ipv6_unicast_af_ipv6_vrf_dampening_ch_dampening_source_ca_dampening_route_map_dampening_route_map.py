...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_dampening_ch_dampening_source_ca_dampening_route_map_dampening_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_dampening_ch_dampening_source_ca_dampening_route_map_dampening_route_map_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_dampening_route_map, delete_dampening, dampening_route_map, delete_ca_dampening_route_map, delete_rbridge_id, delete_router, delete_ch_dampening_source, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_dampening_ch_dampening_source_ca_dampening_route_map_dampening_route_map(delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_ca_dampening_route_map=delete_ca_dampening_route_map, host=host, password=password, delete_dampening_route_map=delete_dampening_route_map, delete_address_family=delete_address_family, dampening_route_map=dampening_route_map, delete_ch_dampening_source=delete_ch_dampening_source, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
