...
def interface_hundredgigabitethernet_ip_ip_config_arp_learn_any(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_ip_config_arp_learn_any_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_learn_any, delete_interface, delete_name, delete_hundredgigabitethernet, delete_arp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_ip_config_arp_learn_any(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_ip_config=delete_ip_config, delete_arp=delete_arp, delete_ip=delete_ip, delete_learn_any=delete_learn_any, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
