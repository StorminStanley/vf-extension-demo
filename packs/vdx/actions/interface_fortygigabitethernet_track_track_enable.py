...
def interface_fortygigabitethernet_track_track_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_track_track_enable_act(Action):
    def run(self, delete_track_enable, name, delete_fortygigabitethernet, delete_interface, delete_name, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_track_track_enable(delete_track_enable=delete_track_enable, name=name, delete_name=delete_name, delete_track=delete_track, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
