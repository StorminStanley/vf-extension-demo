...
def interface_port_channel_spanning_tree_vlan_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_spanning_tree_vlan_priority_act(Action):
    def run(self, delete_vlan, name, delete_id, id, priority, delete_port_channel, delete_priority, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_spanning_tree_vlan_priority(name=name, delete_name=delete_name, username=username, delete_vlan=delete_vlan, delete_id=delete_id, priority=priority, delete_spanning_tree=delete_spanning_tree, delete_port_channel=delete_port_channel, host=host, id=id, delete_priority=delete_priority, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
