...
def interface_hundredgigabitethernet_lldp_dcbx_version(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_lldp_dcbx_version_act(Action):
    def run(self, delete_lldp, name, delete_dcbx_version, delete_interface, delete_name, dcbx_version, delete_hundredgigabitethernet, host, username, password):
