...
def interface_fortygigabitethernet_ip_ip_config_directed_broadcast(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_ip_config_directed_broadcast_act(Action):
    def run(self, delete_ip_config, delete_directed_broadcast, name, delete_ip, delete_fortygigabitethernet, delete_interface, delete_name, host, username, password):
