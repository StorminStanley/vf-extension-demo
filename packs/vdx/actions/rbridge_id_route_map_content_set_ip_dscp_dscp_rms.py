...
def rbridge_id_route_map_content_set_ip_dscp_dscp_rms(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ip_dscp_dscp_rms_act(Action):
    def run(self, dscp_rms, rbridge_id, delete_set, delete_dscp_rms, delete_route_map, delete_content, delete_dscp, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_ip, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_ip_dscp_dscp_rms(delete_dscp=delete_dscp, delete_instance=delete_instance, dscp_rms=dscp_rms, action_rm=action_rm, delete_name=delete_name, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, name=name, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_dscp_rms=delete_dscp_rms, host=host, delete_set=delete_set, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
