...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_dest(**kwargs):
    """Auto Generated Code
    """
    ...
    bfd_ipv6_static_route_dest = ET.SubElement(bfd_ipv6_static_route, "bfd-ipv6-static-route-dest")
    ...
    bfd_ipv6_static_route_dest.text = kwargs.pop('bfd_ipv6_static_route_dest')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_dest_act(Action):
    def run(self, delete_address_family, rbridge_id, delete_route, delete_vrf, delete_static, vrf_name, delete_rbridge_id, delete_unicast, delete_bfd, delete_vrf_name, host, username, password):
