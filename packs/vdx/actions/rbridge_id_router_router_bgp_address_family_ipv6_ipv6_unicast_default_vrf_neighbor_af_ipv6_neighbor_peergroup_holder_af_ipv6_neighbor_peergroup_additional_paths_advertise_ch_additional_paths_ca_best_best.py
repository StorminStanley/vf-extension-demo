...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_neighbor_af_ipv6_neighbor_peergroup_holder_af_ipv6_neighbor_peergroup_additional_paths_advertise_ch_additional_paths_ca_best_best(**kwargs):
    """Auto Generated Code
    """
    ...
    additional_paths = ET.SubElement(af_ipv6_neighbor_peergroup, "additional-paths")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_neighbor_af_ipv6_neighbor_peergroup_holder_af_ipv6_neighbor_peergroup_additional_paths_advertise_ch_additional_paths_ca_best_best_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, best, delete_best, delete_default_vrf, delete_advertise, delete_ch_additional_paths, delete_rbridge_id, delete_ca_best, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_neighbor_af_ipv6_neighbor_peergroup_holder_af_ipv6_neighbor_peergroup_additional_paths_advertise_ch_additional_paths_ca_best_best(delete_ch_additional_paths=delete_ch_additional_paths, delete_additional_paths=delete_additional_paths, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_best=delete_best, delete_ca_best=delete_ca_best, best=best, delete_router=delete_router, host=host, password=password, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
