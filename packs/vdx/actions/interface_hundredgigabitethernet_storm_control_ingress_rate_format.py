...
def interface_hundredgigabitethernet_storm_control_ingress_rate_format(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_storm_control_ingress_rate_format_act(Action):
    def run(self, rate_format, delete_storm_control, delete_rate_format, delete_ingress, delete_protocol_type, delete_interface, delete_name, delete_hundredgigabitethernet, protocol_type, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_storm_control_ingress_rate_format(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, delete_hundredgigabitethernet=delete_hundredgigabitethernet, rate_format=rate_format, delete_ingress=delete_ingress, delete_rate_format=delete_rate_format, host=host, delete_protocol_type=delete_protocol_type, protocol_type=protocol_type, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
