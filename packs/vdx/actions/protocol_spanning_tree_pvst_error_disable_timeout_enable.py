...
def protocol_spanning_tree_pvst_error_disable_agtimeout_enable(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_pvst_error_disable_agtimeout_enable_act(Action):
    def run(self, delete_pvst, delete_error_disable_agtimeout, delete_enable, delete_spanning_tree, delete_protocol, host, username, password):
