...
def interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_remove(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_remove_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_pvlan_remove, delete_trunk, delete_private_vlan, delete_interface, delete_name, delete_tengigabitethernet, pvlan_remove, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_remove(delete_pvlan_remove=delete_pvlan_remove, name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, pvlan_remove=pvlan_remove, delete_allowed=delete_allowed, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_private_vlan=delete_private_vlan, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
