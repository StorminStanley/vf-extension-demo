...
def interface_tengigabitethernet_ipv6_access_group_ipv6_access_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_access_group_ipv6_access_list_act(Action):
    def run(self, name, delete_ip_direction, delete_access_group, delete_name, ip_direction, delete_tengigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_access_group_ipv6_access_list(name=name, delete_name=delete_name, delete_access_group=delete_access_group, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_ip_direction=delete_ip_direction, ip_direction=ip_direction, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
