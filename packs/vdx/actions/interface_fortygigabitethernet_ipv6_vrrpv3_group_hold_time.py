...
def interface_fortygigabitethernet_ipv6_vrrpv3_group_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3_group_hold_time_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_vrid, delete_hold_time, vrid, delete_interface, delete_name, hold_time, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3_group_hold_time(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, host=host, vrid=vrid, hold_time=hold_time, delete_name=delete_name, delete_hold_time=delete_hold_time, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
