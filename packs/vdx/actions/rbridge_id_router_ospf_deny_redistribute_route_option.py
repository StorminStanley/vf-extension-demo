...
def rbridge_id_router_ospf_deny_redistribute_route_option(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_deny_redistribute_route_option_act(Action):
