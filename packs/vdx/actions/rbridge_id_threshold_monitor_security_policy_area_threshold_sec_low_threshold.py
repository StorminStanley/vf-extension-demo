...
def rbridge_id_threshold_monitor_security_policy_area_threshold_sec_low_threshold(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_security_policy_area_threshold_sec_low_threshold_act(Action):
    def run(self, delete_sec_policy_name, sec_policy_name, delete_threshold, sec_area_value, sec_low_threshold, delete_policy, delete_security, delete_area, delete_threshold_monitor, delete_sec_low_threshold, delete_rbridge_id, delete_sec_area_value, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_security_policy_area_threshold_sec_low_threshold(sec_area_value=sec_area_value, username=username, delete_threshold_monitor=delete_threshold_monitor, sec_policy_name=sec_policy_name, delete_security=delete_security, delete_sec_area_value=delete_sec_area_value, delete_sec_low_threshold=delete_sec_low_threshold, sec_low_threshold=sec_low_threshold, delete_area=delete_area, delete_policy=delete_policy, delete_threshold=delete_threshold, host=host, delete_rbridge_id=delete_rbridge_id, delete_sec_policy_name=delete_sec_policy_name, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
