...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id_act(Action):
    def run(self, no_encrypt_key_id, delete_ip, delete_interface_PO_ospf_conf, delete_no_encrypt_key_table, delete_port_channel, delete_interface, delete_name, delete_no_encrypt_key_id, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(delete_ospf_interface_config=delete_ospf_interface_config, delete_no_encrypt_key_table=delete_no_encrypt_key_table, delete_ip=delete_ip, delete_name=delete_name, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_no_encrypt_key_id=delete_no_encrypt_key_id, delete_port_channel=delete_port_channel, host=host, no_encrypt_key_id=no_encrypt_key_id, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
