...
def rbridge_id_system_monitor_sfp_alert_action(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_system_monitor_sfp_alert_action_act(Action):
    def run(self, rbridge_id, delete_alert, delete_action, action, delete_rbridge_id, delete_sfp, delete_system_monitor, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_system_monitor_sfp_alert_action(delete_system_monitor=delete_system_monitor, action=action, username=username, rbridge_id=rbridge_id, delete_action=delete_action, host=host, delete_sfp=delete_sfp, delete_alert=delete_alert, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
