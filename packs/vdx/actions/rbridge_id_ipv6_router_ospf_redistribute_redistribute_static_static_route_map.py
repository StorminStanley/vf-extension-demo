...
def rbridge_id_ipv6_router_ospf_redistribute_redistribute_static_static_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_redistribute_redistribute_static_static_route_map_act(Action):
    def run(self, delete_static_route_map, delete_redistribute_static, rbridge_id, delete_ospf, delete_vrf, delete_redistribute, vrf, delete_rbridge_id, static_route_map, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_redistribute_redistribute_static_static_route_map(delete_static_route_map=delete_static_route_map, delete_redistribute_static=delete_redistribute_static, username=username, delete_redistribute=delete_redistribute, rbridge_id=rbridge_id, delete_vrf=delete_vrf, static_route_map=static_route_map, delete_router=delete_router, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
