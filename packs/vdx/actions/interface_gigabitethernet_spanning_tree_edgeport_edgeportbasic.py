...
def interface_gigabitethernet_spanning_tree_edgeport_edgeportbasic(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_edgeport_edgeportbasic_act(Action):
    def run(self, name, delete_interface, delete_name, delete_edgeport, delete_edgeportbasic, delete_spanning_tree, delete_gigabitethernet, host, username, password):
