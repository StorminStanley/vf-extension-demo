...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_nh_route_attributes_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_nh_route_attributes_metric_act(Action):
    def run(self, delete_static_route_next_hop, delete_address_family, rbridge_id, delete_route, delete_vrf, metric, delete_static_route_nh, delete_route_attributes, delete_static_route_dest, vrf_name, static_route_dest, delete_metric, delete_rbridge_id, delete_unicast, static_route_next_hop, delete_vrf_name, host, username, password):
