...
def interface_fortygigabitethernet_switchport_port_security_port_sec_max(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_port_security_port_sec_max_act(Action):
    def run(self, delete_switchport, delete_port_sec_max, name, port_sec_max, delete_fortygigabitethernet, delete_interface, delete_name, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_port_security_port_sec_max(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, username=username, host=host, port_sec_max=port_sec_max, delete_name=delete_name, delete_interface=delete_interface, delete_port_sec_max=delete_port_sec_max, delete_port_security=delete_port_security, password=password, callback=_callback, mgr=mgr)
        return 0
