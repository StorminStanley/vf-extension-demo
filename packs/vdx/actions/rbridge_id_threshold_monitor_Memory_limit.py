...
def rbridge_id_threshold_monitor_Memory_limit(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_Memory_limit_act(Action):
    def run(self, rbridge_id, delete_Memory, delete_limit, limit, delete_threshold_monitor, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_Memory_limit(username=username, limit=limit, delete_Memory=delete_Memory, rbridge_id=rbridge_id, delete_threshold_monitor=delete_threshold_monitor, host=host, delete_rbridge_id=delete_rbridge_id, delete_limit=delete_limit, password=password, callback=_callback, mgr=mgr)
        return 0
