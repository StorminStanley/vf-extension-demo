...
def protocol_spanning_tree_rpvst_bridge_priority(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rpvst_bridge_priority_act(Action):
    def run(self, delete_rpvst, delete_bridge_priority, delete_spanning_tree, bridge_priority, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rpvst_bridge_priority(delete_rpvst=delete_rpvst, username=username, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, delete_bridge_priority=delete_bridge_priority, host=host, bridge_priority=bridge_priority, password=password, callback=_callback, mgr=mgr)
        return 0
