...
def interface_hundredgigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary_act(Action):
    def run(self, delete_eui_secondary, name, delete_interface, delete_name, address, delete_hundredgigabitethernet, delete_address, delete_eui_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(name=name, delete_name=delete_name, address=address, delete_eui_config=delete_eui_config, delete_eui_secondary=delete_eui_secondary, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_address=delete_address, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
