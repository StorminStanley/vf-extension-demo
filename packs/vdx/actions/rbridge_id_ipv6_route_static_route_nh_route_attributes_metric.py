...
def rbridge_id_ipv6_route_static_route_nh_route_attributes_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_route_nh_route_attributes_metric_act(Action):
    def run(self, delete_static_route_next_hop, delete_route_attributes, rbridge_id, delete_route, metric, delete_static_route_nh, delete_static_route_dest, static_route_dest, delete_rbridge_id, static_route_next_hop, delete_metric, host, username, password):
