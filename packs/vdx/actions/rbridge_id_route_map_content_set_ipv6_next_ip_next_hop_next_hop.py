...
def rbridge_id_route_map_content_set_ipv6_next_ip_next_hop_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ipv6_next_ip_next_hop_next_hop_act(Action):
    def run(self, next_hop, rbridge_id, delete_set, delete_next_hop, delete_next_ip, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_ipv6_next_ip_next_hop_next_hop(delete_instance=delete_instance, delete_route_map=delete_route_map, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_next_ip=delete_next_ip, password=password, delete_next_hop=delete_next_hop, delete_content=delete_content, delete_set=delete_set, instance=instance, delete_name=delete_name, host=host, delete_rbridge_id=delete_rbridge_id, next_hop=next_hop, callback=_callback, mgr=mgr)
        return 0
