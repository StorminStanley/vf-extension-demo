...
def interface_tengigabitethernet_ip_interface_te_dhcp_conf_dhcp_relay_servers_relay_ip_addr(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_interface_te_dhcp_conf', False) is True:
        delete_interface_te_dhcp_conf = config.find('.//*interface-te-dhcp-conf')
        delete_interface_te_dhcp_conf.set('operation', 'delete')
...
class interface_tengigabitethernet_ip_interface_te_dhcp_conf_dhcp_relay_servers_relay_ip_addr_act(Action):
    def run(self, delete_interface_te_dhcp_conf, name, delete_ip, delete_servers, server_vrf_name, relay_ip_addr, delete_dhcp, delete_relay, delete_interface, delete_name, delete_tengigabitethernet, delete_server_vrf_name, delete_relay_ip_addr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_dhcp_conf_dhcp_relay_servers_relay_ip_addr(delete_interface_te_dhcp_conf=delete_interface_te_dhcp_conf, relay_ip_addr=relay_ip_addr, name=name, delete_name=delete_name, delete_relay=delete_relay, username=username, delete_dhcp=delete_dhcp, delete_ip=delete_ip, server_vrf_name=server_vrf_name, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, delete_servers=delete_servers, delete_relay_ip_addr=delete_relay_ip_addr, password=password, delete_server_vrf_name=delete_server_vrf_name, callback=_callback, mgr=mgr)
        return 0
