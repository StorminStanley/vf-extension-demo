...
def rbridge_id_ipv6_route_static_route_nh_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_route_nh_static_route_dest_act(Action):
