...
def rbridge_id_route_map_content_match_next_hop_next_hop_filter_val(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_next_hop_next_hop_filter_val_act(Action):
    def run(self, rbridge_id, delete_next_hop, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_next_hop_filter_val, delete_name, delete_rbridge_id, next_hop_filter_val, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_next_hop_next_hop_filter_val(delete_instance=delete_instance, delete_route_map=delete_route_map, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, password=password, delete_next_hop=delete_next_hop, delete_content=delete_content, next_hop_filter_val=next_hop_filter_val, host=host, delete_next_hop_filter_val=delete_next_hop_filter_val, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
