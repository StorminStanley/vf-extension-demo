...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_associate_peer_group(**kwargs):
    """Auto Generated Code
    """
    ...
    associate_peer_group = ET.SubElement(af_ipv6_neighbor_addr, "associate-peer-group")
    if kwargs.pop('delete_associate_peer_group', False) is True:
        delete_associate_peer_group = config.find('.//*associate-peer-group')
        delete_associate_peer_group.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_associate_peer_group_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_associate_peer_group, delete_rbridge_id, delete_neighbor, delete_router, associate_peer_group, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_associate_peer_group(delete_router_bgp=delete_router_bgp, delete_associate_peer_group=delete_associate_peer_group, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, associate_peer_group=associate_peer_group, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
