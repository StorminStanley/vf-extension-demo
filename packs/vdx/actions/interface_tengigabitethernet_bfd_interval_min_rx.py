...
def interface_tengigabitethernet_bfd_interval_min_rx(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_bfd_interval_min_rx_act(Action):
    def run(self, name, delete_interval, delete_interface, delete_name, delete_min_rx, delete_bfd, delete_tengigabitethernet, min_rx, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_bfd_interval_min_rx(delete_interval=delete_interval, delete_min_rx=delete_min_rx, name=name, delete_name=delete_name, delete_bfd=delete_bfd, delete_tengigabitethernet=delete_tengigabitethernet, password=password, host=host, delete_interface=delete_interface, username=username, min_rx=min_rx, callback=_callback, mgr=mgr)
        return 0
