...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_address_holder_af_ipv4_neighbor_address_additional_paths_advertise_ch_additional_paths_ca_best_best(**kwargs):
    """Auto Generated Code
    """
    ...
    additional_paths = ET.SubElement(af_ipv4_neighbor_address, "additional-paths")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_address_holder_af_ipv4_neighbor_address_additional_paths_advertise_ch_additional_paths_ca_best_best_act(Action):
