...
def rbridge_id_interface_ve_ip_ip_config_address_secondary(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_config_address_secondary_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_secondary, delete_ve, delete_interface, delete_name, address, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_config_address_secondary(name=name, delete_secondary=delete_secondary, username=username, address=address, delete_ip_config=delete_ip_config, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_address=delete_address, delete_ve=delete_ve, host=host, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
