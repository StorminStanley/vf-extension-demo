...
def interface_fortygigabitethernet_rmon_collection_history_control_entry_history_control_owner(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_rmon_collection_history_control_entry_history_control_owner_act(Action):
    def run(self, delete_collection, delete_rmon, name, history_control_index, history_control_owner, delete_fortygigabitethernet, delete_history_control_index, delete_interface, delete_name, delete_history_control_entry, delete_history_control_owner, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_rmon_collection_history_control_entry_history_control_owner(delete_rmon=delete_rmon, name=name, history_control_index=history_control_index, delete_history_control_entry=delete_history_control_entry, delete_history_control_index=delete_history_control_index, delete_name=delete_name, delete_history_control_owner=delete_history_control_owner, history_control_owner=history_control_owner, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_collection=delete_collection, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
