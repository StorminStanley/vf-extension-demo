...
def interface_hundredgigabitethernet_dot1x_reauthMax(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_dot1x_reauthMax_act(Action):
    def run(self, delete_reauthMax, reauthMax, delete_interface, delete_name, delete_hundredgigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_dot1x_reauthMax(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, reauthMax=reauthMax, host=host, delete_reauthMax=delete_reauthMax, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
