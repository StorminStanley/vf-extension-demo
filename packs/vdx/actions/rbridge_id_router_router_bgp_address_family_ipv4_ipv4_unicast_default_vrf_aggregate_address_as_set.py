...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_aggregate_address_as_set(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_aggregate_address_as_set_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_as_set, delete_aggregate_address, delete_default_vrf, delete_aggregate_ip_prefix, delete_rbridge_id, delete_router, aggregate_ip_prefix, host, username, password):
