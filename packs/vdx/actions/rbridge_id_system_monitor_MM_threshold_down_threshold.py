...
def rbridge_id_system_monitor_MM_threshold_down_threshold(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_system_monitor_MM_threshold_down_threshold_act(Action):
    def run(self, delete_threshold, down_threshold, delete_system_monitor, delete_MM, delete_rbridge_id, delete_down_threshold, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_system_monitor_MM_threshold_down_threshold(delete_system_monitor=delete_system_monitor, delete_down_threshold=delete_down_threshold, username=username, delete_MM=delete_MM, down_threshold=down_threshold, rbridge_id=rbridge_id, host=host, delete_threshold=delete_threshold, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
