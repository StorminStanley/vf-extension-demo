...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_mtu(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_suppress_ra_mtu', False) is True:
        delete_suppress_ra_mtu = config.find('.//*suppress-ra-mtu')
        delete_suppress_ra_mtu.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_mtu_act(Action):
    def run(self, delete_suppress_ra_mtu, name, delete_fortygigabitethernet, delete_suppress_ra, delete_name, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_mtu(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, host=host, delete_nd=delete_nd, delete_name=delete_name, delete_suppress_ra=delete_suppress_ra, delete_suppress_ra_mtu=delete_suppress_ra_mtu, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
