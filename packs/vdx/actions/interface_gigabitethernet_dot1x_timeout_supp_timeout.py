...
def interface_gigabitethernet_dot1x_agtimeout_supp_agtimeout(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_agtimeout_supp_agtimeout_act(Action):
    def run(self, name, delete_agtimeout, delete_interface, delete_name, supp_agtimeout, delete_supp_agtimeout, delete_gigabitethernet, host, username, password):
