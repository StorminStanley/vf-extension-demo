...
def interface_tengigabitethernet_dot1x_agtimeout_re_authperiod(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_dot1x_agtimeout_re_authperiod_act(Action):
    def run(self, delete_re_authperiod, name, re_authperiod, delete_agtimeout, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_dot1x_agtimeout_re_authperiod(name=name, delete_name=delete_name, delete_re_authperiod=delete_re_authperiod, delete_agtimeout=delete_agtimeout, re_authperiod=re_authperiod, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
