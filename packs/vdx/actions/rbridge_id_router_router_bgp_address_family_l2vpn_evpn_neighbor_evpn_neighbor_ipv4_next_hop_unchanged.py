...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_next_hop_unchanged(**kwargs):
    """Auto Generated Code
    """
    ...
    next_hop_unchanged = ET.SubElement(evpn_neighbor_ipv4, "next-hop-unchanged")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_next_hop_unchanged_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_next_hop_unchanged, delete_evpn, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_next_hop_unchanged(delete_router_bgp=delete_router_bgp, delete_evpn=delete_evpn, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, delete_next_hop_unchanged=delete_next_hop_unchanged, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
