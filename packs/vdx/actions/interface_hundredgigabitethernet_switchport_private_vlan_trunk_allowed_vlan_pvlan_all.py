...
def interface_hundredgigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_all(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_pvlan_all', False) is True:
        delete_pvlan_all = config.find('.//*pvlan_all')
        delete_pvlan_all.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_hundredgigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_all_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_pvlan_all, delete_private_vlan, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_all(name=name, delete_trunk=delete_trunk, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_vlan=delete_vlan, host=host, password=password, delete_private_vlan=delete_private_vlan, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_pvlan_all=delete_pvlan_all, callback=_callback, mgr=mgr)
        return 0
