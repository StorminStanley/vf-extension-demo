...
def interface_hundredgigabitethernet_spanning_tree_restricted_role(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_restricted_role_act(Action):
    def run(self, name, delete_interface, delete_name, delete_hundredgigabitethernet, delete_restricted_role, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_restricted_role(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, delete_spanning_tree=delete_spanning_tree, host=host, delete_interface=delete_interface, delete_restricted_role=delete_restricted_role, password=password, callback=_callback, mgr=mgr)
        return 0
