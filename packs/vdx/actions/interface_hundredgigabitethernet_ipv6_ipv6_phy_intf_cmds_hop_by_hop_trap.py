...
def interface_hundredgigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap_act(Action):
    def run(self, delete_hundredgigabitethernet, delete_hop_by_hop_trap, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap(delete_hop_by_hop_trap=delete_hop_by_hop_trap, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, name=name, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
