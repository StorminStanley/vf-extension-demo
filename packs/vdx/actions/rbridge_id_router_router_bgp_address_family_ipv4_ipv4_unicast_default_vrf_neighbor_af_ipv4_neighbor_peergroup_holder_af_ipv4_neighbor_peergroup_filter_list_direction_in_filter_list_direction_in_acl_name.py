...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_filter_list_direction_in_filter_list_direction_in_acl_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_filter_list_direction_in_filter_list_direction_in_acl_name_act(Action):
    def run(self, delete_direction_in, delete_address_family, delete_router_bgp, rbridge_id, delete_filter_list, filter_list_direction_in_acl_name, delete_default_vrf, delete_filter_list_direction_in_acl_name, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_filter_list_direction_in_filter_list_direction_in_acl_name(delete_router_bgp=delete_router_bgp, delete_filter_list=delete_filter_list, username=username, delete_direction_in=delete_direction_in, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_filter_list_direction_in_acl_name=delete_filter_list_direction_in_acl_name, filter_list_direction_in_acl_name=filter_list_direction_in_acl_name, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
