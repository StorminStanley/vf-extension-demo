...
def interface_gigabitethernet_spanning_tree_portfast_portfastbasic(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_portfast_portfastbasic_act(Action):
    def run(self, delete_portfast, name, delete_portfastbasic, delete_interface, delete_name, delete_spanning_tree, delete_gigabitethernet, host, username, password):
