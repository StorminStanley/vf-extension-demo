...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
    ...
    bfd = ET.SubElement(neighbor_ipv6_addr, "bfd")
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_multiplier_act(Action):
    def run(self, delete_bfd, delete_router_bgp, rbridge_id, delete_multiplier, delete_router_bgp_attributes, delete_interval, multiplier, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
