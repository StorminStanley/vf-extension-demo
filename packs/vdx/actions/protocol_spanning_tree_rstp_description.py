...
def protocol_spanning_tree_rstp_description(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rstp_description_act(Action):
    def run(self, delete_description, description, delete_spanning_tree, delete_rstp, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rstp_description(delete_rstp=delete_rstp, description=description, delete_spanning_tree=delete_spanning_tree, delete_description=delete_description, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
