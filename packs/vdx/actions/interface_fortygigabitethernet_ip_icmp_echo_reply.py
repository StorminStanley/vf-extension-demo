...
def interface_fortygigabitethernet_ip_icmp_echo_reply(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_icmp_echo_reply_act(Action):
    def run(self, name, delete_ip, delete_fortygigabitethernet, delete_icmp, delete_interface, delete_name, delete_echo_reply, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_icmp_echo_reply(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_icmp=delete_icmp, delete_echo_reply=delete_echo_reply, delete_ip=delete_ip, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
