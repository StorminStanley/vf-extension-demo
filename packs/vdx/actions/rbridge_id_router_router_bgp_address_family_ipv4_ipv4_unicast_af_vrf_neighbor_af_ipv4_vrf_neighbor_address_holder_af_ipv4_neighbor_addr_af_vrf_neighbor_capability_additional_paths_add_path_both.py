...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_additional_paths_add_path_both(**kwargs):
    """Auto Generated Code
    """
    ...
    add_path_both = ET.SubElement(additional_paths, "add-path-both")
    if kwargs.pop('delete_add_path_both', False) is True:
        delete_add_path_both = config.find('.//*add-path-both')
        delete_add_path_both.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_additional_paths_add_path_both_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_add_path_both, delete_af_vrf_neighbor_capability, delete_rbridge_id, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_additional_paths_add_path_both(delete_additional_paths=delete_additional_paths, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_af_vrf_neighbor_capability=delete_af_vrf_neighbor_capability, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_add_path_both=delete_add_path_both, password=password, callback=_callback, mgr=mgr)
        return 0
