...
class rbridge_id_route_map_content_set_origin_origin_incomplete_act(Action):
    def run(self, rbridge_id, delete_set, delete_route_map, delete_content, delete_origin_incomplete, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_origin, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_origin_origin_incomplete(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, delete_origin_incomplete=delete_origin_incomplete, delete_origin=delete_origin, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
