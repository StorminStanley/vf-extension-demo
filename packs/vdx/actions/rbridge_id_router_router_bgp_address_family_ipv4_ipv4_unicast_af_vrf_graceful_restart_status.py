...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_graceful_restart_status(**kwargs):
    """Auto Generated Code
    """
    ...
    graceful_restart_status = ET.SubElement(af_vrf, "graceful-restart-status")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_graceful_restart_status_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_graceful_restart_status, delete_rbridge_id, delete_router, host, username, password):
