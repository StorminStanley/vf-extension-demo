...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_multiplier_act(Action):
    def run(self, delete_address_family, rbridge_id, delete_route, delete_vrf, delete_static, delete_multiplier, vrf_name, multiplier, delete_rbridge_id, delete_unicast, delete_bfd, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_multiplier(delete_static=delete_static, delete_route=delete_route, username=username, delete_multiplier=delete_multiplier, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, host=host, password=password, delete_vrf_name=delete_vrf_name, delete_bfd=delete_bfd, delete_address_family=delete_address_family, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, multiplier=multiplier, callback=_callback, mgr=mgr)
        return 0
