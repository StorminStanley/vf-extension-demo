...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_static_route_oif_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_static_route_oif_name_act(Action):
    def run(self, delete_static_route_oif, delete_address_family, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_vrf, delete_static_route_oif_name, delete_static_route_dest, vrf_name, static_route_dest, static_route_oif_name, delete_rbridge_id, delete_unicast, delete_vrf_name, host, username, password):
