...
def rbridge_id_router_ospf_area_virtual_link_retransmit_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_area_virtual_link_retransmit_interval_act(Action):
    def run(self, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, retransmit_interval, delete_area, vrf, delete_virt_link_neighbor, delete_rbridge_id, virt_link_neighbor, delete_router, delete_retransmit_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_area_virtual_link_retransmit_interval(delete_virt_link_neighbor=delete_virt_link_neighbor, username=username, virt_link_neighbor=virt_link_neighbor, delete_area=delete_area, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, delete_router=delete_router, delete_ospf=delete_ospf, host=host, delete_retransmit_interval=delete_retransmit_interval, vrf=vrf, retransmit_interval=retransmit_interval, delete_rbridge_id=delete_rbridge_id, delete_virtual_link=delete_virtual_link, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
