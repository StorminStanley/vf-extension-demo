...
def interface_fortygigabitethernet_switchport_port_security_shutdown_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_port_security_shutdown_time_act(Action):
    def run(self, delete_switchport, delete_shutdown_time, name, shutdown_time, delete_fortygigabitethernet, delete_interface, delete_name, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_port_security_shutdown_time(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, username=username, host=host, shutdown_time=shutdown_time, delete_name=delete_name, delete_interface=delete_interface, delete_shutdown_time=delete_shutdown_time, delete_port_security=delete_port_security, password=password, callback=_callback, mgr=mgr)
        return 0
