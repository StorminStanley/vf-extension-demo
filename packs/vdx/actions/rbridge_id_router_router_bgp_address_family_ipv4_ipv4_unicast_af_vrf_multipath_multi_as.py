...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_multipath_multi_as(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_multipath_multi_as_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_multipath, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_multi_as, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_multipath_multi_as(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_multi_as=delete_multi_as, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_multipath=delete_multipath, password=password, callback=_callback, mgr=mgr)
        return 0
