...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_active(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_active_act(Action):
    def run(self, delete_active, delete_name, delete_interface, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_active(name=name, delete_name=delete_name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_active=delete_active, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
