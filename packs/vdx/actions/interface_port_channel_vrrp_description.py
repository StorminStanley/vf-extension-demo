...
def interface_port_channel_vrrp_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_description_act(Action):
    def run(self, delete_description, name, delete_vrid, vrid, delete_version, delete_port_channel, version, delete_interface, delete_name, delete_vrrp, description, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_vrrp_description(delete_vrid=delete_vrid, delete_port_channel=delete_port_channel, name=name, delete_version=delete_version, delete_vrrp=delete_vrrp, delete_description=delete_description, host=host, description=description, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, version=version, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
