...
def protocol_spanning_tree_rstp_max_age(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rstp_max_age_act(Action):
    def run(self, max_age, delete_max_age, delete_spanning_tree, delete_rstp, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rstp_max_age(delete_rstp=delete_rstp, delete_spanning_tree=delete_spanning_tree, delete_max_age=delete_max_age, delete_protocol=delete_protocol, max_age=max_age, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
