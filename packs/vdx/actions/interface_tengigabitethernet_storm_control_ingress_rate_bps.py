...
def interface_tengigabitethernet_storm_control_ingress_rate_bps(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_storm_control_ingress_rate_bps_act(Action):
    def run(self, delete_storm_control, rate_bps, delete_ingress, delete_protocol_type, delete_rate_bps, delete_interface, delete_name, delete_tengigabitethernet, protocol_type, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_storm_control_ingress_rate_bps(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, delete_rate_bps=delete_rate_bps, delete_ingress=delete_ingress, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_protocol_type=delete_protocol_type, rate_bps=rate_bps, protocol_type=protocol_type, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
