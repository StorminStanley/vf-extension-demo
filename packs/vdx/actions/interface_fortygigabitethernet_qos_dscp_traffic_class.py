...
def interface_fortygigabitethernet_qos_dscp_traffic_class(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_qos_dscp_traffic_class_act(Action):
    def run(self, delete_dscp_traffic_class, delete_qos, name, delete_fortygigabitethernet, dscp_traffic_class, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_qos_dscp_traffic_class(delete_qos=delete_qos, delete_fortygigabitethernet=delete_fortygigabitethernet, dscp_traffic_class=dscp_traffic_class, name=name, host=host, delete_dscp_traffic_class=delete_dscp_traffic_class, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
