...
def interface_tengigabitethernet_switchport_private_vlan_host_association_host_pri_pvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_private_vlan_host_association_host_pri_pvlan_act(Action):
    def run(self, delete_switchport, name, delete_host_pri_pvlan, delete_private_vlan, delete_interface, delete_name, host_pri_pvlan, delete_tengigabitethernet, delete_host_association, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_private_vlan_host_association_host_pri_pvlan(delete_host_pri_pvlan=delete_host_pri_pvlan, name=name, delete_name=delete_name, delete_switchport=delete_switchport, username=username, host_pri_pvlan=host_pri_pvlan, delete_tengigabitethernet=delete_tengigabitethernet, delete_private_vlan=delete_private_vlan, host=host, delete_interface=delete_interface, delete_host_association=delete_host_association, password=password, callback=_callback, mgr=mgr)
        return 0
