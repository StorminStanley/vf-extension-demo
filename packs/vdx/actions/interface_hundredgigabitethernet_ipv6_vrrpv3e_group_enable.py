...
def interface_hundredgigabitethernet_ipv6_vrrpv3e_group_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3e_group_enable_act(Action):
