...
def interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_ipv6_gateway_address_ipv6_gw_addr(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ipv6_gateway_address', False) is True:
        delete_ipv6_gateway_address = config.find('.//*ipv6-gateway-address')
        delete_ipv6_gateway_address.set('operation', 'delete')
        
    ipv6_gw_addr = ET.SubElement(ipv6_gateway_address, "ipv6-gw-addr")
    if kwargs.pop('delete_ipv6_gw_addr', False) is True:
        delete_ipv6_gw_addr = config.find('.//*ipv6-gw-addr')
        delete_ipv6_gw_addr.set('operation', 'delete')
...
class interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_ipv6_gateway_address_ipv6_gw_addr_act(Action):
    def run(self, delete_interface_vlan, gve_name, delete_interface, delete_ve, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_ipv6_gateway_address_ipv6_gw_addr(delete_gve_name=delete_gve_name, gve_name=gve_name, delete_ve=delete_ve, host=host, delete_interface_vlan=delete_interface_vlan, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
