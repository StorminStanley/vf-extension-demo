...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval_act(Action):
    def run(self, name, delete_dead_interval, delete_fortygigabitethernet, dead_interval, delete_interface, delete_name, delete_link_interval_properties, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_link_interval_properties=delete_link_interval_properties, dead_interval=dead_interval, host=host, delete_dead_interval=delete_dead_interval, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
