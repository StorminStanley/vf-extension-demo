...
def rbridge_id_ipv6_route_link_local_static_route_nh_link_local_route_oif_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_link_local_static_route_nh_link_local_route_oif_name_act(Action):
