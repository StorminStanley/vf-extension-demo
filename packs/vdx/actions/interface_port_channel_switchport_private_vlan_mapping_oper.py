...
def interface_port_channel_switchport_private_vlan_mapping_oper(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_private_vlan_mapping_oper_act(Action):
    def run(self, delete_switchport, delete_mapping, delete_oper, name, delete_promis_pri_pvlan, delete_port_channel, delete_private_vlan, delete_interface, delete_name, promis_pri_pvlan, oper, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_private_vlan_mapping_oper(oper=oper, delete_port_channel=delete_port_channel, name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_mapping=delete_mapping, delete_oper=delete_oper, delete_promis_pri_pvlan=delete_promis_pri_pvlan, promis_pri_pvlan=promis_pri_pvlan, delete_private_vlan=delete_private_vlan, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
