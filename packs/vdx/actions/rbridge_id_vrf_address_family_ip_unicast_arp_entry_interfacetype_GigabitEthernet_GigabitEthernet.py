...
def rbridge_id_vrf_address_family_ip_unicast_arp_entry_interfacetype_GigabitEthernet_GigabitEthernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_arp_entry_interfacetype_GigabitEthernet_GigabitEthernet_act(Action):
    def run(self, delete_address_family, rbridge_id, delete_ip, delete_vrf, delete_interfacetype, GigabitEthernet, delete_arp_ip_address, arp_ip_address, vrf_name, delete_rbridge_id, delete_unicast, delete_arp_entry, delete_GigabitEthernet, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_arp_entry_interfacetype_GigabitEthernet_GigabitEthernet(delete_address_family=delete_address_family, vrf_name=vrf_name, username=username, delete_vrf=delete_vrf, rbridge_id=rbridge_id, delete_ip=delete_ip, host=host, delete_GigabitEthernet=delete_GigabitEthernet, delete_interfacetype=delete_interfacetype, GigabitEthernet=GigabitEthernet, delete_arp_entry=delete_arp_entry, delete_vrf_name=delete_vrf_name, delete_arp_ip_address=delete_arp_ip_address, arp_ip_address=arp_ip_address, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
