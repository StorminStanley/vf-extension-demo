...
def interface_fortygigabitethernet_spanning_tree_instance_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_spanning_tree_instance_priority_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_id, id, priority, delete_instance, delete_priority, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_spanning_tree_instance_priority(delete_instance=delete_instance, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, delete_id=delete_id, priority=priority, delete_spanning_tree=delete_spanning_tree, host=host, delete_name=delete_name, id=id, delete_priority=delete_priority, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
