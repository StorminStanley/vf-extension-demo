...
def protocol_lldp_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_multiplier_act(Action):
    def run(self, delete_multiplier, delete_lldp, multiplier, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_multiplier(delete_multiplier=delete_multiplier, delete_lldp=delete_lldp, delete_protocol=delete_protocol, password=password, host=host, username=username, multiplier=multiplier, callback=_callback, mgr=mgr)
        return 0
