...
def rbridge_id_router_ospf_max_metric_router_lsa_link_all(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_max_metric_router_lsa_link_all_act(Action):
    def run(self, rbridge_id, delete_ospf, delete_vrf, delete_router_lsa, delete_link, delete_max_metric, vrf, delete_all, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_max_metric_router_lsa_link_all(delete_max_metric=delete_max_metric, delete_all=delete_all, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_router_lsa=delete_router_lsa, delete_router=delete_router, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_link=delete_link, password=password, callback=_callback, mgr=mgr)
        return 0
