...
def interface_hundredgigabitethernet_qos_cos_mutation(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_qos_cos_mutation_act(Action):
    def run(self, delete_qos, name, delete_interface, delete_name, delete_hundredgigabitethernet, delete_cos_mutation, cos_mutation, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_qos_cos_mutation(delete_qos=delete_qos, delete_name=delete_name, cos_mutation=cos_mutation, delete_hundredgigabitethernet=delete_hundredgigabitethernet, name=name, delete_cos_mutation=delete_cos_mutation, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
