...
def rbridge_id_interface_ve_vrrpe_track_interface_track_priority(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_track_interface_track_priority_act(Action):
    def run(self, delete_track_priority, interface_name, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_interface_type, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, delete_track, track_priority, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_track_interface_track_priority(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_track=delete_track, delete_vrrpe=delete_vrrpe, username=username, track_priority=track_priority, interface_name=interface_name, delete_track_priority=delete_track_priority, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, vrid=vrid, interface_type=interface_type, delete_ve=delete_ve, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
