...
def rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_distance(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_distance_act(Action):
    def run(self, delete_static_route_oif, distance, delete_route_attributes, static_route_oif_type, rbridge_id, delete_ip, delete_route, delete_static_route_oif_name, delete_distance, delete_static_route_dest, static_route_dest, static_route_oif_name, delete_rtm_config, delete_rbridge_id, delete_static_route_oif_type, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_distance(delete_route_attributes=delete_route_attributes, delete_rtm_config=delete_rtm_config, distance=distance, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, username=username, static_route_dest=static_route_dest, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_static_route_oif=delete_static_route_oif, static_route_oif_name=static_route_oif_name, host=host, static_route_oif_type=static_route_oif_type, delete_static_route_oif_type=delete_static_route_oif_type, delete_rbridge_id=delete_rbridge_id, delete_distance=delete_distance, delete_static_route_dest=delete_static_route_dest, password=password, callback=_callback, mgr=mgr)
        return 0
