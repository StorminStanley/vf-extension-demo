...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_route_reflector_client(**kwargs):
    """Auto Generated Code
    """
    ...
    route_reflector_client = ET.SubElement(evpn_neighbor_ipv4, "route-reflector-client")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_route_reflector_client_act(Action):
