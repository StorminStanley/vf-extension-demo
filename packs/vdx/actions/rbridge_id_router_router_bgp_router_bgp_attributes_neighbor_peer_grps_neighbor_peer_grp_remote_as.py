...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_remote_as(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_remote_as', False) is True:
        delete_remote_as = config.find('.//*remote-as')
        delete_remote_as.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_remote_as_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, remote_as, router_bgp_neighbor_peer_grp, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_remote_as, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_remote_as(delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router_bgp=delete_router_bgp, username=username, remote_as=remote_as, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_remote_as=delete_remote_as, delete_neighbor=delete_neighbor, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_peer_grps=delete_peer_grps, callback=_callback, mgr=mgr)
        return 0
