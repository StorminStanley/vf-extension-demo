...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_flag_ebgp_multihop_flag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_flag_ebgp_multihop_flag_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_ch_ebgp_multihop_type, delete_ebgp_multihop, delete_ebgp_multihop_flag, delete_rbridge_id, delete_neighbor, delete_router, delete_ca_ebgp_multihop_flag, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_flag_ebgp_multihop_flag(delete_router_bgp=delete_router_bgp, delete_ebgp_multihop=delete_ebgp_multihop, username=username, af_vrf_name=af_vrf_name, delete_ch_ebgp_multihop_type=delete_ch_ebgp_multihop_type, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_ebgp_multihop_flag=delete_ebgp_multihop_flag, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, password=password, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_ca_ebgp_multihop_flag=delete_ca_ebgp_multihop_flag, callback=_callback, mgr=mgr)
        return 0
