...
def interface_fortygigabitethernet_rmon_collection_history_control_entry_history_control_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_rmon_collection_history_control_entry_history_control_interval_act(Action):
    def run(self, delete_collection, delete_rmon, name, history_control_index, delete_fortygigabitethernet, delete_history_control_interval, delete_history_control_index, delete_interface, delete_name, delete_history_control_entry, history_control_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_rmon_collection_history_control_entry_history_control_interval(delete_rmon=delete_rmon, name=name, history_control_index=history_control_index, delete_history_control_entry=delete_history_control_entry, delete_history_control_index=delete_history_control_index, delete_history_control_interval=delete_history_control_interval, delete_name=delete_name, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, history_control_interval=history_control_interval, delete_collection=delete_collection, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
