...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_lifetime(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_lifetime_act(Action):
    def run(self, ra_lifetime, name, delete_ra_lifetime, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_lifetime(name=name, delete_name=delete_name, ra_lifetime=ra_lifetime, delete_ra_lifetime=delete_ra_lifetime, delete_tengigabitethernet=delete_tengigabitethernet, delete_nd=delete_nd, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
