...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_network_backdoor(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_network_backdoor_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_network, delete_default_vrf, delete_rbridge_id, delete_backdoor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_network_backdoor(delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_backdoor=delete_backdoor, host=host, delete_network=delete_network, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
