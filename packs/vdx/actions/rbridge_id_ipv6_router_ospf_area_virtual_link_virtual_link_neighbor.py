...
def rbridge_id_ipv6_router_ospf_area_virtual_link_virtual_link_neighbor(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_virtual_link_virtual_link_neighbor_act(Action):
    def run(self, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_virtual_link_neighbor, virtual_link_neighbor, delete_area, vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_virtual_link_virtual_link_neighbor(username=username, delete_area=delete_area, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_router=delete_router, delete_ospf=delete_ospf, password=password, delete_virtual_link_neighbor=delete_virtual_link_neighbor, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, delete_virtual_link=delete_virtual_link, virtual_link_neighbor=virtual_link_neighbor, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
