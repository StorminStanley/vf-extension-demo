...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_holdover_interval(**kwargs):
    """Auto Generated Code
    """
    ...
    bfd = ET.SubElement(af_ipv6_neighbor_addr, "bfd")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_holdover_interval_act(Action):
    def run(self, delete_bfd, delete_address_family, delete_router_bgp, rbridge_id, holdover_interval, delete_rbridge_id, delete_neighbor, delete_router, delete_holdover_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_holdover_interval(delete_address_family=delete_address_family, username=username, delete_neighbor=delete_neighbor, delete_bfd=delete_bfd, rbridge_id=rbridge_id, holdover_interval=holdover_interval, delete_router=delete_router, host=host, password=password, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, delete_holdover_interval=delete_holdover_interval, callback=_callback, mgr=mgr)
        return 0
