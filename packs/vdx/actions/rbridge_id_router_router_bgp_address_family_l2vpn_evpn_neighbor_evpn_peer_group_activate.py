...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_activate(**kwargs):
    """Auto Generated Code
    """
    ...
    activate = ET.SubElement(evpn_peer_group, "activate")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_activate_act(Action):
    def run(self, delete_evpn_neighbor_peergroup_name, delete_address_family, delete_router_bgp, rbridge_id, delete_evpn, evpn_neighbor_peergroup_name, delete_evpn_peer_group, delete_activate, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
