...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count_act(Action):
    def run(self, router_bgp_neighbor_address, delete_ch_ebgp_multihop_type, delete_router_bgp, rbridge_id, delete_ca_ebgp_multihop_count, delete_neighbor_addr, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, ebgp_multihop_count, delete_neighbor_ips, delete_ebgp_multihop, delete_rbridge_id, delete_neighbor, delete_router, delete_ebgp_multihop_count, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count(router_bgp_neighbor_address=router_bgp_neighbor_address, delete_neighbor_ips=delete_neighbor_ips, delete_router_bgp=delete_router_bgp, delete_ebgp_multihop=delete_ebgp_multihop, username=username, delete_neighbor=delete_neighbor, delete_ca_ebgp_multihop_count=delete_ca_ebgp_multihop_count, rbridge_id=rbridge_id, delete_ch_ebgp_multihop_type=delete_ch_ebgp_multihop_type, ebgp_multihop_count=ebgp_multihop_count, delete_router=delete_router, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp_neighbor_address=delete_router_bgp_neighbor_address, delete_rbridge_id=delete_rbridge_id, delete_neighbor_addr=delete_neighbor_addr, delete_ebgp_multihop_count=delete_ebgp_multihop_count, password=password, callback=_callback, mgr=mgr)
        return 0
