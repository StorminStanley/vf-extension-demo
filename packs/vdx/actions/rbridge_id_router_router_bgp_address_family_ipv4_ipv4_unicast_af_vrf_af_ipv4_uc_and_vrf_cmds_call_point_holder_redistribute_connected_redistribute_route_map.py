...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_connected_redistribute_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_connected_redistribute_route_map_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_connected, delete_af_vrf, redistribute_route_map, delete_af_vrf_name, af_vrf_name, delete_redistribute_route_map, delete_redistribute, delete_rbridge_id, delete_router, host, username, password):
