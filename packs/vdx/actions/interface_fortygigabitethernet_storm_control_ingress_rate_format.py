...
def interface_fortygigabitethernet_storm_control_ingress_rate_format(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_rate_format', False) is True:
        delete_rate_format = config.find('.//*rate-format')
        delete_rate_format.set('operation', 'delete')
...
class interface_fortygigabitethernet_storm_control_ingress_rate_format_act(Action):
    def run(self, delete_protocol_type, delete_storm_control, delete_rate_format, delete_ingress, delete_fortygigabitethernet, delete_interface, delete_name, rate_format, protocol_type, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_storm_control_ingress_rate_format(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_storm_control=delete_storm_control, rate_format=rate_format, delete_ingress=delete_ingress, protocol_type=protocol_type, delete_rate_format=delete_rate_format, host=host, delete_protocol_type=delete_protocol_type, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
