...
def interface_tengigabitethernet_spanning_tree_instance_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_spanning_tree_instance_id_act(Action):
    def run(self, name, delete_id, id, delete_instance, delete_interface, delete_name, delete_tengigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_spanning_tree_instance_id(delete_instance=delete_instance, name=name, delete_name=delete_name, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_tengigabitethernet=delete_tengigabitethernet, host=host, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
