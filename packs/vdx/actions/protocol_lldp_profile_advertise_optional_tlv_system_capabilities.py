...
def protocol_lldp_profile_advertise_optional_tlv_system_capabilities(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_profile_advertise_optional_tlv_system_capabilities_act(Action):
    def run(self, delete_profile_name, delete_protocol, delete_system_capabilities, delete_lldp, delete_optional_tlv, profile_name, delete_advertise, delete_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_profile_advertise_optional_tlv_system_capabilities(delete_profile_name=delete_profile_name, profile_name=profile_name, delete_optional_tlv=delete_optional_tlv, delete_lldp=delete_lldp, delete_profile=delete_profile, delete_protocol=delete_protocol, password=password, delete_system_capabilities=delete_system_capabilities, host=host, username=username, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
