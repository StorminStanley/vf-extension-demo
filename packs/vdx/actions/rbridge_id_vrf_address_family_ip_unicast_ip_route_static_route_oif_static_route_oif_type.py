...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_static_route_oif_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_static_route_oif_type_act(Action):
