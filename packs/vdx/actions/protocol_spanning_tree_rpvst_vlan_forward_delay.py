...
def protocol_spanning_tree_rpvst_vlan_forward_delay(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rpvst_vlan_forward_delay_act(Action):
    def run(self, delete_vlan, delete_protocol, delete_rpvst, delete_forward_delay, delete_spanning_tree, delete_id, id, forward_delay, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rpvst_vlan_forward_delay(delete_rpvst=delete_rpvst, delete_vlan=delete_vlan, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, host=host, delete_forward_delay=delete_forward_delay, forward_delay=forward_delay, id=id, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
