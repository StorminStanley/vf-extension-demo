...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_all(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_all_act(Action):
    def run(self, name, delete_suppress_ra_all, delete_port_channel, delete_suppress_ra, delete_name, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_all(name=name, delete_name=delete_name, delete_port_channel=delete_port_channel, delete_suppress_ra_all=delete_suppress_ra_all, host=host, delete_nd=delete_nd, delete_suppress_ra=delete_suppress_ra, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
