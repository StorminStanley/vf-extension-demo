...
def interface_hundredgigabitethernet_ipv6_vrrpv3e_group_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3e_group_description_act(Action):
    def run(self, delete_description, name, delete_vrid, vrid, delete_interface, delete_name, delete_hundredgigabitethernet, description, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_vrrpv3e_group_description(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_description=delete_description, host=host, vrid=vrid, description=description, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
