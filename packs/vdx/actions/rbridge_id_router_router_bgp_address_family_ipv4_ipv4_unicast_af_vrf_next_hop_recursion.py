...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_next_hop_recursion(**kwargs):
    """Auto Generated Code
    """
    ...
    next_hop_recursion = ET.SubElement(af_vrf, "next-hop-recursion")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_next_hop_recursion_act(Action):
    def run(self, delete_next_hop_recursion, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_next_hop_recursion(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_next_hop_recursion=delete_next_hop_recursion, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
