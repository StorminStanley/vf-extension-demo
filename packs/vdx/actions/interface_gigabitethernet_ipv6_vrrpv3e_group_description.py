...
def interface_gigabitethernet_ipv6_vrrpv3e_group_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_description_act(Action):
