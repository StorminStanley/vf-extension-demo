...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_ipv6_sip_ipv6_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_ipv6_sip_ipv6_address_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_update_source, delete_router_bgp_attributes, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_ipv6_sip_ipv6_address(delete_ch_update_source=delete_ch_update_source, delete_neighbor=delete_neighbor, username=username, rbridge_id=rbridge_id, delete_router=delete_router, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
