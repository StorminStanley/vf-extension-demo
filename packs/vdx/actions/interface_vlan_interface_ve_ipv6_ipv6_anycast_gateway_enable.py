...
def interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_enable_act(Action):
    def run(self, gve_name, delete_interface_vlan, delete_ve, delete_enable, delete_interface, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_enable(delete_gve_name=delete_gve_name, delete_enable=delete_enable, gve_name=gve_name, delete_ve=delete_ve, host=host, delete_interface_vlan=delete_interface_vlan, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
