...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_network_network_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_network_network_route_map_act(Action):
