...
def interface_hundredgigabitethernet_switchport_port_security_shutdown_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_port_security_shutdown_time_act(Action):
    def run(self, delete_switchport, delete_shutdown_time, name, shutdown_time, delete_interface, delete_name, delete_hundredgigabitethernet, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_port_security_shutdown_time(name=name, delete_name=delete_name, delete_switchport=delete_switchport, username=username, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, shutdown_time=shutdown_time, delete_port_security=delete_port_security, delete_interface=delete_interface, delete_shutdown_time=delete_shutdown_time, password=password, callback=_callback, mgr=mgr)
        return 0
