...
def interface_gigabitethernet_sflow_sample_rate(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_sflow_sample_rate_act(Action):
    def run(self, delete_sflow, name, delete_sample_rate, sample_rate, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_sflow_sample_rate(name=name, delete_name=delete_name, delete_sflow=delete_sflow, sample_rate=sample_rate, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, delete_sample_rate=delete_sample_rate, password=password, callback=_callback, mgr=mgr)
        return 0
