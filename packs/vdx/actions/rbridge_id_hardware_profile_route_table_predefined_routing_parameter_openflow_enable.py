...
def rbridge_id_hardware_profile_route_table_predefined_routing_parameter_openflow_enable(**kwargs):
    """Auto Generated Code
    """
    ...
    openflow_enable = ET.SubElement(routing_parameter, "openflow_enable")
    if kwargs.pop('delete_openflow_enable', False) is True:
        delete_openflow_enable = config.find('.//*openflow_enable')
        delete_openflow_enable.set('operation', 'delete')
        
    openflow_enable.text = kwargs.pop('openflow_enable')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_hardware_profile_route_table_predefined_routing_parameter_openflow_enable_act(Action):
    def run(self, rbridge_id, delete_predefined, delete_hardware_profile, delete_routing_parameter, delete_openflow_enable, delete_route_table, delete_rbridge_id, openflow_enable, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_hardware_profile_route_table_predefined_routing_parameter_openflow_enable(username=username, delete_openflow_enable=delete_openflow_enable, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_routing_parameter=delete_routing_parameter, openflow_enable=openflow_enable, delete_hardware_profile=delete_hardware_profile, host=host, delete_predefined=delete_predefined, password=password, delete_route_table=delete_route_table, callback=_callback, mgr=mgr)
        return 0
