...
def interface_hundredgigabitethernet_switchport_trunk_tag_native_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_trunk_tag_native_vlan_act(Action):
    def run(self, delete_switchport, name, delete_tag, delete_trunk, delete_interface, delete_name, delete_hundredgigabitethernet, delete_native_vlan, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_trunk_tag_native_vlan(name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_tag=delete_tag, delete_interface=delete_interface, username=username, delete_native_vlan=delete_native_vlan, password=password, callback=_callback, mgr=mgr)
        return 0
