...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_broadcast_mac_trap, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap(name=name, delete_name=delete_name, delete_broadcast_mac_trap=delete_broadcast_mac_trap, host=host, delete_nd=delete_nd, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
