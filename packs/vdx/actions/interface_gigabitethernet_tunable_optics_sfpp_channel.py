...
def interface_gigabitethernet_tunable_optics_sfpp_channel(**kwargs):
    """Auto Generated Code
    """
    ...
    tunable_optics = ET.SubElement(gigabitethernet, "tunable-optics")
...
class interface_gigabitethernet_tunable_optics_sfpp_channel_act(Action):
    def run(self, name, channel, delete_sfpp, delete_interface, delete_name, delete_tunable_optics, delete_channel, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_tunable_optics_sfpp_channel(delete_tunable_optics=delete_tunable_optics, name=name, delete_name=delete_name, delete_channel=delete_channel, delete_sfpp=delete_sfpp, host=host, channel=channel, delete_interface=delete_interface, delete_gigabitethernet=delete_gigabitethernet, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
