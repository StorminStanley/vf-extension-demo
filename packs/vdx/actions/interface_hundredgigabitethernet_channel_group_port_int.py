...
def interface_hundredgigabitethernet_channel_group_port_int(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_channel_group_port_int_act(Action):
    def run(self, name, port_int, delete_channel_group, delete_name, delete_hundredgigabitethernet, delete_port_int, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_channel_group_port_int(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_channel_group=delete_channel_group, delete_port_int=delete_port_int, host=host, password=password, delete_interface=delete_interface, username=username, port_int=port_int, callback=_callback, mgr=mgr)
        return 0
