...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_key_act(Action):
    def run(self, name, esp_key, delete_ipsec_auth_key_config, delete_ca_esp_algorithm, delete_authentication, delete_name, delete_esp_key, delete_ch_algorithm, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_key(delete_ca_esp_algorithm=delete_ca_esp_algorithm, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, name=name, delete_name=delete_name, username=username, esp_key=esp_key, delete_gigabitethernet=delete_gigabitethernet, delete_authentication=delete_authentication, delete_ch_algorithm=delete_ch_algorithm, host=host, delete_interface=delete_interface, delete_esp_key=delete_esp_key, password=password, callback=_callback, mgr=mgr)
        return 0
