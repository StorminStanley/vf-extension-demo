...
def interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_auth_no_encrypt(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_auth_no_encrypt_act(Action):
    def run(self, name, delete_ipsec_auth_key_config, delete_esp_auth_no_encrypt, delete_ca_esp_algorithm, delete_authentication, delete_name, delete_hundredgigabitethernet, delete_ch_algorithm, delete_interface, host, username, password):
