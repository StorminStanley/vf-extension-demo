...
def interface_hundredgigabitethernet_switchport_trunk_allowed_trunk_rspan_vlan_classification_rspan_vlan_remove_trunk_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_trunk_allowed_trunk_rspan_vlan_classification_rspan_vlan_remove_trunk_vlan_id_act(Action):
    def run(self, delete_switchport, delete_allowed, delete_rspan_vlan, name, delete_trunk_ctag_id, delete_trunk, trunk_vlan_id, trunk_ctag_id, delete_trunk_rspan_vlan_classification, delete_interface, delete_name, delete_remove, delete_hundredgigabitethernet, delete_trunk_vlan_id, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_trunk_allowed_trunk_rspan_vlan_classification_rspan_vlan_remove_trunk_vlan_id(name=name, delete_trunk=delete_trunk, delete_trunk_vlan_id=delete_trunk_vlan_id, username=username, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_rspan_vlan=delete_rspan_vlan, trunk_vlan_id=trunk_vlan_id, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_trunk_rspan_vlan_classification=delete_trunk_rspan_vlan_classification, host=host, delete_trunk_ctag_id=delete_trunk_ctag_id, delete_name=delete_name, delete_interface=delete_interface, delete_remove=delete_remove, password=password, trunk_ctag_id=trunk_ctag_id, callback=_callback, mgr=mgr)
        return 0
