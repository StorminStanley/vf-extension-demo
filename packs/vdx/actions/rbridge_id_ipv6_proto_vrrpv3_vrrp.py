...
def rbridge_id_ipv6_proto_vrrpv3_vrrp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_proto_vrrpv3_vrrp_act(Action):
    def run(self, delete_vrrp, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_proto_vrrpv3_vrrp(username=username, rbridge_id=rbridge_id, delete_vrrp=delete_vrrp, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
