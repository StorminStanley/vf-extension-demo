...
def rbridge_id_snmp_server_v3host_hostip(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_v3host_hostip_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, hostip, delete_hostip, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_v3host_hostip(delete_snmp_server=delete_snmp_server, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_hostip=delete_hostip, delete_username=delete_username, host=host, hostip=hostip, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
