...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_instance(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_instance_act(Action):
    def run(self, name, delete_fortygigabitethernet, instance, delete_instance, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_instance(delete_instance=delete_instance, name=name, delete_name=delete_name, host=host, password=password, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, instance=instance, callback=_callback, mgr=mgr)
        return 0
