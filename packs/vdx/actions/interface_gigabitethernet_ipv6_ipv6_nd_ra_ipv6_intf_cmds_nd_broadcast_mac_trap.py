...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap_act(Action):
    def run(self, name, delete_broadcast_mac_trap, delete_interface, delete_name, delete_nd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap(name=name, delete_name=delete_name, delete_broadcast_mac_trap=delete_broadcast_mac_trap, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
