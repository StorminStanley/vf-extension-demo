...
def rbridge_id_ip_rtm_config_route_static_route_nh_route_attributes_distance(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_nh_route_attributes_distance_act(Action):
    def run(self, delete_static_route_next_hop, distance, delete_route_attributes, rbridge_id, delete_ip, delete_route, delete_static_route_nh, delete_distance, delete_static_route_dest, static_route_dest, delete_rtm_config, delete_rbridge_id, static_route_next_hop, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_rtm_config_route_static_route_nh_route_attributes_distance(delete_route_attributes=delete_route_attributes, distance=distance, delete_static_route_dest=delete_static_route_dest, delete_route=delete_route, username=username, static_route_dest=static_route_dest, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_rtm_config=delete_rtm_config, delete_static_route_next_hop=delete_static_route_next_hop, static_route_next_hop=static_route_next_hop, host=host, delete_rbridge_id=delete_rbridge_id, delete_distance=delete_distance, delete_static_route_nh=delete_static_route_nh, password=password, callback=_callback, mgr=mgr)
        return 0
