...
def interface_tengigabitethernet_port_profile_to_interface_associations_port_profile_port_port_to_port_profile_domain_association_profile_domain_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_port_profile_to_interface_associations_port_profile_port_port_to_port_profile_domain_association_profile_domain_name_act(Action):
    def run(self, delete_port_to_port_profile_domain_association, name, profile_domain_name, delete_port_profile_to_interface_associations, delete_port_profile_port, delete_interface, delete_name, delete_tengigabitethernet, delete_profile_domain_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_port_profile_to_interface_associations_port_profile_port_port_to_port_profile_domain_association_profile_domain_name(profile_domain_name=profile_domain_name, name=name, delete_name=delete_name, delete_profile_domain_name=delete_profile_domain_name, username=username, delete_port_profile_port=delete_port_profile_port, delete_port_profile_to_interface_associations=delete_port_profile_to_interface_associations, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, delete_port_to_port_profile_domain_association=delete_port_to_port_profile_domain_association, password=password, callback=_callback, mgr=mgr)
        return 0
