...
def rbridge_id_threshold_monitor_Memory_retry(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_Memory_retry_act(Action):
    def run(self, retry, rbridge_id, delete_Memory, delete_threshold_monitor, delete_rbridge_id, delete_retry, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_Memory_retry(retry=retry, username=username, delete_threshold_monitor=delete_threshold_monitor, delete_Memory=delete_Memory, rbridge_id=rbridge_id, host=host, delete_retry=delete_retry, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
