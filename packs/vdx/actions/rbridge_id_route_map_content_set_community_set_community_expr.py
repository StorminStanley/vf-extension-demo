...
def rbridge_id_route_map_content_set_community_set_community_expr(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_community_set_community_expr_act(Action):
    def run(self, set_community_expr, rbridge_id, delete_set, delete_community, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_set_community_expr, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_community_set_community_expr(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_name=delete_name, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_set_community_expr=delete_set_community_expr, delete_community=delete_community, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, set_community_expr=set_community_expr, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
