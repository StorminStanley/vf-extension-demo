...
def rbridge_id_snmp_server_user_groupname(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_user_groupname_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, delete_user, groupname, delete_groupname, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_user_groupname(delete_groupname=delete_groupname, delete_snmp_server=delete_snmp_server, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, groupname=groupname, host=host, delete_user=delete_user, delete_username=delete_username, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
