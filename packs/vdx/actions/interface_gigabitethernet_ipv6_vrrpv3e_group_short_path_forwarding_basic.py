...
def interface_gigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_basic(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_basic_act(Action):
    def run(self, delete_basic, name, delete_vrid, vrid, delete_short_path_forwarding, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_basic(delete_vrid=delete_vrid, name=name, delete_basic=delete_basic, delete_short_path_forwarding=delete_short_path_forwarding, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
