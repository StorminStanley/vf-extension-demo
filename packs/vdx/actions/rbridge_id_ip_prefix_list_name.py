...
def rbridge_id_ip_prefix_list_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_prefix_list_name_act(Action):
    def run(self, rbridge_id, delete_ip, delete_seq_keyword, instance, delete_instance, delete_name, delete_prefix_list, seq_keyword, delete_rbridge_id, name, host, username, password):
