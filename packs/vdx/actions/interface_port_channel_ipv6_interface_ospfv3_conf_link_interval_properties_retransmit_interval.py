...
def interface_port_channel_ipv6_interface_ospfv3_conf_link_interval_properties_retransmit_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_ospfv3_conf_link_interval_properties_retransmit_interval_act(Action):
    def run(self, retransmit_interval, name, delete_port_channel, delete_interface, delete_name, delete_link_interval_properties, delete_retransmit_interval, host, username, password):
