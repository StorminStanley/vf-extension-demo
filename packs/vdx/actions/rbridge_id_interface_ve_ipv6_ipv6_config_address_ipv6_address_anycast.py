...
def rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_anycast(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_anycast', False) is True:
        delete_anycast = config.find('.//*anycast')
        delete_anycast.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_anycast_act(Action):
    def run(self, delete_anycast, name, delete_ve, delete_interface, delete_name, address, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_anycast(delete_anycast=delete_anycast, delete_name=delete_name, address=address, username=username, rbridge_id=rbridge_id, name=name, delete_ve=delete_ve, host=host, delete_address=delete_address, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
