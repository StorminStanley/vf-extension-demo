...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_connected_unicast_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_connected_unicast_metric_act(Action):
    def run(self, unicast_metric, delete_address_family, delete_router_bgp, rbridge_id, delete_connected, delete_redistribute, delete_rbridge_id, delete_router, delete_unicast_metric, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_connected_unicast_metric(delete_address_family=delete_address_family, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_redistribute=delete_redistribute, delete_unicast_metric=delete_unicast_metric, delete_router=delete_router, host=host, password=password, delete_router_bgp=delete_router_bgp, unicast_metric=unicast_metric, delete_connected=delete_connected, callback=_callback, mgr=mgr)
        return 0
