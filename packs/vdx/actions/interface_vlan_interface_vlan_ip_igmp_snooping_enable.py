...
def interface_vlan_interface_vlan_ip_igmp_snooping_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_snooping_enable_act(Action):
    def run(self, delete_vlan, delete_enable, name, delete_ip, delete_interface_vlan, delete_igmp, delete_interface, delete_name, delete_snooping, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ip_igmp_snooping_enable(name=name, delete_name=delete_name, delete_snooping=delete_snooping, delete_vlan=delete_vlan, delete_enable=delete_enable, delete_ip=delete_ip, delete_igmp=delete_igmp, delete_interface_vlan=delete_interface_vlan, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
