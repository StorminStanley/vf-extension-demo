...
def interface_vlan_interface_vlan_ipv6_mldVlan_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ipv6_mldVlan_query_interval_act(Action):
    def run(self, delete_vlan, name, delete_interface_vlan, delete_query_interval, delete_mldVlan, delete_interface, delete_name, query_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ipv6_mldVlan_query_interval(name=name, delete_mldVlan=delete_mldVlan, delete_vlan=delete_vlan, query_interval=query_interval, delete_interface_vlan=delete_interface_vlan, host=host, delete_query_interval=delete_query_interval, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
