...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_multipath_multipath_ebgp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_multipath_multipath_ebgp_act(Action):
