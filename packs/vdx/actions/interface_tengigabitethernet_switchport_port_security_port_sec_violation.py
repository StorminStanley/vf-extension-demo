...
def interface_tengigabitethernet_switchport_port_security_port_sec_violation(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_port_security_port_sec_violation_act(Action):
    def run(self, delete_switchport, port_sec_violation, name, delete_port_sec_violation, delete_interface, delete_name, delete_tengigabitethernet, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_port_security_port_sec_violation(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_port_sec_violation=delete_port_sec_violation, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_port_security=delete_port_security, port_sec_violation=port_sec_violation, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
