...
def rbridge_id_ipv6_router_ospf_area_area_range_range_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_area_range_range_address_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_area_range, delete_range_address, delete_area, vrf, delete_rbridge_id, delete_router, range_address, host, username, password):
