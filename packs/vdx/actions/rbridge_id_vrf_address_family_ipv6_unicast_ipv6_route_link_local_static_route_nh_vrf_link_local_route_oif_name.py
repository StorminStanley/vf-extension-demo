...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_link_local_route_oif_name(**kwargs):
    """Auto Generated Code
    """
    ...
    link_local_route_oif_name = ET.SubElement(link_local_static_route_nh_vrf, "link-local-route-oif-name")
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_link_local_route_oif_name_act(Action):
