...
def interface_gigabitethernet_qos_rcv_queue_cos_threshold_cos0_threshold(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_cos0_threshold', False) is True:
        delete_cos0_threshold = config.find('.//*cos0-threshold')
        delete_cos0_threshold.set('operation', 'delete')
...
class interface_gigabitethernet_qos_rcv_queue_cos_threshold_cos0_threshold_act(Action):
