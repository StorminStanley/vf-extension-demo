...
def interface_tengigabitethernet_qos_random_detect_traffic_class_red_profile_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_random_detect_traffic_class_red_profile_id_act(Action):
    def run(self, delete_qos, delete_red_tc_value, name, red_tc_value, delete_traffic_class, delete_red_profile_id, delete_interface, delete_name, red_profile_id, delete_tengigabitethernet, delete_random_detect, host, username, password):
