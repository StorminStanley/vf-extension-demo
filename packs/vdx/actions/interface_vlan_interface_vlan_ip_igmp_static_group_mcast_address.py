...
def interface_vlan_interface_vlan_ip_igmp_static_group_mcast_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_static_group_mcast_address_act(Action):
