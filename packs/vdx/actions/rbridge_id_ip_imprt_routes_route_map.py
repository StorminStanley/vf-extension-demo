...
def rbridge_id_ip_imprt_routes_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_imprt_routes_route_map_act(Action):
    def run(self, delete_src_vrf, rbridge_id, delete_ip, route_map, delete_route_map, src_vrf, delete_imprt, delete_rbridge_id, delete_routes, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_imprt_routes_route_map(src_vrf=src_vrf, delete_routes=delete_routes, delete_src_vrf=delete_src_vrf, username=username, delete_imprt=delete_imprt, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_route_map=delete_route_map, route_map=route_map, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
