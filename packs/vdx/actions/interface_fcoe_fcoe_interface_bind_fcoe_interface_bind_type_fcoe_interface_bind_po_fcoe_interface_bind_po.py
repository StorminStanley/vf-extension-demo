...
def interface_fcoe_fcoe_interface_bind_fcoe_interface_bind_type_fcoe_interface_bind_po_fcoe_interface_bind_po(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_fcoe_interface_bind_po', False) is True:
        delete_fcoe_interface_bind_po = config.find('.//*fcoe-interface-bind-po')
        delete_fcoe_interface_bind_po.set('operation', 'delete')
...
class interface_fcoe_fcoe_interface_bind_fcoe_interface_bind_type_fcoe_interface_bind_po_fcoe_interface_bind_po_act(Action):
    def run(self, fcoe_interface_name, delete_fcoe_interface_bind, delete_fcoe_interface_bind_po, delete_interface, delete_fcoe, delete_fcoe_interface_name, delete_fcoe_interface_bind_type, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fcoe_fcoe_interface_bind_fcoe_interface_bind_type_fcoe_interface_bind_po_fcoe_interface_bind_po(fcoe_interface_name=fcoe_interface_name, username=username, delete_fcoe_interface_bind=delete_fcoe_interface_bind, delete_fcoe_interface_bind_type=delete_fcoe_interface_bind_type, host=host, delete_fcoe_interface_name=delete_fcoe_interface_name, delete_fcoe=delete_fcoe, delete_interface=delete_interface, delete_fcoe_interface_bind_po=delete_fcoe_interface_bind_po, password=password, callback=_callback, mgr=mgr)
        return 0
