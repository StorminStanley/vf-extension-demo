...
def protocol_spanning_tree_pvst_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_pvst_vlan_id_act(Action):
    def run(self, delete_vlan, delete_protocol, delete_spanning_tree, delete_pvst, delete_id, id, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_pvst_vlan_id(delete_pvst=delete_pvst, delete_vlan=delete_vlan, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, host=host, id=id, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
