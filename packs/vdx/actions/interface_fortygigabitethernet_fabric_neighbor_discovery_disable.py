...
def interface_fortygigabitethernet_fabric_neighbor_discovery_disable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_fabric_neighbor_discovery_disable_act(Action):
    def run(self, delete_disable, name, delete_neighbor_discovery, delete_fortygigabitethernet, delete_fabric, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_fabric_neighbor_discovery_disable(delete_disable=delete_disable, delete_neighbor_discovery=delete_neighbor_discovery, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, host=host, delete_fabric=delete_fabric, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
