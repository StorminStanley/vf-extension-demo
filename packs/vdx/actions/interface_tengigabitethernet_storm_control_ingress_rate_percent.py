...
def interface_tengigabitethernet_storm_control_ingress_rate_percent(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_storm_control_ingress_rate_percent_act(Action):
    def run(self, delete_storm_control, delete_ingress, rate_percent, delete_protocol_type, delete_rate_percent, delete_interface, delete_name, delete_tengigabitethernet, protocol_type, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_storm_control_ingress_rate_percent(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, rate_percent=rate_percent, delete_ingress=delete_ingress, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_protocol_type=delete_protocol_type, delete_rate_percent=delete_rate_percent, protocol_type=protocol_type, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
