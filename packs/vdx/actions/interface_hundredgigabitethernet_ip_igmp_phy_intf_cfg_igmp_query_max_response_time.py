...
def interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time_act(Action):
    def run(self, query_max_response_time, name, delete_ip, delete_igmp_phy_intf_cfg, delete_query_max_response_time, delete_igmp, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time(query_max_response_time=query_max_response_time, delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_ip=delete_ip, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_query_max_response_time=delete_query_max_response_time, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
