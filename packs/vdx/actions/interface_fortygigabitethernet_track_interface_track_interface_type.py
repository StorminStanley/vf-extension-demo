...
def interface_fortygigabitethernet_track_interface_track_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_track_interface_track_interface_type_act(Action):
