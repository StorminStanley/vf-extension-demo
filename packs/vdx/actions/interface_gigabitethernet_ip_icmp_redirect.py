...
def interface_gigabitethernet_ip_icmp_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_icmp_redirect_act(Action):
    def run(self, name, delete_ip, delete_icmp, delete_redirect, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
