...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_base', False) is True:
        delete_base = config.find('.//*base')
        delete_base.set('operation', 'delete')
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base_act(Action):
    def run(self, name, delete_nud, delete_base, delete_fortygigabitethernet, base, delete_interface, delete_name, delete_nd, delete_retry, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(delete_retry=delete_retry, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, base=base, delete_nud=delete_nud, delete_nd=delete_nd, host=host, delete_base=delete_base, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
