...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_unsuppress_map_map_name(**kwargs):
    """Auto Generated Code
    """
    ...
    unsuppress_map = ET.SubElement(af_ipv4_neighbor_addr, "unsuppress-map")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_unsuppress_map_map_name_act(Action):
    def run(self, delete_address_family, delete_map_name, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_unsuppress_map, map_name, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_unsuppress_map_map_name(delete_map_name=delete_map_name, username=username, af_vrf_name=af_vrf_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, map_name=map_name, delete_router=delete_router, host=host, password=password, delete_address_family=delete_address_family, delete_neighbor=delete_neighbor, delete_unsuppress_map=delete_unsuppress_map, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
