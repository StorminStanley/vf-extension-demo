...
def rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_bsr_cand_intf_id(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_bsr_cand_intf_id_act(Action):
