...
def rbridge_id_threshold_monitor_interface_policy_area_area_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_interface_policy_area_area_value_act(Action):
    def run(self, delete_policy_name, area_value, rbridge_id, delete_area_value, policy_name, delete_area, delete_interface, delete_type, delete_threshold_monitor, delete_policy, type, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_interface_policy_area_area_value(delete_area_value=delete_area_value, type=type, delete_type=delete_type, delete_policy_name=delete_policy_name, username=username, rbridge_id=rbridge_id, delete_threshold_monitor=delete_threshold_monitor, delete_area=delete_area, delete_policy=delete_policy, area_value=area_value, policy_name=policy_name, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
