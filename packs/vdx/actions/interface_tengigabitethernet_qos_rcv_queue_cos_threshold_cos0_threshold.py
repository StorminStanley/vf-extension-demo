...
def interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos0_threshold(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos0_threshold_act(Action):
