...
def rbridge_id_router_ospf_max_metric_router_lsa_on_startup_all_lsas_onstartup(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_all_lsas_onstartup', False) is True:
        delete_all_lsas_onstartup = config.find('.//*all-lsas-onstartup')
        delete_all_lsas_onstartup.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_ospf_max_metric_router_lsa_on_startup_all_lsas_onstartup_act(Action):
    def run(self, delete_on_startup, rbridge_id, delete_ospf, delete_vrf, delete_router_lsa, delete_max_metric, delete_all_lsas_onstartup, vrf, delete_rbridge_id, delete_router, host, username, password):
