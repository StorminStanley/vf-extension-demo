...
def interface_hundredgigabitethernet_dot1x_port_control(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_dot1x_port_control_act(Action):
    def run(self, name, delete_interface, delete_name, port_control, delete_hundredgigabitethernet, delete_port_control, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_dot1x_port_control(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, password=password, delete_port_control=delete_port_control, delete_interface=delete_interface, username=username, port_control=port_control, callback=_callback, mgr=mgr)
        return 0
