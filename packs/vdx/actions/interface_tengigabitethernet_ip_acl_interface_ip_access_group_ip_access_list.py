...
def interface_tengigabitethernet_ip_acl_interface_ip_access_group_ip_access_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_acl_interface_ip_access_group_ip_access_list_act(Action):
