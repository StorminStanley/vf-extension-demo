...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_database_filter_all_summary_external(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_database_filter_all_summary_external_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, delete_database_filter, all_summary_external, delete_interface, delete_name, delete_all_summary_external, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_database_filter_all_summary_external(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, delete_database_filter=delete_database_filter, name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_gigabitethernet=delete_gigabitethernet, host=host, all_summary_external=all_summary_external, delete_interface=delete_interface, delete_all_summary_external=delete_all_summary_external, password=password, callback=_callback, mgr=mgr)
        return 0
