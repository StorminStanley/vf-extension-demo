...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval_act(Action):
    def run(self, name, delete_dead_interval, dead_interval, delete_interface, delete_name, delete_link_interval_properties, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval(name=name, delete_name=delete_name, delete_link_interval_properties=delete_link_interval_properties, dead_interval=dead_interval, delete_tengigabitethernet=delete_tengigabitethernet, delete_dead_interval=delete_dead_interval, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
