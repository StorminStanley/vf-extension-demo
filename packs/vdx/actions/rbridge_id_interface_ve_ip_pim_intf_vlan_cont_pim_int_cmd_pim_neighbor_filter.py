...
def rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_pim_neighbor_filter(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_pim_neighbor_filter_act(Action):
    def run(self, delete_pim, name, delete_ip, delete_neighbor_filter, delete_ve, delete_interface, delete_name, delete_pim_intf_vlan_cont, delete_rbridge_id, delete_pim_int_cmd, neighbor_filter, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_pim_neighbor_filter(name=name, delete_name=delete_name, delete_pim=delete_pim, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_pim_int_cmd=delete_pim_int_cmd, neighbor_filter=neighbor_filter, delete_neighbor_filter=delete_neighbor_filter, delete_ve=delete_ve, host=host, delete_pim_intf_vlan_cont=delete_pim_intf_vlan_cont, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
