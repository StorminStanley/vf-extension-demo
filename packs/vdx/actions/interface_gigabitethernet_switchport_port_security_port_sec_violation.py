...
def interface_gigabitethernet_switchport_port_security_port_sec_violation(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_port_security_port_sec_violation_act(Action):
    def run(self, delete_switchport, port_sec_violation, name, delete_gigabitethernet, delete_port_sec_violation, delete_interface, delete_name, delete_port_security, host, username, password):
