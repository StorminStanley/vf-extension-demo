...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_database_filter_all_external(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_database_filter_all_external_act(Action):
    def run(self, name, delete_ip, delete_all_external, delete_database_filter, all_external, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_database_filter_all_external(delete_database_filter=delete_database_filter, name=name, delete_name=delete_name, username=username, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, delete_ip=delete_ip, rbridge_id=rbridge_id, delete_all_external=delete_all_external, all_external=all_external, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, delete_ospf_interface_config=delete_ospf_interface_config, callback=_callback, mgr=mgr)
        return 0
