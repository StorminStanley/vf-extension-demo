...
def protocol_spanning_tree_mstp_max_hops(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_max_hops_act(Action):
    def run(self, delete_mstp, max_hops, delete_spanning_tree, delete_max_hops, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_max_hops(delete_max_hops=delete_max_hops, delete_spanning_tree=delete_spanning_tree, max_hops=max_hops, delete_protocol=delete_protocol, delete_mstp=delete_mstp, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
