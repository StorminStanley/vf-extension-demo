...
def interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_static_group_sg_addr(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_static_group_sg_addr_act(Action):
    def run(self, name, delete_ip, delete_fortygigabitethernet, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_static_group, delete_sg_addr, sg_addr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_static_group_sg_addr(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_igmp=delete_igmp, delete_ip=delete_ip, sg_addr=sg_addr, delete_static_group=delete_static_group, delete_sg_addr=delete_sg_addr, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
