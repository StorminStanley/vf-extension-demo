...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_key_act(Action):
    def run(self, name, delete_ipsec_auth_key_config, delete_ca_ah_algorithm, delete_ah_key, delete_authentication, delete_name, delete_ch_algorithm, ah_key, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_key(delete_ca_ah_algorithm=delete_ca_ah_algorithm, name=name, delete_ah_key=delete_ah_key, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_gigabitethernet=delete_gigabitethernet, delete_authentication=delete_authentication, host=host, delete_ch_algorithm=delete_ch_algorithm, delete_name=delete_name, ah_key=ah_key, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
