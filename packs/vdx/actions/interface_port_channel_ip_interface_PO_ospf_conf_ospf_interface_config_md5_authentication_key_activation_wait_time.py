...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time_act(Action):
    def run(self, key_activation_wait_time, delete_ip, delete_interface_PO_ospf_conf, delete_key_activation_wait_time, delete_port_channel, delete_interface, delete_name, delete_ospf_interface_config, name, host, username, password):
