...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable_act(Action):
    def run(self, delete_intf_bfd_enable, delete_ip, delete_interface_PO_ospf_conf, delete_port_channel, delete_interface, delete_name, delete_bfd, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable(delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, delete_intf_bfd_enable=delete_intf_bfd_enable, password=password, host=host, delete_interface=delete_interface, username=username, delete_bfd=delete_bfd, callback=_callback, mgr=mgr)
        return 0
