...
def interface_hundredgigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_sparse(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_sparse_act(Action):
    def run(self, delete_pim_intf_phy_cont, delete_ip, delete_pim_sparse, delete_interface, delete_name, delete_hundredgigabitethernet, delete_pim_int_cmd, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_sparse(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_ip=delete_ip, delete_pim_int_cmd=delete_pim_int_cmd, delete_pim_intf_phy_cont=delete_pim_intf_phy_cont, delete_pim_sparse=delete_pim_sparse, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
