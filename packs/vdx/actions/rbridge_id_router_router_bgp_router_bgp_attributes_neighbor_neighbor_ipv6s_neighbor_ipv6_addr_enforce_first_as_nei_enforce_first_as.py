...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_enforce_first_as_nei_enforce_first_as(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_enforce_first_as_nei_enforce_first_as_act(Action):
    def run(self, delete_enforce_first_as, delete_router_bgp, rbridge_id, delete_router_bgp_attributes, delete_nei_enforce_first_as, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_enforce_first_as_nei_enforce_first_as(delete_enforce_first_as=delete_enforce_first_as, delete_router_bgp=delete_router_bgp, delete_nei_enforce_first_as=delete_nei_enforce_first_as, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
