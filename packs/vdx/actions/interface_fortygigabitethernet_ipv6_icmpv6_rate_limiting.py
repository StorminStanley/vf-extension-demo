...
def interface_fortygigabitethernet_ipv6_icmpv6_rate_limiting(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_icmpv6_rate_limiting_act(Action):
    def run(self, delete_rate_limiting, name, delete_fortygigabitethernet, delete_interface, delete_name, rate_limiting, host, username, password):
