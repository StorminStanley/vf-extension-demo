...
def interface_tengigabitethernet_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan_act(Action):
    def run(self, delete_switchport, delete_mac_address, name, delete_port_secutiry_mac_address, port_sec_vlan, delete_interface, delete_name, mac_address, delete_sticky, delete_tengigabitethernet, delete_port_security, delete_port_sec_vlan, host, username, password):
