...
def interface_fortygigabitethernet_port_profile_port(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_port_profile_port_act(Action):
    def run(self, delete_fortygigabitethernet, delete_port_profile_port, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_port_profile_port(name=name, delete_name=delete_name, delete_port_profile_port=delete_port_profile_port, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
