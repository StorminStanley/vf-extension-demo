...
def rbridge_id_arp_entry_interfacetype_HundredGigabitEthernet_HundredGigabitEthernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_arp_entry_interfacetype_HundredGigabitEthernet_HundredGigabitEthernet_act(Action):
    def run(self, rbridge_id, delete_interfacetype, delete_arp_ip_address, arp_ip_address, HundredGigabitEthernet, delete_HundredGigabitEthernet, delete_arp_entry, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_arp_entry_interfacetype_HundredGigabitEthernet_HundredGigabitEthernet(HundredGigabitEthernet=HundredGigabitEthernet, delete_arp_entry=delete_arp_entry, delete_HundredGigabitEthernet=delete_HundredGigabitEthernet, username=username, rbridge_id=rbridge_id, delete_interfacetype=delete_interfacetype, arp_ip_address=arp_ip_address, delete_arp_ip_address=delete_arp_ip_address, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
