...
def interface_tengigabitethernet_switchport_port_security_allowed_ouis_oui(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_port_security_allowed_ouis_oui_act(Action):
    def run(self, delete_switchport, oui, name, delete_oui, delete_allowed_ouis, delete_interface, delete_name, delete_tengigabitethernet, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_port_security_allowed_ouis_oui(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_oui=delete_oui, oui=oui, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_allowed_ouis=delete_allowed_ouis, delete_port_security=delete_port_security, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
