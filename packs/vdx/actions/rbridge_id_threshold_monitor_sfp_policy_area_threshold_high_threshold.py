...
def rbridge_id_threshold_monitor_sfp_policy_area_threshold_high_threshold(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_sfp_policy_area_threshold_high_threshold_act(Action):
    def run(self, high_threshold, delete_policy_name, area_value, rbridge_id, delete_high_threshold, delete_area_value, policy_name, delete_area, delete_type, delete_threshold_monitor, delete_sfp, type, delete_rbridge_id, delete_policy, delete_threshold, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_sfp_policy_area_threshold_high_threshold(delete_area_value=delete_area_value, username=username, type=type, delete_sfp=delete_sfp, delete_type=delete_type, delete_policy_name=delete_policy_name, high_threshold=high_threshold, rbridge_id=rbridge_id, delete_high_threshold=delete_high_threshold, delete_threshold_monitor=delete_threshold_monitor, delete_area=delete_area, delete_threshold=delete_threshold, delete_policy=delete_policy, area_value=area_value, policy_name=policy_name, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
