...
def interface_fcoe_fcoe_interface_bind_fcoe_interface_bind_type_fcoe_interface_bind_mac_fcoe_interface_bind_mac(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_fcoe_interface_bind_mac', False) is True:
        delete_fcoe_interface_bind_mac = config.find('.//*fcoe-interface-bind-mac')
        delete_fcoe_interface_bind_mac.set('operation', 'delete')
...
class interface_fcoe_fcoe_interface_bind_fcoe_interface_bind_type_fcoe_interface_bind_mac_fcoe_interface_bind_mac_act(Action):
    def run(self, fcoe_interface_name, delete_fcoe_interface_bind, delete_fcoe_interface_bind_mac, delete_interface, delete_fcoe, delete_fcoe_interface_name, delete_fcoe_interface_bind_type, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fcoe_fcoe_interface_bind_fcoe_interface_bind_type_fcoe_interface_bind_mac_fcoe_interface_bind_mac(delete_fcoe_interface_bind_mac=delete_fcoe_interface_bind_mac, delete_fcoe=delete_fcoe, delete_fcoe_interface_bind=delete_fcoe_interface_bind, delete_fcoe_interface_bind_type=delete_fcoe_interface_bind_type, host=host, delete_fcoe_interface_name=delete_fcoe_interface_name, fcoe_interface_name=fcoe_interface_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
