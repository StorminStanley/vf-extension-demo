...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_vrid(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_vrid_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_vrid, vrid, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_vrid(delete_vrid=delete_vrid, name=name, delete_name=delete_name, host=host, vrid=vrid, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
