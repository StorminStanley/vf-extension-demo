...
def interface_port_channel_switchport_trunk_private_vlan_classification_private_vlan_trunk_allowed_vlan_add_trunk_ctag_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_trunk_private_vlan_classification_private_vlan_trunk_allowed_vlan_add_trunk_ctag_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk_ctag_id, delete_trunk, trunk_vlan_id, trunk_ctag_id, delete_trunk_private_vlan_classification, delete_port_channel, delete_private_vlan, delete_interface, delete_name, delete_add, delete_trunk_vlan_id, host, username, password):
