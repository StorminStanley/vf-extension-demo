...
def interface_hundredgigabitethernet_spanning_tree_instance_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_instance_priority_act(Action):
    def run(self, name, delete_id, id, priority, delete_instance, delete_priority, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
