...
def rbridge_id_route_map_content_match_ip_address_prefix_list_rmm(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_ip_address_prefix_list_rmm_act(Action):
    def run(self, delete_prefix_list_rmm, rbridge_id, delete_ip, prefix_list_rmm, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_address, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_ip_address_prefix_list_rmm(delete_instance=delete_instance, delete_route_map=delete_route_map, delete_address=delete_address, action_rm=action_rm, delete_prefix_list_rmm=delete_prefix_list_rmm, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, name=name, prefix_list_rmm=prefix_list_rmm, delete_action_rm=delete_action_rm, delete_content=delete_content, host=host, password=password, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
