...
def interface_gigabitethernet_switchport_trunk_native_vlan_xtagged_config_native_vlan_id_xtagged(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_native_vlan_xtagged_config_native_vlan_id_xtagged_act(Action):
    def run(self, delete_switchport, delete_native_vlan_xtagged_config, name, delete_trunk, native_vlan_id_xtagged, delete_interface, delete_name, delete_gigabitethernet, delete_native_vlan_id_xtagged, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_trunk_native_vlan_xtagged_config_native_vlan_id_xtagged(name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, delete_native_vlan_xtagged_config=delete_native_vlan_xtagged_config, password=password, native_vlan_id_xtagged=native_vlan_id_xtagged, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_native_vlan_id_xtagged=delete_native_vlan_id_xtagged, callback=_callback, mgr=mgr)
        return 0
