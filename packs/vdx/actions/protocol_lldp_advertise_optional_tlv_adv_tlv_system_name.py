...
def protocol_lldp_advertise_optional_tlv_adv_tlv_system_name(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_advertise_optional_tlv_adv_tlv_system_name_act(Action):
    def run(self, delete_optional_tlv, delete_advertise, delete_lldp, delete_adv_tlv_system_name, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_advertise_optional_tlv_adv_tlv_system_name(delete_optional_tlv=delete_optional_tlv, password=password, delete_lldp=delete_lldp, delete_protocol=delete_protocol, host=host, delete_adv_tlv_system_name=delete_adv_tlv_system_name, username=username, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
