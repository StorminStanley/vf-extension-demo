...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_orf_prefixlist_prefixlist_status(**kwargs):
    """Auto Generated Code
    """
    ...
    af_vrf_neighbor_capability = ET.SubElement(af_ipv4_neighbor_addr, "af-vrf-neighbor-capability")
    ...
    orf = ET.SubElement(af_vrf_neighbor_capability, "orf")
    ...
    if kwargs.pop('delete_prefixlist_status', False) is True:
        delete_prefixlist_status = config.find('.//*prefixlist-status')
        delete_prefixlist_status.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_orf_prefixlist_prefixlist_status_act(Action):
    def run(self, delete_prefixlist, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_orf, delete_af_vrf_neighbor_capability, delete_rbridge_id, delete_neighbor, delete_router, delete_prefixlist_status, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_af_vrf_neighbor_capability_orf_prefixlist_prefixlist_status(delete_prefixlist_status=delete_prefixlist_status, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_af_vrf_neighbor_capability=delete_af_vrf_neighbor_capability, host=host, delete_prefixlist=delete_prefixlist, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_orf=delete_orf, password=password, callback=_callback, mgr=mgr)
        return 0
