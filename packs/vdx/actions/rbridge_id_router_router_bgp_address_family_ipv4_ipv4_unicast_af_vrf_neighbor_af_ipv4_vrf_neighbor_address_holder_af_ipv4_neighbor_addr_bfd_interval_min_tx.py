...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_interval_min_tx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_interval_min_tx_act(Action):
    def run(self, delete_bfd, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_min_tx, delete_interval, min_tx, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_interval_min_tx(delete_interval=delete_interval, delete_router=delete_router, delete_address_family=delete_address_family, username=username, af_vrf_name=af_vrf_name, delete_bfd=delete_bfd, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_neighbor=delete_neighbor, min_tx=min_tx, host=host, password=password, delete_af_vrf=delete_af_vrf, delete_rbridge_id=delete_rbridge_id, delete_min_tx=delete_min_tx, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
