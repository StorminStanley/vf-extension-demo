...
def interface_tengigabitethernet_ipv6_vrrpv3_group_use_v2_checksum(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3_group_use_v2_checksum_act(Action):
    def run(self, name, delete_vrid, vrid, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_vrrpv3_group_use_v2_checksum(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_tengigabitethernet=delete_tengigabitethernet, vrid=vrid, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
