...
def rbridge_id_route_map_content_set_ip_next_hop_peer_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ip_next_hop_peer_address_act(Action):
    def run(self, rbridge_id, delete_set, delete_next_hop, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_ip, delete_peer_address, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_ip_next_hop_peer_address(delete_instance=delete_instance, delete_route_map=delete_route_map, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, password=password, delete_next_hop=delete_next_hop, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, delete_peer_address=delete_peer_address, callback=_callback, mgr=mgr)
        return 0
