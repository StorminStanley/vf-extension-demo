...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_load_balancing_basic(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_load_balancing_basic_act(Action):
    def run(self, delete_basic, name, delete_ip, delete_load_balancing, delete_ip_local_anycast_gateway, delete_ve, delete_interface, delete_name, delete_rbridge_id, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_local_anycast_gateway_load_balancing_basic(local_ip_gw_id=local_ip_gw_id, delete_ip_local_anycast_gateway=delete_ip_local_anycast_gateway, name=name, delete_basic=delete_basic, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_load_balancing=delete_load_balancing, delete_ve=delete_ve, host=host, delete_local_ip_gw_id=delete_local_ip_gw_id, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
