...
def rbridge_id_ip_rtm_config_route_static_route_oif_vrf_static_route_oif_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_vrf_static_route_oif_name_act(Action):
    def run(self, static_route_oif_type, delete_next_hop_vrf, rbridge_id, delete_ip, delete_route, delete_static_route_next_vrf_dest, next_hop_vrf, delete_static_route_oif_vrf, delete_static_route_oif_name, static_route_next_vrf_dest, delete_rtm_config, delete_rbridge_id, delete_static_route_oif_type, static_route_oif_name, host, username, password):
