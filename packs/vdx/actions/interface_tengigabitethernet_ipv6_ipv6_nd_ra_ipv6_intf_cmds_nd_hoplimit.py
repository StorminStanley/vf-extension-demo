...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_hoplimit(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_hoplimit', False) is True:
        delete_hoplimit = config.find('.//*hoplimit')
        delete_hoplimit.set('operation', 'delete')
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_hoplimit_act(Action):
    def run(self, name, hoplimit, delete_hoplimit, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_hoplimit(name=name, delete_name=delete_name, delete_hoplimit=delete_hoplimit, delete_nd=delete_nd, delete_tengigabitethernet=delete_tengigabitethernet, hoplimit=hoplimit, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
