...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base_act(Action):
    def run(self, delete_retry, name, delete_nud, delete_base, base, delete_interface, delete_name, delete_nd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(name=name, delete_name=delete_name, base=base, delete_nud=delete_nud, delete_base=delete_base, delete_nd=delete_nd, host=host, delete_retry=delete_retry, delete_interface=delete_interface, delete_gigabitethernet=delete_gigabitethernet, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
