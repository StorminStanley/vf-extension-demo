...
def interface_gigabitethernet_ip_icmp_echo_reply(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_icmp_echo_reply_act(Action):
    def run(self, name, delete_ip, delete_icmp, delete_interface, delete_name, delete_gigabitethernet, delete_echo_reply, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_icmp_echo_reply(name=name, delete_name=delete_name, delete_icmp=delete_icmp, delete_echo_reply=delete_echo_reply, delete_ip=delete_ip, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
