...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_database_filter_all_summary_external(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_database_filter_all_summary_external_act(Action):
    def run(self, delete_ip, delete_interface_PO_ospf_conf, delete_database_filter, all_summary_external, delete_port_channel, delete_interface, delete_name, delete_ospf_interface_config, delete_all_summary_external, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_database_filter_all_summary_external(delete_database_filter=delete_database_filter, delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, host=host, all_summary_external=all_summary_external, delete_interface=delete_interface, delete_all_summary_external=delete_all_summary_external, password=password, callback=_callback, mgr=mgr)
        return 0
