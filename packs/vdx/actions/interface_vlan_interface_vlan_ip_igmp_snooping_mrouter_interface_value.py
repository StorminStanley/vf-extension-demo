...
def interface_vlan_interface_vlan_ip_igmp_snooping_mrouter_interface_value(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_snooping_mrouter_interface_value_act(Action):
