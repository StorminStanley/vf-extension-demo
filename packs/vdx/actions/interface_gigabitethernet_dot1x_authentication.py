...
def interface_gigabitethernet_dot1x_authentication(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_authentication_act(Action):
    def run(self, delete_authentication, delete_name, delete_interface, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_dot1x_authentication(name=name, delete_name=delete_name, delete_authentication=delete_authentication, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
