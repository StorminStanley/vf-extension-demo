...
def interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_auth_change_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_auth_change_wait_time_act(Action):
    def run(self, auth_change_wait_time, name, delete_ip, delete_interface_fo_ospf_conf, delete_auth_change_wait_time, delete_interface, delete_name, delete_hundredgigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_auth_change_wait_time(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, auth_change_wait_time=auth_change_wait_time, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, password=password, host=host, delete_interface=delete_interface, username=username, delete_auth_change_wait_time=delete_auth_change_wait_time, callback=_callback, mgr=mgr)
        return 0
