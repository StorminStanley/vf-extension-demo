...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_best_best(**kwargs):
    """Auto Generated Code
    """
    ...
    additional_paths = ET.SubElement(af_ipv4_neighbor_addr, "additional-paths")
    ...
    ca_best = ET.SubElement(ch_additional_paths, "ca-best")
    if kwargs.pop('delete_ca_best', False) is True:
        delete_ca_best = config.find('.//*ca-best')
        delete_ca_best.set('operation', 'delete')
        
    best = ET.SubElement(ca_best, "best")
    if kwargs.pop('delete_best', False) is True:
        delete_best = config.find('.//*best')
        delete_best.set('operation', 'delete')
        
    best.text = kwargs.pop('best')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_best_best_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, best, delete_best, delete_advertise, delete_ch_additional_paths, delete_rbridge_id, delete_ca_best, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_best_best(delete_ch_additional_paths=delete_ch_additional_paths, delete_additional_paths=delete_additional_paths, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_best=delete_best, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_ca_best=delete_ca_best, best=best, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, password=password, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
