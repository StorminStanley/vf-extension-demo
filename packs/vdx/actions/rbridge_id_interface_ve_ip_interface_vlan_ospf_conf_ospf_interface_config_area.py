...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_area(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_area_act(Action):
    def run(self, name, delete_ip, area, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_area, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_area(name=name, delete_name=delete_name, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_area=delete_area, delete_ve=delete_ve, area=area, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
