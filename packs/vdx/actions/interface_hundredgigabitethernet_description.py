...
def interface_hundredgigabitethernet_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_description_act(Action):
    def run(self, delete_description, description, delete_interface, delete_name, delete_hundredgigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_description(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_description=delete_description, host=host, description=description, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
