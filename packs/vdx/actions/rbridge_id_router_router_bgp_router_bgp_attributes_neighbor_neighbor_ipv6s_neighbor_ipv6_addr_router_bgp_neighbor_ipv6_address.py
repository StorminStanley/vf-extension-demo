...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_router_bgp_neighbor_ipv6_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_router_bgp_neighbor_ipv6_address_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_router_bgp_attributes, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
