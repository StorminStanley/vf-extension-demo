...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_transmit_delay(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_transmit_delay_act(Action):
    def run(self, delete_transmit_delay, delete_interface_te_ospf_conf, name, delete_ip, delete_interface, delete_name, delete_tengigabitethernet, transmit_delay, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_transmit_delay(name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_transmit_delay=delete_transmit_delay, host=host, transmit_delay=transmit_delay, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, password=password, callback=_callback, mgr=mgr)
        return 0
