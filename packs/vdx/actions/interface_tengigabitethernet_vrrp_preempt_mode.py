...
def interface_tengigabitethernet_vrrp_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_vrrp_preempt_mode_act(Action):
    def run(self, name, delete_vrid, vrid, delete_preempt_mode, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_vrrp_preempt_mode(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, version=version, delete_tengigabitethernet=delete_tengigabitethernet, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
