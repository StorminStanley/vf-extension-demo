...
def rbridge_id_router_router_bgp_router_bgp_attributes_timers_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_timers_hold_time_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_hold_time, delete_router_bgp_attributes, delete_timers, delete_rbridge_id, hold_time, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_timers_hold_time(delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, hold_time=hold_time, delete_hold_time=delete_hold_time, delete_timers=delete_timers, password=password, callback=_callback, mgr=mgr)
        return 0
