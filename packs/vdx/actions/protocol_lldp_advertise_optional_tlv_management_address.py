...
def protocol_lldp_advertise_optional_tlv_management_address(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_advertise_optional_tlv_management_address_act(Action):
    def run(self, delete_optional_tlv, delete_advertise, delete_lldp, delete_management_address, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_advertise_optional_tlv_management_address(delete_optional_tlv=delete_optional_tlv, delete_management_address=delete_management_address, delete_lldp=delete_lldp, delete_protocol=delete_protocol, password=password, host=host, username=username, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
