...
def interface_fortygigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_host(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_host_act(Action):
    def run(self, delete_switchport, name, delete_fortygigabitethernet, delete_private_vlan, delete_interface, delete_name, delete_trunk_host, delete_mode, delete_private_vlan_trunk, host, username, password):
