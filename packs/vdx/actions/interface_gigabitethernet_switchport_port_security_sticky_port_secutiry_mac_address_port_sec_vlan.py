...
def interface_gigabitethernet_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan_act(Action):
