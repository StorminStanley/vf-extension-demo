...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_enable_act(Action):
    def run(self, name, delete_vrid, vrid, delete_enable, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_vrrpv3e_group_enable(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_enable=delete_enable, delete_tengigabitethernet=delete_tengigabitethernet, vrid=vrid, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
