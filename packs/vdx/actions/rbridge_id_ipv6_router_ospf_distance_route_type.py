...
def rbridge_id_ipv6_router_ospf_distance_route_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_distance_route_type_act(Action):
    def run(self, delete_distance, rbridge_id, delete_ospf, delete_vrf, delete_route_type, route_type, vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_distance_route_type(delete_route_type=delete_route_type, route_type=route_type, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_router=delete_router, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_distance=delete_distance, password=password, callback=_callback, mgr=mgr)
        return 0
