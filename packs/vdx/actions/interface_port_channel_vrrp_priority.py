...
def interface_port_channel_vrrp_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_priority_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, priority, delete_port_channel, version, delete_interface, delete_name, delete_priority, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_vrrp_priority(delete_vrid=delete_vrid, version=version, name=name, delete_version=delete_version, username=username, priority=priority, delete_vrrp=delete_vrrp, delete_port_channel=delete_port_channel, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
