...
def rbridge_id_ip_prefix_list_ge_ipp(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ge_ipp', False) is True:
        delete_ge_ipp = config.find('.//*ge-ipp')
        delete_ge_ipp.set('operation', 'delete')
...
class rbridge_id_ip_prefix_list_ge_ipp_act(Action):
    def run(self, ge_ipp, rbridge_id, delete_ip, delete_ge_ipp, delete_seq_keyword, instance, delete_instance, delete_name, delete_prefix_list, delete_rbridge_id, seq_keyword, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_prefix_list_ge_ipp(delete_instance=delete_instance, delete_prefix_list=delete_prefix_list, delete_ge_ipp=delete_ge_ipp, delete_seq_keyword=delete_seq_keyword, username=username, seq_keyword=seq_keyword, rbridge_id=rbridge_id, delete_ip=delete_ip, name=name, ge_ipp=ge_ipp, host=host, password=password, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
