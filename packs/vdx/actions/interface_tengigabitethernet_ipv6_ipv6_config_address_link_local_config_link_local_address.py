...
def interface_tengigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local_address_act(Action):
    def run(self, delete_link_local_config, name, link_local_address, delete_link_local_address, delete_interface, delete_name, delete_address, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local_address(name=name, delete_name=delete_name, link_local_address=link_local_address, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_link_local_config=delete_link_local_config, delete_link_local_address=delete_link_local_address, delete_address=delete_address, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
