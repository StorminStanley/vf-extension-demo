...
def interface_gigabitethernet_storm_control_ingress_rate_percent(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_storm_control_ingress_rate_percent_act(Action):
    def run(self, protocol_type, delete_storm_control, delete_ingress, rate_percent, delete_protocol_type, delete_rate_percent, delete_interface, delete_name, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_storm_control_ingress_rate_percent(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, rate_percent=rate_percent, delete_gigabitethernet=delete_gigabitethernet, delete_ingress=delete_ingress, protocol_type=protocol_type, delete_protocol_type=delete_protocol_type, delete_rate_percent=delete_rate_percent, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
