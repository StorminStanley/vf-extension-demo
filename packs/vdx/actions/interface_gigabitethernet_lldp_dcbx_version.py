...
def interface_gigabitethernet_lldp_dcbx_version(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_lldp_dcbx_version_act(Action):
    def run(self, delete_lldp, name, delete_dcbx_version, delete_interface, delete_name, dcbx_version, delete_gigabitethernet, host, username, password):
