...
def rbridge_id_threshold_monitor_sfp_policy_area_threshold_buffer(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_sfp_policy_area_threshold_buffer_act(Action):
    def run(self, delete_policy_name, area_value, rbridge_id, buffer, delete_buffer, delete_area_value, policy_name, delete_area, delete_type, delete_threshold_monitor, delete_sfp, type, delete_rbridge_id, delete_policy, delete_threshold, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_sfp_policy_area_threshold_buffer(delete_area_value=delete_area_value, type=type, delete_sfp=delete_sfp, delete_type=delete_type, delete_policy_name=delete_policy_name, username=username, rbridge_id=rbridge_id, delete_threshold=delete_threshold, delete_buffer=delete_buffer, delete_area=delete_area, buffer=buffer, host=host, area_value=area_value, policy_name=policy_name, delete_policy=delete_policy, delete_rbridge_id=delete_rbridge_id, password=password, delete_threshold_monitor=delete_threshold_monitor, callback=_callback, mgr=mgr)
        return 0
