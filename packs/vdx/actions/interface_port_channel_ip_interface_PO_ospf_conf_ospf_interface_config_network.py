...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_network(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_network_act(Action):
    def run(self, delete_ip, delete_interface_PO_ospf_conf, delete_network, network, delete_port_channel, delete_interface, delete_name, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_network(delete_ospf_interface_config=delete_ospf_interface_config, network=network, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, host=host, delete_network=delete_network, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
