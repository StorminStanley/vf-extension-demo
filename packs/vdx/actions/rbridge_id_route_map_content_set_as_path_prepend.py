...
def rbridge_id_route_map_content_set_as_path_prepend(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_as_path_prepend_act(Action):
    def run(self, rbridge_id, delete_set, delete_as_path, delete_route_map, delete_content, prepend, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_prepend, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_as_path_prepend(prepend=prepend, delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_as_path=delete_as_path, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_prepend=delete_prepend, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
