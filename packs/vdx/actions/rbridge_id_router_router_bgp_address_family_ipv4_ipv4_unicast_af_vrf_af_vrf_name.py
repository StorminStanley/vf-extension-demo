...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_vrf_name(**kwargs):
    """Auto Generated Code
    """
    ...
    af_vrf_name = ET.SubElement(af_vrf, "af-vrf-name")
    ...
    af_vrf_name.text = kwargs.pop('af_vrf_name')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_vrf_name_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_rbridge_id, delete_router, host, username, password):
