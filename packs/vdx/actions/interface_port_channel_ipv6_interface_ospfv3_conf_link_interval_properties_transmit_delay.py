...
def interface_port_channel_ipv6_interface_ospfv3_conf_link_interval_properties_transmit_delay(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_ospfv3_conf_link_interval_properties_transmit_delay_act(Action):
    def run(self, delete_transmit_delay, name, delete_port_channel, delete_interface, delete_name, delete_link_interval_properties, transmit_delay, host, username, password):
