...
def rbridge_id_system_monitor_cid_card_threshold_marginal_threshold(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_system_monitor_cid_card_threshold_marginal_threshold_act(Action):
    def run(self, delete_threshold, delete_cid_card, delete_system_monitor, delete_marginal_threshold, delete_rbridge_id, marginal_threshold, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_system_monitor_cid_card_threshold_marginal_threshold(delete_system_monitor=delete_system_monitor, delete_marginal_threshold=delete_marginal_threshold, marginal_threshold=marginal_threshold, username=username, rbridge_id=rbridge_id, delete_cid_card=delete_cid_card, host=host, delete_threshold=delete_threshold, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
