...
def interface_port_channel_switchport_trunk_default_vlan_config_default_transparent_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_trunk_default_vlan_config_default_transparent_vlan_act(Action):
    def run(self, delete_switchport, name, delete_trunk, delete_default_vlan_config, delete_port_channel, delete_interface, delete_name, delete_default_transparent_vlan, default_transparent_vlan, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_trunk_default_vlan_config_default_transparent_vlan(default_transparent_vlan=default_transparent_vlan, delete_port_channel=delete_port_channel, name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, username=username, delete_default_vlan_config=delete_default_vlan_config, host=host, delete_name=delete_name, delete_interface=delete_interface, delete_default_transparent_vlan=delete_default_transparent_vlan, password=password, callback=_callback, mgr=mgr)
        return 0
