...
def protocol_spanning_tree_rstp_error_disable_agtimeout_interval(**kwargs):
    """Auto Generated Code
    """
    ...
    error_disable_agtimeout = ET.SubElement(rstp, "error-disable-agtimeout")
...
class protocol_spanning_tree_rstp_error_disable_agtimeout_interval_act(Action):
    def run(self, delete_error_disable_agtimeout, delete_rstp, delete_protocol, interval, delete_interval, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rstp_error_disable_agtimeout_interval(delete_interval=delete_interval, delete_error_disable_agtimeout=delete_error_disable_agtimeout, delete_spanning_tree=delete_spanning_tree, delete_rstp=delete_rstp, delete_protocol=delete_protocol, interval=interval, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
