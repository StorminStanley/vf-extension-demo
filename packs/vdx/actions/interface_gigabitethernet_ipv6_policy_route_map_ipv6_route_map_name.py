...
def interface_gigabitethernet_ipv6_policy_route_map_ipv6_route_map_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_policy_route_map_ipv6_route_map_name_act(Action):
    def run(self, name, delete_route_map, delete_policy, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_policy_route_map_ipv6_route_map_name(name=name, delete_name=delete_name, delete_route_map=delete_route_map, delete_policy=delete_policy, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
