...
def interface_gigabitethernet_bpdu_drop_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_bpdu_drop_direction_act(Action):
    def run(self, direction, name, delete_bpdu_drop, delete_name, delete_interface, delete_gigabitethernet, delete_direction, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_bpdu_drop_direction(name=name, delete_name=delete_name, direction=direction, password=password, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, delete_bpdu_drop=delete_bpdu_drop, delete_direction=delete_direction, callback=_callback, mgr=mgr)
        return 0
