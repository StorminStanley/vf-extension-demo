...
def rbridge_id_interface_ve_ip_icmp_redirect(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_icmp_redirect_act(Action):
    def run(self, name, delete_ip, delete_icmp, delete_ve, delete_redirect, delete_interface, delete_name, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_icmp_redirect(name=name, delete_redirect=delete_redirect, delete_icmp=delete_icmp, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ve=delete_ve, host=host, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
