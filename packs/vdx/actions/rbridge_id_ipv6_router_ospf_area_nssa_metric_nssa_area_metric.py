...
def rbridge_id_ipv6_router_ospf_area_nssa_metric_nssa_area_metric(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_nssa_area_metric', False) is True:
        delete_nssa_area_metric = config.find('.//*nssa-area-metric')
        delete_nssa_area_metric.set('operation', 'delete')
...
class rbridge_id_ipv6_router_ospf_area_nssa_metric_nssa_area_metric_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_nssa_area_metric, delete_area_id, delete_nssa, delete_area, vrf, nssa_area_metric, delete_rbridge_id, delete_router, delete_metric, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_nssa_metric_nssa_area_metric(delete_metric=delete_metric, username=username, delete_area=delete_area, delete_nssa_area_metric=delete_nssa_area_metric, rbridge_id=rbridge_id, delete_vrf=delete_vrf, nssa_area_metric=nssa_area_metric, delete_router=delete_router, delete_ospf=delete_ospf, password=password, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, area_id=area_id, delete_nssa=delete_nssa, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
