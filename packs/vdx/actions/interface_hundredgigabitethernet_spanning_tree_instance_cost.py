...
def interface_hundredgigabitethernet_spanning_tree_instance_cost(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_instance_cost_act(Action):
    def run(self, name, delete_id, id, delete_cost, delete_instance, cost, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_instance_cost(delete_cost=delete_cost, delete_instance=delete_instance, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, host=host, cost=cost, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
