...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_address_holder_af_ipv4_neighbor_address_neighbor_route_map_neighbor_route_map_direction_in_neighbor_route_map_name_direction_in(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_address_holder_af_ipv4_neighbor_address_neighbor_route_map_neighbor_route_map_direction_in_neighbor_route_map_name_direction_in_act(Action):
