...
def protocol_spanning_tree_mstp_description(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_description_act(Action):
    def run(self, delete_description, description, delete_mstp, delete_spanning_tree, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_description(description=description, delete_spanning_tree=delete_spanning_tree, delete_description=delete_description, delete_protocol=delete_protocol, delete_mstp=delete_mstp, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
