...
def interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_enable_act(Action):
    def run(self, name, delete_vrid, vrid, delete_port_channel, delete_enable, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_enable(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_enable=delete_enable, delete_port_channel=delete_port_channel, host=host, vrid=vrid, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
