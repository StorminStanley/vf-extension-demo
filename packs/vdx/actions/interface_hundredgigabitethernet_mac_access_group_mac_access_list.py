...
def interface_hundredgigabitethernet_mac_access_group_mac_access_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_mac_access_group_mac_access_list_act(Action):
    def run(self, name, mac_access_list, delete_mac_access_list, delete_access_group, delete_name, delete_hundredgigabitethernet, delete_interface, delete_mac_direction, mac_direction, delete_mac, host, username, password):
