...
def interface_tengigabitethernet_ipv6_vrrpv3_group_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3_group_priority_act(Action):
    def run(self, name, delete_vrid, vrid, priority, delete_priority, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_vrrpv3_group_priority(delete_vrid=delete_vrid, name=name, delete_name=delete_name, username=username, priority=priority, delete_tengigabitethernet=delete_tengigabitethernet, vrid=vrid, host=host, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
