...
def rbridge_id_threshold_monitor_sfp_apply(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_sfp_apply_act(Action):
    def run(self, rbridge_id, apply, delete_threshold_monitor, delete_sfp, delete_apply, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_sfp_apply(apply=apply, delete_threshold_monitor=delete_threshold_monitor, username=username, rbridge_id=rbridge_id, delete_apply=delete_apply, delete_sfp=delete_sfp, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
