...
def interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_use_v2_checksum(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_use_v2_checksum_act(Action):
    def run(self, name, delete_vrid, vrid, delete_port_channel, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_use_v2_checksum(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_port_channel=delete_port_channel, host=host, vrid=vrid, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
