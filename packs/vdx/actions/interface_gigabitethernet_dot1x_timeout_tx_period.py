...
def interface_gigabitethernet_dot1x_agtimeout_tx_period(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_agtimeout_tx_period_act(Action):
    def run(self, delete_tx_period, name, delete_agtimeout, delete_interface, delete_name, tx_period, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_dot1x_agtimeout_tx_period(name=name, delete_name=delete_name, username=username, delete_agtimeout=delete_agtimeout, delete_tx_period=delete_tx_period, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, tx_period=tx_period, password=password, callback=_callback, mgr=mgr)
        return 0
