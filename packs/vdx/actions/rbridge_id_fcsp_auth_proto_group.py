...
def rbridge_id_fcsp_auth_proto_group(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_fcsp_auth_proto_group_act(Action):
    def run(self, group, rbridge_id, delete_fcsp, delete_group, delete_auth, delete_rbridge_id, delete_proto, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_fcsp_auth_proto_group(delete_fcsp=delete_fcsp, group=group, username=username, rbridge_id=rbridge_id, delete_auth=delete_auth, delete_group=delete_group, delete_proto=delete_proto, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
