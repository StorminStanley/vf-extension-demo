...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_priority_act(Action):
