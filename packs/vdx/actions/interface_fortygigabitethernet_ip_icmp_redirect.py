...
def interface_fortygigabitethernet_ip_icmp_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_icmp_redirect_act(Action):
    def run(self, name, delete_ip, delete_fortygigabitethernet, delete_icmp, delete_redirect, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_icmp_redirect(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_icmp=delete_icmp, delete_name=delete_name, delete_ip=delete_ip, host=host, delete_redirect=delete_redirect, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
