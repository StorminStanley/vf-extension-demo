...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_interface_type(**kwargs):
    """Auto Generated Code
    """
    ...
    update_source = ET.SubElement(af_ipv4_neighbor_addr, "update-source")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_interface_type_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_ethernet_interface, delete_af_vrf_name, af_vrf_name, delete_update_source, delete_ca_eth, interface_type, delete_interface_type, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_interface_type(delete_ethernet_interface=delete_ethernet_interface, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, password=password, delete_interface_type=delete_interface_type, delete_router=delete_router, delete_ch_update_source=delete_ch_update_source, host=host, interface_type=interface_type, delete_address_family=delete_address_family, delete_neighbor=delete_neighbor, delete_ca_eth=delete_ca_eth, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
