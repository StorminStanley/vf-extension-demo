...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_dead_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_dead_interval_act(Action):
    def run(self, delete_dead_interval, delete_ip, delete_interface_PO_ospf_conf, delete_port_channel, dead_interval, delete_interface, delete_name, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_dead_interval(delete_port_channel=delete_port_channel, delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, dead_interval=dead_interval, host=host, delete_dead_interval=delete_dead_interval, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
