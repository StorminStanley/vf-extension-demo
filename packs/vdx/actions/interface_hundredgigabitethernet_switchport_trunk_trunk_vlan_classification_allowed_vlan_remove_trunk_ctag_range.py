...
def interface_hundredgigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_ctag_range(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_ctag_range_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk_vlan_classification, delete_trunk, trunk_vlan_id, delete_trunk_ctag_range, delete_interface, delete_name, delete_remove, delete_hundredgigabitethernet, trunk_ctag_range, delete_trunk_vlan_id, host, username, password):
