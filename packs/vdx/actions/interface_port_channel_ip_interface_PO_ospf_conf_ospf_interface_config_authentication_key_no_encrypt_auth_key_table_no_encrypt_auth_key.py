...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_authentication_key_no_encrypt_auth_key_table_no_encrypt_auth_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_authentication_key_no_encrypt_auth_key_table_no_encrypt_auth_key_act(Action):
    def run(self, delete_ip, delete_interface_PO_ospf_conf, no_encrypt_auth_key, delete_no_encrypt_auth_key_table, delete_no_encrypt_auth_key, delete_port_channel, delete_authentication_key, delete_interface, delete_name, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_authentication_key_no_encrypt_auth_key_table_no_encrypt_auth_key(delete_port_channel=delete_port_channel, delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, username=username, delete_authentication_key=delete_authentication_key, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_no_encrypt_auth_key=delete_no_encrypt_auth_key, host=host, password=password, delete_interface=delete_interface, no_encrypt_auth_key=no_encrypt_auth_key, delete_no_encrypt_auth_key_table=delete_no_encrypt_auth_key_table, callback=_callback, mgr=mgr)
        return 0
