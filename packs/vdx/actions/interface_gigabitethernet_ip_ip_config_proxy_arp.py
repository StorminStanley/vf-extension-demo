...
def interface_gigabitethernet_ip_ip_config_proxy_arp(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_ip_config_proxy_arp_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_proxy_arp, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
