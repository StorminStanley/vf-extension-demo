...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_active(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_active_act(Action):
    def run(self, delete_active, delete_fortygigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_active(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, host=host, delete_active=delete_active, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
