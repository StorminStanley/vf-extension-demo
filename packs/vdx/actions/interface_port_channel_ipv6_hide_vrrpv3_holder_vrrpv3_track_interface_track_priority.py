...
def interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_track_interface_track_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_track_interface_track_priority_act(Action):
    def run(self, delete_track_priority, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_interface_type, delete_port_channel, delete_interface, delete_name, interface_name, delete_track, track_priority, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_track_interface_track_priority(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_track=delete_track, username=username, interface_name=interface_name, delete_track_priority=delete_track_priority, delete_port_channel=delete_port_channel, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, vrid=vrid, interface_type=interface_type, host=host, delete_interface=delete_interface, track_priority=track_priority, password=password, callback=_callback, mgr=mgr)
        return 0
