...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_hoplimit(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_hoplimit_act(Action):
    def run(self, name, hoplimit, delete_hoplimit, delete_port_channel, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_hoplimit(name=name, delete_name=delete_name, delete_hoplimit=delete_hoplimit, delete_port_channel=delete_port_channel, delete_nd=delete_nd, host=host, hoplimit=hoplimit, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
