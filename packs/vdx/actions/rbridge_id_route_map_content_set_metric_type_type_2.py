...
def rbridge_id_route_map_content_set_metric_type_type_2(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_metric_type_type_2_act(Action):
    def run(self, rbridge_id, delete_set, delete_route_map, delete_content, delete_metric_type, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_metric_type_type_2(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_metric_type=delete_metric_type, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
