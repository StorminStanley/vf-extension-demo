...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_multipath_multipath_ibgp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_multipath_multipath_ibgp_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_multipath, delete_multipath_ibgp, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_multipath_multipath_ibgp(delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_multipath_ibgp=delete_multipath_ibgp, host=host, delete_address_family=delete_address_family, delete_multipath=delete_multipath, password=password, callback=_callback, mgr=mgr)
        return 0
