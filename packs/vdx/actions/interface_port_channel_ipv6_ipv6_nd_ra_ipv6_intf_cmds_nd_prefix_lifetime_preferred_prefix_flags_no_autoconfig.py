...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_autoconfig(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_autoconfig_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_no_autoconfig, delete_port_channel, delete_interface, delete_name, delete_prefix_flags, delete_lifetime, delete_nd, name, host, username, password):
