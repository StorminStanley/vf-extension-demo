...
def interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_description_act(Action):
    def run(self, delete_description, description, gve_name, delete_interface_vlan, delete_ve, delete_interface, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_description(gve_name=gve_name, delete_gve_name=delete_gve_name, description=description, delete_description=delete_description, delete_interface_vlan=delete_interface_vlan, host=host, delete_ve=delete_ve, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
