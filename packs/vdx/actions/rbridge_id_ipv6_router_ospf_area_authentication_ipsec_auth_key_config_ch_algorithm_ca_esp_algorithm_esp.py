...
def rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, esp, delete_ca_esp_algorithm, delete_ipsec_auth_key_config, delete_esp, delete_area, vrf, delete_rbridge_id, delete_ch_algorithm, delete_router, delete_authentication, host, username, password):
