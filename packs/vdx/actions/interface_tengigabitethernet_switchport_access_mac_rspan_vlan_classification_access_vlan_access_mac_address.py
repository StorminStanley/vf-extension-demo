...
def interface_tengigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_mac_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_mac_address_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_access_vlan_id, name, access_mac_address, delete_access_mac_rspan_vlan_classification, delete_access, delete_access_mac_address, access_vlan_id, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_mac_address(delete_access=delete_access, name=name, delete_name=delete_name, delete_switchport=delete_switchport, username=username, access_vlan_id=access_vlan_id, delete_access_vlan_id=delete_access_vlan_id, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, delete_access_mac_rspan_vlan_classification=delete_access_mac_rspan_vlan_classification, host=host, access_mac_address=access_mac_address, delete_access_mac_address=delete_access_mac_address, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
