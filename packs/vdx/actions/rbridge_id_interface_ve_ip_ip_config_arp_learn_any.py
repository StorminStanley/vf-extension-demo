...
def rbridge_id_interface_ve_ip_ip_config_arp_learn_any(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_config_arp_learn_any_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_learn_any, delete_ve, delete_arp, delete_interface, delete_name, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_config_arp_learn_any(name=name, delete_name=delete_name, username=username, delete_ip_config=delete_ip_config, delete_arp=delete_arp, delete_ip=delete_ip, delete_learn_any=delete_learn_any, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
