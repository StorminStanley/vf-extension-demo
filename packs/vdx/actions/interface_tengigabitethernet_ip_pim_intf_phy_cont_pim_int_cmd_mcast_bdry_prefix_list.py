...
def interface_tengigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_mcast_bdry_prefix_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_mcast_bdry_prefix_list_act(Action):
    def run(self, delete_pim_intf_phy_cont, delete_ip, delete_mcast_bdry_prefix_list, mcast_bdry_prefix_list, delete_interface, delete_name, delete_tengigabitethernet, delete_pim_int_cmd, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_mcast_bdry_prefix_list(mcast_bdry_prefix_list=mcast_bdry_prefix_list, name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_pim_int_cmd=delete_pim_int_cmd, delete_pim_intf_phy_cont=delete_pim_intf_phy_cont, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, delete_mcast_bdry_prefix_list=delete_mcast_bdry_prefix_list, password=password, callback=_callback, mgr=mgr)
        return 0
