...
def rbridge_id_ssh_server_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_shutdown_act(Action):
    def run(self, delete_ssh, delete_server, delete_rbridge_id, rbridge_id, delete_shutdown, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_shutdown(delete_shutdown=delete_shutdown, username=username, rbridge_id=rbridge_id, delete_ssh=delete_ssh, host=host, delete_server=delete_server, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
