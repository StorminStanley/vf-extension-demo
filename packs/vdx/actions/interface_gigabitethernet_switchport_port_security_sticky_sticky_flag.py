...
def interface_gigabitethernet_switchport_port_security_sticky_sticky_flag(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_port_security_sticky_sticky_flag_act(Action):
    def run(self, delete_switchport, delete_sticky_flag, name, delete_gigabitethernet, delete_interface, delete_name, delete_sticky, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_port_security_sticky_sticky_flag(delete_sticky=delete_sticky, name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_sticky_flag=delete_sticky_flag, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_port_security=delete_port_security, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
