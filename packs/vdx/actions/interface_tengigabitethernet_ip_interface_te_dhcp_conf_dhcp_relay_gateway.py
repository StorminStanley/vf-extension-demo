...
def interface_tengigabitethernet_ip_interface_te_dhcp_conf_dhcp_relay_gateway(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_dhcp_conf_dhcp_relay_gateway_act(Action):
    def run(self, delete_interface_te_dhcp_conf, name, delete_ip, delete_dhcp, delete_relay, delete_interface, delete_name, delete_gateway, delete_tengigabitethernet, gateway, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_dhcp_conf_dhcp_relay_gateway(delete_interface_te_dhcp_conf=delete_interface_te_dhcp_conf, name=name, delete_name=delete_name, delete_relay=delete_relay, delete_ip=delete_ip, delete_dhcp=delete_dhcp, gateway=gateway, delete_tengigabitethernet=delete_tengigabitethernet, delete_gateway=delete_gateway, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
