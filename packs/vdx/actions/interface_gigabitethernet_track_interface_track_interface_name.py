...
def interface_gigabitethernet_track_interface_track_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_track_interface_track_interface_name_act(Action):
