...
def interface_tengigabitethernet_ipv6_interface_phy_dhcp_conf_dhcp_relay_servers_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_phy_dhcp_conf_dhcp_relay_servers_interface_interface_name_act(Action):
    def run(self, delete_interface_name, name, delete_servers, relay_ip_addr, delete_dhcp, delete_relay, delete_interface, delete_name, delete_interface_phy_dhcp_conf, delete_tengigabitethernet, interface_name, delete_relay_ip_addr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_phy_dhcp_conf_dhcp_relay_servers_interface_interface_name(relay_ip_addr=relay_ip_addr, name=name, delete_name=delete_name, delete_relay=delete_relay, username=username, delete_interface_phy_dhcp_conf=delete_interface_phy_dhcp_conf, interface_name=interface_name, delete_dhcp=delete_dhcp, delete_interface_name=delete_interface_name, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, delete_servers=delete_servers, delete_relay_ip_addr=delete_relay_ip_addr, password=password, callback=_callback, mgr=mgr)
        return 0
