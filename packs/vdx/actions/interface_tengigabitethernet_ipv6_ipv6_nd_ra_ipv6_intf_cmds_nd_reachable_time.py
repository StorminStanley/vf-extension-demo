...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_reachable_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_reachable_time_act(Action):
    def run(self, name, delete_reachable_time, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, reachable_time, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_reachable_time(name=name, delete_name=delete_name, reachable_time=reachable_time, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_nd=delete_nd, delete_reachable_time=delete_reachable_time, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
