...
def interface_vlan_interface_ve_ip_ip_anycast_gateway_load_balancing_disable(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_load_balancing_disable', False) is True:
        delete_load_balancing_disable = config.find('.//*load-balancing-disable')
        delete_load_balancing_disable.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_vlan_interface_ve_ip_ip_anycast_gateway_load_balancing_disable_act(Action):
    def run(self, gve_name, delete_ip, delete_interface_vlan, delete_ip_anycast_gateway, ip_gw_id, delete_ve, delete_interface, delete_load_balancing_disable, delete_ip_gw_id, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ip_ip_anycast_gateway_load_balancing_disable(delete_ip_anycast_gateway=delete_ip_anycast_gateway, delete_ip_gw_id=delete_ip_gw_id, delete_gve_name=delete_gve_name, username=username, delete_ip=delete_ip, gve_name=gve_name, delete_interface_vlan=delete_interface_vlan, host=host, ip_gw_id=ip_gw_id, delete_interface=delete_interface, delete_load_balancing_disable=delete_load_balancing_disable, password=password, delete_ve=delete_ve, callback=_callback, mgr=mgr)
        return 0
