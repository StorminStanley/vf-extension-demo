...
def interface_tengigabitethernet_spanning_tree_hello_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_spanning_tree_hello_time_act(Action):
    def run(self, delete_hello_time, name, hello_time, delete_interface, delete_name, delete_tengigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_spanning_tree_hello_time(name=name, delete_name=delete_name, delete_spanning_tree=delete_spanning_tree, delete_hello_time=delete_hello_time, delete_tengigabitethernet=delete_tengigabitethernet, host=host, hello_time=hello_time, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
