...
def rbridge_id_snmp_server_user_encrypted(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_user_encrypted_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, delete_user, delete_encrypted, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_user_encrypted(delete_snmp_server=delete_snmp_server, delete_encrypted=delete_encrypted, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_username=delete_username, delete_user=delete_user, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
