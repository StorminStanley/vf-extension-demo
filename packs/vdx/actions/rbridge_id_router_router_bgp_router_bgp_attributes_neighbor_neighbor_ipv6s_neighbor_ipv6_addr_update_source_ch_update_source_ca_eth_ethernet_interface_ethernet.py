...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_ethernet_interface, delete_update_source, delete_router_bgp_attributes, delete_ethernet, ethernet, delete_rbridge_id, delete_ch_update_source, delete_ca_eth, delete_neighbor, delete_router, host, username, password):
