...
def rbridge_id_global_lc_holder_linecard_linecards_linecardType(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_linecardType', False) is True:
        delete_linecardType = config.find('.//*linecardType')
        delete_linecardType.set('operation', 'delete')
...
class rbridge_id_global_lc_holder_linecard_linecards_linecardType_act(Action):
    def run(self, rbridge_id, linecardName, delete_linecardName, delete_linecardType, linecardType, delete_global_lc_holder, delete_rbridge_id, delete_linecard, delete_linecards, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_global_lc_holder_linecard_linecards_linecardType(delete_linecardType=delete_linecardType, username=username, delete_linecardName=delete_linecardName, delete_linecard=delete_linecard, rbridge_id=rbridge_id, linecardType=linecardType, linecardName=linecardName, host=host, password=password, delete_global_lc_holder=delete_global_lc_holder, delete_rbridge_id=delete_rbridge_id, delete_linecards=delete_linecards, callback=_callback, mgr=mgr)
        return 0
