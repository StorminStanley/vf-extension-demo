...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_database_filter_all_out(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_database_filter_all_out_act(Action):
    def run(self, delete_ip, delete_interface_PO_ospf_conf, delete_database_filter, delete_port_channel, delete_interface, delete_name, delete_ospf_interface_config, delete_all_out, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_database_filter_all_out(delete_database_filter=delete_database_filter, delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, host=host, delete_all_out=delete_all_out, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
