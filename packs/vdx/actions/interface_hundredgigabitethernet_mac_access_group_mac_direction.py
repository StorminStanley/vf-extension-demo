...
def interface_hundredgigabitethernet_mac_access_group_mac_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_mac_access_group_mac_direction_act(Action):
