...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_maximum_prefix_threshold_holder_teardown(**kwargs):
    """Auto Generated Code
    """
    ...
    maximum_prefix = ET.SubElement(af_ipv4_neighbor_addr, "maximum-prefix")
    ...
    if kwargs.pop('delete_threshold_holder', False) is True:
        delete_threshold_holder = config.find('.//*threshold-holder')
        delete_threshold_holder.set('operation', 'delete')
        
    teardown = ET.SubElement(threshold_holder, "teardown")
    if kwargs.pop('delete_teardown', False) is True:
        delete_teardown = config.find('.//*teardown')
        delete_teardown.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_maximum_prefix_threshold_holder_teardown_act(Action):
    def run(self, delete_address_family, delete_teardown, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_threshold_holder, delete_rbridge_id, delete_maximum_prefix, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_maximum_prefix_threshold_holder_teardown(delete_address_family=delete_address_family, username=username, af_vrf_name=af_vrf_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_maximum_prefix=delete_maximum_prefix, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, password=password, delete_threshold_holder=delete_threshold_holder, delete_af_vrf=delete_af_vrf, delete_teardown=delete_teardown, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
