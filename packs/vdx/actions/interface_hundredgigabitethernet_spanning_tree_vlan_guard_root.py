...
def interface_hundredgigabitethernet_spanning_tree_vlan_guard_root(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_vlan_guard_root_act(Action):
    def run(self, delete_vlan, name, id, delete_id, delete_interface, delete_name, delete_guard, delete_hundredgigabitethernet, delete_spanning_tree, delete_root, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_vlan_guard_root(name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_id=delete_id, delete_guard=delete_guard, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_spanning_tree=delete_spanning_tree, delete_root=delete_root, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
