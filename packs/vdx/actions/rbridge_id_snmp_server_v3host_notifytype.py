...
def rbridge_id_snmp_server_v3host_notifytype(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_v3host_notifytype_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, notifytype, hostip, delete_hostip, delete_rbridge_id, delete_notifytype, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_v3host_notifytype(notifytype=notifytype, delete_snmp_server=delete_snmp_server, delete_notifytype=delete_notifytype, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_hostip=delete_hostip, delete_username=delete_username, host=host, hostip=hostip, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
