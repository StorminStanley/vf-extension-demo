...
def rbridge_id_snmp_server_v3host_udp_port(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_v3host_udp_port_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, udp_port, delete_udp_port, hostip, delete_hostip, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_v3host_udp_port(udp_port=udp_port, delete_snmp_server=delete_snmp_server, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_hostip=delete_hostip, delete_udp_port=delete_udp_port, host=host, delete_username=delete_username, hostip=hostip, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
