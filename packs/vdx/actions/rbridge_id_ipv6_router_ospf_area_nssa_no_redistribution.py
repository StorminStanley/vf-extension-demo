...
def rbridge_id_ipv6_router_ospf_area_nssa_no_redistribution(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_no_redistribution', False) is True:
        delete_no_redistribution = config.find('.//*no-redistribution')
        delete_no_redistribution.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_ipv6_router_ospf_area_nssa_no_redistribution_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_nssa, delete_area, vrf, delete_no_redistribution, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_nssa_no_redistribution(username=username, delete_area=delete_area, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_router=delete_router, delete_ospf=delete_ospf, password=password, delete_no_redistribution=delete_no_redistribution, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, delete_nssa=delete_nssa, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
