...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_min_rx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_min_rx_act(Action):
    def run(self, delete_bfd, delete_router_bgp, rbridge_id, delete_router_bgp_attributes, delete_interval, delete_min_rx, delete_rbridge_id, delete_neighbor, delete_router, min_rx, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_min_rx(delete_interval=delete_interval, delete_min_rx=delete_min_rx, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_router=delete_router, rbridge_id=rbridge_id, delete_bfd=delete_bfd, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_rbridge_id=delete_rbridge_id, min_rx=min_rx, callback=_callback, mgr=mgr)
        return 0
