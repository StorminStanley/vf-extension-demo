...
def rbridge_id_evpn_instance_vni_evpn_vni_route_target_both_target_community(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_evpn_instance_vni_evpn_vni_route_target_both_target_community_act(Action):
    def run(self, delete_both, delete_evpn_instance, rbridge_id, delete_evpn_vni, vni_number, delete_route_target, target_community, delete_vni_number, instance_name, delete_vni, delete_target_community, delete_rbridge_id, delete_instance_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_evpn_instance_vni_evpn_vni_route_target_both_target_community(delete_evpn_vni=delete_evpn_vni, delete_target_community=delete_target_community, delete_route_target=delete_route_target, target_community=target_community, username=username, delete_both=delete_both, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vni=delete_vni, instance_name=instance_name, delete_instance_name=delete_instance_name, host=host, delete_evpn_instance=delete_evpn_instance, delete_vni_number=delete_vni_number, vni_number=vni_number, password=password, callback=_callback, mgr=mgr)
        return 0
