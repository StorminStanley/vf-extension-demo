...
def rbridge_id_ip_rtm_config_route_static_route_oif_vrf_static_route_oif_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_vrf_static_route_oif_type_act(Action):
