...
def rbridge_id_vrf_address_family_ip_unicast_arp_entry_interfacetype_TenGigabitEthernet_TenGigabitEthernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_arp_entry_interfacetype_TenGigabitEthernet_TenGigabitEthernet_act(Action):
    def run(self, delete_address_family, rbridge_id, delete_ip, delete_vrf, delete_interfacetype, TenGigabitEthernet, delete_arp_ip_address, arp_ip_address, vrf_name, delete_TenGigabitEthernet, delete_rbridge_id, delete_unicast, delete_arp_entry, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_arp_entry_interfacetype_TenGigabitEthernet_TenGigabitEthernet(delete_address_family=delete_address_family, vrf_name=vrf_name, username=username, delete_vrf=delete_vrf, rbridge_id=rbridge_id, delete_ip=delete_ip, host=host, delete_interfacetype=delete_interfacetype, arp_ip_address=arp_ip_address, delete_arp_entry=delete_arp_entry, delete_vrf_name=delete_vrf_name, delete_arp_ip_address=delete_arp_ip_address, delete_TenGigabitEthernet=delete_TenGigabitEthernet, TenGigabitEthernet=TenGigabitEthernet, delete_rbridge_id=delete_rbridge_id, delete_unicast=delete_unicast, password=password, callback=_callback, mgr=mgr)
        return 0
