...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_maximum_paths_use_load_sharing(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_maximum_paths_use_load_sharing_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_maximum_paths, delete_use_load_sharing, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_maximum_paths_use_load_sharing(delete_use_load_sharing=delete_use_load_sharing, delete_router_bgp=delete_router_bgp, delete_maximum_paths=delete_maximum_paths, username=username, rbridge_id=rbridge_id, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
