...
def rbridge_id_ipv6_router_ospf_area_area_range_range_cost(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_area_range_range_cost_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_area_range, delete_range_cost, delete_range_address, delete_area, vrf, delete_rbridge_id, range_cost, delete_router, range_address, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_area_range_range_cost(delete_range_cost=delete_range_cost, username=username, range_cost=range_cost, delete_area=delete_area, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, range_address=range_address, vrf=vrf, delete_router=delete_router, delete_ospf=delete_ospf, host=host, delete_area_range=delete_area_range, delete_range_address=delete_range_address, area_id=area_id, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
