...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_max_attempts(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_max_attempts_act(Action):
    def run(self, delete_retry, name, delete_nud, delete_interface, delete_name, delete_nd, delete_max_attempts, delete_gigabitethernet, max_attempts, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_max_attempts(name=name, delete_max_attempts=delete_max_attempts, delete_name=delete_name, max_attempts=max_attempts, delete_nud=delete_nud, delete_nd=delete_nd, host=host, delete_retry=delete_retry, delete_interface=delete_interface, delete_gigabitethernet=delete_gigabitethernet, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
