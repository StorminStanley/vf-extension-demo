...
def interface_hundredgigabitethernet_vrf_forwarding(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrf_forwarding_act(Action):
    def run(self, delete_forwarding, name, delete_vrf, delete_interface, delete_name, delete_hundredgigabitethernet, forwarding, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_vrf_forwarding(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_vrf=delete_vrf, forwarding=forwarding, host=host, delete_forwarding=delete_forwarding, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
