...
def rbridge_id_ssh_server_key_ecdsa(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_key_ecdsa_act(Action):
    def run(self, rbridge_id, delete_server, delete_ecdsa, delete_key, delete_ssh, delete_rbridge_id, ecdsa, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_key_ecdsa(delete_server=delete_server, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_ssh=delete_ssh, host=host, ecdsa=ecdsa, delete_key=delete_key, delete_ecdsa=delete_ecdsa, password=password, callback=_callback, mgr=mgr)
        return 0
