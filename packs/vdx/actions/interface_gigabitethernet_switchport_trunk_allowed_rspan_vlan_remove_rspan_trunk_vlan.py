...
def interface_gigabitethernet_switchport_trunk_allowed_rspan_vlan_remove_rspan_trunk_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_allowed_rspan_vlan_remove_rspan_trunk_vlan_act(Action):
    def run(self, delete_switchport, delete_allowed, delete_rspan_vlan, name, delete_remove_rspan_trunk_vlan, delete_trunk, delete_interface, delete_name, remove_rspan_trunk_vlan, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_trunk_allowed_rspan_vlan_remove_rspan_trunk_vlan(name=name, delete_trunk=delete_trunk, username=username, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_rspan_vlan=delete_rspan_vlan, remove_rspan_trunk_vlan=remove_rspan_trunk_vlan, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, delete_remove_rspan_trunk_vlan=delete_remove_rspan_trunk_vlan, password=password, callback=_callback, mgr=mgr)
        return 0
