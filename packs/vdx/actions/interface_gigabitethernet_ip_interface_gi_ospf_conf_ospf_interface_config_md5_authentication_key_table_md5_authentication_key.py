...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, delete_key_table, delete_interface, delete_name, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
