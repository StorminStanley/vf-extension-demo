...
def interface_tengigabitethernet_spanning_tree_vlan_guard_root(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_spanning_tree_vlan_guard_root_act(Action):
    def run(self, delete_vlan, name, id, delete_id, delete_interface, delete_name, delete_guard, delete_tengigabitethernet, delete_spanning_tree, delete_root, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_spanning_tree_vlan_guard_root(name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_id=delete_id, delete_guard=delete_guard, delete_root=delete_root, delete_tengigabitethernet=delete_tengigabitethernet, delete_spanning_tree=delete_spanning_tree, host=host, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
