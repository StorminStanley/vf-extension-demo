...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_static_route_dest_act(Action):
    def run(self, bfd_static_route_src, delete_address_family, delete_bfd_static_route_src, delete_bfd_static_route, rbridge_id, delete_ip, delete_route, delete_vrf, delete_bfd_static_route_dest, delete_static, bfd_static_route_dest, vrf_name, delete_rbridge_id, delete_unicast, delete_bfd, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_static_route_dest(delete_bfd_static_route_src=delete_bfd_static_route_src, delete_address_family=delete_address_family, delete_route=delete_route, vrf_name=vrf_name, username=username, delete_ip=delete_ip, rbridge_id=rbridge_id, bfd_static_route_src=bfd_static_route_src, delete_bfd_static_route_dest=delete_bfd_static_route_dest, host=host, password=password, delete_vrf_name=delete_vrf_name, delete_bfd_static_route=delete_bfd_static_route, delete_static=delete_static, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, delete_vrf=delete_vrf, delete_bfd=delete_bfd, bfd_static_route_dest=bfd_static_route_dest, callback=_callback, mgr=mgr)
        return 0
