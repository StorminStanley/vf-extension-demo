...
def rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_link_interval_properties_transmit_delay(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_link_interval_properties_transmit_delay_act(Action):
    def run(self, transmit_delay, delete_transmit_delay, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_virtual_link_neighbor, virtual_link_neighbor, delete_area, vrf, delete_link_properties, delete_link_interval_properties, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_link_interval_properties_transmit_delay(username=username, delete_area=delete_area, delete_virtual_link=delete_virtual_link, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, delete_link_interval_properties=delete_link_interval_properties, vrf=vrf, delete_router=delete_router, delete_transmit_delay=delete_transmit_delay, host=host, delete_virtual_link_neighbor=delete_virtual_link_neighbor, transmit_delay=transmit_delay, delete_ospf=delete_ospf, delete_link_properties=delete_link_properties, delete_rbridge_id=delete_rbridge_id, area_id=area_id, virtual_link_neighbor=virtual_link_neighbor, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
