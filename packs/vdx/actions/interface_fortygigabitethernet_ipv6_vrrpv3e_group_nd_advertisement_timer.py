...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_vrid, vrid, delete_nd_advertisement_timer, delete_interface, delete_name, nd_advertisement_timer, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, nd_advertisement_timer=nd_advertisement_timer, username=username, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_nd_advertisement_timer=delete_nd_advertisement_timer, password=password, callback=_callback, mgr=mgr)
        return 0
