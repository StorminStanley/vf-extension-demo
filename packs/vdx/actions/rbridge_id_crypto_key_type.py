...
def rbridge_id_crypto_key_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_crypto_key_type_act(Action):
    def run(self, delete_label, rbridge_id, label, delete_crypto, delete_key, delete_type, delete_rbridge_id, type, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_crypto_key_type(delete_crypto=delete_crypto, delete_type=delete_type, username=username, rbridge_id=rbridge_id, label=label, delete_label=delete_label, host=host, type=type, delete_key=delete_key, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
