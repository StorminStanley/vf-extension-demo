...
def interface_fortygigabitethernet_ipv6_vrrpv3_group_track_interface_track_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3_group_track_interface_track_priority_act(Action):
