...
def interface_port_channel_spanning_tree_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_spanning_tree_vlan_id_act(Action):
    def run(self, delete_vlan, name, delete_id, id, delete_port_channel, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_spanning_tree_vlan_id(name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_port_channel=delete_port_channel, host=host, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
