...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_network_network_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_network_network_address_act(Action):
    def run(self, name, delete_ip, delete_network, network_address, delete_ip_local_anycast_gateway, delete_track, delete_network_address, delete_ve, delete_interface, delete_name, delete_rbridge_id, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_network_network_address(local_ip_gw_id=local_ip_gw_id, name=name, delete_name=delete_name, delete_track=delete_track, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_network_address=delete_network_address, delete_ip_local_anycast_gateway=delete_ip_local_anycast_gateway, network_address=network_address, delete_ve=delete_ve, delete_network=delete_network, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, delete_local_ip_gw_id=delete_local_ip_gw_id, password=password, callback=_callback, mgr=mgr)
        return 0
