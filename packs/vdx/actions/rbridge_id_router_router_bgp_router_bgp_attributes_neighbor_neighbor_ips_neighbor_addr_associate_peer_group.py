...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_associate_peer_group(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_associate_peer_group_act(Action):
    def run(self, router_bgp_neighbor_address, delete_router_bgp, rbridge_id, delete_neighbor_addr, delete_router_bgp_neighbor_address, delete_associate_peer_group, delete_router_bgp_attributes, delete_neighbor_ips, delete_rbridge_id, delete_neighbor, delete_router, associate_peer_group, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_associate_peer_group(router_bgp_neighbor_address=router_bgp_neighbor_address, delete_router_bgp=delete_router_bgp, associate_peer_group=associate_peer_group, username=username, delete_associate_peer_group=delete_associate_peer_group, delete_neighbor_ips=delete_neighbor_ips, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp_neighbor_address=delete_router_bgp_neighbor_address, delete_rbridge_id=delete_rbridge_id, delete_neighbor_addr=delete_neighbor_addr, password=password, callback=_callback, mgr=mgr)
        return 0
