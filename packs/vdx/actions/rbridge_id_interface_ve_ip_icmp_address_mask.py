...
def rbridge_id_interface_ve_ip_icmp_address_mask(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_icmp_address_mask_act(Action):
    def run(self, delete_address_mask, name, delete_ip, delete_icmp, delete_ve, delete_interface, delete_name, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_icmp_address_mask(name=name, delete_name=delete_name, delete_address_mask=delete_address_mask, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_icmp=delete_icmp, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
