...
def interface_hundredgigabitethernet_mac_access_group_traffic_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_mac_access_group_traffic_type_act(Action):
    def run(self, name, mac_access_list, traffic_type, delete_mac_access_list, delete_access_group, delete_name, delete_traffic_type, delete_hundredgigabitethernet, delete_interface, delete_mac_direction, mac_direction, delete_mac, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_mac_access_group_traffic_type(traffic_type=traffic_type, delete_traffic_type=delete_traffic_type, name=name, mac_access_list=mac_access_list, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_mac=delete_mac, delete_access_group=delete_access_group, delete_mac_access_list=delete_mac_access_list, mac_direction=mac_direction, host=host, delete_mac_direction=delete_mac_direction, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
