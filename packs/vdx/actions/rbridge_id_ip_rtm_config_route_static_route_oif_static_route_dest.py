...
def rbridge_id_ip_rtm_config_route_static_route_oif_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_static_route_dest_act(Action):
    def run(self, delete_static_route_oif, static_route_oif_type, rbridge_id, delete_ip, delete_route, delete_static_route_dest, delete_static_route_oif_name, static_route_dest, static_route_oif_name, delete_rtm_config, delete_rbridge_id, delete_static_route_oif_type, host, username, password):
