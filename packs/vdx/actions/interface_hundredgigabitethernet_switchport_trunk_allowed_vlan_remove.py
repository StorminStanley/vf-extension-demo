...
def interface_hundredgigabitethernet_switchport_trunk_allowed_vlan_remove(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_trunk_allowed_vlan_remove_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, remove, delete_interface, delete_name, delete_remove, delete_hundredgigabitethernet, host, username, password):
