...
def rbridge_id_router_ospf_permit_redistribute_set_metric_val(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_set_metric_val', False) is True:
        delete_set_metric_val = config.find('.//*set-metric-val')
        delete_set_metric_val.set('operation', 'delete')
...
class rbridge_id_router_ospf_permit_redistribute_set_metric_val_act(Action):
    def run(self, delete_permit, redist_value, delete_set_metric_val, rbridge_id, delete_route_option, delete_ospf, delete_vrf, set_metric_val, delete_redistribute, delete_redist_value, vrf, delete_rbridge_id, delete_router, route_option, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_permit_redistribute_set_metric_val(delete_route_option=delete_route_option, delete_router=delete_router, delete_set_metric_val=delete_set_metric_val, route_option=route_option, username=username, delete_permit=delete_permit, delete_redistribute=delete_redistribute, rbridge_id=rbridge_id, delete_vrf=delete_vrf, vrf=vrf, set_metric_val=set_metric_val, delete_ospf=delete_ospf, redist_value=redist_value, delete_redist_value=delete_redist_value, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
