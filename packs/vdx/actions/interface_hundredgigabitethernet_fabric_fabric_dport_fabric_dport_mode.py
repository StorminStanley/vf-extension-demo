...
def interface_hundredgigabitethernet_fabric_fabric_dport_fabric_dport_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_fabric_fabric_dport_fabric_dport_mode_act(Action):
    def run(self, name, fabric_dport_mode, delete_fabric, delete_fabric_dport_mode, delete_interface, delete_name, delete_fabric_dport, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_fabric_fabric_dport_fabric_dport_mode(name=name, delete_fabric=delete_fabric, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, host=host, password=password, delete_fabric_dport=delete_fabric_dport, delete_name=delete_name, delete_interface=delete_interface, fabric_dport_mode=fabric_dport_mode, delete_fabric_dport_mode=delete_fabric_dport_mode, callback=_callback, mgr=mgr)
        return 0
