...
def interface_gigabitethernet_dot1x_agtimeout_server_agtimeout(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_agtimeout_server_agtimeout_act(Action):
    def run(self, server_agtimeout, name, delete_agtimeout, delete_server_agtimeout, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_dot1x_agtimeout_server_agtimeout(name=name, delete_name=delete_name, delete_agtimeout=delete_agtimeout, delete_server_agtimeout=delete_server_agtimeout, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, server_agtimeout=server_agtimeout, password=password, callback=_callback, mgr=mgr)
        return 0
