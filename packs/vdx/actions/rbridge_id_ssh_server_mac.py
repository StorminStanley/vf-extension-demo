...
def rbridge_id_ssh_server_mac(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_mac_act(Action):
    def run(self, rbridge_id, delete_server, mac, delete_ssh, delete_rbridge_id, delete_mac, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_mac(delete_server=delete_server, username=username, rbridge_id=rbridge_id, delete_ssh=delete_ssh, host=host, mac=mac, delete_rbridge_id=delete_rbridge_id, delete_mac=delete_mac, password=password, callback=_callback, mgr=mgr)
        return 0
