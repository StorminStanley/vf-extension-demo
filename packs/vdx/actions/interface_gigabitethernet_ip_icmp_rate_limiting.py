...
def interface_gigabitethernet_ip_icmp_rate_limiting(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_icmp_rate_limiting_act(Action):
    def run(self, delete_rate_limiting, name, delete_ip, delete_icmp, delete_interface, delete_name, rate_limiting, delete_gigabitethernet, host, username, password):
