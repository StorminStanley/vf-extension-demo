...
def interface_gigabitethernet_dot1x_reauthMax(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_reauthMax_act(Action):
    def run(self, delete_reauthMax, reauthMax, delete_interface, delete_name, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_dot1x_reauthMax(name=name, delete_name=delete_name, reauthMax=reauthMax, host=host, delete_reauthMax=delete_reauthMax, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
