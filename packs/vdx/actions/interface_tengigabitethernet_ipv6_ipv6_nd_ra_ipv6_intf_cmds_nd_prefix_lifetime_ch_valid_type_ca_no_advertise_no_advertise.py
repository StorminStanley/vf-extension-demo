...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_no_advertise_no_advertise(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_no_advertise_no_advertise_act(Action):
    def run(self, delete_prefix, delete_ch_valid_type, delete_ca_no_advertise, delete_no_advertise, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, delete_lifetime, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_no_advertise_no_advertise(name=name, delete_prefix=delete_prefix, username=username, delete_lifetime=delete_lifetime, delete_nd=delete_nd, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_no_advertise=delete_no_advertise, delete_name=delete_name, delete_ch_valid_type=delete_ch_valid_type, delete_ca_no_advertise=delete_ca_no_advertise, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
