...
def rbridge_id_interface_ve_ipv6_ipv6_config_address_link_local_config_link_local_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ipv6_ipv6_config_address_link_local_config_link_local_address_act(Action):
    def run(self, delete_link_local_config, name, link_local_address, delete_ve, delete_link_local_address, delete_interface, delete_name, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ipv6_ipv6_config_address_link_local_config_link_local_address(name=name, delete_name=delete_name, username=username, rbridge_id=rbridge_id, link_local_address=link_local_address, delete_ve=delete_ve, host=host, delete_link_local_config=delete_link_local_config, delete_link_local_address=delete_link_local_address, delete_address=delete_address, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
