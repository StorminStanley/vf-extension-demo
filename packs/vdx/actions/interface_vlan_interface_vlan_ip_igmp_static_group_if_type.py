...
def interface_vlan_interface_vlan_ip_igmp_static_group_if_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_static_group_if_type_act(Action):
