...
def interface_tengigabitethernet_ip_ip_config_unnumbered_ip_donor_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_ip_config_unnumbered_ip_donor_interface_name_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_unnumbered, delete_interface, delete_name, ip_donor_interface_name, delete_tengigabitethernet, delete_ip_donor_interface_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_ip_config_unnumbered_ip_donor_interface_name(delete_ip_donor_interface_name=delete_ip_donor_interface_name, name=name, delete_unnumbered=delete_unnumbered, delete_ip_config=delete_ip_config, delete_ip=delete_ip, delete_tengigabitethernet=delete_tengigabitethernet, host=host, ip_donor_interface_name=ip_donor_interface_name, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
