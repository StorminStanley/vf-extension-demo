...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_vrf_next_hop_vrf(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_vrf_next_hop_vrf_act(Action):
