...
def interface_tengigabitethernet_ip_ip_config_directed_broadcast(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_ip_config_directed_broadcast_act(Action):
    def run(self, delete_ip_config, delete_directed_broadcast, name, delete_ip, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_ip_config_directed_broadcast(name=name, delete_name=delete_name, delete_ip=delete_ip, delete_ip_config=delete_ip_config, delete_directed_broadcast=delete_directed_broadcast, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
