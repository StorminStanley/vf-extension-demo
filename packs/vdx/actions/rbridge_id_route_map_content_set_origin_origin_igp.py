...
def rbridge_id_route_map_content_set_origin_origin_igp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_origin_origin_igp_act(Action):
    def run(self, rbridge_id, delete_set, delete_origin_igp, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_origin, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_origin_origin_igp(delete_instance=delete_instance, name=name, action_rm=action_rm, username=username, delete_action_rm=delete_action_rm, delete_origin=delete_origin, rbridge_id=rbridge_id, delete_origin_igp=delete_origin_igp, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
