...
def interface_gigabitethernet_mac_access_group_traffic_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_mac_access_group_traffic_type_act(Action):
    def run(self, name, mac_access_list, delete_mac_access_list, delete_access_group, delete_name, traffic_type, delete_traffic_type, delete_interface, delete_mac_direction, mac_direction, delete_gigabitethernet, delete_mac, host, username, password):
