...
def interface_hundredgigabitethernet_udld_udld_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_udld_udld_enable_act(Action):
    def run(self, name, delete_udld_enable, delete_interface, delete_name, delete_hundredgigabitethernet, delete_udld, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_udld_udld_enable(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_udld=delete_udld, delete_interface=delete_interface, username=username, delete_udld_enable=delete_udld_enable, password=password, callback=_callback, mgr=mgr)
        return 0
