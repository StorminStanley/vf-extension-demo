...
def rbridge_id_route_map_content_set_local_preference_local_preference_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_local_preference_local_preference_value_act(Action):
    def run(self, delete_local_preference, rbridge_id, delete_set, delete_local_preference_value, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, local_preference_value, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_local_preference_local_preference_value(delete_local_preference=delete_local_preference, delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_local_preference_value=delete_local_preference_value, local_preference_value=local_preference_value, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
