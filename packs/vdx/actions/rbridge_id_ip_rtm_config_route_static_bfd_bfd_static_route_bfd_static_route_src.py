...
def rbridge_id_ip_rtm_config_route_static_bfd_bfd_static_route_bfd_static_route_src(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_bfd_bfd_static_route_bfd_static_route_src_act(Action):
    def run(self, bfd_static_route_src, delete_bfd_static_route_src, delete_bfd_static_route, rbridge_id, delete_ip, delete_route, delete_bfd_static_route_dest, delete_static, delete_rtm_config, delete_rbridge_id, delete_bfd, bfd_static_route_dest, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_rtm_config_route_static_bfd_bfd_static_route_bfd_static_route_src(delete_bfd_static_route_src=delete_bfd_static_route_src, delete_static=delete_static, delete_route=delete_route, username=username, delete_ip=delete_ip, rbridge_id=rbridge_id, bfd_static_route_src=bfd_static_route_src, delete_rtm_config=delete_rtm_config, delete_bfd_static_route_dest=delete_bfd_static_route_dest, host=host, password=password, delete_bfd_static_route=delete_bfd_static_route, delete_rbridge_id=delete_rbridge_id, delete_bfd=delete_bfd, bfd_static_route_dest=bfd_static_route_dest, callback=_callback, mgr=mgr)
        return 0
