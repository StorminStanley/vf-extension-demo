...
def interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_retransmit_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_retransmit_interval_act(Action):
    def run(self, retransmit_interval, name, delete_ip, delete_interface_fo_ospf_conf, delete_interface, delete_name, delete_hundredgigabitethernet, delete_retransmit_interval, delete_ospf_interface_config, host, username, password):
