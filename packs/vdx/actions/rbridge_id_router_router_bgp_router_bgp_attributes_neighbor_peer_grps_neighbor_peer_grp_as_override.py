...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_as_override(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_as_override_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, delete_as_override, router_bgp_neighbor_peer_grp, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, host, username, password):
