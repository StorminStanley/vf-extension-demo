...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_prefix_list_direction_out_prefix_list_direction_out_prefix_name(**kwargs):
    """Auto Generated Code
    """
    ...
    prefix_list = ET.SubElement(af_ipv4_neighbor_addr, "prefix-list")
    ...
    if kwargs.pop('delete_prefix_list_direction_out_prefix_name', False) is True:
        delete_prefix_list_direction_out_prefix_name = config.find('.//*prefix-list-direction-out-prefix-name')
        delete_prefix_list_direction_out_prefix_name.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_prefix_list_direction_out_prefix_list_direction_out_prefix_name_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_direction_out, delete_prefix_list_direction_out_prefix_name, prefix_list_direction_out_prefix_name, delete_prefix_list, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_prefix_list_direction_out_prefix_list_direction_out_prefix_name(delete_prefix_list=delete_prefix_list, delete_router_bgp=delete_router_bgp, delete_prefix_list_direction_out_prefix_name=delete_prefix_list_direction_out_prefix_name, username=username, af_vrf_name=af_vrf_name, delete_direction_out=delete_direction_out, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, prefix_list_direction_out_prefix_name=prefix_list_direction_out_prefix_name, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
