...
def interface_gigabitethernet_ipv6_vrrpv3e_group_backup_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_backup_advertisement_interval_act(Action):
    def run(self, name, delete_vrid, vrid, delete_backup_advertisement_interval, delete_interface, delete_name, delete_gigabitethernet, backup_advertisement_interval, host, username, password):
