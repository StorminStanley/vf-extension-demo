...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_virtual_ip_virtual_ipaddr(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_virtual_ip_virtual_ipaddr_act(Action):
