...
def interface_fortygigabitethernet_switchport_port_security_allowed_ouis_oui(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_port_security_allowed_ouis_oui_act(Action):
    def run(self, delete_switchport, oui, name, delete_oui, delete_fortygigabitethernet, delete_allowed_ouis, delete_interface, delete_name, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_port_security_allowed_ouis_oui(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, delete_oui=delete_oui, oui=oui, host=host, delete_allowed_ouis=delete_allowed_ouis, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_port_security=delete_port_security, password=password, callback=_callback, mgr=mgr)
        return 0
