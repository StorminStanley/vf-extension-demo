...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_database_filter_all_summary_external(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_database_filter_all_summary_external_act(Action):
    def run(self, delete_interface_te_ospf_conf, name, delete_ip, delete_database_filter, all_summary_external, delete_interface, delete_name, delete_tengigabitethernet, delete_all_summary_external, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_database_filter_all_summary_external(delete_database_filter=delete_database_filter, name=name, delete_name=delete_name, username=username, delete_all_summary_external=delete_all_summary_external, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_tengigabitethernet=delete_tengigabitethernet, all_summary_external=all_summary_external, host=host, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, password=password, callback=_callback, mgr=mgr)
        return 0
