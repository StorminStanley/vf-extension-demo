...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_mtu(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_mtu_act(Action):
    def run(self, name, delete_mtu, delete_fortygigabitethernet, mtu, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_mtu(mtu=mtu, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_mtu=delete_mtu, host=host, delete_nd=delete_nd, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
