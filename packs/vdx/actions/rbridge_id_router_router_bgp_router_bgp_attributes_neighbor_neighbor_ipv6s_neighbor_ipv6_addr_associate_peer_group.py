...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_associate_peer_group(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_associate_peer_group_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_associate_peer_group, delete_router_bgp_attributes, delete_rbridge_id, delete_neighbor, delete_router, associate_peer_group, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_associate_peer_group(delete_router_bgp=delete_router_bgp, associate_peer_group=associate_peer_group, delete_associate_peer_group=delete_associate_peer_group, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
