...
def interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos1_threshold(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_cos1_threshold', False) is True:
        delete_cos1_threshold = config.find('.//*cos1-threshold')
        delete_cos1_threshold.set('operation', 'delete')
...
class interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos1_threshold_act(Action):
