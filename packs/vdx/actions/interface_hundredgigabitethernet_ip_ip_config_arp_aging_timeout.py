...
def interface_hundredgigabitethernet_ip_ip_config_arp_aging_agtimeout(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_ip_config_arp_aging_agtimeout_act(Action):
    def run(self, delete_ip_config, arp_aging_agtimeout, name, delete_ip, delete_interface, delete_name, delete_hundredgigabitethernet, delete_arp_aging_agtimeout, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_ip_config_arp_aging_agtimeout(name=name, arp_aging_agtimeout=arp_aging_agtimeout, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_ip=delete_ip, delete_ip_config=delete_ip_config, host=host, delete_arp_aging_agtimeout=delete_arp_aging_agtimeout, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
