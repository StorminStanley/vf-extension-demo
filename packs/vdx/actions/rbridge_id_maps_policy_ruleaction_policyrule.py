...
def rbridge_id_maps_policy_ruleaction_policyrule(**kwargs):
    """Auto Generated Code
    """
    ...
    policyrule = ET.SubElement(ruleaction, "policyrule")
    ...
    policyrule.text = kwargs.pop('policyrule')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_maps_policy_ruleaction_policyrule_act(Action):
    def run(self, policyname, rbridge_id, delete_policyname, delete_ruleaction, delete_maps, policyrule, delete_policy, delete_policyrule, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_maps_policy_ruleaction_policyrule(policyrule=policyrule, username=username, delete_policyname=delete_policyname, policyname=policyname, delete_maps=delete_maps, delete_policy=delete_policy, host=host, delete_policyrule=delete_policyrule, delete_rbridge_id=delete_rbridge_id, delete_ruleaction=delete_ruleaction, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
