...
def interface_fortygigabitethernet_dot1x_reauthentication(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_dot1x_reauthentication_act(Action):
    def run(self, delete_fortygigabitethernet, delete_reauthentication, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_dot1x_reauthentication(name=name, delete_name=delete_name, delete_reauthentication=delete_reauthentication, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
