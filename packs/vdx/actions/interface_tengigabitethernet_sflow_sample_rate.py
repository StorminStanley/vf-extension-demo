...
def interface_tengigabitethernet_sflow_sample_rate(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_sflow_sample_rate_act(Action):
    def run(self, delete_sflow, name, delete_sample_rate, sample_rate, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_sflow_sample_rate(name=name, delete_name=delete_name, delete_sflow=delete_sflow, sample_rate=sample_rate, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, delete_sample_rate=delete_sample_rate, password=password, callback=_callback, mgr=mgr)
        return 0
