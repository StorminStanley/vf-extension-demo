...
def rbridge_id_system_monitor_sfp_alert_state(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_system_monitor_sfp_alert_state_act(Action):
    def run(self, rbridge_id, state, delete_alert, delete_state, delete_rbridge_id, delete_sfp, delete_system_monitor, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_system_monitor_sfp_alert_state(delete_system_monitor=delete_system_monitor, username=username, rbridge_id=rbridge_id, delete_state=delete_state, state=state, delete_sfp=delete_sfp, delete_alert=delete_alert, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
