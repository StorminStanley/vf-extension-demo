...
def rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_min_rx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_min_rx_act(Action):
    def run(self, rbridge_id, delete_route, delete_static, delete_min_rx, delete_bfd, delete_rbridge_id, min_rx, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_min_rx(delete_min_rx=delete_min_rx, delete_static=delete_static, delete_route=delete_route, username=username, rbridge_id=rbridge_id, delete_bfd=delete_bfd, host=host, password=password, delete_rbridge_id=delete_rbridge_id, min_rx=min_rx, callback=_callback, mgr=mgr)
        return 0
