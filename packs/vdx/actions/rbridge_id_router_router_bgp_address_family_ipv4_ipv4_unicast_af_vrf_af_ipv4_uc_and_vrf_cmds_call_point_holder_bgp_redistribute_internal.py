...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_bgp_redistribute_internal(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_bgp_redistribute_internal', False) is True:
        delete_bgp_redistribute_internal = config.find('.//*bgp-redistribute-internal')
        delete_bgp_redistribute_internal.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_bgp_redistribute_internal_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_bgp_redistribute_internal, delete_af_vrf_name, af_vrf_name, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_bgp_redistribute_internal(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_af_vrf_name=delete_af_vrf_name, rbridge_id=rbridge_id, delete_bgp_redistribute_internal=delete_bgp_redistribute_internal, delete_af_vrf=delete_af_vrf, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
