...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_mtu_ignore(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_mtu_ignore_act(Action):
    def run(self, delete_mtu_ignore, delete_tengigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_mtu_ignore(name=name, delete_name=delete_name, delete_mtu_ignore=delete_mtu_ignore, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
