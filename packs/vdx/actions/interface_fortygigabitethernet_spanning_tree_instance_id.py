...
def interface_fortygigabitethernet_spanning_tree_instance_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_spanning_tree_instance_id_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_id, id, delete_instance, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_spanning_tree_instance_id(delete_instance=delete_instance, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, host=host, delete_name=delete_name, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
