...
def interface_hundredgigabitethernet_switchport_port_security_sticky_port_secutiry_mac_address_mac_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_port_security_sticky_port_secutiry_mac_address_mac_address_act(Action):
