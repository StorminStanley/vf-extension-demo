...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_static_unicast_static_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_static_unicast_static_metric_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_unicast_static_metric, delete_static, delete_redistribute, delete_rbridge_id, unicast_static_metric, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_static_unicast_static_metric(delete_static=delete_static, username=username, delete_router=delete_router, rbridge_id=rbridge_id, delete_redistribute=delete_redistribute, unicast_static_metric=unicast_static_metric, host=host, delete_unicast_static_metric=delete_unicast_static_metric, delete_address_family=delete_address_family, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
