...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_encrypttype(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_encrypttype_act(Action):
    def run(self, encrypttype, delete_ip, delete_interface_PO_ospf_conf, delete_port_channel, delete_authentication_key, delete_interface, delete_name, delete_auth_key_table, delete_ospf_interface_config, delete_encrypttype, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_encrypttype(encrypttype=encrypttype, delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, delete_authentication_key=delete_authentication_key, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, delete_auth_key_table=delete_auth_key_table, host=host, delete_interface=delete_interface, username=username, delete_encrypttype=delete_encrypttype, password=password, callback=_callback, mgr=mgr)
        return 0
