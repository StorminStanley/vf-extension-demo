...
def interface_gigabitethernet_qos_cos_traffic_class(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_qos_cos_traffic_class_act(Action):
    def run(self, delete_qos, name, delete_cos_traffic_class, cos_traffic_class, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_qos_cos_traffic_class(delete_qos=delete_qos, delete_name=delete_name, delete_cos_traffic_class=delete_cos_traffic_class, cos_traffic_class=cos_traffic_class, name=name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
