...
def protocol_lldp_advertise_dcbx_iscsi_app_tlv(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_advertise_dcbx_iscsi_app_tlv_act(Action):
    def run(self, delete_advertise, delete_lldp, delete_dcbx_iscsi_app_tlv, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_advertise_dcbx_iscsi_app_tlv(delete_lldp=delete_lldp, password=password, delete_protocol=delete_protocol, host=host, delete_dcbx_iscsi_app_tlv=delete_dcbx_iscsi_app_tlv, username=username, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
