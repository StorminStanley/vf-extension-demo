...
def interface_gigabitethernet_vlan_classifier_activate_group_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vlan_classifier_activate_group_vlan_act(Action):
    def run(self, delete_vlan, delete_classifier, name, delete_group, vlan, delete_activate, delete_interface, delete_name, delete_groupid, groupid, delete_gigabitethernet, host, username, password):
