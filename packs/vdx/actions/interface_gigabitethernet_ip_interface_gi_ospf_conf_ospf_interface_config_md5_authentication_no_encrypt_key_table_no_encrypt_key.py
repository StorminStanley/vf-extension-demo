...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, delete_no_encrypt_key_table, delete_no_encrypt_key, delete_interface, delete_name, no_encrypt_key, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
