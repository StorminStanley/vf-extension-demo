...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_priority_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_vrid, vrid, priority, delete_priority, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_priority(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, priority=priority, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
