...
def rbridge_id_event_handler_activate_name_delay(**kwargs):
    """Auto Generated Code
    """
    ...
    delay = ET.SubElement(name, "delay")
...
class rbridge_id_event_handler_activate_name_delay_act(Action):
    def run(self, delay, rbridge_id, delete_event_handler, delete_activate, delete_delay, delete_name, delete_rbridge_id, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_event_handler_activate_name_delay(delete_activate=delete_activate, name=name, delete_name=delete_name, username=username, rbridge_id=rbridge_id, delete_event_handler=delete_event_handler, host=host, delay=delay, delete_delay=delete_delay, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
