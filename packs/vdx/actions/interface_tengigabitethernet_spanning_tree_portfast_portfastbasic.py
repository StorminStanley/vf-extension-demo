...
def interface_tengigabitethernet_spanning_tree_portfast_portfastbasic(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_spanning_tree_portfast_portfastbasic_act(Action):
    def run(self, delete_portfast, name, delete_portfastbasic, delete_interface, delete_name, delete_tengigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_spanning_tree_portfast_portfastbasic(name=name, delete_name=delete_name, delete_portfastbasic=delete_portfastbasic, delete_spanning_tree=delete_spanning_tree, delete_tengigabitethernet=delete_tengigabitethernet, delete_portfast=delete_portfast, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
