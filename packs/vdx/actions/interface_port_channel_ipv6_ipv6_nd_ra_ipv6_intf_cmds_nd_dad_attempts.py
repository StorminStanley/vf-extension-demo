...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_attempts(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_attempts_act(Action):
    def run(self, name, attempts, delete_port_channel, delete_dad, delete_name, delete_attempts, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_attempts(attempts=attempts, name=name, delete_name=delete_name, delete_dad=delete_dad, delete_port_channel=delete_port_channel, delete_nd=delete_nd, host=host, delete_attempts=delete_attempts, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
