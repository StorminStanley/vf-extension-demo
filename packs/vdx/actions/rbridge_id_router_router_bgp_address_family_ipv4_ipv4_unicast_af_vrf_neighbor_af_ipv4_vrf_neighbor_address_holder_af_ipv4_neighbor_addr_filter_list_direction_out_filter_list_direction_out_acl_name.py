...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_filter_list_direction_out_filter_list_direction_out_acl_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_filter_list_direction_out_filter_list_direction_out_acl_name_act(Action):
    def run(self, delete_address_family, delete_filter_list, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_direction_out, filter_list_direction_out_acl_name, delete_filter_list_direction_out_acl_name, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_filter_list_direction_out_filter_list_direction_out_acl_name(delete_router_bgp=delete_router_bgp, delete_filter_list=delete_filter_list, username=username, af_vrf_name=af_vrf_name, delete_direction_out=delete_direction_out, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_filter_list_direction_out_acl_name=delete_filter_list_direction_out_acl_name, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, filter_list_direction_out_acl_name=filter_list_direction_out_acl_name, password=password, callback=_callback, mgr=mgr)
        return 0
