...
def interface_gigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer_act(Action):
    def run(self, delete_nd_advertisement_timer, name, delete_vrid, vrid, delete_interface, delete_name, nd_advertisement_timer, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer(delete_vrid=delete_vrid, name=name, delete_name=delete_name, nd_advertisement_timer=nd_advertisement_timer, username=username, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, delete_nd_advertisement_timer=delete_nd_advertisement_timer, password=password, callback=_callback, mgr=mgr)
        return 0
