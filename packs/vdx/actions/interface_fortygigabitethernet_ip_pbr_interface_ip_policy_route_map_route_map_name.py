...
def interface_fortygigabitethernet_ip_pbr_interface_ip_policy_route_map_route_map_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_pbr_interface_ip_policy_route_map_route_map_name_act(Action):
    def run(self, delete_route_map_name, route_map_name, name, delete_ip, delete_fortygigabitethernet, delete_route_map, delete_policy, delete_interface, delete_name, delete_ip_pbr_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_pbr_interface_ip_policy_route_map_route_map_name(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, delete_route_map_name=delete_route_map_name, delete_ip=delete_ip, delete_route_map=delete_route_map, delete_policy=delete_policy, delete_ip_pbr_interface=delete_ip_pbr_interface, host=host, delete_name=delete_name, delete_interface=delete_interface, route_map_name=route_map_name, password=password, callback=_callback, mgr=mgr)
        return 0
