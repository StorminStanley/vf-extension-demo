...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_bfd_interval_multiplier_act(Action):
    def run(self, router_bgp_neighbor_address, delete_bfd, delete_router_bgp, rbridge_id, delete_multiplier, delete_neighbor_addr, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, delete_interval, delete_neighbor_ips, multiplier, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_bfd_interval_multiplier(router_bgp_neighbor_address=router_bgp_neighbor_address, delete_interval=delete_interval, delete_router_bgp=delete_router_bgp, username=username, delete_multiplier=delete_multiplier, delete_neighbor_ips=delete_neighbor_ips, rbridge_id=rbridge_id, delete_bfd=delete_bfd, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp_neighbor_address=delete_router_bgp_neighbor_address, delete_rbridge_id=delete_rbridge_id, delete_neighbor_addr=delete_neighbor_addr, multiplier=multiplier, callback=_callback, mgr=mgr)
        return 0
