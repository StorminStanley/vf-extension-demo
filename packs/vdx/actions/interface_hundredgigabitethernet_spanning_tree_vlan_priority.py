...
def interface_hundredgigabitethernet_spanning_tree_vlan_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_vlan_priority_act(Action):
    def run(self, delete_vlan, name, id, priority, delete_id, delete_priority, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_vlan_priority(name=name, delete_name=delete_name, username=username, delete_vlan=delete_vlan, priority=priority, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, id=id, delete_priority=delete_priority, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
