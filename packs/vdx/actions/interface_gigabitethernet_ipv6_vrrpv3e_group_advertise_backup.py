...
def interface_gigabitethernet_ipv6_vrrpv3e_group_advertise_backup(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_advertise_backup_act(Action):
    def run(self, name, delete_vrid, vrid, delete_interface, delete_name, delete_gigabitethernet, delete_advertise_backup, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_vrrpv3e_group_advertise_backup(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_advertise_backup=delete_advertise_backup, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
