...
def rbridge_id_vrf_route_target_action(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_route_target_action_act(Action):
    def run(self, rbridge_id, delete_vrf, target_community, delete_target_community, vrf_name, delete_action, action, delete_rbridge_id, delete_route_target, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_route_target_action(delete_target_community=delete_target_community, delete_route_target=delete_route_target, username=username, action=action, delete_vrf=delete_vrf, rbridge_id=rbridge_id, vrf_name=vrf_name, delete_action=delete_action, host=host, target_community=target_community, delete_rbridge_id=delete_rbridge_id, password=password, delete_vrf_name=delete_vrf_name, callback=_callback, mgr=mgr)
        return 0
