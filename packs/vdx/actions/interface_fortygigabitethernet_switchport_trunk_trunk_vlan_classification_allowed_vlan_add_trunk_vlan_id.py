...
def interface_fortygigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_add_trunk_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_add_trunk_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, trunk_vlan_id, name, delete_trunk_vlan_classification, delete_trunk, delete_fortygigabitethernet, delete_interface, delete_name, delete_add, delete_trunk_vlan_id, host, username, password):
