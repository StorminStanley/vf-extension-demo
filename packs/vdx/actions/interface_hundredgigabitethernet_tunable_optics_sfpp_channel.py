...
def interface_hundredgigabitethernet_tunable_optics_sfpp_channel(**kwargs):
    """Auto Generated Code
    """
    ...
    tunable_optics = ET.SubElement(hundredgigabitethernet, "tunable-optics")
...
class interface_hundredgigabitethernet_tunable_optics_sfpp_channel_act(Action):
    def run(self, name, delete_sfpp, delete_interface, delete_name, delete_tunable_optics, delete_hundredgigabitethernet, delete_channel, channel, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_tunable_optics_sfpp_channel(delete_tunable_optics=delete_tunable_optics, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_channel=delete_channel, channel=channel, host=host, delete_sfpp=delete_sfpp, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
