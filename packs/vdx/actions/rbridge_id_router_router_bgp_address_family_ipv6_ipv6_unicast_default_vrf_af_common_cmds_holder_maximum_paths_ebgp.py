...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ebgp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ebgp_act(Action):
