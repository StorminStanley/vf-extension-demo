...
def interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_interval_act(Action):
    def run(self, name, delete_ip, delete_query_interval, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_tengigabitethernet, query_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_interval(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_ip=delete_ip, query_interval=query_interval, delete_tengigabitethernet=delete_tengigabitethernet, delete_query_interval=delete_query_interval, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
