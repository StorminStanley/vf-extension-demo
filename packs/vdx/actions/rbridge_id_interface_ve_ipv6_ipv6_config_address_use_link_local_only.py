...
def rbridge_id_interface_ve_ipv6_ipv6_config_address_use_link_local_only(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ipv6_ipv6_config_address_use_link_local_only_act(Action):
    def run(self, name, delete_ve, delete_interface, delete_name, delete_use_link_local_only, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ipv6_ipv6_config_address_use_link_local_only(name=name, delete_name=delete_name, username=username, rbridge_id=rbridge_id, delete_use_link_local_only=delete_use_link_local_only, delete_ve=delete_ve, host=host, delete_address=delete_address, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
