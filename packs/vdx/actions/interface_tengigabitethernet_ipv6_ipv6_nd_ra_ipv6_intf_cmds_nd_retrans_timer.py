...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_retrans_timer(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_retrans_timer', False) is True:
        delete_retrans_timer = config.find('.//*retrans-timer')
        delete_retrans_timer.set('operation', 'delete')
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_retrans_timer_act(Action):
    def run(self, delete_retrans_timer, retrans_timer, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_retrans_timer(name=name, delete_name=delete_name, retrans_timer=retrans_timer, delete_retrans_timer=delete_retrans_timer, delete_tengigabitethernet=delete_tengigabitethernet, delete_nd=delete_nd, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
