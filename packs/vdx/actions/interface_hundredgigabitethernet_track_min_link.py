...
def interface_hundredgigabitethernet_track_min_link(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_track_min_link_act(Action):
    def run(self, delete_min_link, name, min_link, delete_interface, delete_name, delete_hundredgigabitethernet, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_track_min_link(delete_min_link=delete_min_link, name=name, delete_name=delete_name, delete_track=delete_track, delete_hundredgigabitethernet=delete_hundredgigabitethernet, min_link=min_link, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
