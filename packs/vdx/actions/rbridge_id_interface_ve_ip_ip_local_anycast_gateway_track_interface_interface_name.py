...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_interface_interface_name_act(Action):
    def run(self, interface_name, delete_interface_name, name, delete_ip, interface_type, delete_ip_local_anycast_gateway, delete_track, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_interface_type, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
