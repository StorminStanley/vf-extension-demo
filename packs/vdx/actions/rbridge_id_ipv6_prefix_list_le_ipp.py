...
def rbridge_id_ipv6_prefix_list_le_ipp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_prefix_list_le_ipp_act(Action):
    def run(self, le_ipp, rbridge_id, delete_seq_keyword, instance, delete_instance, delete_name, delete_prefix_list, seq_keyword, delete_le_ipp, delete_rbridge_id, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_prefix_list_le_ipp(delete_instance=delete_instance, delete_prefix_list=delete_prefix_list, delete_name=delete_name, le_ipp=le_ipp, delete_seq_keyword=delete_seq_keyword, username=username, rbridge_id=rbridge_id, seq_keyword=seq_keyword, name=name, host=host, password=password, delete_le_ipp=delete_le_ipp, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
