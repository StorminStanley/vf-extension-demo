...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_network(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_network_act(Action):
    def run(self, network, delete_network, delete_fortygigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_network(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, host=host, delete_network=delete_network, network=network, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
