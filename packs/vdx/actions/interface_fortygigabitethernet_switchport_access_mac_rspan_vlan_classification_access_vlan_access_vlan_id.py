...
def interface_fortygigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_access_vlan_id, name, delete_fortygigabitethernet, delete_access_mac_rspan_vlan_classification, delete_access, delete_access_mac_address, access_mac_address, delete_interface, delete_name, access_vlan_id, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_vlan_id(delete_access=delete_access, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, username=username, access_vlan_id=access_vlan_id, delete_access_vlan_id=delete_access_vlan_id, delete_vlan=delete_vlan, host=host, delete_access_mac_rspan_vlan_classification=delete_access_mac_rspan_vlan_classification, delete_name=delete_name, access_mac_address=access_mac_address, delete_access_mac_address=delete_access_mac_address, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
