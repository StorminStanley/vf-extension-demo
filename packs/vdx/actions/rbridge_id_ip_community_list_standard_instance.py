...
def rbridge_id_ip_community_list_standard_instance(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_community_list_standard_instance_act(Action):
    def run(self, delete_standard, name, delete_ip, delete_community_list, instance, delete_instance, delete_name, delete_rbridge_id, delete_seq_keyword, seq_keyword, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_community_list_standard_instance(delete_instance=delete_instance, name=name, delete_community_list=delete_community_list, delete_seq_keyword=delete_seq_keyword, username=username, delete_standard=delete_standard, seq_keyword=seq_keyword, rbridge_id=rbridge_id, delete_ip=delete_ip, host=host, password=password, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
