...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_neighbor_route_map_neighbor_route_map_direction_out_neighbor_route_map_name_direction_out(**kwargs):
    """Auto Generated Code
    """
    ...
    neighbor_route_map = ET.SubElement(af_ipv4_neighbor_addr, "neighbor-route-map")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_neighbor_route_map_neighbor_route_map_direction_out_neighbor_route_map_name_direction_out_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, neighbor_route_map_name_direction_out, delete_neighbor_route_map_name_direction_out, delete_neighbor_route_map, delete_rbridge_id, delete_neighbor_route_map_direction_out, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_neighbor_route_map_neighbor_route_map_direction_out_neighbor_route_map_name_direction_out(delete_neighbor_route_map_direction_out=delete_neighbor_route_map_direction_out, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_neighbor_route_map_name_direction_out=delete_neighbor_route_map_name_direction_out, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor_route_map=delete_neighbor_route_map, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, neighbor_route_map_name_direction_out=neighbor_route_map_name_direction_out, password=password, callback=_callback, mgr=mgr)
        return 0
