...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_suppress_linklsa(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_suppress_linklsa_act(Action):
    def run(self, delete_suppress_linklsa, delete_name, delete_interface, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_suppress_linklsa(name=name, delete_name=delete_name, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_suppress_linklsa=delete_suppress_linklsa, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
