...
def interface_hundredgigabitethernet_spanning_tree_link_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_link_type_act(Action):
    def run(self, name, delete_link_type, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, link_type, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_link_type(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, link_type=link_type, delete_spanning_tree=delete_spanning_tree, host=host, delete_link_type=delete_link_type, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
