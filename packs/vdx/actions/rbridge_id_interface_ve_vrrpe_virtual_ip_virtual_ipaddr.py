...
def rbridge_id_interface_ve_vrrpe_virtual_ip_virtual_ipaddr(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_virtual_ip_virtual_ipaddr_act(Action):
    def run(self, virtual_ipaddr, delete_virtual_ipaddr, name, delete_vrid, vrid, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, delete_virtual_ip, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_virtual_ip_virtual_ipaddr(delete_virtual_ipaddr=delete_virtual_ipaddr, delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_vrrpe=delete_vrrpe, username=username, delete_virtual_ip=delete_virtual_ip, rbridge_id=rbridge_id, virtual_ipaddr=virtual_ipaddr, delete_ve=delete_ve, vrid=vrid, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
