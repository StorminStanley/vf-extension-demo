...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_bfd_bfd_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_bfd_bfd_enable_act(Action):
    def run(self, name, delete_bfd_enable, delete_interface, delete_name, delete_bfd, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_bfd_bfd_enable(name=name, delete_name=delete_name, delete_bfd_enable=delete_bfd_enable, delete_bfd=delete_bfd, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
