...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_jitter(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_jitter_act(Action):
    def run(self, name, delete_hello_jitter, hello_jitter, delete_interface, delete_name, delete_link_interval_properties, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_jitter(name=name, delete_name=delete_name, delete_link_interval_properties=delete_link_interval_properties, delete_gigabitethernet=delete_gigabitethernet, host=host, hello_jitter=hello_jitter, delete_hello_jitter=delete_hello_jitter, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
