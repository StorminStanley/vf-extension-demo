...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_preferred_infinite, delete_fortygigabitethernet, delete_ch_preferred_type, delete_interface, delete_name, delete_lifetime, delete_nd, delete_ca_preferred_infinite, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite(name=name, delete_preferred_infinite=delete_preferred_infinite, delete_name=delete_name, delete_lifetime=delete_lifetime, delete_nd=delete_nd, delete_ca_preferred_infinite=delete_ca_preferred_infinite, host=host, delete_preferred=delete_preferred, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ch_preferred_type=delete_ch_preferred_type, delete_prefix=delete_prefix, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
