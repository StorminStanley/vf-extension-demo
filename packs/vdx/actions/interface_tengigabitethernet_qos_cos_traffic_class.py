...
def interface_tengigabitethernet_qos_cos_traffic_class(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_cos_traffic_class_act(Action):
    def run(self, delete_qos, name, delete_cos_traffic_class, cos_traffic_class, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_qos_cos_traffic_class(delete_qos=delete_qos, delete_name=delete_name, delete_cos_traffic_class=delete_cos_traffic_class, cos_traffic_class=cos_traffic_class, name=name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
