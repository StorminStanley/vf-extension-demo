...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_dead_interval_act(Action):
    def run(self, name, delete_dead_interval, dead_interval, delete_interface, delete_name, delete_link_interval_properties, delete_gigabitethernet, host, username, password):
