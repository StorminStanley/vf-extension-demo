...
def rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_hash_mask_length(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_hash_mask_length', False) is True:
        delete_hash_mask_length = config.find('.//*hash-mask-length')
        delete_hash_mask_length.set('operation', 'delete')
...
class rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_hash_mask_length_act(Action):
    def run(self, delete_pim, delete_bsr_cand_intf_type, rbridge_id, delete_hide_pim_holder, delete_hash_mask_length, bsr_cand_intf_type, bsr_cand_intf_id, delete_bsr_cand_interface, hash_mask_length, delete_bsr_candidate, delete_rbridge_id, delete_bsr_cand_intf_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_hash_mask_length(delete_bsr_cand_intf_id=delete_bsr_cand_intf_id, bsr_cand_intf_id=bsr_cand_intf_id, delete_bsr_candidate=delete_bsr_candidate, username=username, delete_pim=delete_pim, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_bsr_cand_intf_type=delete_bsr_cand_intf_type, delete_hide_pim_holder=delete_hide_pim_holder, hash_mask_length=hash_mask_length, delete_router=delete_router, host=host, delete_hash_mask_length=delete_hash_mask_length, bsr_cand_intf_type=bsr_cand_intf_type, delete_bsr_cand_interface=delete_bsr_cand_interface, password=password, callback=_callback, mgr=mgr)
        return 0
