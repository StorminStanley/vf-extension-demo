...
def interface_fortygigabitethernet_openflow_interface_cfg_openflow_enable_match_profile(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_openflow_interface_cfg_openflow_enable_match_profile_act(Action):
    def run(self, name, delete_fortygigabitethernet, match_profile, delete_openflow_interface_cfg, delete_interface, delete_name, delete_openflow_enable, delete_match_profile, host, username, password):
