...
def rbridge_id_router_router_bgp_router_bgp_attributes_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_bfd_interval_multiplier_act(Action):
    def run(self, delete_multiplier, delete_router_bgp, rbridge_id, delete_router_bgp_attributes, delete_interval, multiplier, delete_bfd, delete_rbridge_id, delete_router, host, username, password):
