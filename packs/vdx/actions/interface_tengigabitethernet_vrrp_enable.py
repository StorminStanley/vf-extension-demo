...
def interface_tengigabitethernet_vrrp_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_vrrp_enable_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, version, delete_enable, delete_interface, delete_name, delete_vrrp, delete_tengigabitethernet, host, username, password):
