...
def interface_gigabitethernet_ip_ip_config_unnumbered_ip_donor_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_ip_config_unnumbered_ip_donor_interface_type_act(Action):
    def run(self, delete_ip_config, delete_ip_donor_interface_type, name, delete_ip, ip_donor_interface_type, delete_unnumbered, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_ip_config_unnumbered_ip_donor_interface_type(name=name, delete_unnumbered=delete_unnumbered, delete_ip_config=delete_ip_config, delete_ip=delete_ip, delete_gigabitethernet=delete_gigabitethernet, delete_ip_donor_interface_type=delete_ip_donor_interface_type, host=host, ip_donor_interface_type=ip_donor_interface_type, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
