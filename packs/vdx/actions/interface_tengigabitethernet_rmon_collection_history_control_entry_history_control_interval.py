...
def interface_tengigabitethernet_rmon_collection_history_control_entry_history_control_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_rmon_collection_history_control_entry_history_control_interval_act(Action):
    def run(self, delete_collection, delete_history_control_index, name, history_control_index, delete_rmon, delete_history_control_interval, delete_interface, delete_name, delete_history_control_entry, delete_tengigabitethernet, history_control_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_rmon_collection_history_control_entry_history_control_interval(delete_rmon=delete_rmon, name=name, history_control_index=history_control_index, delete_history_control_entry=delete_history_control_entry, delete_history_control_index=delete_history_control_index, delete_history_control_interval=delete_history_control_interval, delete_name=delete_name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, history_control_interval=history_control_interval, delete_collection=delete_collection, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
