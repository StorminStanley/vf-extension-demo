...
def rbridge_id_ip_rtm_config_route_static_route_oif_vrf_next_hop_vrf(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_vrf_next_hop_vrf_act(Action):
    def run(self, static_route_oif_type, rbridge_id, delete_ip, delete_route, delete_next_hop_vrf, delete_static_route_next_vrf_dest, next_hop_vrf, delete_static_route_oif_name, delete_static_route_oif_vrf, static_route_next_vrf_dest, delete_rtm_config, delete_rbridge_id, delete_static_route_oif_type, static_route_oif_name, host, username, password):
