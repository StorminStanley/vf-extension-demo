...
def interface_gigabitethernet_rmon_collection_ether_stats_entry_ether_stats_owner(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_rmon_collection_ether_stats_entry_ether_stats_owner_act(Action):
    def run(self, delete_collection, name, ether_stats_owner, delete_ether_stats_index, delete_rmon, delete_ether_stats_entry, ether_stats_index, delete_interface, delete_name, delete_ether_stats_owner, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_rmon_collection_ether_stats_entry_ether_stats_owner(ether_stats_owner=ether_stats_owner, delete_rmon=delete_rmon, name=name, delete_collection=delete_collection, username=username, delete_ether_stats_entry=delete_ether_stats_entry, ether_stats_index=ether_stats_index, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_ether_stats_index=delete_ether_stats_index, delete_ether_stats_owner=delete_ether_stats_owner, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
