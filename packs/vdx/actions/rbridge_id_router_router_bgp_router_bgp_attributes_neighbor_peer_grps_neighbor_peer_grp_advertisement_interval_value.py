...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_advertisement_interval_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_advertisement_interval_value_act(Action):
    def run(self, delete_value, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, delete_advertisement_interval, router_bgp_neighbor_peer_grp, value, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_advertisement_interval_value(delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router=delete_router, delete_router_bgp=delete_router_bgp, delete_value=delete_value, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_advertisement_interval=delete_advertisement_interval, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, value=value, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, host=host, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_peer_grps=delete_peer_grps, callback=_callback, mgr=mgr)
        return 0
