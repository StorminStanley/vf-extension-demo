...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_time_act(Action):
    def run(self, name, delete_time, delete_dad, delete_name, time, delete_hundredgigabitethernet, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_dad_time(name=name, delete_name=delete_name, time=time, delete_time=delete_time, delete_dad=delete_dad, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
