...
def rbridge_id_ipv6_router_ospf_area_nssa_nssa_area_no_summary(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_nssa_area_no_summary', False) is True:
        delete_nssa_area_no_summary = config.find('.//*nssa-area-no-summary')
        delete_nssa_area_no_summary.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_ipv6_router_ospf_area_nssa_nssa_area_no_summary_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_nssa, delete_area, vrf, delete_nssa_area_no_summary, delete_rbridge_id, delete_router, host, username, password):
