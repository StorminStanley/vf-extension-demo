...
def protocol_lldp_profile_advertise_optional_tlv_adv_tlv_system_description(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_profile_advertise_optional_tlv_adv_tlv_system_description_act(Action):
    def run(self, delete_profile_name, delete_protocol, delete_lldp, delete_optional_tlv, profile_name, delete_advertise, delete_profile, delete_adv_tlv_system_description, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_profile_advertise_optional_tlv_adv_tlv_system_description(delete_profile_name=delete_profile_name, profile_name=profile_name, delete_lldp=delete_lldp, username=username, delete_optional_tlv=delete_optional_tlv, delete_profile=delete_profile, delete_protocol=delete_protocol, password=password, host=host, delete_adv_tlv_system_description=delete_adv_tlv_system_description, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
