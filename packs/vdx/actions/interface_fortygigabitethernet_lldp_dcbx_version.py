...
def interface_fortygigabitethernet_lldp_dcbx_version(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_lldp_dcbx_version_act(Action):
    def run(self, delete_lldp, name, delete_dcbx_version, delete_fortygigabitethernet, delete_interface, delete_name, dcbx_version, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_lldp_dcbx_version(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, dcbx_version=dcbx_version, delete_lldp=delete_lldp, delete_dcbx_version=delete_dcbx_version, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
