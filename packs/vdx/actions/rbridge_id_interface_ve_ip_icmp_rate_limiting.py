...
def rbridge_id_interface_ve_ip_icmp_rate_limiting(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_icmp_rate_limiting_act(Action):
    def run(self, delete_rate_limiting, name, delete_ip, delete_icmp, delete_ve, delete_interface, delete_name, rate_limiting, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_icmp_rate_limiting(delete_rate_limiting=delete_rate_limiting, name=name, delete_name=delete_name, delete_icmp=delete_icmp, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, rate_limiting=rate_limiting, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
