...
def interface_hundredgigabitethernet_bpdu_drop_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_bpdu_drop_direction_act(Action):
    def run(self, direction, name, delete_bpdu_drop, delete_name, delete_hundredgigabitethernet, delete_interface, delete_direction, host, username, password):
