...
def interface_tengigabitethernet_track_remove_remove_all_track_interfaces(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_track_remove_remove_all_track_interfaces_act(Action):
    def run(self, name, delete_remove_all_track_interfaces, delete_interface, delete_name, delete_remove, delete_tengigabitethernet, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_track_remove_remove_all_track_interfaces(name=name, delete_name=delete_name, delete_track=delete_track, username=username, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, delete_remove=delete_remove, delete_remove_all_track_interfaces=delete_remove_all_track_interfaces, password=password, callback=_callback, mgr=mgr)
        return 0
