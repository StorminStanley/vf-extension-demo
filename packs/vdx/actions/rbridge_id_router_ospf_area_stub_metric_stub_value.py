...
def rbridge_id_router_ospf_area_stub_metric_stub_value(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_stub_value', False) is True:
        delete_stub_value = config.find('.//*stub-value')
        delete_stub_value.set('operation', 'delete')
...
class rbridge_id_router_ospf_area_stub_metric_stub_value_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_stub, delete_area, vrf, stub_value, delete_rbridge_id, delete_stub_value, delete_router, delete_metric, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_area_stub_metric_stub_value(delete_metric=delete_metric, username=username, delete_area=delete_area, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, delete_stub_value=delete_stub_value, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_stub=delete_stub, area_id=area_id, delete_area_id=delete_area_id, stub_value=stub_value, callback=_callback, mgr=mgr)
        return 0
