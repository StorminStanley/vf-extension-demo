...
def interface_hundredgigabitethernet_openflow_interface_cfg_openflow_enable_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_openflow_interface_cfg_openflow_enable_enable_act(Action):
    def run(self, name, delete_openflow_interface_cfg, delete_enable, delete_interface, delete_name, delete_openflow_enable, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_openflow_interface_cfg_openflow_enable_enable(name=name, delete_openflow_interface_cfg=delete_openflow_interface_cfg, delete_openflow_enable=delete_openflow_enable, delete_enable=delete_enable, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
