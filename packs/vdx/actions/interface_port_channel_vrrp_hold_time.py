...
def interface_port_channel_vrrp_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_hold_time_act(Action):
    def run(self, name, delete_vrid, delete_hold_time, vrid, delete_version, delete_port_channel, version, delete_interface, delete_name, delete_vrrp, hold_time, host, username, password):
