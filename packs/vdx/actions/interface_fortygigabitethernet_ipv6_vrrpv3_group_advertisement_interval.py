...
def interface_fortygigabitethernet_ipv6_vrrpv3_group_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3_group_advertisement_interval_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_vrid, vrid, delete_advertisement_interval, advertisement_interval, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3_group_advertisement_interval(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_advertisement_interval=delete_advertisement_interval, advertisement_interval=advertisement_interval, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
