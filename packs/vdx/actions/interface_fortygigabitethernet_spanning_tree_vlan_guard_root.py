...
def interface_fortygigabitethernet_spanning_tree_vlan_guard_root(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_guard', False) is True:
        delete_guard = config.find('.//*guard')
        delete_guard.set('operation', 'delete')
...
class interface_fortygigabitethernet_spanning_tree_vlan_guard_root_act(Action):
    def run(self, delete_vlan, name, delete_fortygigabitethernet, id, delete_id, delete_interface, delete_name, delete_guard, delete_spanning_tree, delete_root, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_spanning_tree_vlan_guard_root(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_vlan=delete_vlan, delete_id=delete_id, delete_guard=delete_guard, delete_root=delete_root, host=host, delete_spanning_tree=delete_spanning_tree, delete_name=delete_name, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
