...
def interface_hundredgigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_basic(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_basic_act(Action):
    def run(self, delete_basic, name, delete_vrid, vrid, delete_short_path_forwarding, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
