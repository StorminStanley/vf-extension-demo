...
def interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_immediate_leave(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_immediate_leave_act(Action):
    def run(self, name, delete_ip, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_hundredgigabitethernet, delete_immediate_leave, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_immediate_leave(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_immediate_leave=delete_immediate_leave, delete_ip=delete_ip, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
