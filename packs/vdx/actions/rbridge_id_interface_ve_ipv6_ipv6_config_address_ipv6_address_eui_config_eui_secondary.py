...
def rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary_act(Action):
    def run(self, delete_eui_secondary, delete_eui_config, name, delete_ve, delete_interface, delete_name, address, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(name=name, delete_name=delete_name, address=address, username=username, rbridge_id=rbridge_id, delete_eui_config=delete_eui_config, delete_eui_secondary=delete_eui_secondary, delete_ve=delete_ve, host=host, delete_address=delete_address, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
