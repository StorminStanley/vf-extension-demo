...
def rbridge_id_router_ospf_distribute_list_route_map_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_distribute_list_route_map_route_map_act(Action):
    def run(self, rbridge_id, delete_ospf, delete_vrf, route_map, delete_route_map, vrf, delete_distribute_list, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_distribute_list_route_map_route_map(username=username, delete_router=delete_router, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_route_map=delete_route_map, delete_distribute_list=delete_distribute_list, route_map=route_map, host=host, vrf=vrf, delete_ospf=delete_ospf, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
