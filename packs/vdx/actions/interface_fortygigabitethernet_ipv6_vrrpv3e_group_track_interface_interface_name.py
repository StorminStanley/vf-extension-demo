...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_track_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_track_interface_interface_name_act(Action):
    def run(self, delete_fortygigabitethernet, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_interface_type, delete_interface, delete_name, interface_name, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_track_interface_interface_name(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_track=delete_track, interface_name=interface_name, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, vrid=vrid, interface_type=interface_type, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
