...
def interface_fortygigabitethernet_switchport_private_vlan_association_trunk_trunk_sec_pvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_private_vlan_association_trunk_trunk_sec_pvlan_act(Action):
