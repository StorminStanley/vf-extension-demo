...
def interface_port_channel_ip_interface_po_dhcp_conf_dhcp_relay_servers_relay_ip_addr(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_po_dhcp_conf_dhcp_relay_servers_relay_ip_addr_act(Action):
