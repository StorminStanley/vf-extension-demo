...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_ipv6_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_ipv6_address_act(Action):
    def run(self, delete_neighbor, delete_tengigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_ipv6_address(name=name, delete_name=delete_name, delete_neighbor=delete_neighbor, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
