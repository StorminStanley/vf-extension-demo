...
def rbridge_id_fabric_route_mcast_priority(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_fabric_route_mcast_priority_act(Action):
    def run(self, rbridge_id, delete_route, priority, delete_fabric, delete_priority, delete_mcast, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_fabric_route_mcast_priority(delete_fabric=delete_fabric, delete_route=delete_route, username=username, delete_mcast=delete_mcast, rbridge_id=rbridge_id, priority=priority, host=host, delete_rbridge_id=delete_rbridge_id, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
