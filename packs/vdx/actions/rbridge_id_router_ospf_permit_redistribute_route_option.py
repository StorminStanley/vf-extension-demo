...
def rbridge_id_router_ospf_permit_redistribute_route_option(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_permit_redistribute_route_option_act(Action):
    def run(self, delete_permit, redist_value, rbridge_id, delete_route_option, delete_ospf, delete_vrf, delete_redistribute, delete_redist_value, vrf, delete_rbridge_id, delete_router, route_option, host, username, password):
