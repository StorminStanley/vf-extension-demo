...
def interface_hundredgigabitethernet_ipv6_vrrpv3_group_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3_group_preempt_mode_act(Action):
