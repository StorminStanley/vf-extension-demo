...
def interface_vlan_interface_vlan_ip_igmp_robustness_variable(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_robustness_variable_act(Action):
    def run(self, delete_vlan, name, delete_ip, delete_interface_vlan, delete_igmp, delete_interface, delete_name, delete_robustness_variable, robustness_variable, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ip_igmp_robustness_variable(name=name, delete_name=delete_name, delete_vlan=delete_vlan, robustness_variable=robustness_variable, delete_ip=delete_ip, delete_igmp=delete_igmp, delete_interface_vlan=delete_interface_vlan, host=host, delete_interface=delete_interface, username=username, delete_robustness_variable=delete_robustness_variable, password=password, callback=_callback, mgr=mgr)
        return 0
