...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_best_best(**kwargs):
    """Auto Generated Code
    """
    ...
    additional_paths = ET.SubElement(af_ipv6_neighbor_addr, "additional-paths")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_best_best_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, best, delete_best, delete_advertise, delete_ch_additional_paths, delete_rbridge_id, delete_ca_best, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
