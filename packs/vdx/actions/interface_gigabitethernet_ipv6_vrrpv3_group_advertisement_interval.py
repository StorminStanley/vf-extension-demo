...
def interface_gigabitethernet_ipv6_vrrpv3_group_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3_group_advertisement_interval_act(Action):
    def run(self, name, delete_vrid, vrid, delete_advertisement_interval, advertisement_interval, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
