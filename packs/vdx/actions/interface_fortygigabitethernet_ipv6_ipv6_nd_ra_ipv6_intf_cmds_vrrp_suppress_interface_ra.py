...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_vrrp_suppress_interface_ra(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_vrrp_suppress_interface_ra_act(Action):
    def run(self, delete_vrrp_suppress_interface_ra, delete_fortygigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_vrrp_suppress_interface_ra(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_vrrp_suppress_interface_ra=delete_vrrp_suppress_interface_ra, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
