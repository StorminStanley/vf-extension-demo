...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv6_activate(**kwargs):
    """Auto Generated Code
    """
    ...
    activate = ET.SubElement(evpn_neighbor_ipv6, "activate")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv6_activate_act(Action):
