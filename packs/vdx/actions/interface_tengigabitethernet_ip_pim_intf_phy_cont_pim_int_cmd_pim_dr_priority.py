...
def interface_tengigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_dr_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_dr_priority_act(Action):
    def run(self, delete_pim, delete_pim_intf_phy_cont, delete_ip, delete_dr_priority, dr_priority, delete_interface, delete_name, delete_tengigabitethernet, delete_pim_int_cmd, name, host, username, password):
