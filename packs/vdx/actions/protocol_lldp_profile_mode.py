...
def protocol_lldp_profile_mode(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_profile_mode_act(Action):
    def run(self, delete_profile_name, delete_protocol, delete_lldp, profile_name, mode, delete_profile, delete_mode, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_profile_mode(delete_profile_name=delete_profile_name, profile_name=profile_name, delete_lldp=delete_lldp, delete_mode=delete_mode, delete_profile=delete_profile, mode=mode, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
