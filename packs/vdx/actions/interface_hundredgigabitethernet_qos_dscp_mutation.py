...
def interface_hundredgigabitethernet_qos_dscp_mutation(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_qos_dscp_mutation_act(Action):
    def run(self, delete_qos, name, delete_dscp_mutation, dscp_mutation, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_qos_dscp_mutation(delete_qos=delete_qos, delete_name=delete_name, delete_dscp_mutation=delete_dscp_mutation, name=name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, dscp_mutation=dscp_mutation, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
