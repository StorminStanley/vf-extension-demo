...
def interface_fortygigabitethernet_ip_ip_config_mtu(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_ip_config_mtu_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_mtu, delete_fortygigabitethernet, mtu, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_ip_config_mtu(mtu=mtu, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ip_config=delete_ip_config, delete_ip=delete_ip, delete_mtu=delete_mtu, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
