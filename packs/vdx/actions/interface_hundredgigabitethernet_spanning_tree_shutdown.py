...
def interface_hundredgigabitethernet_spanning_tree_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_shutdown_act(Action):
    def run(self, name, delete_shutdown, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_shutdown(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_spanning_tree=delete_spanning_tree, host=host, delete_shutdown=delete_shutdown, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
