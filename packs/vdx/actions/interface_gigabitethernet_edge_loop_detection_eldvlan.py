...
def interface_gigabitethernet_edge_loop_detection_eldvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_edge_loop_detection_eldvlan_act(Action):
    def run(self, name, delete_edge_loop_detection, delete_interface, delete_name, delete_eldvlan, eldvlan, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_edge_loop_detection_eldvlan(name=name, delete_eldvlan=delete_eldvlan, eldvlan=eldvlan, delete_edge_loop_detection=delete_edge_loop_detection, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
