...
def interface_tengigabitethernet_fcoeport_ns_ip_registration(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_fcoeport_ns_ip_registration_act(Action):
    def run(self, name, delete_ns_ip_registration, delete_fcoeport, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_fcoeport_ns_ip_registration(name=name, delete_name=delete_name, delete_fcoeport=delete_fcoeport, host=host, delete_ns_ip_registration=delete_ns_ip_registration, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
