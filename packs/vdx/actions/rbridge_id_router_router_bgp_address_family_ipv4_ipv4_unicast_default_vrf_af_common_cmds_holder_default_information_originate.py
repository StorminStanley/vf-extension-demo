...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_default_information_originate(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_default_information_originate_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_common_cmds_holder, delete_default_vrf, delete_rbridge_id, delete_router, delete_default_information_originate, host, username, password):
