...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base_act(Action):
    def run(self, name, delete_nud, delete_base, delete_port_channel, base, delete_interface, delete_name, delete_nd, delete_retry, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(delete_retry=delete_retry, name=name, delete_name=delete_name, base=base, delete_nud=delete_nud, delete_port_channel=delete_port_channel, delete_nd=delete_nd, host=host, delete_base=delete_base, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
