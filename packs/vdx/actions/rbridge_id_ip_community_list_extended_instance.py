...
def rbridge_id_ip_community_list_extended_instance(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_community_list_extended_instance_act(Action):
