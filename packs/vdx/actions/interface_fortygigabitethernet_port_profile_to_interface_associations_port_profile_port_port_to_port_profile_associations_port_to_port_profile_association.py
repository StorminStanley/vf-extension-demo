...
def interface_fortygigabitethernet_port_profile_to_interface_associations_port_profile_port_port_to_port_profile_associations_port_to_port_profile_association(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_port_profile_to_interface_associations_port_profile_port_port_to_port_profile_associations_port_to_port_profile_association_act(Action):
    def run(self, delete_port_to_port_profile_associations, name, delete_fortygigabitethernet, delete_port_to_port_profile_association, delete_port_profile_to_interface_associations, delete_port_profile_port, delete_interface, delete_name, port_to_port_profile_association, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_port_profile_to_interface_associations_port_profile_port_port_to_port_profile_associations_port_to_port_profile_association(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, delete_port_profile_port=delete_port_profile_port, delete_port_profile_to_interface_associations=delete_port_profile_to_interface_associations, host=host, port_to_port_profile_association=port_to_port_profile_association, delete_port_to_port_profile_association=delete_port_to_port_profile_association, delete_port_to_port_profile_associations=delete_port_to_port_profile_associations, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
