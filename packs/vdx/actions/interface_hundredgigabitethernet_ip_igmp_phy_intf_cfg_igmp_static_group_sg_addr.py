...
def interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_static_group_sg_addr(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_static_group_sg_addr_act(Action):
    def run(self, name, delete_ip, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_static_group, delete_hundredgigabitethernet, delete_sg_addr, sg_addr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_igmp_phy_intf_cfg_igmp_static_group_sg_addr(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_ip=delete_ip, delete_static_group=delete_static_group, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_sg_addr=delete_sg_addr, host=host, sg_addr=sg_addr, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
