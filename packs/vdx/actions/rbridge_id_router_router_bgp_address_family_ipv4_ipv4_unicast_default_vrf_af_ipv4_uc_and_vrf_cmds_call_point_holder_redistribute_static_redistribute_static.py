...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_static_redistribute_static(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_static_redistribute_static_act(Action):
    def run(self, delete_redistribute_static, delete_address_family, delete_router_bgp, rbridge_id, delete_static, delete_redistribute, delete_default_vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_static_redistribute_static(delete_redistribute_static=delete_redistribute_static, delete_static=delete_static, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_redistribute=delete_redistribute, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_router_bgp=delete_router_bgp, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
