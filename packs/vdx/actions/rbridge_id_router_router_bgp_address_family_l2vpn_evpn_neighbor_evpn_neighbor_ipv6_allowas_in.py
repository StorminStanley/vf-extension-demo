...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv6_allowas_in(**kwargs):
    """Auto Generated Code
    """
    ...
    allowas_in = ET.SubElement(evpn_neighbor_ipv6, "allowas-in")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv6_allowas_in_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, allowas_in, delete_evpn, delete_allowas_in, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv6_allowas_in(delete_router_bgp=delete_router_bgp, delete_evpn=delete_evpn, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, delete_allowas_in=delete_allowas_in, host=host, delete_address_family=delete_address_family, allowas_in=allowas_in, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
