...
def interface_gigabitethernet_switchport_private_vlan_trunk_pvlan_tag_pvlan_tag_native_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_private_vlan_trunk_pvlan_tag_pvlan_tag_native_vlan_act(Action):
    def run(self, delete_switchport, delete_pvlan_tag_native_vlan, name, delete_trunk, delete_pvlan_tag, delete_private_vlan, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_private_vlan_trunk_pvlan_tag_pvlan_tag_native_vlan(name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, username=username, delete_name=delete_name, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_private_vlan=delete_private_vlan, delete_pvlan_tag_native_vlan=delete_pvlan_tag_native_vlan, delete_interface=delete_interface, delete_pvlan_tag=delete_pvlan_tag, password=password, callback=_callback, mgr=mgr)
        return 0
