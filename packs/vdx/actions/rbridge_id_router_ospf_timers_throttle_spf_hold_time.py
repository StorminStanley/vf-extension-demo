...
def rbridge_id_router_ospf_timers_throttle_spf_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_timers_throttle_spf_hold_time_act(Action):
    def run(self, rbridge_id, delete_ospf, delete_vrf, delete_hold_time, delete_timers, vrf, delete_rbridge_id, delete_spf, hold_time, delete_router, delete_throttle, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_timers_throttle_spf_hold_time(delete_spf=delete_spf, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_throttle=delete_throttle, delete_vrf=delete_vrf, hold_time=hold_time, delete_router=delete_router, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_hold_time=delete_hold_time, delete_timers=delete_timers, password=password, callback=_callback, mgr=mgr)
        return 0
