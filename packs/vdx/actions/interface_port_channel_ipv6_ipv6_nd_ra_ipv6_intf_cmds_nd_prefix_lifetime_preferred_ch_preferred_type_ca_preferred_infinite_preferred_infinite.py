...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_preferred_infinite, delete_ch_preferred_type, delete_port_channel, delete_interface, delete_name, delete_lifetime, delete_nd, delete_ca_preferred_infinite, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite(name=name, delete_preferred_infinite=delete_preferred_infinite, delete_name=delete_name, delete_lifetime=delete_lifetime, delete_port_channel=delete_port_channel, delete_nd=delete_nd, delete_ca_preferred_infinite=delete_ca_preferred_infinite, host=host, delete_preferred=delete_preferred, delete_ch_preferred_type=delete_ch_preferred_type, delete_prefix=delete_prefix, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
