...
def interface_port_channel_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_ctag_range(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_ctag_range_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk_vlan_classification, delete_trunk, trunk_vlan_id, delete_trunk_ctag_range, delete_port_channel, delete_interface, delete_name, delete_remove, trunk_ctag_range, delete_trunk_vlan_id, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_ctag_range(delete_port_channel=delete_port_channel, name=name, delete_trunk=delete_trunk, delete_trunk_vlan_id=delete_trunk_vlan_id, username=username, delete_switchport=delete_switchport, delete_remove=delete_remove, delete_trunk_vlan_classification=delete_trunk_vlan_classification, delete_allowed=delete_allowed, trunk_vlan_id=trunk_vlan_id, delete_vlan=delete_vlan, host=host, delete_name=delete_name, delete_interface=delete_interface, trunk_ctag_range=trunk_ctag_range, delete_trunk_ctag_range=delete_trunk_ctag_range, password=password, callback=_callback, mgr=mgr)
        return 0
