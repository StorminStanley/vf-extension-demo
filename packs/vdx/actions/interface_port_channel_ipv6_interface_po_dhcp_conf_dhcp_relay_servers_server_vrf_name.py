...
def interface_port_channel_ipv6_interface_po_dhcp_conf_dhcp_relay_servers_server_vrf_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_po_dhcp_conf_dhcp_relay_servers_server_vrf_name_act(Action):
    def run(self, relay_ip_addr, name, delete_port_channel, delete_interface_po_dhcp_conf, delete_servers, delete_dhcp, delete_relay, delete_interface, delete_name, delete_server_vrf_name, server_vrf_name, delete_relay_ip_addr, host, username, password):
