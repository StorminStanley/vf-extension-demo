...
def rbridge_id_router_ospf_deny_redistribute_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_deny_redistribute_address_act(Action):
    def run(self, redist_value, rbridge_id, delete_route_option, delete_ospf, delete_vrf, delete_deny, delete_redistribute, delete_redist_value, vrf, address, delete_rbridge_id, delete_address, delete_router, route_option, host, username, password):
