...
def rbridge_id_maps_rule_timebase(**kwargs):
    """Auto Generated Code
    """
    ...
    timebase = ET.SubElement(rule, "timebase")
...
class rbridge_id_maps_rule_timebase_act(Action):
    def run(self, timebase, rbridge_id, delete_maps, delete_rulename, rulename, delete_rbridge_id, delete_rule, delete_timebase, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_maps_rule_timebase(timebase=timebase, username=username, rbridge_id=rbridge_id, delete_maps=delete_maps, rulename=rulename, delete_timebase=delete_timebase, delete_rule=delete_rule, delete_rulename=delete_rulename, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
