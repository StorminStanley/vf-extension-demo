...
def rbridge_id_router_ospf_summary_address_sum_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_summary_address_sum_address_act(Action):
