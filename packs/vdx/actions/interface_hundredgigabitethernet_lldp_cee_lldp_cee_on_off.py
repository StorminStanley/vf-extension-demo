...
def interface_hundredgigabitethernet_lldp_cee_lldp_cee_on_off(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_lldp_cee_lldp_cee_on_off_act(Action):
    def run(self, name, delete_cee, delete_lldp, delete_lldp_cee_on_off, delete_interface, delete_name, delete_hundredgigabitethernet, lldp_cee_on_off, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_lldp_cee_lldp_cee_on_off(name=name, delete_name=delete_name, delete_lldp=delete_lldp, username=username, delete_cee=delete_cee, delete_lldp_cee_on_off=delete_lldp_cee_on_off, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_interface=delete_interface, lldp_cee_on_off=lldp_cee_on_off, password=password, callback=_callback, mgr=mgr)
        return 0
