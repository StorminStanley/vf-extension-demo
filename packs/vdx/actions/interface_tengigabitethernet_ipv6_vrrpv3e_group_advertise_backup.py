...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_advertise_backup(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_advertise_backup_act(Action):
    def run(self, name, delete_vrid, vrid, delete_interface, delete_name, delete_tengigabitethernet, delete_advertise_backup, host, username, password):
