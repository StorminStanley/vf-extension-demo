...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_interval_min_tx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_interval_min_tx_act(Action):
    def run(self, delete_bfd, delete_address_family, delete_router_bgp, rbridge_id, delete_min_tx, delete_interval, min_tx, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_interval_min_tx(delete_interval=delete_interval, delete_router=delete_router, delete_address_family=delete_address_family, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_bfd=delete_bfd, min_tx=min_tx, host=host, delete_router_bgp=delete_router_bgp, delete_min_tx=delete_min_tx, password=password, callback=_callback, mgr=mgr)
        return 0
