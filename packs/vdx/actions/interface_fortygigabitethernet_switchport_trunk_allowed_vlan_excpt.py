...
def interface_fortygigabitethernet_switchport_trunk_allowed_vlan_excpt(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_allowed_vlan_excpt_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_fortygigabitethernet, delete_excpt, delete_interface, delete_name, excpt, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_trunk_allowed_vlan_excpt(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, delete_name=delete_name, delete_allowed=delete_allowed, delete_vlan=delete_vlan, host=host, password=password, excpt=excpt, delete_trunk=delete_trunk, delete_interface=delete_interface, username=username, delete_excpt=delete_excpt, callback=_callback, mgr=mgr)
        return 0
