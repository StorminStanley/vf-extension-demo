...
def interface_hundredgigabitethernet_ipv6_access_group_ip_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_access_group_ip_direction_act(Action):
