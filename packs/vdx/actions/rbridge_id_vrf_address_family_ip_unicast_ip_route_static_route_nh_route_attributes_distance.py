...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_route_attributes_distance(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_route_attributes_distance_act(Action):
    def run(self, delete_static_route_next_hop, distance, delete_address_family, rbridge_id, delete_ip, delete_route, delete_vrf, delete_static_route_nh, delete_route_attributes, delete_static_route_dest, vrf_name, delete_distance, static_route_dest, delete_rbridge_id, delete_unicast, static_route_next_hop, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_route_attributes_distance(delete_route_attributes=delete_route_attributes, distance=distance, username=username, delete_address_family=delete_address_family, delete_static_route_dest=delete_static_route_dest, delete_route=delete_route, vrf_name=vrf_name, static_route_dest=static_route_dest, delete_vrf=delete_vrf, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_static_route_next_hop=delete_static_route_next_hop, delete_vrf_name=delete_vrf_name, static_route_next_hop=static_route_next_hop, host=host, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, delete_distance=delete_distance, delete_static_route_nh=delete_static_route_nh, password=password, callback=_callback, mgr=mgr)
        return 0
