...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_act(Action):
    def run(self, name, delete_ipsec_auth_key_config, ah, delete_ah, delete_fortygigabitethernet, delete_ca_ah_algorithm, delete_authentication, delete_name, delete_ch_algorithm, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah(delete_ca_ah_algorithm=delete_ca_ah_algorithm, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ah=delete_ah, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, ah=ah, delete_authentication=delete_authentication, host=host, delete_ch_algorithm=delete_ch_algorithm, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
