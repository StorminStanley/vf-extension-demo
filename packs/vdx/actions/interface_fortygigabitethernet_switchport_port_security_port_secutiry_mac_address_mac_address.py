...
def interface_fortygigabitethernet_switchport_port_security_port_secutiry_mac_address_mac_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_port_security_port_secutiry_mac_address_mac_address_act(Action):
    def run(self, delete_switchport, delete_mac_address, name, delete_fortygigabitethernet, delete_port_secutiry_mac_address, delete_interface, delete_name, mac_address, port_sec_vlan, delete_port_security, delete_port_sec_vlan, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_port_security_port_secutiry_mac_address_mac_address(port_sec_vlan=port_sec_vlan, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, delete_port_sec_vlan=delete_port_sec_vlan, mac_address=mac_address, delete_mac_address=delete_mac_address, host=host, password=password, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_port_security=delete_port_security, delete_port_secutiry_mac_address=delete_port_secutiry_mac_address, callback=_callback, mgr=mgr)
        return 0
