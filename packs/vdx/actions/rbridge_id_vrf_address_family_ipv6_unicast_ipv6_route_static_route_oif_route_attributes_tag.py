...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_route_attributes_tag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_route_attributes_tag_act(Action):
    def run(self, delete_static_route_oif, delete_address_family, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_vrf, delete_static_route_oif_name, tag, delete_route_attributes, delete_static_route_dest, vrf_name, static_route_dest, static_route_oif_name, delete_rbridge_id, delete_unicast, delete_tag, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_route_attributes_tag(delete_route_attributes=delete_route_attributes, delete_tag=delete_tag, delete_address_family=delete_address_family, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, username=username, tag=tag, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_static_route_oif=delete_static_route_oif, delete_static_route_oif_type=delete_static_route_oif_type, host=host, delete_vrf_name=delete_vrf_name, static_route_oif_type=static_route_oif_type, static_route_oif_name=static_route_oif_name, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, static_route_dest=static_route_dest, delete_static_route_dest=delete_static_route_dest, password=password, callback=_callback, mgr=mgr)
        return 0
