...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_valid_lifetime_valid_lifetime(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_valid_lifetime_valid_lifetime_act(Action):
    def run(self, delete_prefix, valid_lifetime, delete_valid_lifetime, delete_ca_valid_lifetime, delete_ch_valid_type, delete_interface, delete_name, delete_hundredgigabitethernet, delete_lifetime, delete_nd, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_valid_lifetime_valid_lifetime(name=name, delete_valid_lifetime=delete_valid_lifetime, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_lifetime=delete_lifetime, delete_name=delete_name, valid_lifetime=valid_lifetime, host=host, password=password, delete_nd=delete_nd, delete_prefix=delete_prefix, delete_ch_valid_type=delete_ch_valid_type, username=username, delete_interface=delete_interface, delete_ca_valid_lifetime=delete_ca_valid_lifetime, callback=_callback, mgr=mgr)
        return 0
