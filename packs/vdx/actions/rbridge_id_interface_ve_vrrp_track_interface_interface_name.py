...
def rbridge_id_interface_ve_vrrp_track_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrp_track_interface_interface_name_act(Action):
