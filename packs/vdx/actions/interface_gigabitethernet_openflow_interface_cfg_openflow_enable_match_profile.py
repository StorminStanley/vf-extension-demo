...
def interface_gigabitethernet_openflow_interface_cfg_openflow_enable_match_profile(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_openflow_interface_cfg_openflow_enable_match_profile_act(Action):
    def run(self, name, match_profile, delete_openflow_interface_cfg, delete_interface, delete_name, delete_openflow_enable, delete_gigabitethernet, delete_match_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_openflow_interface_cfg_openflow_enable_match_profile(name=name, delete_openflow_interface_cfg=delete_openflow_interface_cfg, delete_match_profile=delete_match_profile, delete_openflow_enable=delete_openflow_enable, delete_name=delete_name, host=host, delete_gigabitethernet=delete_gigabitethernet, match_profile=match_profile, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
