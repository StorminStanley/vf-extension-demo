...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key_act(Action):
    def run(self, delete_ip, delete_interface_PO_ospf_conf, delete_key_table, delete_port_channel, delete_interface, delete_name, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key(delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, host=host, delete_key_table=delete_key_table, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
