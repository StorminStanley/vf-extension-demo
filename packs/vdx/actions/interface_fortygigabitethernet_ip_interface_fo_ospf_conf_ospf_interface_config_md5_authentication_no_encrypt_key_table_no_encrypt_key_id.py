...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id_act(Action):
    def run(self, no_encrypt_key_id, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_no_encrypt_key_table, delete_interface, delete_name, delete_no_encrypt_key_id, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(name=name, delete_no_encrypt_key_table=delete_no_encrypt_key_table, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_no_encrypt_key_id=delete_no_encrypt_key_id, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, no_encrypt_key_id=no_encrypt_key_id, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
