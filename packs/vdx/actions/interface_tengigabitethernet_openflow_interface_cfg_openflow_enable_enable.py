...
def interface_tengigabitethernet_openflow_interface_cfg_openflow_enable_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_openflow_interface_cfg_openflow_enable_enable_act(Action):
    def run(self, name, delete_openflow_interface_cfg, delete_enable, delete_interface, delete_name, delete_openflow_enable, delete_tengigabitethernet, host, username, password):
