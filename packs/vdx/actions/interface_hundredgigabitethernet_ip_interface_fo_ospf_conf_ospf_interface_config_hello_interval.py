...
def interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_hello_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_hello_interval_act(Action):
    def run(self, name, delete_ip, delete_interface_fo_ospf_conf, delete_interface, delete_name, delete_hello_interval, delete_hundredgigabitethernet, hello_interval, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_hello_interval(name=name, delete_name=delete_name, hello_interval=hello_interval, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_hello_interval=delete_hello_interval, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
