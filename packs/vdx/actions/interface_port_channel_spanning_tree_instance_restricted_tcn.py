...
def interface_port_channel_spanning_tree_instance_restricted_tcn(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_spanning_tree_instance_restricted_tcn_act(Action):
    def run(self, delete_id, name, delete_instance, id, delete_port_channel, delete_restricted_tcn, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_spanning_tree_instance_restricted_tcn(delete_instance=delete_instance, name=name, delete_name=delete_name, delete_restricted_tcn=delete_restricted_tcn, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_port_channel=delete_port_channel, host=host, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
