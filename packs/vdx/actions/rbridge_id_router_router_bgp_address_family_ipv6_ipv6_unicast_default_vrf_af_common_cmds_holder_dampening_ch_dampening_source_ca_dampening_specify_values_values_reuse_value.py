...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_specify_values_values_reuse_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_specify_values_values_reuse_value_act(Action):
    def run(self, delete_reuse_value, delete_address_family, delete_ca_dampening_specify_values, delete_router_bgp, rbridge_id, delete_dampening, delete_af_common_cmds_holder, delete_default_vrf, delete_rbridge_id, delete_values, reuse_value, delete_router, delete_ch_dampening_source, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_specify_values_values_reuse_value(reuse_value=reuse_value, delete_router_bgp=delete_router_bgp, username=username, delete_reuse_value=delete_reuse_value, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, password=password, delete_af_common_cmds_holder=delete_af_common_cmds_holder, host=host, delete_values=delete_values, delete_ca_dampening_specify_values=delete_ca_dampening_specify_values, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, delete_ch_dampening_source=delete_ch_dampening_source, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
