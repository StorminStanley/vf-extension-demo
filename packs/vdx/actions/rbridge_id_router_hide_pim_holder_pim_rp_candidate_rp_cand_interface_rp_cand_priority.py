...
def rbridge_id_router_hide_pim_holder_pim_rp_candidate_rp_cand_interface_rp_cand_priority(**kwargs):
    """Auto Generated Code
    """
    ...
    rp_cand_priority = ET.SubElement(rp_cand_interface, "rp-cand-priority")
    if kwargs.pop('delete_rp_cand_priority', False) is True:
        delete_rp_cand_priority = config.find('.//*rp-cand-priority')
        delete_rp_cand_priority.set('operation', 'delete')
        
    rp_cand_priority.text = kwargs.pop('rp_cand_priority')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_hide_pim_holder_pim_rp_candidate_rp_cand_interface_rp_cand_priority_act(Action):
    def run(self, delete_pim, delete_rp_cand_intf_id, rbridge_id, delete_hide_pim_holder, delete_rp_cand_intf_type, delete_rp_cand_interface, rp_cand_intf_id, rp_cand_priority, rp_cand_intf_type, delete_rbridge_id, delete_rp_cand_priority, delete_router, delete_rp_candidate, host, username, password):
