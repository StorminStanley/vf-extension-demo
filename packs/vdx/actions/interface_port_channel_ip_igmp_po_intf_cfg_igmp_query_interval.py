...
def interface_port_channel_ip_igmp_po_intf_cfg_igmp_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_igmp_po_intf_cfg_igmp_query_interval_act(Action):
    def run(self, name, delete_ip, delete_igmp_po_intf_cfg, delete_query_interval, delete_port_channel, delete_igmp, delete_interface, delete_name, query_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_igmp_po_intf_cfg_igmp_query_interval(delete_igmp_po_intf_cfg=delete_igmp_po_intf_cfg, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_ip=delete_ip, delete_port_channel=delete_port_channel, query_interval=query_interval, host=host, delete_query_interval=delete_query_interval, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
