...
def rbridge_id_arp_entry_interfacename(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_arp_entry_interfacename_act(Action):
    def run(self, rbridge_id, delete_arp_ip_address, delete_interfacename, arp_ip_address, delete_arp_entry, delete_rbridge_id, interfacename, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_arp_entry_interfacename(delete_interfacename=delete_interfacename, delete_arp_entry=delete_arp_entry, username=username, rbridge_id=rbridge_id, arp_ip_address=arp_ip_address, host=host, delete_arp_ip_address=delete_arp_ip_address, interfacename=interfacename, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
