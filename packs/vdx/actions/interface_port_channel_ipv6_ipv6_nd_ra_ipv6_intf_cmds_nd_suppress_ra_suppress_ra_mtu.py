...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_mtu(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_mtu_act(Action):
    def run(self, delete_suppress_ra_mtu, name, delete_port_channel, delete_suppress_ra, delete_name, delete_nd, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_mtu(name=name, delete_name=delete_name, username=username, delete_port_channel=delete_port_channel, host=host, delete_nd=delete_nd, delete_suppress_ra=delete_suppress_ra, delete_suppress_ra_mtu=delete_suppress_ra_mtu, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
