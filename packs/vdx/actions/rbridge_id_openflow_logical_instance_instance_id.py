...
def rbridge_id_openflow_logical_instance_instance_id(**kwargs):
    """Auto Generated Code
    """
    ...
    instance_id = ET.SubElement(logical_instance, "instance-id")
...
class rbridge_id_openflow_logical_instance_instance_id_act(Action):
    def run(self, delete_openflow, rbridge_id, instance_id, delete_rbridge_id, delete_logical_instance, delete_instance_id, host, username, password):
