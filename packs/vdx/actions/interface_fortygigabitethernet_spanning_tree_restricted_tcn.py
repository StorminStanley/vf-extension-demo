...
def interface_fortygigabitethernet_spanning_tree_restricted_tcn(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_spanning_tree_restricted_tcn_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_restricted_tcn, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_spanning_tree_restricted_tcn(name=name, delete_name=delete_name, delete_restricted_tcn=delete_restricted_tcn, delete_spanning_tree=delete_spanning_tree, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
