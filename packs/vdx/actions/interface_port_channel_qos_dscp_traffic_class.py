...
def interface_port_channel_qos_dscp_traffic_class(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_qos_dscp_traffic_class_act(Action):
    def run(self, delete_dscp_traffic_class, delete_qos, name, dscp_traffic_class, delete_port_channel, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_qos_dscp_traffic_class(delete_qos=delete_qos, delete_name=delete_name, dscp_traffic_class=dscp_traffic_class, name=name, delete_port_channel=delete_port_channel, host=host, delete_dscp_traffic_class=delete_dscp_traffic_class, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
