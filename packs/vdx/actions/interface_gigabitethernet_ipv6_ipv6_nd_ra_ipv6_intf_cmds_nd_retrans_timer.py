...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_retrans_timer(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_retrans_timer_act(Action):
    def run(self, delete_retrans_timer, retrans_timer, delete_interface, delete_name, delete_nd, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_retrans_timer(name=name, delete_name=delete_name, retrans_timer=retrans_timer, delete_gigabitethernet=delete_gigabitethernet, delete_retrans_timer=delete_retrans_timer, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
