...
def interface_tengigabitethernet_switchport_private_vlan_mapping_promis_sec_pvlan_range(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_private_vlan_mapping_promis_sec_pvlan_range_act(Action):
    def run(self, delete_switchport, delete_mapping, name, delete_promis_pri_pvlan, delete_promis_sec_pvlan_range, promis_sec_pvlan_range, delete_private_vlan, delete_interface, delete_name, delete_tengigabitethernet, promis_pri_pvlan, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_private_vlan_mapping_promis_sec_pvlan_range(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_promis_sec_pvlan_range=delete_promis_sec_pvlan_range, delete_mapping=delete_mapping, delete_promis_pri_pvlan=delete_promis_pri_pvlan, promis_sec_pvlan_range=promis_sec_pvlan_range, host=host, delete_private_vlan=delete_private_vlan, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, promis_pri_pvlan=promis_pri_pvlan, password=password, callback=_callback, mgr=mgr)
        return 0
