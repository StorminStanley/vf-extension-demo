...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_maximum_prefix_threshold_holder_teardown(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_maximum_prefix_threshold_holder_teardown_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_teardown, delete_threshold_holder, delete_default_vrf, delete_rbridge_id, delete_maximum_prefix, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_maximum_prefix_threshold_holder_teardown(delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_teardown=delete_teardown, rbridge_id=rbridge_id, delete_router=delete_router, delete_maximum_prefix=delete_maximum_prefix, host=host, delete_threshold_holder=delete_threshold_holder, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
