...
def interface_hundredgigabitethernet_ipv6_vrrpv3_group_use_v2_checksum(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3_group_use_v2_checksum_act(Action):
