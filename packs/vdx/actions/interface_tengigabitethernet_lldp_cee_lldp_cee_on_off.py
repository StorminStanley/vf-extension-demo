...
def interface_tengigabitethernet_lldp_cee_lldp_cee_on_off(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_lldp_cee_lldp_cee_on_off_act(Action):
    def run(self, name, delete_cee, delete_lldp, delete_lldp_cee_on_off, delete_interface, delete_name, delete_tengigabitethernet, lldp_cee_on_off, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_lldp_cee_lldp_cee_on_off(name=name, delete_name=delete_name, delete_lldp=delete_lldp, username=username, delete_cee=delete_cee, delete_lldp_cee_on_off=delete_lldp_cee_on_off, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, lldp_cee_on_off=lldp_cee_on_off, password=password, callback=_callback, mgr=mgr)
        return 0
