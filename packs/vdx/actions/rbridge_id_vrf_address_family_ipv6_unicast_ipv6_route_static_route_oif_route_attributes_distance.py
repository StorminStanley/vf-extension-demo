...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_route_attributes_distance(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_route_attributes_distance_act(Action):
    def run(self, delete_static_route_oif, distance, delete_address_family, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_vrf, delete_static_route_oif_name, delete_route_attributes, delete_static_route_dest, vrf_name, delete_distance, static_route_dest, static_route_oif_name, delete_rbridge_id, delete_unicast, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_oif_route_attributes_distance(delete_route_attributes=delete_route_attributes, distance=distance, delete_address_family=delete_address_family, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, username=username, static_route_dest=static_route_dest, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_static_route_oif=delete_static_route_oif, delete_static_route_oif_type=delete_static_route_oif_type, host=host, delete_vrf_name=delete_vrf_name, static_route_oif_type=static_route_oif_type, static_route_oif_name=static_route_oif_name, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, delete_distance=delete_distance, delete_static_route_dest=delete_static_route_dest, password=password, callback=_callback, mgr=mgr)
        return 0
