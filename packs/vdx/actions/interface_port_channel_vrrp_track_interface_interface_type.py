...
def interface_port_channel_vrrp_track_interface_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_track_interface_interface_type_act(Action):
