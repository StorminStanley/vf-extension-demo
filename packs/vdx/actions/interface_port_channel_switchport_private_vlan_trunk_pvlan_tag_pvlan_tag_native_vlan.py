...
def interface_port_channel_switchport_private_vlan_trunk_pvlan_tag_pvlan_tag_native_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_private_vlan_trunk_pvlan_tag_pvlan_tag_native_vlan_act(Action):
    def run(self, delete_switchport, delete_pvlan_tag_native_vlan, name, delete_trunk, delete_port_channel, delete_private_vlan, delete_interface, delete_name, delete_pvlan_tag, host, username, password):
