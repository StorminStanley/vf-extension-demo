...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_interval_attributes_min_rx(**kwargs):
    """Auto Generated Code
    """
    ...
    min_rx = ET.SubElement(bfd_interval_attributes, "min-rx")
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_interval_attributes_min_rx_act(Action):
    def run(self, bfd_static_route_src, delete_bfd_interval_attributes, delete_address_family, delete_bfd_static_route_src, delete_bfd_static_route, rbridge_id, delete_ip, delete_route, delete_vrf, delete_bfd_static_route_dest, delete_static, bfd_static_route_dest, vrf_name, min_rx, delete_min_rx, delete_rbridge_id, delete_unicast, delete_bfd, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_interval_attributes_min_rx(delete_static=delete_static, delete_ip=delete_ip, delete_vrf_name=delete_vrf_name, bfd_static_route_dest=bfd_static_route_dest, delete_bfd_interval_attributes=delete_bfd_interval_attributes, delete_address_family=delete_address_family, rbridge_id=rbridge_id, vrf_name=vrf_name, delete_rbridge_id=delete_rbridge_id, password=password, delete_min_rx=delete_min_rx, delete_bfd_static_route_src=delete_bfd_static_route_src, delete_route=delete_route, delete_bfd=delete_bfd, delete_vrf=delete_vrf, delete_bfd_static_route=delete_bfd_static_route, username=username, min_rx=min_rx, bfd_static_route_src=bfd_static_route_src, host=host, delete_bfd_static_route_dest=delete_bfd_static_route_dest, delete_unicast=delete_unicast, callback=_callback, mgr=mgr)
        return 0
