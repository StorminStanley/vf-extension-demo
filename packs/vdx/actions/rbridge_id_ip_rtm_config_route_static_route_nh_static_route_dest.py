...
def rbridge_id_ip_rtm_config_route_static_route_nh_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_nh_static_route_dest_act(Action):
