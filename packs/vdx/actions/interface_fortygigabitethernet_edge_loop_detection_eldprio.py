...
def interface_fortygigabitethernet_edge_loop_detection_eldprio(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_edge_loop_detection_eldprio_act(Action):
    def run(self, name, delete_eldprio, delete_fortygigabitethernet, eldprio, delete_edge_loop_detection, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_edge_loop_detection_eldprio(eldprio=eldprio, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_edge_loop_detection=delete_edge_loop_detection, delete_eldprio=delete_eldprio, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
