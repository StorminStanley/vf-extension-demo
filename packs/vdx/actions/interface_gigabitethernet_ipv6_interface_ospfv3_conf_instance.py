...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_instance(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_instance_act(Action):
    def run(self, name, instance, delete_instance, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_instance(delete_instance=delete_instance, name=name, delete_name=delete_name, host=host, password=password, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, instance=instance, callback=_callback, mgr=mgr)
        return 0
