...
def protocol_spanning_tree_stp_port_channel_path_cost(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_stp_port_channel_path_cost_act(Action):
    def run(self, path_cost, delete_protocol, delete_path_cost, delete_stp, delete_port_channel, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_stp_port_channel_path_cost(delete_stp=delete_stp, path_cost=path_cost, delete_spanning_tree=delete_spanning_tree, delete_port_channel=delete_port_channel, delete_protocol=delete_protocol, delete_path_cost=delete_path_cost, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
