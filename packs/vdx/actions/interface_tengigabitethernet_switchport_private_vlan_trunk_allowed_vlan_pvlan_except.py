...
def interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_except(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_except_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_pvlan_except, delete_trunk, delete_private_vlan, delete_interface, delete_name, delete_tengigabitethernet, pvlan_except, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_except(name=name, delete_trunk=delete_trunk, pvlan_except=pvlan_except, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_pvlan_except=delete_pvlan_except, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_private_vlan=delete_private_vlan, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
