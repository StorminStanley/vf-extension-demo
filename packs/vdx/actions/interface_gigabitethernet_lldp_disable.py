...
def interface_gigabitethernet_lldp_disable(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_lldp_disable_act(Action):
    def run(self, delete_name, delete_lldp, delete_interface, delete_disable, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_lldp_disable(delete_disable=delete_disable, name=name, delete_name=delete_name, delete_lldp=delete_lldp, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
