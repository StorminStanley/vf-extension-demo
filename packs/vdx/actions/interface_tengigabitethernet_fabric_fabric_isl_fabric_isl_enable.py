...
def interface_tengigabitethernet_fabric_fabric_isl_fabric_isl_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_fabric_fabric_isl_fabric_isl_enable_act(Action):
    def run(self, name, delete_fabric_isl, delete_fabric_isl_enable, delete_fabric, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_fabric_fabric_isl_fabric_isl_enable(name=name, delete_fabric=delete_fabric, delete_fabric_isl=delete_fabric_isl, delete_fabric_isl_enable=delete_fabric_isl_enable, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
