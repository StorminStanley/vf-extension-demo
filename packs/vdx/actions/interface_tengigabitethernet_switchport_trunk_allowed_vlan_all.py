...
def interface_tengigabitethernet_switchport_trunk_allowed_vlan_all(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_trunk_allowed_vlan_all_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_interface, delete_name, delete_all, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_trunk_allowed_vlan_all(name=name, delete_trunk=delete_trunk, delete_all=delete_all, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
