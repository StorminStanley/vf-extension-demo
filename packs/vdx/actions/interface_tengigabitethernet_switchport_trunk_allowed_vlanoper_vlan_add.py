...
def interface_tengigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, add, delete_interface, delete_name, delete_add, delete_tengigabitethernet, delete_vlanoper, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add(delete_vlanoper=delete_vlanoper, name=name, delete_trunk=delete_trunk, delete_add=delete_add, delete_switchport=delete_switchport, delete_allowed=delete_allowed, add=add, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
