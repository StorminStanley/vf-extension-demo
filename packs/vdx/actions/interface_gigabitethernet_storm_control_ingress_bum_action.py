...
def interface_gigabitethernet_storm_control_ingress_bum_action(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_storm_control_ingress_bum_action_act(Action):
    def run(self, protocol_type, delete_storm_control, delete_ingress, delete_protocol_type, bum_action, delete_interface, delete_name, delete_bum_action, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_storm_control_ingress_bum_action(name=name, delete_name=delete_name, bum_action=bum_action, delete_storm_control=delete_storm_control, delete_bum_action=delete_bum_action, delete_ingress=delete_ingress, protocol_type=protocol_type, delete_protocol_type=delete_protocol_type, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
