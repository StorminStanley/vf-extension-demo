...
def interface_gigabitethernet_switchport_mode_private_vlan_host(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_mode_private_vlan_host_act(Action):
    def run(self, delete_switchport, delete_host, name, delete_gigabitethernet, delete_private_vlan, delete_interface, delete_name, delete_mode, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_mode_private_vlan_host(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_mode=delete_mode, delete_host=delete_host, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, delete_private_vlan=delete_private_vlan, callback=_callback, mgr=mgr)
        return 0
