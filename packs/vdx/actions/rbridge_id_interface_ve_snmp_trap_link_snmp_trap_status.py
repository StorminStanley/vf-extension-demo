...
def rbridge_id_interface_ve_snmp_trap_link_snmp_trap_status(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_snmp_trap_link_snmp_trap_status_act(Action):
    def run(self, name, delete_trap, delete_ve, delete_link_snmp_trap_status, delete_interface, delete_name, delete_snmp, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_snmp_trap_link_snmp_trap_status(name=name, delete_name=delete_name, delete_link_snmp_trap_status=delete_link_snmp_trap_status, username=username, rbridge_id=rbridge_id, delete_snmp=delete_snmp, delete_ve=delete_ve, host=host, delete_trap=delete_trap, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
