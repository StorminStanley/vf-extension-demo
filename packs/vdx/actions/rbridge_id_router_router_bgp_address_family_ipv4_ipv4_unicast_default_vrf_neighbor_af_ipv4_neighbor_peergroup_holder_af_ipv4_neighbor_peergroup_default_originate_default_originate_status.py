...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_default_originate_default_originate_status(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_default_originate_default_originate_status_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_default_originate_status, delete_default_vrf, delete_default_originate, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_default_originate_default_originate_status(delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_default_originate_status=delete_default_originate_status, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_default_originate=delete_default_originate, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
