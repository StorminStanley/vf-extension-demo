...
def interface_tengigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap_act(Action):
    def run(self, delete_tengigabitethernet, delete_hop_by_hop_trap, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap(delete_hop_by_hop_trap=delete_hop_by_hop_trap, delete_name=delete_name, name=name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
