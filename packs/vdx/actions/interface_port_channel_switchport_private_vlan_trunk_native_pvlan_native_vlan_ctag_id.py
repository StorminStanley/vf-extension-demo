...
def interface_port_channel_switchport_private_vlan_trunk_native_pvlan_native_vlan_ctag_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_private_vlan_trunk_native_pvlan_native_vlan_ctag_id_act(Action):
    def run(self, delete_switchport, delete_native, name, pvlan_native_vlan_ctag_id, delete_trunk, delete_port_channel, delete_pvlan_native_vlan_ctag_id, delete_private_vlan, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_private_vlan_trunk_native_pvlan_native_vlan_ctag_id(name=name, delete_native=delete_native, delete_switchport=delete_switchport, delete_name=delete_name, pvlan_native_vlan_ctag_id=pvlan_native_vlan_ctag_id, delete_port_channel=delete_port_channel, host=host, delete_pvlan_native_vlan_ctag_id=delete_pvlan_native_vlan_ctag_id, delete_private_vlan=delete_private_vlan, delete_trunk=delete_trunk, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
