...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_maximum_prefix_max_prefix_limit(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_max_prefix_limit', False) is True:
        delete_max_prefix_limit = config.find('.//*max-prefix-limit')
        delete_max_prefix_limit.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_maximum_prefix_max_prefix_limit_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_max_prefix_limit, max_prefix_limit, delete_rbridge_id, delete_maximum_prefix, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_maximum_prefix_max_prefix_limit(delete_maximum_prefix=delete_maximum_prefix, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, max_prefix_limit=max_prefix_limit, delete_max_prefix_limit=delete_max_prefix_limit, delete_neighbor=delete_neighbor, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
