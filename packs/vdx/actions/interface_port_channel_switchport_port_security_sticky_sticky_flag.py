...
def interface_port_channel_switchport_port_security_sticky_sticky_flag(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_port_security_sticky_sticky_flag_act(Action):
    def run(self, delete_switchport, delete_sticky_flag, name, delete_port_channel, delete_interface, delete_name, delete_sticky, delete_port_security, host, username, password):
