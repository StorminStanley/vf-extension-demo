...
def interface_fortygigabitethernet_dot1x_quiet_period(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_dot1x_quiet_period_act(Action):
    def run(self, name, delete_fortygigabitethernet, quiet_period, delete_interface, delete_name, delete_quiet_period, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_dot1x_quiet_period(name=name, delete_name=delete_name, delete_quiet_period=delete_quiet_period, host=host, quiet_period=quiet_period, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
