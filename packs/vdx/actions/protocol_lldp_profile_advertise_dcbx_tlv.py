...
def protocol_lldp_profile_advertise_dcbx_tlv(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_dcbx_tlv', False) is True:
        delete_dcbx_tlv = config.find('.//*dcbx-tlv')
        delete_dcbx_tlv.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class protocol_lldp_profile_advertise_dcbx_tlv_act(Action):
    def run(self, delete_profile_name, delete_protocol, delete_lldp, delete_dcbx_tlv, profile_name, delete_advertise, delete_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_profile_advertise_dcbx_tlv(delete_profile_name=delete_profile_name, profile_name=profile_name, delete_lldp=delete_lldp, username=username, delete_profile=delete_profile, delete_protocol=delete_protocol, password=password, host=host, delete_dcbx_tlv=delete_dcbx_tlv, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
