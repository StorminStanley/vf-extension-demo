...
def interface_fortygigabitethernet_ip_ip_config_address_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_ip_config_address_address_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_fortygigabitethernet, delete_interface, delete_name, address, delete_address, host, username, password):
