...
def rbridge_id_ssh_server_key_rsa(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_key_rsa_act(Action):
    def run(self, delete_rsa, rbridge_id, delete_server, rsa, delete_key, delete_ssh, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_key_rsa(delete_server=delete_server, username=username, rbridge_id=rbridge_id, delete_ssh=delete_ssh, delete_rsa=delete_rsa, host=host, rsa=rsa, delete_key=delete_key, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
