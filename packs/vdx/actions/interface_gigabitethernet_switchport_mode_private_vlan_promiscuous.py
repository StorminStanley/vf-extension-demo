...
def interface_gigabitethernet_switchport_mode_private_vlan_promiscuous(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_mode_private_vlan_promiscuous_act(Action):
    def run(self, delete_switchport, name, delete_gigabitethernet, delete_private_vlan, delete_interface, delete_name, delete_promiscuous, delete_mode, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_mode_private_vlan_promiscuous(name=name, delete_name=delete_name, delete_promiscuous=delete_promiscuous, delete_switchport=delete_switchport, delete_mode=delete_mode, delete_private_vlan=delete_private_vlan, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
