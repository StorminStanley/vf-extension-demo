...
def rbridge_id_ssh_server_key_exchange(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_key_exchange_act(Action):
    def run(self, key_exchange, rbridge_id, delete_server, delete_key_exchange, delete_ssh, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_key_exchange(delete_key_exchange=delete_key_exchange, delete_server=delete_server, key_exchange=key_exchange, username=username, rbridge_id=rbridge_id, delete_ssh=delete_ssh, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
