...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_cost(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_cost_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_cost, cost, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_cost(delete_cost=delete_cost, name=name, delete_name=delete_name, host=host, cost=cost, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
