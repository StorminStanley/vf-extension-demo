...
def interface_tengigabitethernet_storm_control_ingress_rate_format(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_storm_control_ingress_rate_format_act(Action):
    def run(self, rate_format, delete_storm_control, delete_rate_format, delete_ingress, delete_protocol_type, delete_interface, delete_name, delete_tengigabitethernet, protocol_type, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_storm_control_ingress_rate_format(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, rate_format=rate_format, delete_ingress=delete_ingress, protocol_type=protocol_type, delete_rate_format=delete_rate_format, host=host, delete_protocol_type=delete_protocol_type, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
