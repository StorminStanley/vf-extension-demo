...
def interface_hundredgigabitethernet_spanning_tree_edgeport_edgeportbasic(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_edgeport_edgeportbasic_act(Action):
    def run(self, name, delete_interface, delete_name, delete_edgeport, delete_hundredgigabitethernet, delete_edgeportbasic, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_edgeport_edgeportbasic(delete_edgeport=delete_edgeport, delete_edgeportbasic=delete_edgeportbasic, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_spanning_tree=delete_spanning_tree, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
