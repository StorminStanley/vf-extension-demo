...
def protocol_lldp_advertise_dot1_tlv(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_dot1_tlv', False) is True:
        delete_dot1_tlv = config.find('.//*dot1-tlv')
        delete_dot1_tlv.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class protocol_lldp_advertise_dot1_tlv_act(Action):
    def run(self, delete_advertise, delete_lldp, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_advertise_dot1_tlv(delete_lldp=delete_lldp, host=host, delete_advertise=delete_advertise, delete_protocol=delete_protocol, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
