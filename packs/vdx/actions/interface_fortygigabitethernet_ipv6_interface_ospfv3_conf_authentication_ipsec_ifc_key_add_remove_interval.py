...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval_act(Action):
    def run(self, delete_ifc_key_add_remove_interval, name, ifc_key_add_remove_interval, delete_fortygigabitethernet, delete_ipsec, delete_authentication, delete_name, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval(name=name, delete_ipsec=delete_ipsec, delete_name=delete_name, ifc_key_add_remove_interval=ifc_key_add_remove_interval, delete_authentication=delete_authentication, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ifc_key_add_remove_interval=delete_ifc_key_add_remove_interval, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
