...
def interface_hundredgigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer_act(Action):
    def run(self, delete_nd_advertisement_timer, name, delete_vrid, vrid, delete_interface, delete_name, delete_hundredgigabitethernet, nd_advertisement_timer, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_vrrpv3e_group_nd_advertisement_timer(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, nd_advertisement_timer=nd_advertisement_timer, host=host, vrid=vrid, delete_interface=delete_interface, delete_nd_advertisement_timer=delete_nd_advertisement_timer, password=password, callback=_callback, mgr=mgr)
        return 0
