...
def interface_hundredgigabitethernet_ipv6_policy_route_map_ipv6_route_map_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_policy_route_map_ipv6_route_map_name_act(Action):
    def run(self, name, delete_route_map, delete_policy, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
