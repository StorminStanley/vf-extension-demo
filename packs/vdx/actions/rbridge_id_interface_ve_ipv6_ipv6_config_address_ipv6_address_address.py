...
def rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_address_act(Action):
    def run(self, name, delete_ve, delete_interface, delete_name, address, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ipv6_ipv6_config_address_ipv6_address_address(name=name, delete_name=delete_name, address=address, username=username, rbridge_id=rbridge_id, delete_ve=delete_ve, host=host, delete_address=delete_address, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
