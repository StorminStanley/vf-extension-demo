...
def rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_next_hop_vrf(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_next_hop_vrf_act(Action):
    def run(self, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_static_route_next_vrf_dest, delete_next_hop_vrf, delete_route, next_hop_vrf, delete_static_route_oif_name, static_route_next_vrf_dest, delete_rbridge_id, static_route_oif_name, host, username, password):
