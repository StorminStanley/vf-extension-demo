...
def interface_fortygigabitethernet_ip_icmp_address_mask(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_icmp_address_mask_act(Action):
    def run(self, delete_address_mask, name, delete_ip, delete_fortygigabitethernet, delete_icmp, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_icmp_address_mask(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_address_mask=delete_address_mask, delete_ip=delete_ip, delete_icmp=delete_icmp, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
