...
def interface_hundredgigabitethernet_qos_random_detect_traffic_class_red_enable(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_red_enable', False) is True:
        delete_red_enable = config.find('.//*red-enable')
        delete_red_enable.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_hundredgigabitethernet_qos_random_detect_traffic_class_red_enable_act(Action):
    def run(self, delete_qos, delete_red_tc_value, name, red_tc_value, delete_traffic_class, delete_interface, delete_name, delete_red_enable, delete_hundredgigabitethernet, delete_random_detect, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_qos_random_detect_traffic_class_red_enable(delete_qos=delete_qos, delete_traffic_class=delete_traffic_class, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_name=delete_name, name=name, red_tc_value=red_tc_value, delete_red_enable=delete_red_enable, host=host, delete_random_detect=delete_random_detect, delete_red_tc_value=delete_red_tc_value, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
