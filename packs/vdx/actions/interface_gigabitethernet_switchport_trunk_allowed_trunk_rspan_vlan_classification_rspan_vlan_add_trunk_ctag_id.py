...
def interface_gigabitethernet_switchport_trunk_allowed_trunk_rspan_vlan_classification_rspan_vlan_add_trunk_ctag_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_allowed_trunk_rspan_vlan_classification_rspan_vlan_add_trunk_ctag_id_act(Action):
