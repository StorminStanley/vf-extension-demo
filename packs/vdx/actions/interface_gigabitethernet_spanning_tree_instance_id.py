...
def interface_gigabitethernet_spanning_tree_instance_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_instance_id_act(Action):
    def run(self, name, delete_id, id, delete_instance, delete_interface, delete_name, delete_spanning_tree, delete_gigabitethernet, host, username, password):
