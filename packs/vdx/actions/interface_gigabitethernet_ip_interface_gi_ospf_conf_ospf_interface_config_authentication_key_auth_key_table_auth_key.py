...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_auth_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_auth_key_act(Action):
    def run(self, auth_key, name, delete_ip, delete_interface_gi_ospf_conf, delete_auth_key, delete_interface, delete_name, delete_auth_key_table, delete_authentication_key, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_auth_key(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, name=name, auth_key=auth_key, delete_auth_key=delete_auth_key, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_authentication_key=delete_authentication_key, delete_auth_key_table=delete_auth_key_table, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
