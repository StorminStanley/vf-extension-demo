...
def interface_fortygigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local_act(Action):
    def run(self, delete_link_local_config, name, delete_fortygigabitethernet, delete_interface, delete_name, delete_address, delete_link_local, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local(name=name, delete_name=delete_name, delete_link_local=delete_link_local, host=host, delete_link_local_config=delete_link_local_config, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_address=delete_address, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
