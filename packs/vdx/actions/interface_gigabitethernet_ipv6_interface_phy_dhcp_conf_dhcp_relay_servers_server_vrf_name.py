...
def interface_gigabitethernet_ipv6_interface_phy_dhcp_conf_dhcp_relay_servers_server_vrf_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_phy_dhcp_conf_dhcp_relay_servers_server_vrf_name_act(Action):
    def run(self, name, delete_servers, server_vrf_name, relay_ip_addr, delete_dhcp, delete_relay, delete_interface, delete_name, delete_interface_phy_dhcp_conf, delete_server_vrf_name, delete_relay_ip_addr, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_phy_dhcp_conf_dhcp_relay_servers_server_vrf_name(relay_ip_addr=relay_ip_addr, name=name, delete_name=delete_name, delete_relay=delete_relay, username=username, delete_interface_phy_dhcp_conf=delete_interface_phy_dhcp_conf, delete_dhcp=delete_dhcp, server_vrf_name=server_vrf_name, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, delete_servers=delete_servers, delete_relay_ip_addr=delete_relay_ip_addr, password=password, delete_server_vrf_name=delete_server_vrf_name, callback=_callback, mgr=mgr)
        return 0
