...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_broadcast_mac_trap', False) is True:
        delete_broadcast_mac_trap = config.find('.//*broadcast-mac-trap')
        delete_broadcast_mac_trap.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap_act(Action):
    def run(self, name, delete_broadcast_mac_trap, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_broadcast_mac_trap(name=name, delete_name=delete_name, delete_broadcast_mac_trap=delete_broadcast_mac_trap, delete_tengigabitethernet=delete_tengigabitethernet, delete_nd=delete_nd, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
