...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_max_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_max_interval_act(Action):
    def run(self, name, delete_ra_interval, delete_max_interval, max_interval, delete_interface, delete_name, delete_nd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_interval_max_interval(name=name, delete_name=delete_name, delete_max_interval=delete_max_interval, delete_ra_interval=delete_ra_interval, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_nd=delete_nd, max_interval=max_interval, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
