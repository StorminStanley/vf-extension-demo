...
def interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_interval_act(Action):
    def run(self, last_member_query_interval, name, delete_ip, delete_last_member_query_interval, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_interval(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, last_member_query_interval=last_member_query_interval, delete_igmp=delete_igmp, delete_ip=delete_ip, delete_last_member_query_interval=delete_last_member_query_interval, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
