...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_summary_only(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_summary_only_act(Action):
    def run(self, delete_address_family, delete_router_bgp, aggregate_ip_prefix, delete_aggregate_ip_prefix, delete_rbridge_id, delete_summary_only, delete_router, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_summary_only(aggregate_ip_prefix=aggregate_ip_prefix, delete_router_bgp=delete_router_bgp, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_summary_only=delete_summary_only, host=host, delete_aggregate_ip_prefix=delete_aggregate_ip_prefix, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
