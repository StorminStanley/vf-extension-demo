...
def rbridge_id_interface_ve_vrrp_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrp_preempt_mode_act(Action):
    def run(self, name, delete_vrid, vrid, delete_preempt_mode, delete_version, delete_ve, version, delete_interface, delete_name, delete_vrrp, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrp_preempt_mode(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, version=version, delete_ve=delete_ve, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
