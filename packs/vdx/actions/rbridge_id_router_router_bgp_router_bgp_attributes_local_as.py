...
def rbridge_id_router_router_bgp_router_bgp_attributes_local_as(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_local_as_act(Action):
    def run(self, delete_router_bgp, rbridge_id, local_as, delete_router_bgp_attributes, delete_local_as, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_local_as(local_as=local_as, delete_local_as=delete_local_as, username=username, rbridge_id=rbridge_id, delete_router=delete_router, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
