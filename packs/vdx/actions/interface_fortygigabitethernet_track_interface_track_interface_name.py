...
def interface_fortygigabitethernet_track_interface_track_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_track_interface_track_interface_name_act(Action):
    def run(self, delete_track_interface_name, name, track_interface_type, track_interface_name, delete_fortygigabitethernet, delete_interface, delete_name, delete_track_interface_type, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_track_interface_track_interface_name(track_interface_type=track_interface_type, delete_track_interface_type=delete_track_interface_type, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_track=delete_track, delete_track_interface_name=delete_track_interface_name, track_interface_name=track_interface_name, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
