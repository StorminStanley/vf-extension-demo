...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_maximum_paths_use_load_sharing(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_maximum_paths_use_load_sharing_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_maximum_paths, delete_rbridge_id, delete_use_load_sharing, delete_router, host, username, password):
