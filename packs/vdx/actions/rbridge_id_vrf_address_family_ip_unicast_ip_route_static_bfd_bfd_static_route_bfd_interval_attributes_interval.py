...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_interval_attributes_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_bfd_bfd_static_route_bfd_interval_attributes_interval_act(Action):
    def run(self, bfd_static_route_src, delete_bfd_interval_attributes, delete_address_family, delete_bfd_static_route_src, delete_bfd_static_route, rbridge_id, delete_ip, delete_route, delete_vrf, delete_bfd_static_route_dest, delete_static, bfd_static_route_dest, interval, delete_interval, vrf_name, delete_rbridge_id, delete_unicast, delete_bfd, delete_vrf_name, host, username, password):
