...
def rbridge_id_ipv6_route_link_local_static_route_nh_link_local_static_route_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_link_local_static_route_nh_link_local_static_route_dest_act(Action):
    def run(self, delete_link_local_static_route_nh, link_local_route_oif_name, rbridge_id, link_local_nexthop, delete_link_local_route_oif_name, delete_route, delete_link_local_route_oif_type, delete_link_local_static_route_dest, delete_link_local_nexthop, delete_rbridge_id, link_local_static_route_dest, link_local_route_oif_type, host, username, password):
