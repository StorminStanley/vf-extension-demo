...
def rbridge_id_threshold_monitor_security_policy_area_alert_below_sec_below_highthresh_action(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_security_policy_area_alert_below_sec_below_highthresh_action_act(Action):
    def run(self, delete_sec_policy_name, sec_policy_name, sec_area_value, delete_policy, sec_below_highthresh_action, delete_security, delete_alert, delete_area, delete_sec_below_highthresh_action, delete_threshold_monitor, delete_below, delete_rbridge_id, delete_sec_area_value, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_security_policy_area_alert_below_sec_below_highthresh_action(sec_area_value=sec_area_value, username=username, delete_area=delete_area, delete_below=delete_below, delete_threshold_monitor=delete_threshold_monitor, sec_policy_name=sec_policy_name, delete_sec_policy_name=delete_sec_policy_name, delete_sec_area_value=delete_sec_area_value, sec_below_highthresh_action=sec_below_highthresh_action, delete_policy=delete_policy, delete_alert=delete_alert, host=host, delete_sec_below_highthresh_action=delete_sec_below_highthresh_action, delete_rbridge_id=delete_rbridge_id, delete_security=delete_security, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
