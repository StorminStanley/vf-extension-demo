...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_retransmit_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_retransmit_interval_act(Action):
    def run(self, retransmit_interval, name, delete_ip, delete_retransmit_interval, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
