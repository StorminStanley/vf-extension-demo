...
def rbridge_id_http_server_http_vrf_cont_use_vrf_use_vrf_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_http_server_http_vrf_cont_use_vrf_use_vrf_name_act(Action):
    def run(self, delete_use_vrf, use_vrf_name, rbridge_id, delete_http_vrf_cont, delete_use_vrf_name, delete_server, delete_rbridge_id, delete_http, host, username, password):
