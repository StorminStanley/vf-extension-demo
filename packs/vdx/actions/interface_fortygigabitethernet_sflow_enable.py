...
def interface_fortygigabitethernet_sflow_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_sflow_enable_act(Action):
    def run(self, delete_sflow, name, delete_fortygigabitethernet, delete_enable, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_sflow_enable(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_sflow=delete_sflow, delete_enable=delete_enable, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
