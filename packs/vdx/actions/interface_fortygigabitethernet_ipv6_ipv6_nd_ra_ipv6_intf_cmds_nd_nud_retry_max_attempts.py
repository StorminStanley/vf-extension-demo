...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_max_attempts(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_max_attempts_act(Action):
    def run(self, name, delete_nud, delete_fortygigabitethernet, delete_interface, delete_name, delete_nd, delete_max_attempts, delete_retry, max_attempts, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_max_attempts(delete_retry=delete_retry, name=name, delete_name=delete_name, max_attempts=max_attempts, delete_nud=delete_nud, delete_max_attempts=delete_max_attempts, host=host, delete_nd=delete_nd, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
