...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_onlink(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_onlink_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_no_onlink, delete_interface, delete_name, delete_prefix_flags, delete_hundredgigabitethernet, delete_lifetime, delete_nd, name, host, username, password):
