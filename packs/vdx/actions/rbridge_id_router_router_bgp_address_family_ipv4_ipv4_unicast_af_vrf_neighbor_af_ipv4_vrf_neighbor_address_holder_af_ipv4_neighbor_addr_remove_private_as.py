...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_remove_private_as(**kwargs):
    """Auto Generated Code
    """
    ...
    remove_private_as = ET.SubElement(af_ipv4_neighbor_addr, "remove-private-as")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_remove_private_as_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_remove_private_as, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
