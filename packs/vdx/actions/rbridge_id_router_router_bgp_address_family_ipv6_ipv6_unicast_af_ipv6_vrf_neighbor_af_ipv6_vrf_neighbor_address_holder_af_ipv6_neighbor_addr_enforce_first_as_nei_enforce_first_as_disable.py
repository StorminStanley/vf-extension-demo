...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_enforce_first_as_nei_enforce_first_as_disable(**kwargs):
    """Auto Generated Code
    """
    ...
    enforce_first_as = ET.SubElement(af_ipv6_neighbor_addr, "enforce-first-as")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_enforce_first_as_nei_enforce_first_as_disable_act(Action):
    def run(self, delete_address_family, delete_enforce_first_as, delete_router_bgp, rbridge_id, delete_nei_enforce_first_as_disable, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_enforce_first_as_nei_enforce_first_as_disable(delete_enforce_first_as=delete_enforce_first_as, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_router=delete_router, rbridge_id=rbridge_id, delete_nei_enforce_first_as_disable=delete_nei_enforce_first_as_disable, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
