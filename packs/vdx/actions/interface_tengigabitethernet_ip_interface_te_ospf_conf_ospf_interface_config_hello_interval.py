...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_hello_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_hello_interval_act(Action):
    def run(self, delete_interface_te_ospf_conf, name, delete_ip, delete_interface, delete_name, delete_hello_interval, delete_tengigabitethernet, hello_interval, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_hello_interval(name=name, delete_name=delete_name, hello_interval=hello_interval, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_hello_interval=delete_hello_interval, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, password=password, callback=_callback, mgr=mgr)
        return 0
