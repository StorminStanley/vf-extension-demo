...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_act(Action):
    def run(self, delete_direction_in, delete_address_family, delete_router_bgp, rbridge_id, delete_prefix_list_direction_in, delete_prefix_list, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
