...
def rbridge_id_route_map_content_match_extcommunity_extcommunity_num(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_extcommunity_extcommunity_num_act(Action):
    def run(self, rbridge_id, delete_match, delete_route_map, delete_content, delete_extcommunity, instance, delete_instance, action_rm, delete_extcommunity_num, delete_name, delete_rbridge_id, extcommunity_num, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_extcommunity_extcommunity_num(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_extcommunity_num=delete_extcommunity_num, host=host, delete_match=delete_match, delete_extcommunity=delete_extcommunity, delete_name=delete_name, extcommunity_num=extcommunity_num, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
