...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ibgp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ibgp_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_maximum_paths, delete_ibgp, ibgp, delete_af_common_cmds_holder, delete_default_vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ibgp(ibgp=ibgp, delete_router_bgp=delete_router_bgp, delete_maximum_paths=delete_maximum_paths, username=username, delete_default_vrf=delete_default_vrf, rbridge_id=rbridge_id, delete_router=delete_router, delete_af_common_cmds_holder=delete_af_common_cmds_holder, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_ibgp=delete_ibgp, password=password, callback=_callback, mgr=mgr)
        return 0
