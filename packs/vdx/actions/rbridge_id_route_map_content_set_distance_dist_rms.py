...
def rbridge_id_route_map_content_set_distance_dist_rms(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_distance_dist_rms_act(Action):
    def run(self, delete_distance, rbridge_id, delete_set, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_dist_rms, delete_rbridge_id, dist_rms, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_distance_dist_rms(delete_instance=delete_instance, delete_dist_rms=delete_dist_rms, name=name, action_rm=action_rm, username=username, delete_action_rm=delete_action_rm, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, dist_rms=dist_rms, delete_name=delete_name, delete_distance=delete_distance, instance=instance, callback=_callback, mgr=mgr)
        return 0
