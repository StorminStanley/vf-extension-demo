...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_flag_ebgp_multihop_flag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_flag_ebgp_multihop_flag_act(Action):
    def run(self, router_bgp_neighbor_address, delete_ch_ebgp_multihop_type, delete_router_bgp, rbridge_id, delete_neighbor_addr, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, delete_neighbor_ips, delete_ebgp_multihop, delete_ebgp_multihop_flag, delete_rbridge_id, delete_neighbor, delete_router, delete_ca_ebgp_multihop_flag, host, username, password):
