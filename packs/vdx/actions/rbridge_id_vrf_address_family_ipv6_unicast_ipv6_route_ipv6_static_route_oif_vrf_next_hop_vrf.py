...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_ipv6_static_route_oif_vrf_next_hop_vrf(**kwargs):
    """Auto Generated Code
    """
    ...
    static_route_oif_type_key = ET.SubElement(ipv6_static_route_oif_vrf, "static-route-oif-type")
    ...
    next_hop_vrf = ET.SubElement(ipv6_static_route_oif_vrf, "next-hop-vrf")
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_ipv6_static_route_oif_vrf_next_hop_vrf_act(Action):
    def run(self, delete_address_family, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_vrf, delete_static_route_next_vrf_dest, next_hop_vrf, delete_static_route_oif_name, vrf_name, delete_next_hop_vrf, static_route_next_vrf_dest, delete_rbridge_id, delete_unicast, static_route_oif_name, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_ipv6_static_route_oif_vrf_next_hop_vrf(delete_address_family=delete_address_family, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, username=username, static_route_next_vrf_dest=static_route_next_vrf_dest, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_next_hop_vrf=delete_next_hop_vrf, delete_vrf=delete_vrf, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, delete_static_route_oif_type=delete_static_route_oif_type, host=host, delete_vrf_name=delete_vrf_name, static_route_oif_type=static_route_oif_type, next_hop_vrf=next_hop_vrf, delete_unicast=delete_unicast, static_route_oif_name=static_route_oif_name, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
