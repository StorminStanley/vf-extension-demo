...
def rbridge_id_route_map_content_set_route_type_route_type_rms(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_route_type_route_type_rms_act(Action):
    def run(self, rbridge_id, delete_set, delete_route_type_rms, delete_route_map, delete_content, delete_route_type, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, route_type_rms, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_route_type_route_type_rms(delete_route_type=delete_route_type, delete_instance=delete_instance, route_type_rms=route_type_rms, action_rm=action_rm, username=username, delete_action_rm=delete_action_rm, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, name=name, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_route_type_rms=delete_route_type_rms, instance=instance, callback=_callback, mgr=mgr)
        return 0
