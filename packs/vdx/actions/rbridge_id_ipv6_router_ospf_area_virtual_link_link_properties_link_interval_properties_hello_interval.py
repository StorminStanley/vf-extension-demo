...
def rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_link_interval_properties_hello_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_link_interval_properties_hello_interval_act(Action):
    def run(self, area_id, delete_virtual_link, rbridge_id, hello_interval, delete_ospf, delete_vrf, delete_area_id, delete_virtual_link_neighbor, virtual_link_neighbor, delete_area, vrf, delete_link_properties, delete_link_interval_properties, delete_hello_interval, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_link_interval_properties_hello_interval(username=username, delete_area=delete_area, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_hello_interval=delete_hello_interval, password=password, delete_link_interval_properties=delete_link_interval_properties, delete_router=delete_router, hello_interval=hello_interval, host=host, delete_virtual_link_neighbor=delete_virtual_link_neighbor, vrf=vrf, delete_ospf=delete_ospf, delete_link_properties=delete_link_properties, delete_rbridge_id=delete_rbridge_id, delete_virtual_link=delete_virtual_link, virtual_link_neighbor=virtual_link_neighbor, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
