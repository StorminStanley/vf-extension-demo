...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_flag(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_flag_act(Action):
    def run(self, name, delete_suppress_ra, delete_name, delete_suppress_ra_flag, delete_nd, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_suppress_ra_suppress_ra_flag(name=name, delete_name=delete_name, delete_gigabitethernet=delete_gigabitethernet, delete_suppress_ra_flag=delete_suppress_ra_flag, delete_nd=delete_nd, host=host, delete_suppress_ra=delete_suppress_ra, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
