...
def interface_fortygigabitethernet_switchport_trunk_allowed_vlan_remove(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_allowed_vlan_remove_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_fortygigabitethernet, remove, delete_interface, delete_name, delete_remove, host, username, password):
