...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ebgp(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ebgp', False) is True:
        delete_ebgp = config.find('.//*ebgp')
        delete_ebgp.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ebgp_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_maximum_paths, delete_ebgp, ebgp, delete_af_common_cmds_holder, delete_default_vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_maximum_paths_ebgp(delete_router_bgp=delete_router_bgp, delete_maximum_paths=delete_maximum_paths, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_ebgp=delete_ebgp, delete_af_common_cmds_holder=delete_af_common_cmds_holder, delete_router=delete_router, host=host, ebgp=ebgp, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
