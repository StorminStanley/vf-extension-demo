...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_soft_reconfiguration_inbound(**kwargs):
    """Auto Generated Code
    """
    ...
    soft_reconfiguration = ET.SubElement(af_ipv4_neighbor_addr, "soft-reconfiguration")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_soft_reconfiguration_inbound_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_inbound, delete_soft_reconfiguration, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_soft_reconfiguration_inbound(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, host=host, delete_soft_reconfiguration=delete_soft_reconfiguration, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_inbound=delete_inbound, password=password, callback=_callback, mgr=mgr)
        return 0
