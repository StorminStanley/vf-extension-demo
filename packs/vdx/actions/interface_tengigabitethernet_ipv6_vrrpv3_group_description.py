...
def interface_tengigabitethernet_ipv6_vrrpv3_group_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3_group_description_act(Action):
