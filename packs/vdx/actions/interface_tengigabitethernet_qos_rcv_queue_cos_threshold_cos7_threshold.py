...
def interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos7_threshold(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_cos7_threshold', False) is True:
        delete_cos7_threshold = config.find('.//*cos7-threshold')
        delete_cos7_threshold.set('operation', 'delete')
...
class interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos7_threshold_act(Action):
    def run(self, delete_qos, name, delete_rcv_queue, delete_interface, delete_name, delete_tengigabitethernet, delete_cos_threshold, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos7_threshold(delete_qos=delete_qos, delete_name=delete_name, name=name, delete_tengigabitethernet=delete_tengigabitethernet, password=password, host=host, delete_interface=delete_interface, username=username, delete_rcv_queue=delete_rcv_queue, delete_cos_threshold=delete_cos_threshold, callback=_callback, mgr=mgr)
        return 0
