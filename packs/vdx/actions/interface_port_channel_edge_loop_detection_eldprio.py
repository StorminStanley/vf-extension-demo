...
def interface_port_channel_edge_loop_detection_eldprio(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_edge_loop_detection_eldprio_act(Action):
    def run(self, name, delete_eldprio, eldprio, delete_edge_loop_detection, delete_port_channel, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_edge_loop_detection_eldprio(eldprio=eldprio, name=name, delete_name=delete_name, delete_edge_loop_detection=delete_edge_loop_detection, delete_eldprio=delete_eldprio, delete_port_channel=delete_port_channel, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
