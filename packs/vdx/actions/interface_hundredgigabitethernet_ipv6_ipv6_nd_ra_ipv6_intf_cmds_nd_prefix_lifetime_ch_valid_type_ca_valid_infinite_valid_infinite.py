...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_valid_infinite_valid_infinite(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_valid_infinite_valid_infinite_act(Action):
    def run(self, delete_prefix, delete_ch_valid_type, delete_interface, delete_name, delete_valid_infinite, delete_hundredgigabitethernet, delete_lifetime, delete_nd, delete_ca_valid_infinite, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_ch_valid_type_ca_valid_infinite_valid_infinite(delete_valid_infinite=delete_valid_infinite, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_lifetime=delete_lifetime, delete_ca_valid_infinite=delete_ca_valid_infinite, host=host, delete_nd=delete_nd, delete_prefix=delete_prefix, delete_ch_valid_type=delete_ch_valid_type, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
