...
def interface_port_channel_vlan_classifier_activate_group_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vlan_classifier_activate_group_vlan_act(Action):
    def run(self, delete_vlan, delete_classifier, name, delete_group, vlan, delete_activate, delete_port_channel, delete_interface, delete_name, delete_groupid, groupid, host, username, password):
