...
def interface_tengigabitethernet_spanning_tree_cost(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_spanning_tree_cost_act(Action):
    def run(self, name, delete_cost, cost, delete_interface, delete_name, delete_tengigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_spanning_tree_cost(delete_cost=delete_cost, name=name, delete_name=delete_name, delete_spanning_tree=delete_spanning_tree, delete_tengigabitethernet=delete_tengigabitethernet, cost=cost, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
