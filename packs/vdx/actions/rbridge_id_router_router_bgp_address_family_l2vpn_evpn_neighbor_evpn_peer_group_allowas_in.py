...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_allowas_in(**kwargs):
    """Auto Generated Code
    """
    ...
    allowas_in = ET.SubElement(evpn_peer_group, "allowas-in")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_allowas_in_act(Action):
    def run(self, delete_evpn_neighbor_peergroup_name, delete_address_family, delete_router_bgp, rbridge_id, allowas_in, delete_evpn, delete_allowas_in, evpn_neighbor_peergroup_name, delete_evpn_peer_group, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_peer_group_allowas_in(delete_address_family=delete_address_family, username=username, delete_evpn=delete_evpn, evpn_neighbor_peergroup_name=evpn_neighbor_peergroup_name, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, delete_allowas_in=delete_allowas_in, host=host, delete_evpn_peer_group=delete_evpn_peer_group, delete_router_bgp=delete_router_bgp, allowas_in=allowas_in, delete_rbridge_id=delete_rbridge_id, delete_evpn_neighbor_peergroup_name=delete_evpn_neighbor_peergroup_name, password=password, callback=_callback, mgr=mgr)
        return 0
