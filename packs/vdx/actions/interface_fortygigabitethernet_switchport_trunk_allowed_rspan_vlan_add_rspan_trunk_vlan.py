...
def interface_fortygigabitethernet_switchport_trunk_allowed_rspan_vlan_add_rspan_trunk_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_allowed_rspan_vlan_add_rspan_trunk_vlan_act(Action):
    def run(self, delete_switchport, delete_allowed, delete_rspan_vlan, name, delete_trunk, delete_fortygigabitethernet, delete_add_rspan_trunk_vlan, add_rspan_trunk_vlan, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_trunk_allowed_rspan_vlan_add_rspan_trunk_vlan(delete_add_rspan_trunk_vlan=delete_add_rspan_trunk_vlan, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, add_rspan_trunk_vlan=add_rspan_trunk_vlan, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_name=delete_name, delete_rspan_vlan=delete_rspan_vlan, host=host, delete_trunk=delete_trunk, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
