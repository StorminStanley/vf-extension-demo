...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_timers_nei_keep_alive(**kwargs):
    """Auto Generated Code
    """
    ...
    timers = ET.SubElement(af_ipv4_neighbor_addr, "timers")
    ...
    if kwargs.pop('delete_nei_keep_alive', False) is True:
        delete_nei_keep_alive = config.find('.//*nei-keep-alive')
        delete_nei_keep_alive.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_timers_nei_keep_alive_act(Action):
    def run(self, nei_keep_alive, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_timers, delete_rbridge_id, delete_neighbor, delete_router, delete_nei_keep_alive, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_timers_nei_keep_alive(delete_address_family=delete_address_family, delete_nei_keep_alive=delete_nei_keep_alive, username=username, af_vrf_name=af_vrf_name, nei_keep_alive=nei_keep_alive, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, password=password, delete_af_vrf=delete_af_vrf, delete_rbridge_id=delete_rbridge_id, delete_timers=delete_timers, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
