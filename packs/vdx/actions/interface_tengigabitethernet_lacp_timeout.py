...
def interface_tengigabitethernet_lacp_agtimeout(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_lacp_agtimeout_act(Action):
    def run(self, name, delete_lacp, delete_agtimeout, delete_interface, delete_name, delete_tengigabitethernet, host, username, password, agtimeout_ag):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_lacp_agtimeout(agtimeout_ag=agtimeout_ag, name=name, delete_name=delete_name, delete_agtimeout=delete_agtimeout, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_lacp=delete_lacp, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
