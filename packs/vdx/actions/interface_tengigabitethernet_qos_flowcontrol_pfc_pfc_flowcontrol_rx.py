...
def interface_tengigabitethernet_qos_flowcontrol_pfc_pfc_flowcontrol_rx(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_flowcontrol_pfc_pfc_flowcontrol_rx_act(Action):
    def run(self, delete_qos, pfc_flowcontrol_rx, name, pfc_cos, delete_pfc_flowcontrol_rx, delete_pfc, delete_flowcontrol, delete_interface, delete_name, delete_tengigabitethernet, delete_pfc_cos, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_qos_flowcontrol_pfc_pfc_flowcontrol_rx(delete_pfc_flowcontrol_rx=delete_pfc_flowcontrol_rx, delete_qos=delete_qos, pfc_cos=pfc_cos, delete_flowcontrol=delete_flowcontrol, name=name, password=password, pfc_flowcontrol_rx=pfc_flowcontrol_rx, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_pfc_cos=delete_pfc_cos, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_pfc=delete_pfc, callback=_callback, mgr=mgr)
        return 0
