...
def interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_ipv6_gw_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_ipv6_gw_id_act(Action):
    def run(self, delete_interface_vlan, gve_name, delete_interface, delete_ve, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_ipv6_gw_id(delete_gve_name=delete_gve_name, gve_name=gve_name, delete_ve=delete_ve, host=host, delete_interface_vlan=delete_interface_vlan, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
