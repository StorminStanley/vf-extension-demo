...
def rbridge_id_ipv6_prefix_list_ipv6_prefix_ipp(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ipv6_prefix_ipp', False) is True:
        delete_ipv6_prefix_ipp = config.find('.//*ipv6-prefix-ipp')
        delete_ipv6_prefix_ipp.set('operation', 'delete')
...
class rbridge_id_ipv6_prefix_list_ipv6_prefix_ipp_act(Action):
