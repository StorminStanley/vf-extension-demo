...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ns_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ns_interval_act(Action):
    def run(self, delete_ns_interval, name, ns_interval, delete_interface, delete_name, delete_hundredgigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ns_interval(delete_ns_interval=delete_ns_interval, delete_name=delete_name, ns_interval=ns_interval, name=name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
