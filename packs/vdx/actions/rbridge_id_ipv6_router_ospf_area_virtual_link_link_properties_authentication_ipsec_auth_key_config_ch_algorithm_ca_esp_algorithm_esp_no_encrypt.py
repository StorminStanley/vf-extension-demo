...
def rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_no_encrypt(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_no_encrypt_act(Action):
    def run(self, delete_ca_esp_algorithm, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_virtual_link_neighbor, virtual_link_neighbor, delete_ipsec_auth_key_config, delete_area, vrf, delete_link_properties, delete_esp_no_encrypt, delete_rbridge_id, delete_ch_algorithm, delete_router, delete_authentication, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_no_encrypt(delete_ca_esp_algorithm=delete_ca_esp_algorithm, username=username, delete_area=delete_area, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_authentication=delete_authentication, password=password, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_esp_no_encrypt=delete_esp_no_encrypt, delete_router=delete_router, delete_ospf=delete_ospf, host=host, delete_virtual_link_neighbor=delete_virtual_link_neighbor, vrf=vrf, delete_link_properties=delete_link_properties, delete_rbridge_id=delete_rbridge_id, delete_virtual_link=delete_virtual_link, virtual_link_neighbor=virtual_link_neighbor, delete_area_id=delete_area_id, delete_ch_algorithm=delete_ch_algorithm, callback=_callback, mgr=mgr)
        return 0
