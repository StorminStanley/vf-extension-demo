...
def interface_port_channel_ipv6_access_group_traffic_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_access_group_traffic_type_act(Action):
    def run(self, name, delete_ip_direction, delete_port_channel, delete_access_group, delete_name, delete_traffic_type, ip_direction, traffic_type, delete_interface, host, username, password):
