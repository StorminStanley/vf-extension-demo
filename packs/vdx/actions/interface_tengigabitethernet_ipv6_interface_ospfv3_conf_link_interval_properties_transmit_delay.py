...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_transmit_delay(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_transmit_delay_act(Action):
    def run(self, delete_transmit_delay, name, delete_interface, delete_name, delete_link_interval_properties, delete_tengigabitethernet, transmit_delay, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_transmit_delay(name=name, delete_name=delete_name, delete_link_interval_properties=delete_link_interval_properties, delete_tengigabitethernet=delete_tengigabitethernet, host=host, transmit_delay=transmit_delay, delete_transmit_delay=delete_transmit_delay, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
