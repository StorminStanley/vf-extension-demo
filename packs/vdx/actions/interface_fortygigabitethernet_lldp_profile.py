...
def interface_fortygigabitethernet_lldp_profile(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_lldp_profile_act(Action):
    def run(self, profile, delete_fortygigabitethernet, name, delete_lldp, delete_interface, delete_name, delete_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_lldp_profile(profile=profile, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_lldp=delete_lldp, delete_profile=delete_profile, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
