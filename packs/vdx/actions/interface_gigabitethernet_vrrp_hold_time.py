...
def interface_gigabitethernet_vrrp_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_hold_time_act(Action):
    def run(self, name, delete_vrid, delete_hold_time, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, hold_time, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_hold_time(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, version=version, delete_gigabitethernet=delete_gigabitethernet, host=host, vrid=vrid, hold_time=hold_time, delete_name=delete_name, delete_hold_time=delete_hold_time, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
