...
def rbridge_id_threshold_monitor_Cpu_actions(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_Cpu_actions_act(Action):
    def run(self, rbridge_id, actions, delete_actions, delete_Cpu, delete_threshold_monitor, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_Cpu_actions(username=username, delete_threshold_monitor=delete_threshold_monitor, actions=actions, rbridge_id=rbridge_id, delete_actions=delete_actions, host=host, delete_Cpu=delete_Cpu, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
