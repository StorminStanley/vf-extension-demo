...
def rbridge_id_evpn_instance_route_target_imprt_target_community(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_evpn_instance_route_target_imprt_target_community_act(Action):
    def run(self, delete_evpn_instance, rbridge_id, target_community, delete_target_community, delete_instance_name, instance_name, delete_imprt, delete_rbridge_id, delete_route_target, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_evpn_instance_route_target_imprt_target_community(delete_target_community=delete_target_community, delete_route_target=delete_route_target, delete_evpn_instance=delete_evpn_instance, instance_name=instance_name, username=username, rbridge_id=rbridge_id, delete_imprt=delete_imprt, delete_instance_name=delete_instance_name, host=host, target_community=target_community, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
