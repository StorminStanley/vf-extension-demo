...
def interface_gigabitethernet_switchport_trunk_native_vlan_untagged_config_native_vlan_id_untagged(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_native_vlan_untagged_config_native_vlan_id_untagged_act(Action):
    def run(self, delete_switchport, name, native_vlan_id_untagged, delete_trunk, delete_native_vlan_id_untagged, delete_interface, delete_name, delete_native_vlan_untagged_config, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_trunk_native_vlan_untagged_config_native_vlan_id_untagged(name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, delete_name=delete_name, delete_native_vlan_id_untagged=delete_native_vlan_id_untagged, delete_native_vlan_untagged_config=delete_native_vlan_untagged_config, host=host, delete_gigabitethernet=delete_gigabitethernet, native_vlan_id_untagged=native_vlan_id_untagged, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
