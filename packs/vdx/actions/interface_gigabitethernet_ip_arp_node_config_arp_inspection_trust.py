...
def interface_gigabitethernet_ip_arp_node_config_arp_inspection_trust(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_arp_node_config_arp_inspection_trust_act(Action):
    def run(self, delete_arp_node_config, delete_inspection, name, delete_ip, delete_trust, delete_interface, delete_name, delete_gigabitethernet, delete_arp, host, username, password):
