...
def rbridge_id_system_monitor_cid_card_alert_state(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_system_monitor_cid_card_alert_state_act(Action):
    def run(self, rbridge_id, delete_cid_card, state, delete_alert, delete_state, delete_rbridge_id, delete_system_monitor, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_system_monitor_cid_card_alert_state(delete_system_monitor=delete_system_monitor, username=username, rbridge_id=rbridge_id, delete_state=delete_state, delete_cid_card=delete_cid_card, state=state, delete_alert=delete_alert, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
