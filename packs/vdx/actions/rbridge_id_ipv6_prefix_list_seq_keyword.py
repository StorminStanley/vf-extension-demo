...
def rbridge_id_ipv6_prefix_list_seq_keyword(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_prefix_list_seq_keyword_act(Action):
    def run(self, rbridge_id, delete_seq_keyword, instance, delete_instance, delete_name, delete_prefix_list, delete_rbridge_id, seq_keyword, name, host, username, password):
