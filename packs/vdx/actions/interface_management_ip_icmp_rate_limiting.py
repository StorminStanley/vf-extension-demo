...
def interface_management_ip_icmp_rate_limiting(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_rate_limiting', False) is True:
        delete_rate_limiting = config.find('.//*rate_limiting')
...
class interface_management_ip_icmp_rate_limiting_act(Action):
    def run(self, delete_rate_limiting, name, delete_ip, delete_icmp, delete_interface, delete_name, rate_limiting, delete_management, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_ip_icmp_rate_limiting(delete_rate_limiting=delete_rate_limiting, name=name, delete_name=delete_name, delete_icmp=delete_icmp, delete_ip=delete_ip, delete_management=delete_management, rate_limiting=rate_limiting, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
