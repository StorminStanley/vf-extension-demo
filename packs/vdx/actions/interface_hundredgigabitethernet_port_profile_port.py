...
def interface_hundredgigabitethernet_port_profile_port(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_port_profile_port_act(Action):
    def run(self, delete_hundredgigabitethernet, delete_port_profile_port, delete_interface, delete_name, name, host, username, password):
