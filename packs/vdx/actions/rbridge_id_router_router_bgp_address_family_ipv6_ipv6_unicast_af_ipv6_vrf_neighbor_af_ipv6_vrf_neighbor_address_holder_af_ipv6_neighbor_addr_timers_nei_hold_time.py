...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_timers_nei_hold_time(**kwargs):
    """Auto Generated Code
    """
    ...
    timers = ET.SubElement(af_ipv6_neighbor_addr, "timers")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_timers_nei_hold_time_act(Action):
    def run(self, delete_nei_hold_time, delete_address_family, delete_router_bgp, rbridge_id, delete_timers, nei_hold_time, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_timers_nei_hold_time(delete_address_family=delete_address_family, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, nei_hold_time=nei_hold_time, delete_router=delete_router, delete_nei_hold_time=delete_nei_hold_time, host=host, delete_router_bgp=delete_router_bgp, delete_timers=delete_timers, password=password, callback=_callback, mgr=mgr)
        return 0
