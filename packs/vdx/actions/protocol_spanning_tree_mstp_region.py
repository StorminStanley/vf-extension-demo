...
def protocol_spanning_tree_mstp_region(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_region', False) is True:
        delete_region = config.find('.//*region')
        delete_region.set('operation', 'delete')
...
class protocol_spanning_tree_mstp_region_act(Action):
    def run(self, region, delete_mstp, delete_region, delete_spanning_tree, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_region(region=region, delete_spanning_tree=delete_spanning_tree, delete_region=delete_region, delete_protocol=delete_protocol, delete_mstp=delete_mstp, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
