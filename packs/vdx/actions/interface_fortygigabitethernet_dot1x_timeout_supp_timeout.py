...
def interface_fortygigabitethernet_dot1x_agtimeout_supp_agtimeout(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_dot1x_agtimeout_supp_agtimeout_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_agtimeout, delete_interface, delete_name, supp_agtimeout, delete_supp_agtimeout, host, username, password):
