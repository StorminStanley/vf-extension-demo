...
def interface_fortygigabitethernet_dot1x_reauthMax(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_dot1x_reauthMax_act(Action):
    def run(self, delete_reauthMax, delete_fortygigabitethernet, reauthMax, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_dot1x_reauthMax(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, reauthMax=reauthMax, host=host, delete_reauthMax=delete_reauthMax, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
