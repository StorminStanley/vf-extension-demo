...
def interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_interval_act(Action):
    def run(self, startup_query_interval, name, delete_ip, delete_fortygigabitethernet, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_startup_query_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_interval(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_igmp=delete_igmp, startup_query_interval=startup_query_interval, delete_ip=delete_ip, delete_startup_query_interval=delete_startup_query_interval, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
