...
def rbridge_id_router_ospf_redistribute_bgp_bgp_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_redistribute_bgp_bgp_route_map_act(Action):
    def run(self, rbridge_id, delete_ospf, delete_vrf, delete_bgp, delete_redistribute, bgp_route_map, vrf, delete_rbridge_id, delete_router, delete_bgp_route_map, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_redistribute_bgp_bgp_route_map(username=username, delete_redistribute=delete_redistribute, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_bgp_route_map=delete_bgp_route_map, delete_bgp=delete_bgp, delete_rbridge_id=delete_rbridge_id, bgp_route_map=bgp_route_map, password=password, callback=_callback, mgr=mgr)
        return 0
