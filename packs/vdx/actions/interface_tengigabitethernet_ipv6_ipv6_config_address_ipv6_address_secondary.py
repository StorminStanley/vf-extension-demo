...
def interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_secondary(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_secondary_act(Action):
    def run(self, name, delete_secondary, delete_interface, delete_name, address, delete_address, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_secondary(name=name, delete_name=delete_name, address=address, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_secondary=delete_secondary, delete_address=delete_address, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
