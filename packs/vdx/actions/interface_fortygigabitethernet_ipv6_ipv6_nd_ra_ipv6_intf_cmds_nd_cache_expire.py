...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_cache_expire(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_cache_expire_act(Action):
    def run(self, delete_expire, name, delete_fortygigabitethernet, delete_cache, expire, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_cache_expire(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_expire=delete_expire, username=username, host=host, password=password, delete_nd=delete_nd, delete_name=delete_name, delete_interface=delete_interface, delete_cache=delete_cache, expire=expire, callback=_callback, mgr=mgr)
        return 0
