...
def interface_vlan_interface_vlan_ip_igmp_startup_query_count(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_startup_query_count_act(Action):
    def run(self, delete_vlan, name, delete_ip, delete_interface_vlan, startup_query_count, delete_igmp, delete_interface, delete_name, delete_startup_query_count, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ip_igmp_startup_query_count(startup_query_count=startup_query_count, delete_startup_query_count=delete_startup_query_count, name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_ip=delete_ip, delete_igmp=delete_igmp, delete_interface_vlan=delete_interface_vlan, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
