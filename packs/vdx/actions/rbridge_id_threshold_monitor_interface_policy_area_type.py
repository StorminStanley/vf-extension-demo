...
def rbridge_id_threshold_monitor_interface_policy_area_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_interface_policy_area_type_act(Action):
