...
def interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_active(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_active_act(Action):
    def run(self, name, delete_ip, delete_active, delete_interface_fo_ospf_conf, delete_interface, delete_name, delete_hundredgigabitethernet, delete_ospf_interface_config, host, username, password):
