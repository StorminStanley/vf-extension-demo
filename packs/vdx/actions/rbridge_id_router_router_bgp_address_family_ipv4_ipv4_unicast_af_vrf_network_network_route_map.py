...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_network_network_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_network_network_route_map_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_network, delete_af_vrf_name, af_vrf_name, delete_network_route_map, delete_rbridge_id, network_route_map, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_network_network_route_map(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, network_route_map=network_route_map, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_network_route_map=delete_network_route_map, delete_router=delete_router, host=host, delete_network=delete_network, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
