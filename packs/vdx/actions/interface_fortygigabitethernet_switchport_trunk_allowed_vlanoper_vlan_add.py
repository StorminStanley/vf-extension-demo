...
def interface_fortygigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_fortygigabitethernet, add, delete_interface, delete_name, delete_add, delete_vlanoper, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add(delete_vlanoper=delete_vlanoper, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_add=delete_add, delete_switchport=delete_switchport, add=add, delete_name=delete_name, delete_allowed=delete_allowed, delete_vlan=delete_vlan, host=host, delete_trunk=delete_trunk, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
