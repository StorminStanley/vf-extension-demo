...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_revert_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_revert_priority_act(Action):
    def run(self, delete_fortygigabitethernet, name, revert_priority, delete_vrid, vrid, delete_short_path_forwarding, delete_interface, delete_name, delete_revert_priority, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_revert_priority(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_short_path_forwarding=delete_short_path_forwarding, host=host, vrid=vrid, revert_priority=revert_priority, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_revert_priority=delete_revert_priority, password=password, callback=_callback, mgr=mgr)
        return 0
