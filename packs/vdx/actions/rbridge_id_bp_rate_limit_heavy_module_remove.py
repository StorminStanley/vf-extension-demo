...
def rbridge_id_bp_rate_limit_heavy_module_remove(**kwargs):
    """Auto Generated Code
    """
    ...
    remove = ET.SubElement(module, "remove")
...
class rbridge_id_bp_rate_limit_heavy_module_remove_act(Action):
    def run(self, delete_module, rbridge_id, delete_heavy, remove, delete_bp_rate_limit, delete_remove, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_bp_rate_limit_heavy_module_remove(username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, remove=remove, delete_bp_rate_limit=delete_bp_rate_limit, delete_module=delete_module, password=password, host=host, delete_remove=delete_remove, delete_heavy=delete_heavy, callback=_callback, mgr=mgr)
        return 0
