...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_af_neighbor_capability_as4_neighbor_as4_disable_act(Action):
