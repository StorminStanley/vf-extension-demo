...
def interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ns_interval(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ns_interval', False) is True:
        delete_ns_interval = config.find('.//*ns-interval')
        delete_ns_interval.set('operation', 'delete')
...
class interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ns_interval_act(Action):
    def run(self, delete_ns_interval, name, delete_fortygigabitethernet, ns_interval, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ns_interval(delete_ns_interval=delete_ns_interval, delete_name=delete_name, ns_interval=ns_interval, name=name, host=host, delete_nd=delete_nd, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
