...
def interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos5_threshold(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos5_threshold_act(Action):
