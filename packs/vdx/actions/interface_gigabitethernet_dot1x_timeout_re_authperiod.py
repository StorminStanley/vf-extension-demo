...
def interface_gigabitethernet_dot1x_agtimeout_re_authperiod(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_dot1x_agtimeout_re_authperiod_act(Action):
    def run(self, delete_re_authperiod, name, re_authperiod, delete_agtimeout, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
