...
def interface_gigabitethernet_tunnel_tagged_ieee_bpdu(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_tunnel_tagged_ieee_bpdu_act(Action):
    def run(self, delete_tagged_ieee_bpdu, name, delete_tunnel, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_tunnel_tagged_ieee_bpdu(name=name, delete_tunnel=delete_tunnel, delete_name=delete_name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_tagged_ieee_bpdu=delete_tagged_ieee_bpdu, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
