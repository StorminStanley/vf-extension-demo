...
def interface_fortygigabitethernet_spanning_tree_edgeport_bpdu_filter(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_spanning_tree_edgeport_bpdu_filter_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_bpdu_filter, delete_interface, delete_name, delete_edgeport, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_spanning_tree_edgeport_bpdu_filter(delete_edgeport=delete_edgeport, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_bpdu_filter=delete_bpdu_filter, delete_spanning_tree=delete_spanning_tree, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
