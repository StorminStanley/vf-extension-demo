...
def interface_fortygigabitethernet_fabric_fabric_trunk_fabric_trunk_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_fabric_fabric_trunk_fabric_trunk_enable_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_fabric, delete_interface, delete_name, delete_fabric_trunk, delete_fabric_trunk_enable, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_fabric_fabric_trunk_fabric_trunk_enable(name=name, delete_fabric=delete_fabric, delete_name=delete_name, delete_fabric_trunk_enable=delete_fabric_trunk_enable, delete_fabric_trunk=delete_fabric_trunk, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
