...
def interface_gigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_mac_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_access_mac_rspan_vlan_classification_access_vlan_access_mac_address_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_access_vlan_id, name, access_mac_address, delete_access_mac_rspan_vlan_classification, delete_access, delete_access_mac_address, access_vlan_id, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
