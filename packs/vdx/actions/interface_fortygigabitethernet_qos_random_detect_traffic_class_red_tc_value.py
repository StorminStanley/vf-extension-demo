...
def interface_fortygigabitethernet_qos_random_detect_traffic_class_red_tc_value(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_qos_random_detect_traffic_class_red_tc_value_act(Action):
    def run(self, delete_qos, delete_red_tc_value, name, red_tc_value, delete_fortygigabitethernet, delete_traffic_class, delete_interface, delete_name, delete_random_detect, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_qos_random_detect_traffic_class_red_tc_value(delete_qos=delete_qos, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, name=name, red_tc_value=red_tc_value, host=host, delete_random_detect=delete_random_detect, delete_red_tc_value=delete_red_tc_value, delete_interface=delete_interface, username=username, password=password, delete_traffic_class=delete_traffic_class, callback=_callback, mgr=mgr)
        return 0
