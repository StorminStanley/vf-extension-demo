...
def rbridge_id_arp_entry_interfacetype_TenGigabitEthernet_TenGigabitEthernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_arp_entry_interfacetype_TenGigabitEthernet_TenGigabitEthernet_act(Action):
    def run(self, rbridge_id, delete_interfacetype, TenGigabitEthernet, delete_arp_ip_address, arp_ip_address, delete_TenGigabitEthernet, delete_arp_entry, delete_rbridge_id, host, username, password):
