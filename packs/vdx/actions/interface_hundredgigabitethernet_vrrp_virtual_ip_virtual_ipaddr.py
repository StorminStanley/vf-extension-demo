...
def interface_hundredgigabitethernet_vrrp_virtual_ip_virtual_ipaddr(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_virtual_ip_virtual_ipaddr_act(Action):
    def run(self, virtual_ipaddr, name, delete_vrid, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_hundredgigabitethernet, delete_virtual_ip, delete_virtual_ipaddr, host, username, password):
