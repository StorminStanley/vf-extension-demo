...
def rbridge_id_openflow_logical_instance_passive_no_ssl_passive_controller_port(**kwargs):
    """Auto Generated Code
    """
    ...
    passive_controller_port = ET.SubElement(no_ssl, "passive-controller-port")
    if kwargs.pop('delete_passive_controller_port', False) is True:
        delete_passive_controller_port = config.find('.//*passive-controller-port')
        delete_passive_controller_port.set('operation', 'delete')
        
    passive_controller_port.text = kwargs.pop('passive_controller_port')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_openflow_logical_instance_passive_no_ssl_passive_controller_port_act(Action):
    def run(self, delete_openflow, rbridge_id, delete_passive_controller_port, delete_passive, instance_id, passive_controller_port, delete_rbridge_id, delete_no_ssl, delete_logical_instance, delete_instance_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_openflow_logical_instance_passive_no_ssl_passive_controller_port(delete_logical_instance=delete_logical_instance, passive_controller_port=passive_controller_port, username=username, rbridge_id=rbridge_id, delete_openflow=delete_openflow, delete_no_ssl=delete_no_ssl, instance_id=instance_id, delete_passive=delete_passive, host=host, delete_passive_controller_port=delete_passive_controller_port, delete_instance_id=delete_instance_id, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
