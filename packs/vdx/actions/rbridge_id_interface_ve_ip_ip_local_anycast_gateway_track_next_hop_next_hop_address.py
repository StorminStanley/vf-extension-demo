...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_next_hop_next_hop_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_next_hop_next_hop_address_act(Action):
    def run(self, name, delete_ip, delete_next_hop, delete_next_hop_address, delete_ip_local_anycast_gateway, delete_track, delete_ve, next_hop_address, delete_interface, delete_name, delete_rbridge_id, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_next_hop_next_hop_address(local_ip_gw_id=local_ip_gw_id, delete_ip_local_anycast_gateway=delete_ip_local_anycast_gateway, name=name, delete_name=delete_name, delete_track=delete_track, delete_next_hop_address=delete_next_hop_address, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_next_hop=delete_next_hop, next_hop_address=next_hop_address, delete_ve=delete_ve, delete_local_ip_gw_id=delete_local_ip_gw_id, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
