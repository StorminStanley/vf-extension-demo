...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_default_information_originate(**kwargs):
    """Auto Generated Code
    """
    ...
    default_information_originate = ET.SubElement(af_ipv6_vrf, "default-information-originate")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_default_information_originate_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_rbridge_id, delete_router, delete_default_information_originate, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_default_information_originate(delete_router_bgp=delete_router_bgp, delete_default_information_originate=delete_default_information_originate, username=username, rbridge_id=rbridge_id, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
