...
def protocol_lldp_advertise_dcbx_tlv(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_advertise_dcbx_tlv_act(Action):
    def run(self, delete_advertise, delete_lldp, delete_dcbx_tlv, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_advertise_dcbx_tlv(delete_lldp=delete_lldp, username=username, delete_protocol=delete_protocol, password=password, host=host, delete_dcbx_tlv=delete_dcbx_tlv, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
