...
def interface_gigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_interval_act(Action):
    def run(self, last_member_query_interval, name, delete_ip, delete_last_member_query_interval, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
