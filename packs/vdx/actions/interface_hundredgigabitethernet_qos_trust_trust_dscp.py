...
def interface_hundredgigabitethernet_qos_trust_trust_dscp(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_qos_trust_trust_dscp_act(Action):
    def run(self, delete_qos, name, delete_trust_dscp, delete_trust, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_qos_trust_trust_dscp(delete_qos=delete_qos, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_trust_dscp=delete_trust_dscp, delete_trust=delete_trust, name=name, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
