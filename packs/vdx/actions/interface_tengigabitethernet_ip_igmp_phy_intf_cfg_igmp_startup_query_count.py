...
def interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_count(**kwargs):
    """Auto Generated Code
    """
    ...
    startup_query_count = ET.SubElement(igmp, "startup-query-count")
...
class interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_count_act(Action):
    def run(self, name, delete_ip, startup_query_count, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_startup_query_count, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_count(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, delete_startup_query_count=delete_startup_query_count, name=name, delete_name=delete_name, startup_query_count=startup_query_count, delete_ip=delete_ip, delete_igmp=delete_igmp, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
