...
def interface_hundredgigabitethernet_ipv6_vrrpv3e_group_advertisement_interval_scale(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3e_group_advertisement_interval_scale_act(Action):
    def run(self, name, delete_vrid, advertisement_interval_scale, vrid, delete_interface, delete_name, delete_advertisement_interval_scale, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_vrrpv3e_group_advertisement_interval_scale(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, advertisement_interval_scale=advertisement_interval_scale, vrid=vrid, host=host, delete_interface=delete_interface, delete_advertisement_interval_scale=delete_advertisement_interval_scale, password=password, callback=_callback, mgr=mgr)
        return 0
