...
def rbridge_id_fcsp_auth_proto_auth_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_fcsp_auth_proto_auth_type_act(Action):
    def run(self, auth_type, rbridge_id, delete_fcsp, delete_auth_type, delete_auth, delete_rbridge_id, delete_proto, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_fcsp_auth_proto_auth_type(delete_fcsp=delete_fcsp, username=username, auth_type=auth_type, rbridge_id=rbridge_id, delete_auth_type=delete_auth_type, delete_auth=delete_auth, delete_proto=delete_proto, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
