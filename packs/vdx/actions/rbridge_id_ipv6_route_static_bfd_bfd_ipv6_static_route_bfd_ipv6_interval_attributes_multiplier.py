...
def rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_multiplier_act(Action):
    def run(self, rbridge_id, delete_route, delete_static, delete_multiplier, multiplier, delete_bfd, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_interval_attributes_multiplier(delete_static=delete_static, delete_route=delete_route, delete_multiplier=delete_multiplier, username=username, rbridge_id=rbridge_id, delete_bfd=delete_bfd, host=host, password=password, delete_rbridge_id=delete_rbridge_id, multiplier=multiplier, callback=_callback, mgr=mgr)
        return 0
