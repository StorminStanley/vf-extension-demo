...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_ospf_ospf_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_ospf_ospf_metric_act(Action):
    def run(self, ospf_metric, delete_address_family, delete_router_bgp, rbridge_id, delete_ospf, delete_redistribute, delete_rbridge_id, delete_router, delete_ospf_metric, host, username, password):
