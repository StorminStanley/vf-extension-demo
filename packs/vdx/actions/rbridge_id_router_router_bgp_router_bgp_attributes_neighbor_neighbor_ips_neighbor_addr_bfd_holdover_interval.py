...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_bfd_holdover_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_bfd_holdover_interval_act(Action):
    def run(self, router_bgp_neighbor_address, delete_bfd, delete_router_bgp, rbridge_id, delete_neighbor_addr, holdover_interval, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, delete_neighbor_ips, delete_rbridge_id, delete_neighbor, delete_router, delete_holdover_interval, host, username, password):
