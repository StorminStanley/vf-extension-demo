...
def interface_hundredgigabitethernet_ipv6_vrrpv3_group_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3_group_enable_act(Action):
    def run(self, name, delete_vrid, vrid, delete_enable, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_vrrpv3_group_enable(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_enable=delete_enable, host=host, vrid=vrid, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
