...
def interface_tengigabitethernet_switchport_access_rspan_access_rspan_access_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_access_rspan_access_rspan_access_vlan_act(Action):
    def run(self, delete_switchport, name, rspan_access_vlan, delete_access, delete_interface, delete_name, delete_rspan_access_vlan, delete_tengigabitethernet, delete_rspan_access, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_access_rspan_access_rspan_access_vlan(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_access=delete_access, rspan_access_vlan=rspan_access_vlan, host=host, delete_rspan_access_vlan=delete_rspan_access_vlan, delete_rspan_access=delete_rspan_access, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
