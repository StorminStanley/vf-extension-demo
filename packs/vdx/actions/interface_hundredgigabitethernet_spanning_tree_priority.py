...
def interface_hundredgigabitethernet_spanning_tree_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_priority_act(Action):
    def run(self, name, priority, delete_priority, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_priority(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, priority=priority, delete_spanning_tree=delete_spanning_tree, host=host, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
