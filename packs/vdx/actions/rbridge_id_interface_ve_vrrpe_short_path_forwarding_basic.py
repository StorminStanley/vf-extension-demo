...
def rbridge_id_interface_ve_vrrpe_short_path_forwarding_basic(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_short_path_forwarding_basic_act(Action):
    def run(self, delete_basic, name, delete_vrid, vrid, delete_short_path_forwarding, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_short_path_forwarding_basic(delete_vrid=delete_vrid, name=name, delete_basic=delete_basic, delete_vrrpe=delete_vrrpe, delete_short_path_forwarding=delete_short_path_forwarding, username=username, rbridge_id=rbridge_id, delete_ve=delete_ve, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
