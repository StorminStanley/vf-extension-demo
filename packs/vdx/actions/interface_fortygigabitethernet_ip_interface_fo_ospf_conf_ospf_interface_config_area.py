...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_area(**kwargs):
    """Auto Generated Code
    """
    ...
    area = ET.SubElement(ospf_interface_config, "area")
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_area_act(Action):
    def run(self, name, delete_ip, area, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_area, delete_interface, delete_name, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_area(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_area=delete_area, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, area=area, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
