...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_default_information_originate(**kwargs):
    """Auto Generated Code
    """
    ...
    default_information_originate = ET.SubElement(af_vrf, "default-information-originate")
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_default_information_originate_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_rbridge_id, delete_router, delete_default_information_originate, host, username, password):
