...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_graceful_restart_purge_time(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_purge_time', False) is True:
        delete_purge_time = config.find('.//*purge-time')
        delete_purge_time.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_graceful_restart_purge_time_act(Action):
    def run(self, delete_purge_time, delete_address_family, delete_router_bgp, rbridge_id, delete_graceful_restart, delete_af_common_cmds_holder, delete_default_vrf, purge_time, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_graceful_restart_purge_time(delete_address_family=delete_address_family, username=username, delete_graceful_restart=delete_graceful_restart, delete_default_vrf=delete_default_vrf, rbridge_id=rbridge_id, delete_router=delete_router, delete_af_common_cmds_holder=delete_af_common_cmds_holder, host=host, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, delete_purge_time=delete_purge_time, purge_time=purge_time, password=password, callback=_callback, mgr=mgr)
        return 0
