...
def rbridge_id_interface_ve_ip_ip_config_address_ospf_ignore(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ospf_ignore', False) is True:
        delete_ospf_ignore = config.find('.//*ospf-ignore')
        delete_ospf_ignore.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_interface_ve_ip_ip_config_address_ospf_ignore_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_ospf_ignore, delete_ve, delete_interface, delete_name, address, delete_rbridge_id, delete_address, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_config_address_ospf_ignore(name=name, delete_name=delete_name, delete_ospf_ignore=delete_ospf_ignore, username=username, address=address, delete_ip_config=delete_ip_config, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ve=delete_ve, host=host, delete_address=delete_address, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
