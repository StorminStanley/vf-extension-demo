...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_database_filter_all_external(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_database_filter_all_external_act(Action):
    def run(self, name, delete_ip, delete_interface_fo_ospf_conf, delete_database_filter, delete_fortygigabitethernet, all_external, delete_interface, delete_name, delete_all_external, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_database_filter_all_external(delete_database_filter=delete_database_filter, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_all_external=delete_all_external, delete_ip=delete_ip, all_external=all_external, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, delete_ospf_interface_config=delete_ospf_interface_config, callback=_callback, mgr=mgr)
        return 0
