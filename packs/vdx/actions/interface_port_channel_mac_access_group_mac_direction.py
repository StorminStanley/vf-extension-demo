...
def interface_port_channel_mac_access_group_mac_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_mac_access_group_mac_direction_act(Action):
