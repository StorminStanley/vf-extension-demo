...
def interface_fortygigabitethernet_ipv6_vrrpv3_group_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3_group_priority_act(Action):
