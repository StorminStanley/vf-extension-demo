...
def rbridge_id_threshold_monitor_sfp_policy_area_alert_above_above_highthresh_action(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_sfp_policy_area_alert_above_above_highthresh_action_act(Action):
    def run(self, delete_policy_name, area_value, rbridge_id, delete_above, delete_area_value, policy_name, delete_alert, delete_area, above_highthresh_action, delete_type, delete_threshold_monitor, delete_sfp, type, delete_rbridge_id, delete_policy, delete_above_highthresh_action, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_sfp_policy_area_alert_above_above_highthresh_action(delete_area_value=delete_area_value, username=username, type=type, delete_sfp=delete_sfp, delete_above=delete_above, delete_type=delete_type, delete_policy_name=delete_policy_name, delete_area=delete_area, rbridge_id=rbridge_id, above_highthresh_action=above_highthresh_action, delete_alert=delete_alert, delete_above_highthresh_action=delete_above_highthresh_action, delete_policy=delete_policy, area_value=area_value, policy_name=policy_name, host=host, delete_rbridge_id=delete_rbridge_id, password=password, delete_threshold_monitor=delete_threshold_monitor, callback=_callback, mgr=mgr)
        return 0
