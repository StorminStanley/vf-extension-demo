...
def interface_fortygigabitethernet_lldp_iscsi_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_lldp_iscsi_priority_act(Action):
    def run(self, iscsi_priority, delete_fortygigabitethernet, name, delete_lldp, delete_iscsi_priority, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_lldp_iscsi_priority(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_lldp=delete_lldp, delete_name=delete_name, iscsi_priority=iscsi_priority, host=host, delete_iscsi_priority=delete_iscsi_priority, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
