...
def interface_tengigabitethernet_switchport_access_accessvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_access_accessvlan_act(Action):
    def run(self, delete_switchport, delete_accessvlan, name, delete_access, delete_interface, delete_name, accessvlan, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_access_accessvlan(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_access=delete_access, accessvlan=accessvlan, delete_accessvlan=delete_accessvlan, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
