...
def rbridge_id_router_hide_pim_holder_pim_hello_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_hide_pim_holder_pim_hello_interval_act(Action):
    def run(self, delete_pim, rbridge_id, delete_hide_pim_holder, hello_interval, delete_hello_interval, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_hide_pim_holder_pim_hello_interval(delete_pim=delete_pim, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_hide_pim_holder=delete_hide_pim_holder, hello_interval=hello_interval, host=host, delete_hello_interval=delete_hello_interval, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
