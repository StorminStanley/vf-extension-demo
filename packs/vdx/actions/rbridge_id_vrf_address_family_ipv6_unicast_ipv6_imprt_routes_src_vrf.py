...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_imprt_routes_src_vrf(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_imprt_routes_src_vrf_act(Action):
    def run(self, delete_address_family, delete_src_vrf, rbridge_id, delete_vrf, route_map, delete_route_map, src_vrf, vrf_name, delete_routes, delete_imprt, delete_rbridge_id, delete_unicast, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_imprt_routes_src_vrf(src_vrf=src_vrf, delete_routes=delete_routes, delete_src_vrf=delete_src_vrf, delete_address_family=delete_address_family, delete_imprt=delete_imprt, username=username, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_route_map=delete_route_map, route_map=route_map, delete_vrf_name=delete_vrf_name, host=host, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
