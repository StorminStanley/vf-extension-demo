...
def interface_hundredgigabitethernet_fcoeport_ns_ip_registration(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_fcoeport_ns_ip_registration_act(Action):
    def run(self, name, delete_ns_ip_registration, delete_fcoeport, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
