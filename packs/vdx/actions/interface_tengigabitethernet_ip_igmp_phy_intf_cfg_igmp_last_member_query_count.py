...
def interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_count(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_count_act(Action):
    def run(self, delete_last_member_query_count, name, delete_ip, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_tengigabitethernet, last_member_query_count, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_last_member_query_count(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_ip=delete_ip, last_member_query_count=last_member_query_count, delete_last_member_query_count=delete_last_member_query_count, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
