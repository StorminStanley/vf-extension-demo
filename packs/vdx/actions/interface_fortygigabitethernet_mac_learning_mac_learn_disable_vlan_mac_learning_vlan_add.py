...
def interface_fortygigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_add(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_add_act(Action):
    def run(self, delete_vlan, name, delete_mac_learning_vlan_add, delete_mac_learn_disable, delete_fortygigabitethernet, delete_mac_learning, delete_interface, delete_name, mac_learning_vlan_add, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_add(delete_mac_learning=delete_mac_learning, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_vlan=delete_vlan, delete_mac_learn_disable=delete_mac_learn_disable, mac_learning_vlan_add=mac_learning_vlan_add, delete_mac_learning_vlan_add=delete_mac_learning_vlan_add, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
