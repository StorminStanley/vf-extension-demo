...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_evpn_neighbor_ipv4_address(**kwargs):
    """Auto Generated Code
    """
    ...
    evpn_neighbor_ipv4_address = ET.SubElement(evpn_neighbor_ipv4, "evpn-neighbor-ipv4-address")
    ...
    evpn_neighbor_ipv4_address.text = kwargs.pop('evpn_neighbor_ipv4_address')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_evpn_neighbor_ipv4_address_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_evpn, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_evpn_neighbor_ipv4_address(delete_router_bgp=delete_router_bgp, delete_evpn=delete_evpn, username=username, rbridge_id=rbridge_id, delete_router=delete_router, delete_neighbor=delete_neighbor, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
