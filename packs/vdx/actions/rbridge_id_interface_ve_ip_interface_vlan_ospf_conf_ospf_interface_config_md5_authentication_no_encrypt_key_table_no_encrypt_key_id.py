...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id_act(Action):
    def run(self, no_encrypt_key_id, name, delete_ip, delete_no_encrypt_key_table, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_no_encrypt_key_id, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(name=name, delete_no_encrypt_key_table=delete_no_encrypt_key_table, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, username=username, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_no_encrypt_key_id=delete_no_encrypt_key_id, delete_ve=delete_ve, host=host, no_encrypt_key_id=no_encrypt_key_id, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
