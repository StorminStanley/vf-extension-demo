...
def interface_management_ipv6_icmpv6_v6_unreachable(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_v6_unreachable', False) is True:
        delete_v6_unreachable = config.find('.//*v6_unreachable')
        delete_v6_unreachable.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_management_ipv6_icmpv6_v6_unreachable_act(Action):
    def run(self, delete_management, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_ipv6_icmpv6_v6_unreachable(name=name, delete_name=delete_name, delete_management=delete_management, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
