...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time_act(Action):
    def run(self, key_activation_wait_time, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_key_activation_wait_time, delete_interface, delete_name, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time(key_activation_wait_time=key_activation_wait_time, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_key_activation_wait_time=delete_key_activation_wait_time, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
