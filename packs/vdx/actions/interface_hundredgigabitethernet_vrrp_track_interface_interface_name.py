...
def interface_hundredgigabitethernet_vrrp_track_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_track_interface_interface_name_act(Action):
    def run(self, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_version, delete_interface_type, version, delete_interface, delete_name, delete_vrrp, delete_hundredgigabitethernet, interface_name, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_vrrp_track_interface_interface_name(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_track=delete_track, delete_hundredgigabitethernet=delete_hundredgigabitethernet, interface_name=interface_name, version=version, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, vrid=vrid, interface_type=interface_type, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
