...
def rbridge_id_ip_rtm_config_route_static_route_nh_route_attributes_tag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_nh_route_attributes_tag_act(Action):
    def run(self, delete_static_route_next_hop, delete_route_attributes, rbridge_id, delete_ip, delete_route, delete_static_route_nh, tag, delete_tag, delete_static_route_dest, static_route_dest, delete_rtm_config, delete_rbridge_id, static_route_next_hop, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_rtm_config_route_static_route_nh_route_attributes_tag(delete_route_attributes=delete_route_attributes, delete_tag=delete_tag, delete_static_route_dest=delete_static_route_dest, delete_route=delete_route, username=username, tag=tag, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_rtm_config=delete_rtm_config, delete_static_route_next_hop=delete_static_route_next_hop, static_route_next_hop=static_route_next_hop, host=host, static_route_dest=static_route_dest, delete_static_route_nh=delete_static_route_nh, password=password, callback=_callback, mgr=mgr)
        return 0
