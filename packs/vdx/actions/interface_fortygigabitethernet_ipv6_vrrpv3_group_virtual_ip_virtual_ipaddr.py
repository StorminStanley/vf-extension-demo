...
def interface_fortygigabitethernet_ipv6_vrrpv3_group_virtual_ip_virtual_ipaddr(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3_group_virtual_ip_virtual_ipaddr_act(Action):
    def run(self, virtual_ipaddr, delete_fortygigabitethernet, name, delete_vrid, vrid, delete_interface, delete_name, delete_virtual_ip, delete_virtual_ipaddr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3_group_virtual_ip_virtual_ipaddr(delete_vrid=delete_vrid, delete_virtual_ipaddr=delete_virtual_ipaddr, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_virtual_ip=delete_virtual_ip, virtual_ipaddr=virtual_ipaddr, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
