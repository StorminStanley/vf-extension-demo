...
def interface_fortygigabitethernet_dot1x_agtimeout_tx_period(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_dot1x_agtimeout_tx_period_act(Action):
    def run(self, delete_tx_period, name, delete_fortygigabitethernet, delete_agtimeout, delete_interface, delete_name, tx_period, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_dot1x_agtimeout_tx_period(name=name, delete_name=delete_name, username=username, delete_agtimeout=delete_agtimeout, delete_tx_period=delete_tx_period, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, tx_period=tx_period, password=password, callback=_callback, mgr=mgr)
        return 0
