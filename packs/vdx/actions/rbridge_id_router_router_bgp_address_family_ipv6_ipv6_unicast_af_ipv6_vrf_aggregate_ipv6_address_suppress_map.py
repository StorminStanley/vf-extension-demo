...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_suppress_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_suppress_map_act(Action):
    def run(self, delete_suppress_map, delete_address_family, delete_router_bgp, aggregate_ip_prefix, suppress_map, delete_aggregate_ip_prefix, delete_rbridge_id, delete_router, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_suppress_map(aggregate_ip_prefix=aggregate_ip_prefix, delete_router_bgp=delete_router_bgp, username=username, rbridge_id=rbridge_id, delete_router=delete_router, suppress_map=suppress_map, delete_aggregate_ip_prefix=delete_aggregate_ip_prefix, host=host, delete_suppress_map=delete_suppress_map, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
