...
def interface_tengigabitethernet_qos_default_cos(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_default_cos_act(Action):
    def run(self, delete_qos, name, default_cos, delete_default_cos, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_qos_default_cos(delete_qos=delete_qos, delete_name=delete_name, default_cos=default_cos, name=name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, delete_default_cos=delete_default_cos, password=password, callback=_callback, mgr=mgr)
        return 0
