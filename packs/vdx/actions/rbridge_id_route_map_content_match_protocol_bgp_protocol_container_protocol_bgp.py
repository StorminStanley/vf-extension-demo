...
def rbridge_id_route_map_content_match_protocol_bgp_protocol_container_protocol_bgp(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_protocol_bgp_protocol_container_protocol_bgp_act(Action):
    def run(self, rbridge_id, delete_protocol, delete_match, delete_route_map, delete_content, delete_bgp_protocol_container, instance, delete_instance, action_rm, delete_protocol_bgp, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_protocol_bgp_protocol_container_protocol_bgp(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_bgp_protocol_container=delete_bgp_protocol_container, username=username, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_action_rm=delete_action_rm, delete_content=delete_content, delete_protocol=delete_protocol, host=host, delete_match=delete_match, delete_protocol_bgp=delete_protocol_bgp, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
