...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_status_next_hop_self_status(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_status_next_hop_self_status_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_next_hop_self, delete_next_hop_self_status, delete_router_bgp_attributes, delete_ch_next_hop_self_type, delete_ca_next_hop_self_status, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
