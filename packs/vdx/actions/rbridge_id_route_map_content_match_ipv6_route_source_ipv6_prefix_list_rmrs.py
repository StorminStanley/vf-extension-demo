...
def rbridge_id_route_map_content_match_ipv6_route_source_ipv6_prefix_list_rmrs(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_ipv6_route_source_ipv6_prefix_list_rmrs_act(Action):
    def run(self, rbridge_id, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_route_source, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
