...
def interface_gigabitethernet_qos_rcv_queue_cos_threshold_cos2_threshold(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_cos2_threshold', False) is True:
        delete_cos2_threshold = config.find('.//*cos2-threshold')
        delete_cos2_threshold.set('operation', 'delete')
...
class interface_gigabitethernet_qos_rcv_queue_cos_threshold_cos2_threshold_act(Action):
