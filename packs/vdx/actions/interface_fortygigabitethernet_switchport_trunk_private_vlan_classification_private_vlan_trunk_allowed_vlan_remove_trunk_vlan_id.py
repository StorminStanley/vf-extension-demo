...
def interface_fortygigabitethernet_switchport_trunk_private_vlan_classification_private_vlan_trunk_allowed_vlan_remove_trunk_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_private_vlan_classification_private_vlan_trunk_allowed_vlan_remove_trunk_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, trunk_vlan_id, name, delete_trunk_ctag_id, delete_trunk, delete_fortygigabitethernet, trunk_ctag_id, delete_trunk_private_vlan_classification, delete_private_vlan, delete_interface, delete_name, delete_remove, delete_trunk_vlan_id, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_trunk_private_vlan_classification_private_vlan_trunk_allowed_vlan_remove_trunk_vlan_id(name=name, delete_trunk=delete_trunk, delete_trunk_private_vlan_classification=delete_trunk_private_vlan_classification, username=username, delete_switchport=delete_switchport, trunk_ctag_id=trunk_ctag_id, delete_name=delete_name, delete_allowed=delete_allowed, delete_trunk_vlan_id=delete_trunk_vlan_id, trunk_vlan_id=trunk_vlan_id, delete_vlan=delete_vlan, host=host, delete_trunk_ctag_id=delete_trunk_ctag_id, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, delete_remove=delete_remove, password=password, delete_private_vlan=delete_private_vlan, callback=_callback, mgr=mgr)
        return 0
