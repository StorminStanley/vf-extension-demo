...
def rbridge_id_evpn_instance_vni_vni_add_remove(**kwargs):
    """Auto Generated Code
    """
    ...
    remove = ET.SubElement(vni_add, "remove")
...
class rbridge_id_evpn_instance_vni_vni_add_remove_act(Action):
    def run(self, delete_evpn_instance, rbridge_id, remove, instance_name, delete_vni_add, delete_vni, delete_remove, delete_rbridge_id, delete_instance_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_evpn_instance_vni_vni_add_remove(username=username, delete_vni=delete_vni, instance_name=instance_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, remove=remove, delete_instance_name=delete_instance_name, host=host, delete_evpn_instance=delete_evpn_instance, delete_vni_add=delete_vni_add, delete_remove=delete_remove, password=password, callback=_callback, mgr=mgr)
        return 0
