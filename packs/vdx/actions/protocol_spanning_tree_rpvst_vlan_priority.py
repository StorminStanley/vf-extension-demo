...
def protocol_spanning_tree_rpvst_vlan_priority(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rpvst_vlan_priority_act(Action):
    def run(self, delete_vlan, delete_protocol, delete_rpvst, delete_spanning_tree, priority, delete_id, delete_priority, id, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rpvst_vlan_priority(username=username, delete_rpvst=delete_rpvst, delete_vlan=delete_vlan, delete_id=delete_id, priority=priority, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, host=host, id=id, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
