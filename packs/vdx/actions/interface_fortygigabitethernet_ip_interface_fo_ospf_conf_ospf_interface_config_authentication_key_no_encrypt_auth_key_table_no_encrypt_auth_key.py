...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_authentication_key_no_encrypt_auth_key_table_no_encrypt_auth_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_authentication_key_no_encrypt_auth_key_table_no_encrypt_auth_key_act(Action):
    def run(self, name, delete_ip, no_encrypt_auth_key, delete_interface_fo_ospf_conf, delete_no_encrypt_auth_key_table, delete_fortygigabitethernet, delete_no_encrypt_auth_key, delete_interface, delete_name, delete_authentication_key, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_authentication_key_no_encrypt_auth_key_table_no_encrypt_auth_key(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_authentication_key=delete_authentication_key, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, password=password, delete_no_encrypt_auth_key=delete_no_encrypt_auth_key, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_name=delete_name, delete_interface=delete_interface, no_encrypt_auth_key=no_encrypt_auth_key, delete_no_encrypt_auth_key_table=delete_no_encrypt_auth_key_table, callback=_callback, mgr=mgr)
        return 0
