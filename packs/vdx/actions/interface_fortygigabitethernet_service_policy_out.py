...
def interface_fortygigabitethernet_service_policy_out(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_service_policy_out_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_service_policy, delete_interface, delete_name, delete_out, out, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_service_policy_out(name=name, delete_name=delete_name, out=out, delete_out=delete_out, host=host, delete_service_policy=delete_service_policy, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
