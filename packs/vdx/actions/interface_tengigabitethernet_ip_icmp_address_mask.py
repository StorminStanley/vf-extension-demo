...
def interface_tengigabitethernet_ip_icmp_address_mask(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_icmp_address_mask_act(Action):
    def run(self, delete_address_mask, name, delete_ip, delete_icmp, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
