...
def interface_tengigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk_vlan_classification, delete_trunk, trunk_vlan_id, delete_interface, delete_name, delete_remove, delete_tengigabitethernet, delete_trunk_vlan_id, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_remove_trunk_vlan_id(name=name, delete_trunk=delete_trunk, username=username, delete_switchport=delete_switchport, delete_trunk_vlan_id=delete_trunk_vlan_id, delete_trunk_vlan_classification=delete_trunk_vlan_classification, delete_allowed=delete_allowed, trunk_vlan_id=trunk_vlan_id, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, delete_remove=delete_remove, password=password, callback=_callback, mgr=mgr)
        return 0
