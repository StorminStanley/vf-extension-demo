...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_interface_area(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_interface_area_act(Action):
    def run(self, name, delete_interface_area, delete_interface, delete_name, interface_area, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_interface_area(interface_area=interface_area, delete_name=delete_name, name=name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface_area=delete_interface_area, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
