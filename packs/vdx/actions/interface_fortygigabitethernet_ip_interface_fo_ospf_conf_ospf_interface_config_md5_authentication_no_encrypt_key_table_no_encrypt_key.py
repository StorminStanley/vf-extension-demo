...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_act(Action):
    def run(self, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_no_encrypt_key_table, delete_no_encrypt_key, delete_interface, delete_name, no_encrypt_key, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key(name=name, delete_no_encrypt_key_table=delete_no_encrypt_key_table, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_no_encrypt_key=delete_no_encrypt_key, delete_interface=delete_interface, username=username, no_encrypt_key=no_encrypt_key, password=password, callback=_callback, mgr=mgr)
        return 0
