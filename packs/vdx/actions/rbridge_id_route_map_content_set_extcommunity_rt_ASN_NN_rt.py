...
def rbridge_id_route_map_content_set_extcommunity_rt_ASN_NN_rt(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_extcommunity_rt_ASN_NN_rt_act(Action):
    def run(self, ASN_NN_rt, delete_ASN_NN_rt, rbridge_id, delete_set, delete_route_map, delete_content, delete_extcommunity, instance, delete_instance, action_rm, delete_name, delete_rt, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_extcommunity_rt_ASN_NN_rt(delete_instance=delete_instance, delete_rt=delete_rt, name=name, action_rm=action_rm, ASN_NN_rt=ASN_NN_rt, username=username, rbridge_id=rbridge_id, delete_ASN_NN_rt=delete_ASN_NN_rt, password=password, delete_route_map=delete_route_map, delete_action_rm=delete_action_rm, delete_content=delete_content, delete_set=delete_set, host=host, delete_extcommunity=delete_extcommunity, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
