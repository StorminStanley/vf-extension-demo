...
def interface_port_channel_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary_act(Action):
    def run(self, delete_eui_secondary, name, delete_port_channel, delete_interface, delete_name, address, delete_address, delete_eui_config, host, username, password):
