...
def interface_hundredgigabitethernet_bfd_bfd_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_bfd_bfd_shutdown_act(Action):
    def run(self, delete_bfd_shutdown, name, delete_interface, delete_name, delete_hundredgigabitethernet, delete_bfd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_bfd_bfd_shutdown(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_bfd=delete_bfd, delete_bfd_shutdown=delete_bfd_shutdown, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
