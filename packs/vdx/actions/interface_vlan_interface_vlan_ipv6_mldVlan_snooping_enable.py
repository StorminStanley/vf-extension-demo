...
def interface_vlan_interface_vlan_ipv6_mldVlan_snooping_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ipv6_mldVlan_snooping_enable_act(Action):
    def run(self, delete_vlan, name, delete_snooping, delete_interface_vlan, delete_mldVlan, delete_enable, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ipv6_mldVlan_snooping_enable(name=name, delete_mldVlan=delete_mldVlan, delete_vlan=delete_vlan, delete_enable=delete_enable, delete_snooping=delete_snooping, delete_interface_vlan=delete_interface_vlan, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
