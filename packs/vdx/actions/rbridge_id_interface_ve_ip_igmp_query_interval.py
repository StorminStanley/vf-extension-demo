...
def rbridge_id_interface_ve_ip_igmp_query_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_igmp_query_interval_act(Action):
    def run(self, name, delete_ip, delete_query_interval, delete_ve, delete_igmp, delete_interface, delete_name, delete_rbridge_id, query_interval, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_igmp_query_interval(name=name, delete_name=delete_name, delete_igmp=delete_igmp, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, query_interval=query_interval, delete_ve=delete_ve, delete_query_interval=delete_query_interval, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
