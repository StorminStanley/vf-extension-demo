...
def interface_gigabitethernet_ip_ip_config_directed_broadcast(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_ip_config_directed_broadcast_act(Action):
    def run(self, delete_ip_config, delete_directed_broadcast, name, delete_ip, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_ip_config_directed_broadcast(name=name, delete_name=delete_name, delete_ip=delete_ip, delete_ip_config=delete_ip_config, delete_directed_broadcast=delete_directed_broadcast, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
