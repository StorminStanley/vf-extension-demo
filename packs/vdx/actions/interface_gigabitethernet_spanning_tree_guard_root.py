...
def interface_gigabitethernet_spanning_tree_guard_root(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_guard_root_act(Action):
    def run(self, name, delete_interface, delete_name, delete_guard, delete_spanning_tree, delete_gigabitethernet, delete_root, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_spanning_tree_guard_root(name=name, delete_name=delete_name, delete_root=delete_root, delete_spanning_tree=delete_spanning_tree, host=host, delete_guard=delete_guard, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
