...
def interface_tengigabitethernet_qos_dscp_traffic_class(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_dscp_traffic_class_act(Action):
    def run(self, delete_dscp_traffic_class, delete_qos, name, dscp_traffic_class, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_qos_dscp_traffic_class(delete_qos=delete_qos, delete_name=delete_name, dscp_traffic_class=dscp_traffic_class, name=name, delete_tengigabitethernet=delete_tengigabitethernet, delete_dscp_traffic_class=delete_dscp_traffic_class, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
