...
def rbridge_id_secpolicy_defined_policy_policies_member_entry_member(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_secpolicy_defined_policy_policies_member_entry_member_act(Action):
    def run(self, delete_defined_policy, delete_policies, delete_member, delete_policy, member, policy, delete_secpolicy, delete_rbridge_id, delete_member_entry, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_secpolicy_defined_policy_policies_member_entry_member(delete_defined_policy=delete_defined_policy, delete_member=delete_member, delete_secpolicy=delete_secpolicy, username=username, rbridge_id=rbridge_id, delete_policies=delete_policies, delete_member_entry=delete_member_entry, member=member, host=host, policy=policy, delete_policy=delete_policy, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
