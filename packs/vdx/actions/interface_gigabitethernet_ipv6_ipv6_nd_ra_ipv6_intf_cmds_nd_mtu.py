...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_mtu(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_mtu_act(Action):
    def run(self, name, delete_mtu, mtu, delete_interface, delete_name, delete_nd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_mtu(mtu=mtu, name=name, delete_name=delete_name, delete_mtu=delete_mtu, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
