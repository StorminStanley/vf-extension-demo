...
def interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_anycast(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_anycast_act(Action):
    def run(self, delete_anycast, name, delete_interface, delete_name, address, delete_address, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_anycast(delete_anycast=delete_anycast, delete_name=delete_name, address=address, name=name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_address=delete_address, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
