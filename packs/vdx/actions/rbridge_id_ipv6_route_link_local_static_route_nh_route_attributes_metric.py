...
def rbridge_id_ipv6_route_link_local_static_route_nh_route_attributes_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_link_local_static_route_nh_route_attributes_metric_act(Action):
    def run(self, delete_link_local_static_route_nh, delete_route_attributes, link_local_route_oif_name, rbridge_id, delete_route, delete_link_local_static_route_dest, metric, link_local_nexthop, delete_link_local_route_oif_type, delete_metric, delete_link_local_route_oif_name, delete_link_local_nexthop, delete_rbridge_id, link_local_static_route_dest, link_local_route_oif_type, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_link_local_static_route_nh_route_attributes_metric(delete_route_attributes=delete_route_attributes, delete_link_local_route_oif_type=delete_link_local_route_oif_type, delete_link_local_nexthop=delete_link_local_nexthop, delete_metric=delete_metric, delete_route=delete_route, link_local_route_oif_type=link_local_route_oif_type, username=username, rbridge_id=rbridge_id, delete_link_local_route_oif_name=delete_link_local_route_oif_name, metric=metric, link_local_route_oif_name=link_local_route_oif_name, host=host, link_local_static_route_dest=link_local_static_route_dest, delete_link_local_static_route_nh=delete_link_local_static_route_nh, delete_link_local_static_route_dest=delete_link_local_static_route_dest, delete_rbridge_id=delete_rbridge_id, link_local_nexthop=link_local_nexthop, password=password, callback=_callback, mgr=mgr)
        return 0
