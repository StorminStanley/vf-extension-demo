...
def interface_tengigabitethernet_ip_pbr_interface_ip_policy_route_map_route_map_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_pbr_interface_ip_policy_route_map_route_map_name_act(Action):
    def run(self, route_map_name, name, delete_ip, delete_route_map_name, delete_route_map, delete_policy, delete_interface, delete_name, delete_ip_pbr_interface, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_pbr_interface_ip_policy_route_map_route_map_name(name=name, delete_name=delete_name, username=username, route_map_name=route_map_name, delete_tengigabitethernet=delete_tengigabitethernet, delete_ip=delete_ip, delete_route_map=delete_route_map, delete_policy=delete_policy, host=host, delete_ip_pbr_interface=delete_ip_pbr_interface, delete_interface=delete_interface, delete_route_map_name=delete_route_map_name, password=password, callback=_callback, mgr=mgr)
        return 0
