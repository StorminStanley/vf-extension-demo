...
def interface_gigabitethernet_switchport_port_security_port_secutiry_mac_address_port_sec_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_port_security_port_secutiry_mac_address_port_sec_vlan_act(Action):
    def run(self, delete_switchport, delete_mac_address, name, delete_gigabitethernet, delete_port_secutiry_mac_address, delete_interface, delete_name, mac_address, port_sec_vlan, delete_port_security, delete_port_sec_vlan, host, username, password):
