...
def interface_port_channel_switchport_trunk_allowed_vlan_none(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_trunk_allowed_vlan_none_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_none, delete_trunk, delete_port_channel, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_trunk_allowed_vlan_none(delete_port_channel=delete_port_channel, name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, delete_allowed=delete_allowed, delete_none=delete_none, delete_vlan=delete_vlan, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
