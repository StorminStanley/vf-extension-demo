...
def rbridge_id_ssh_server_cipher(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_cipher_act(Action):
    def run(self, rbridge_id, delete_server, cipher, delete_ssh, delete_rbridge_id, delete_cipher, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_cipher(delete_server=delete_server, username=username, delete_cipher=delete_cipher, rbridge_id=rbridge_id, delete_ssh=delete_ssh, cipher=cipher, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
