...
def interface_hundredgigabitethernet_switchport_trunk_native_vlan_classification_native_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_trunk_native_vlan_classification_native_vlan_id_act(Action):
    def run(self, delete_switchport, name, delete_native_vlan_classification, delete_trunk, native_vlan_id, delete_native_vlan_id, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
