...
def interface_fortygigabitethernet_dot1x_authentication(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_dot1x_authentication_act(Action):
    def run(self, delete_authentication, delete_fortygigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_dot1x_authentication(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_authentication=delete_authentication, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
