...
def interface_tengigabitethernet_rmon_collection_ether_stats_entry_ether_stats_index(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_rmon_collection_ether_stats_entry_ether_stats_index_act(Action):
    def run(self, delete_collection, name, delete_ether_stats_index, delete_rmon, delete_ether_stats_entry, ether_stats_index, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_rmon_collection_ether_stats_entry_ether_stats_index(delete_rmon=delete_rmon, name=name, delete_collection=delete_collection, delete_ether_stats_entry=delete_ether_stats_entry, ether_stats_index=ether_stats_index, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_ether_stats_index=delete_ether_stats_index, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
