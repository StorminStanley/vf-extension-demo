...
def rbridge_id_route_map_content_set_comm_list_comm_list_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_comm_list_comm_list_name_act(Action):
    def run(self, delete_comm_list_name, rbridge_id, delete_set, delete_route_map, delete_content, delete_comm_list, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, comm_list_name, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_comm_list_comm_list_name(delete_instance=delete_instance, name=name, delete_comm_list_name=delete_comm_list_name, delete_name=delete_name, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, instance=instance, host=host, action_rm=action_rm, comm_list_name=comm_list_name, delete_rbridge_id=delete_rbridge_id, delete_comm_list=delete_comm_list, callback=_callback, mgr=mgr)
        return 0
