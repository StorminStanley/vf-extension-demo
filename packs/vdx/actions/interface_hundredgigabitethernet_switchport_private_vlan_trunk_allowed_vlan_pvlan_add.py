...
def interface_hundredgigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_add(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_pvlan_add', False) is True:
        delete_pvlan_add = config.find('.//*pvlan_add')
        delete_pvlan_add.set('operation', 'delete')
...
class interface_hundredgigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_add_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_pvlan_add, delete_private_vlan, delete_interface, delete_name, delete_hundredgigabitethernet, pvlan_add, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_add(name=name, delete_trunk=delete_trunk, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_switchport=delete_switchport, username=username, delete_allowed=delete_allowed, delete_pvlan_add=delete_pvlan_add, delete_vlan=delete_vlan, host=host, delete_private_vlan=delete_private_vlan, delete_name=delete_name, delete_interface=delete_interface, pvlan_add=pvlan_add, password=password, callback=_callback, mgr=mgr)
        return 0
