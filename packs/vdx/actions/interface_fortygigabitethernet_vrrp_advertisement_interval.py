...
def interface_fortygigabitethernet_vrrp_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_advertisement_interval_act(Action):
    def run(self, vrid, name, delete_vrid, delete_fortygigabitethernet, delete_advertisement_interval, delete_version, advertisement_interval, version, delete_interface, delete_name, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_vrrp_advertisement_interval(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, delete_advertisement_interval=delete_advertisement_interval, version=version, advertisement_interval=advertisement_interval, host=host, vrid=vrid, delete_version=delete_version, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
