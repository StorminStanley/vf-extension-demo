...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_vrf_static_route_oif_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_vrf_static_route_oif_name_act(Action):
    def run(self, delete_address_family, delete_next_hop_vrf, rbridge_id, delete_ip, delete_route, delete_vrf, delete_static_route_next_vrf_dest, next_hop_vrf, delete_static_route_oif_vrf, vrf_name, delete_static_route_oif_name, static_route_next_vrf_dest, static_route_oif_type, delete_rbridge_id, delete_unicast, delete_static_route_oif_type, static_route_oif_name, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_oif_vrf_static_route_oif_name(static_route_oif_type=static_route_oif_type, username=username, delete_address_family=delete_address_family, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, vrf_name=vrf_name, static_route_next_vrf_dest=static_route_next_vrf_dest, delete_ip=delete_ip, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_static_route_oif_vrf=delete_static_route_oif_vrf, delete_next_hop_vrf=delete_next_hop_vrf, host=host, delete_vrf_name=delete_vrf_name, static_route_oif_name=static_route_oif_name, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, next_hop_vrf=next_hop_vrf, delete_unicast=delete_unicast, delete_static_route_oif_type=delete_static_route_oif_type, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
