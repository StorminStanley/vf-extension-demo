...
def rbridge_id_ipv6_route_link_local_static_route_nh_vrf_link_local_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_link_local_static_route_nh_vrf_link_local_next_hop_act(Action):
