...
def interface_port_channel_switchport_trunk_allowed_vlanoper_vlan_remove(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_trunk_allowed_vlanoper_vlan_remove_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, remove, delete_port_channel, delete_interface, delete_name, delete_remove, delete_vlanoper, host, username, password):
