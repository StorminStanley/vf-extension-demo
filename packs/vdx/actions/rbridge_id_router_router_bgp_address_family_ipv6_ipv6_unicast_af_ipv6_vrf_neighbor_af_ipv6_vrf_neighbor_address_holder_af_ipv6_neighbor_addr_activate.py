...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_activate(**kwargs):
    """Auto Generated Code
    """
    ...
    activate = ET.SubElement(af_ipv6_neighbor_addr, "activate")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_activate_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_activate, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
