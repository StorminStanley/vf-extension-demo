...
def interface_gigabitethernet_spanning_tree_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_vlan_id_act(Action):
    def run(self, delete_vlan, name, id, delete_id, delete_interface, delete_name, delete_spanning_tree, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_spanning_tree_vlan_id(name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, host=host, delete_gigabitethernet=delete_gigabitethernet, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
