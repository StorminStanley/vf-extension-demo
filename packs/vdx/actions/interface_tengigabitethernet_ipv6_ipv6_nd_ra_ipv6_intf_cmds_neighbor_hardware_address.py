...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_hardware_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_hardware_address_act(Action):
    def run(self, hardware_address, name, delete_hardware_address, delete_interface, delete_name, delete_tengigabitethernet, delete_neighbor, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_hardware_address(name=name, delete_name=delete_name, delete_neighbor=delete_neighbor, hardware_address=hardware_address, delete_hardware_address=delete_hardware_address, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
