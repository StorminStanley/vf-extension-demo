...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_area(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_area_act(Action):
    def run(self, delete_interface_te_ospf_conf, name, delete_ip, area, delete_area, delete_interface, delete_name, delete_tengigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_area(name=name, delete_name=delete_name, delete_area=delete_area, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_tengigabitethernet=delete_tengigabitethernet, area=area, host=host, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, password=password, callback=_callback, mgr=mgr)
        return 0
