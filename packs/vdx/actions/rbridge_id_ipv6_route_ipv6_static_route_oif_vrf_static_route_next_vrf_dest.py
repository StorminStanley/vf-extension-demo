...
def rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_static_route_next_vrf_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_static_route_next_vrf_dest_act(Action):
    def run(self, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, delete_next_hop_vrf, delete_static_route_next_vrf_dest, static_route_next_vrf_dest, delete_static_route_oif_name, next_hop_vrf, delete_rbridge_id, static_route_oif_name, host, username, password):
