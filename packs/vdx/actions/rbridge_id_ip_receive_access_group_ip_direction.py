...
def rbridge_id_ip_receive_access_group_ip_direction(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_receive_access_group_ip_direction_act(Action):
    def run(self, rbridge_id, delete_ip, delete_ip_direction, delete_access_group, ip_direction, delete_rbridge_id, delete_receive, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_receive_access_group_ip_direction(delete_receive=delete_receive, username=username, delete_ip=delete_ip, rbridge_id=rbridge_id, delete_access_group=delete_access_group, delete_ip_direction=delete_ip_direction, host=host, ip_direction=ip_direction, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
