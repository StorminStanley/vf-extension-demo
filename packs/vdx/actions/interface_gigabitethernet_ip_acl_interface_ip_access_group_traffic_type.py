...
def interface_gigabitethernet_ip_acl_interface_ip_access_group_traffic_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_acl_interface_ip_access_group_traffic_type_act(Action):
    def run(self, delete_ip_access_list, name, delete_ip, ip_access_list, delete_ip_direction, delete_ip_acl_interface, delete_interface, delete_name, delete_traffic_type, ip_direction, traffic_type, delete_gigabitethernet, delete_access_group, host, username, password):
