...
def protocol_spanning_tree_rpvst_transmit_holdcount(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rpvst_transmit_holdcount_act(Action):
    def run(self, delete_transmit_holdcount, delete_rpvst, transmit_holdcount, delete_spanning_tree, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rpvst_transmit_holdcount(delete_rpvst=delete_rpvst, transmit_holdcount=transmit_holdcount, delete_transmit_holdcount=delete_transmit_holdcount, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
