...
def interface_tengigabitethernet_bfd_interval_min_tx(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_bfd_interval_min_tx_act(Action):
    def run(self, name, delete_min_tx, delete_interval, delete_interface, delete_name, min_tx, delete_bfd, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_bfd_interval_min_tx(delete_interval=delete_interval, name=name, delete_name=delete_name, username=username, delete_bfd=delete_bfd, min_tx=min_tx, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, delete_min_tx=delete_min_tx, password=password, callback=_callback, mgr=mgr)
        return 0
