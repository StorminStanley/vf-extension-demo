...
def protocol_spanning_tree_pvst_description(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_pvst_description_act(Action):
    def run(self, delete_pvst, delete_description, description, delete_spanning_tree, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_pvst_description(delete_pvst=delete_pvst, description=description, delete_spanning_tree=delete_spanning_tree, delete_description=delete_description, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
