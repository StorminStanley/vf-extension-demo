...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_dead_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_dead_interval_act(Action):
    def run(self, delete_dead_interval, name, delete_ip, delete_interface_gi_ospf_conf, dead_interval, delete_interface, delete_name, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
