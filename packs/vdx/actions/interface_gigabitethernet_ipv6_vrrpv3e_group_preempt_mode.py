...
def interface_gigabitethernet_ipv6_vrrpv3e_group_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_preempt_mode_act(Action):
