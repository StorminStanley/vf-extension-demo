...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_cost(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_cost_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, delete_cost, cost, delete_interface, delete_name, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_cost(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, delete_cost=delete_cost, name=name, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, host=host, cost=cost, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
