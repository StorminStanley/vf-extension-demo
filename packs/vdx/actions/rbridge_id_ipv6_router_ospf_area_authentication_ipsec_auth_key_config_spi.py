...
def rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_spi(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_spi_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, spi, delete_ipsec_auth_key_config, delete_area, vrf, delete_spi, delete_rbridge_id, delete_router, delete_authentication, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_spi(delete_spi=delete_spi, username=username, delete_area=delete_area, spi=spi, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_authentication=delete_authentication, delete_rbridge_id=delete_rbridge_id, area_id=area_id, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
