...
def interface_fortygigabitethernet_service_policy_in_cg(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_service_policy_in_cg_act(Action):
    def run(self, in_cg, delete_fortygigabitethernet, name, delete_service_policy, delete_interface, delete_name, delete_in_cg, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_service_policy_in_cg(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, in_cg=in_cg, host=host, delete_service_policy=delete_service_policy, delete_name=delete_name, delete_interface=delete_interface, delete_in_cg=delete_in_cg, password=password, callback=_callback, mgr=mgr)
        return 0
