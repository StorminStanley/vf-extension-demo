...
def interface_hundredgigabitethernet_vrrp_version(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_version_act(Action):
