...
def interface_hundredgigabitethernet_ip_ip_config_address_ospf_passive(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_ip_config_address_ospf_passive_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_interface, delete_name, address, delete_hundredgigabitethernet, delete_address, delete_ospf_passive, host, username, password):
