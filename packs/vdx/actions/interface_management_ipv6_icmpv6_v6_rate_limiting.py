...
def interface_management_ipv6_icmpv6_v6_rate_limiting(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_v6_rate_limiting', False) is True:
        delete_v6_rate_limiting = config.find('.//*v6_rate_limiting')
        delete_v6_rate_limiting.set('operation', 'delete')
...
class interface_management_ipv6_icmpv6_v6_rate_limiting_act(Action):
    def run(self, delete_management, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_ipv6_icmpv6_v6_rate_limiting(name=name, delete_name=delete_name, delete_management=delete_management, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
