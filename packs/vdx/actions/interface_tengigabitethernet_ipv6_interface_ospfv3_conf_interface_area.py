...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_interface_area(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_interface_area_act(Action):
    def run(self, name, delete_interface_area, delete_interface, delete_name, interface_area, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_interface_area(interface_area=interface_area, delete_name=delete_name, name=name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface_area=delete_interface_area, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
