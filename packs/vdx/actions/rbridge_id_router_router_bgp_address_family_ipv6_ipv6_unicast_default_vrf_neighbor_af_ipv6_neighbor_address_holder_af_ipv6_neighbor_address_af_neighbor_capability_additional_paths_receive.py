...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_neighbor_af_ipv6_neighbor_address_holder_af_ipv6_neighbor_address_af_neighbor_capability_additional_paths_receive(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_neighbor_af_ipv6_neighbor_address_holder_af_ipv6_neighbor_address_af_neighbor_capability_additional_paths_receive_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_receive, delete_af_neighbor_capability, delete_default_vrf, delete_rbridge_id, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_neighbor_af_ipv6_neighbor_address_holder_af_ipv6_neighbor_address_af_neighbor_capability_additional_paths_receive(delete_additional_paths=delete_additional_paths, delete_receive=delete_receive, delete_af_neighbor_capability=delete_af_neighbor_capability, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_router_bgp=delete_router_bgp, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
