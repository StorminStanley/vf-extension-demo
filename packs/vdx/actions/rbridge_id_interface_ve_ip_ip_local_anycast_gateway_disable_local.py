...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_disable_local(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_disable_local', False) is True:
        delete_disable_local = config.find('.//*disable_local')
        delete_disable_local.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_disable_local_act(Action):
    def run(self, name, delete_ip, delete_disable_local, delete_ip_local_anycast_gateway, delete_ve, delete_interface, delete_name, delete_rbridge_id, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_local_anycast_gateway_disable_local(local_ip_gw_id=local_ip_gw_id, name=name, delete_name=delete_name, delete_disable_local=delete_disable_local, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ip_local_anycast_gateway=delete_ip_local_anycast_gateway, delete_ve=delete_ve, delete_local_ip_gw_id=delete_local_ip_gw_id, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
