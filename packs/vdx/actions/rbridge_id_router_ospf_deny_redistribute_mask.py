...
def rbridge_id_router_ospf_deny_redistribute_mask(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_deny_redistribute_mask_act(Action):
    def run(self, redist_value, rbridge_id, delete_route_option, delete_ospf, delete_vrf, delete_deny, mask, delete_mask, delete_redistribute, delete_redist_value, vrf, delete_rbridge_id, delete_router, route_option, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_deny_redistribute_mask(delete_route_option=delete_route_option, route_option=route_option, delete_redistribute=delete_redistribute, username=username, delete_mask=delete_mask, rbridge_id=rbridge_id, delete_vrf=delete_vrf, mask=mask, vrf=vrf, delete_router=delete_router, delete_ospf=delete_ospf, redist_value=redist_value, delete_redist_value=delete_redist_value, host=host, delete_rbridge_id=delete_rbridge_id, delete_deny=delete_deny, password=password, callback=_callback, mgr=mgr)
        return 0
