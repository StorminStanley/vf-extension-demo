...
def interface_fortygigabitethernet_vrrp_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_priority_act(Action):
    def run(self, vrid, name, delete_vrid, delete_fortygigabitethernet, delete_version, priority, version, delete_interface, delete_name, delete_priority, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_vrrp_priority(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, delete_name=delete_name, priority=priority, version=version, host=host, vrid=vrid, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
