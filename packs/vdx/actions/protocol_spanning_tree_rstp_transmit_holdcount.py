...
def protocol_spanning_tree_rstp_transmit_holdcount(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rstp_transmit_holdcount_act(Action):
    def run(self, delete_transmit_holdcount, transmit_holdcount, delete_spanning_tree, delete_rstp, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rstp_transmit_holdcount(transmit_holdcount=transmit_holdcount, delete_transmit_holdcount=delete_transmit_holdcount, delete_spanning_tree=delete_spanning_tree, delete_rstp=delete_rstp, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
