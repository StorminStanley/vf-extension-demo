...
def rbridge_id_ip_rtm_config_route_static_route_nh_vrf_static_route_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_nh_vrf_static_route_next_hop_act(Action):
    def run(self, delete_static_route_next_hop, delete_next_hop_vrf, rbridge_id, delete_ip, delete_route, delete_static_route_next_vrf_dest, next_hop_vrf, delete_static_route_nh_vrf, static_route_next_vrf_dest, delete_rtm_config, delete_rbridge_id, static_route_next_hop, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_rtm_config_route_static_route_nh_vrf_static_route_next_hop(next_hop_vrf=next_hop_vrf, delete_route=delete_route, username=username, static_route_next_hop=static_route_next_hop, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_static_route_nh_vrf=delete_static_route_nh_vrf, delete_rtm_config=delete_rtm_config, static_route_next_vrf_dest=static_route_next_vrf_dest, delete_next_hop_vrf=delete_next_hop_vrf, host=host, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, delete_static_route_next_hop=delete_static_route_next_hop, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
