...
def interface_fortygigabitethernet_switchport_trunk_native_vlan_untagged_config_native_vlan_id_untagged(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_native_vlan_untagged_config_native_vlan_id_untagged_act(Action):
    def run(self, delete_switchport, delete_native_vlan_id_untagged, name, delete_trunk, delete_fortygigabitethernet, delete_interface, delete_name, delete_native_vlan_untagged_config, native_vlan_id_untagged, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_trunk_native_vlan_untagged_config_native_vlan_id_untagged(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, delete_name=delete_name, delete_native_vlan_id_untagged=delete_native_vlan_id_untagged, delete_native_vlan_untagged_config=delete_native_vlan_untagged_config, host=host, delete_trunk=delete_trunk, delete_interface=delete_interface, native_vlan_id_untagged=native_vlan_id_untagged, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
