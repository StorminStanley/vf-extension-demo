...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_always_next_hop_self_always(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_always_next_hop_self_always_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, delete_next_hop_self_always, delete_next_hop_self, router_bgp_neighbor_peer_grp, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_ch_next_hop_self_type, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, delete_ca_next_hop_self_always, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_always_next_hop_self_always(delete_next_hop_self=delete_next_hop_self, delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_ch_next_hop_self_type=delete_ch_next_hop_self_type, delete_next_hop_self_always=delete_next_hop_self_always, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_ca_next_hop_self_always=delete_ca_next_hop_self_always, delete_peer_grps=delete_peer_grps, callback=_callback, mgr=mgr)
        return 0
