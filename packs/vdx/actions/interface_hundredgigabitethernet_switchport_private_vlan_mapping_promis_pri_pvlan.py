...
def interface_hundredgigabitethernet_switchport_private_vlan_mapping_promis_pri_pvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_private_vlan_mapping_promis_pri_pvlan_act(Action):
    def run(self, delete_switchport, delete_mapping, name, delete_promis_pri_pvlan, delete_private_vlan, delete_interface, delete_name, delete_hundredgigabitethernet, promis_pri_pvlan, host, username, password):
