...
def interface_fortygigabitethernet_ipv6_policy_route_map_ipv6_route_map_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_policy_route_map_ipv6_route_map_name_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_route_map, delete_policy, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_policy_route_map_ipv6_route_map_name(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_route_map=delete_route_map, delete_policy=delete_policy, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
