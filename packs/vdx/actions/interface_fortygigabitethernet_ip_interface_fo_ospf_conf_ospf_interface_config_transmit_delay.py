...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_transmit_delay(**kwargs):
    """Auto Generated Code
    """
    ...
    transmit_delay = ET.SubElement(ospf_interface_config, "transmit-delay")
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_transmit_delay_act(Action):
    def run(self, delete_transmit_delay, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_interface, delete_name, transmit_delay, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_transmit_delay(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_transmit_delay=delete_transmit_delay, host=host, transmit_delay=transmit_delay, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
