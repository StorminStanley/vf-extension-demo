...
def interface_fortygigabitethernet_lldp_disable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_lldp_disable_act(Action):
    def run(self, delete_fortygigabitethernet, delete_name, delete_lldp, delete_interface, delete_disable, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_lldp_disable(delete_disable=delete_disable, name=name, delete_name=delete_name, delete_lldp=delete_lldp, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
