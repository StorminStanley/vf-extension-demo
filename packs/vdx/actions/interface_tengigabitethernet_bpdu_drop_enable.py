...
def interface_tengigabitethernet_bpdu_drop_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_bpdu_drop_enable_act(Action):
    def run(self, name, delete_enable, delete_bpdu_drop, delete_name, delete_tengigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_bpdu_drop_enable(name=name, delete_name=delete_name, delete_enable=delete_enable, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, delete_bpdu_drop=delete_bpdu_drop, password=password, callback=_callback, mgr=mgr)
        return 0
