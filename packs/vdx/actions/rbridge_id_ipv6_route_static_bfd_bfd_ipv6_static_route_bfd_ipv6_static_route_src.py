...
def rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_src(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_src_act(Action):
    def run(self, delete_bfd, delete_rbridge_id, delete_static, rbridge_id, delete_route, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_src(delete_static=delete_static, delete_route=delete_route, username=username, rbridge_id=rbridge_id, delete_bfd=delete_bfd, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
