...
def interface_fortygigabitethernet_rmon_collection_ether_stats_entry_ether_stats_owner(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_rmon_collection_ether_stats_entry_ether_stats_owner_act(Action):
    def run(self, delete_collection, delete_rmon, name, ether_stats_owner, delete_ether_stats_index, delete_fortygigabitethernet, delete_ether_stats_entry, ether_stats_index, delete_interface, delete_name, delete_ether_stats_owner, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_rmon_collection_ether_stats_entry_ether_stats_owner(delete_rmon=delete_rmon, ether_stats_owner=ether_stats_owner, name=name, delete_collection=delete_collection, username=username, delete_name=delete_name, delete_ether_stats_entry=delete_ether_stats_entry, ether_stats_index=ether_stats_index, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ether_stats_index=delete_ether_stats_index, delete_ether_stats_owner=delete_ether_stats_owner, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
