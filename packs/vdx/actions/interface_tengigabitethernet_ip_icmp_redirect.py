...
def interface_tengigabitethernet_ip_icmp_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_icmp_redirect_act(Action):
    def run(self, name, delete_ip, delete_icmp, delete_redirect, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
