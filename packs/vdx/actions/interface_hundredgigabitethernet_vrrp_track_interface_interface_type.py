...
def interface_hundredgigabitethernet_vrrp_track_interface_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_track_interface_interface_type_act(Action):
