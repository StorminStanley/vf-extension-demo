...
def interface_port_channel_vrrp_arp_unicast_request_receive(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_arp_unicast_request_receive_act(Action):
    def run(self, delete_unicast_request, name, delete_vrid, delete_receive, vrid, delete_version, delete_port_channel, version, delete_interface, delete_name, delete_vrrp, delete_arp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_vrrp_arp_unicast_request_receive(delete_vrid=delete_vrid, version=version, name=name, delete_version=delete_version, delete_vrrp=delete_vrrp, delete_arp=delete_arp, delete_receive=delete_receive, delete_port_channel=delete_port_channel, host=host, password=password, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_unicast_request=delete_unicast_request, callback=_callback, mgr=mgr)
        return 0
