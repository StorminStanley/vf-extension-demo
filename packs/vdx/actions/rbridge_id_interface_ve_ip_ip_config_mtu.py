...
def rbridge_id_interface_ve_ip_ip_config_mtu(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_config_mtu_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_mtu, mtu, delete_ve, delete_interface, delete_name, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_config_mtu(mtu=mtu, name=name, delete_name=delete_name, username=username, delete_ip_config=delete_ip_config, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_mtu=delete_mtu, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
