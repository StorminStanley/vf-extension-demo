...
def interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_gratuitous_arp_gve_timer(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_gratuitous_arp_gve_timer_act(Action):
    def run(self, gve_name, delete_interface_vlan, delete_ve, delete_gve_timer, delete_gratuitous_arp, gve_timer, delete_interface, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ipv6_ipv6_anycast_gateway_gratuitous_arp_gve_timer(delete_gve_name=delete_gve_name, delete_gratuitous_arp=delete_gratuitous_arp, delete_gve_timer=delete_gve_timer, gve_name=gve_name, delete_ve=delete_ve, host=host, gve_timer=gve_timer, delete_interface_vlan=delete_interface_vlan, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
