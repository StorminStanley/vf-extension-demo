...
def rbridge_id_router_hide_pim_holder_pim_rp_candidate_rp_cand_interface_rp_cand_intf_id(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_hide_pim_holder_pim_rp_candidate_rp_cand_interface_rp_cand_intf_id_act(Action):
