...
def interface_tengigabitethernet_channel_group_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_channel_group_type_act(Action):
    def run(self, name, delete_channel_group, delete_name, delete_type, delete_tengigabitethernet, type, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_channel_group_type(name=name, delete_name=delete_name, delete_type=delete_type, delete_channel_group=delete_channel_group, delete_tengigabitethernet=delete_tengigabitethernet, host=host, type=type, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
