...
def interface_gigabitethernet_spanning_tree_autoedge(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_autoedge_act(Action):
    def run(self, name, delete_autoedge, delete_interface, delete_name, delete_spanning_tree, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_spanning_tree_autoedge(name=name, delete_name=delete_name, delete_autoedge=delete_autoedge, delete_spanning_tree=delete_spanning_tree, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
