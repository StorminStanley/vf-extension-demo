...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_static_route_next_vrf_dest(**kwargs):
    """Auto Generated Code
    """
    ...
    static_route_next_vrf_dest = ET.SubElement(link_local_static_route_nh_vrf, "static-route-next-vrf-dest")
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_static_route_next_vrf_dest_act(Action):
    def run(self, delete_address_family, link_local_route_oif_name, rbridge_id, delete_route, delete_vrf, delete_link_local_route_oif_name, delete_next_hop_vrf, delete_static_route_next_vrf_dest, delete_link_local_route_oif_type, static_route_next_vrf_dest, link_local_next_hop, vrf_name, delete_link_local_next_hop, link_local_route_oif_type, next_hop_vrf, delete_rbridge_id, delete_unicast, delete_link_local_static_route_nh_vrf, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_vrf_static_route_next_vrf_dest(link_local_route_oif_type=link_local_route_oif_type, delete_vrf_name=delete_vrf_name, delete_address_family=delete_address_family, rbridge_id=rbridge_id, delete_next_hop_vrf=delete_next_hop_vrf, vrf_name=vrf_name, delete_link_local_static_route_nh_vrf=delete_link_local_static_route_nh_vrf, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, host=host, delete_rbridge_id=delete_rbridge_id, password=password, delete_link_local_route_oif_type=delete_link_local_route_oif_type, delete_route=delete_route, delete_vrf=delete_vrf, delete_link_local_route_oif_name=delete_link_local_route_oif_name, delete_link_local_next_hop=delete_link_local_next_hop, link_local_route_oif_name=link_local_route_oif_name, static_route_next_vrf_dest=static_route_next_vrf_dest, username=username, next_hop_vrf=next_hop_vrf, link_local_next_hop=link_local_next_hop, delete_unicast=delete_unicast, callback=_callback, mgr=mgr)
        return 0
