...
def interface_fortygigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_ipv6_phy_intf_cmds_hop_by_hop_trap_act(Action):
    def run(self, delete_fortygigabitethernet, delete_hop_by_hop_trap, delete_interface, delete_name, name, host, username, password):
