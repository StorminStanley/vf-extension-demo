...
def interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_interface_ospfv3_conf_priority_act(Action):
    def run(self, name, delete_fortygigabitethernet, priority, delete_priority, delete_interface, delete_name, host, username, password):
