...
def interface_gigabitethernet_bpdu_drop_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_bpdu_drop_enable_act(Action):
    def run(self, name, delete_enable, delete_bpdu_drop, delete_name, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_bpdu_drop_enable(name=name, delete_name=delete_name, delete_enable=delete_enable, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_bpdu_drop=delete_bpdu_drop, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
