...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time_act(Action):
    def run(self, key_activation_wait_time, name, delete_ip, delete_key_activation_wait_time, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_key_activation_wait_time(key_activation_wait_time=key_activation_wait_time, name=name, delete_name=delete_name, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_key_activation_wait_time=delete_key_activation_wait_time, delete_ve=delete_ve, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
