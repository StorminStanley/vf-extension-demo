...
def rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_metric_act(Action):
    def run(self, delete_static_route_oif, delete_route_attributes, static_route_oif_type, rbridge_id, delete_ip, delete_route, metric, delete_static_route_oif_name, delete_static_route_dest, static_route_dest, static_route_oif_name, delete_rtm_config, delete_rbridge_id, delete_static_route_oif_type, delete_metric, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_metric(delete_route_attributes=delete_route_attributes, metric=metric, delete_metric=delete_metric, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_rtm_config=delete_rtm_config, delete_static_route_oif=delete_static_route_oif, static_route_oif_name=static_route_oif_name, host=host, static_route_oif_type=static_route_oif_type, delete_static_route_oif_type=delete_static_route_oif_type, static_route_dest=static_route_dest, delete_static_route_dest=delete_static_route_dest, password=password, callback=_callback, mgr=mgr)
        return 0
