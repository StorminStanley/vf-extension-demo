...
def rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_bsr_cand_priority(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_bsr_cand_priority', False) is True:
        delete_bsr_cand_priority = config.find('.//*bsr-cand-priority')
        delete_bsr_cand_priority.set('operation', 'delete')
...
class rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_bsr_cand_priority_act(Action):
    def run(self, delete_pim, delete_bsr_cand_intf_type, rbridge_id, delete_hide_pim_holder, delete_bsr_cand_priority, bsr_cand_intf_type, bsr_cand_priority, bsr_cand_intf_id, delete_bsr_cand_interface, delete_bsr_candidate, delete_rbridge_id, delete_bsr_cand_intf_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_hide_pim_holder_pim_bsr_candidate_bsr_cand_interface_bsr_cand_priority(delete_bsr_cand_intf_id=delete_bsr_cand_intf_id, delete_router=delete_router, bsr_cand_intf_id=bsr_cand_intf_id, delete_bsr_candidate=delete_bsr_candidate, username=username, delete_pim=delete_pim, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_bsr_cand_intf_type=delete_bsr_cand_intf_type, delete_hide_pim_holder=delete_hide_pim_holder, delete_bsr_cand_priority=delete_bsr_cand_priority, host=host, bsr_cand_priority=bsr_cand_priority, bsr_cand_intf_type=bsr_cand_intf_type, delete_bsr_cand_interface=delete_bsr_cand_interface, password=password, callback=_callback, mgr=mgr)
        return 0
