...
def rbridge_id_ip_prefix_list_seq_keyword(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_prefix_list_seq_keyword_act(Action):
    def run(self, rbridge_id, delete_ip, delete_seq_keyword, instance, delete_instance, delete_name, delete_prefix_list, delete_rbridge_id, seq_keyword, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_prefix_list_seq_keyword(delete_instance=delete_instance, delete_prefix_list=delete_prefix_list, delete_name=delete_name, delete_seq_keyword=delete_seq_keyword, username=username, seq_keyword=seq_keyword, rbridge_id=rbridge_id, delete_ip=delete_ip, name=name, host=host, password=password, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
