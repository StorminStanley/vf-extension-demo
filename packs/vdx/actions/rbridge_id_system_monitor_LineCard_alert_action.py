...
def rbridge_id_system_monitor_LineCard_alert_action(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_system_monitor_LineCard_alert_action_act(Action):
    def run(self, rbridge_id, delete_alert, delete_action, action, delete_rbridge_id, delete_LineCard, delete_system_monitor, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_system_monitor_LineCard_alert_action(delete_system_monitor=delete_system_monitor, username=username, action=action, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_action=delete_action, host=host, delete_alert=delete_alert, delete_LineCard=delete_LineCard, password=password, callback=_callback, mgr=mgr)
        return 0
