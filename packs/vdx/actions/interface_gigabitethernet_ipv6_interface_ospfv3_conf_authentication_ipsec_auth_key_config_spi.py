...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_spi(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_spi_act(Action):
    def run(self, name, delete_ipsec_auth_key_config, spi, delete_spi, delete_authentication, delete_name, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_spi(delete_spi=delete_spi, name=name, delete_name=delete_name, username=username, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_authentication=delete_authentication, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, spi=spi, password=password, callback=_callback, mgr=mgr)
        return 0
