...
def rbridge_id_secpolicy_active_policy_policies_policy(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_secpolicy_active_policy_policies_policy_act(Action):
    def run(self, rbridge_id, delete_policy, delete_active_policy, policy, delete_secpolicy, delete_rbridge_id, delete_policies, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_secpolicy_active_policy_policies_policy(delete_secpolicy=delete_secpolicy, delete_active_policy=delete_active_policy, username=username, rbridge_id=rbridge_id, delete_policies=delete_policies, delete_policy=delete_policy, policy=policy, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
