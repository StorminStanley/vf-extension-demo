...
def interface_tengigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_add_trunk_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_trunk_trunk_vlan_classification_allowed_vlan_add_trunk_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk_vlan_classification, delete_trunk, trunk_vlan_id, delete_interface, delete_name, delete_add, delete_tengigabitethernet, delete_trunk_vlan_id, host, username, password):
