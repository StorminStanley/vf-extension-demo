...
def interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable_act(Action):
    def run(self, delete_intf_bfd_enable, name, delete_ip, delete_interface_fo_ospf_conf, delete_interface, delete_name, delete_hundredgigabitethernet, delete_bfd, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_intf_bfd_enable=delete_intf_bfd_enable, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, password=password, host=host, delete_interface=delete_interface, username=username, delete_bfd=delete_bfd, callback=_callback, mgr=mgr)
        return 0
