...
def interface_fortygigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_none(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_none_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_fortygigabitethernet, delete_private_vlan, delete_interface, delete_name, delete_pvlan_none, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_none(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_switchport=delete_switchport, delete_name=delete_name, delete_allowed=delete_allowed, delete_pvlan_none=delete_pvlan_none, delete_vlan=delete_vlan, host=host, delete_private_vlan=delete_private_vlan, delete_trunk=delete_trunk, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
