...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_timers_nei_keep_alive(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_timers_nei_keep_alive_act(Action):
    def run(self, nei_keep_alive, delete_router_bgp, rbridge_id, delete_router_bgp_attributes, delete_timers, delete_rbridge_id, delete_neighbor, delete_router, delete_nei_keep_alive, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_timers_nei_keep_alive(delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, nei_keep_alive=nei_keep_alive, delete_router=delete_router, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_nei_keep_alive=delete_nei_keep_alive, delete_timers=delete_timers, password=password, callback=_callback, mgr=mgr)
        return 0
