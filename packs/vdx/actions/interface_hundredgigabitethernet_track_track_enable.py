...
def interface_hundredgigabitethernet_track_track_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_track_track_enable_act(Action):
    def run(self, delete_track_enable, name, delete_interface, delete_name, delete_hundredgigabitethernet, delete_track, host, username, password):
