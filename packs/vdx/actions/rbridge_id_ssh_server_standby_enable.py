...
def rbridge_id_ssh_server_standby_enable(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_standby_enable_act(Action):
    def run(self, rbridge_id, delete_server, delete_standby, delete_enable, delete_ssh, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_standby_enable(delete_server=delete_server, username=username, delete_ssh=delete_ssh, rbridge_id=rbridge_id, delete_enable=delete_enable, host=host, delete_rbridge_id=delete_rbridge_id, delete_standby=delete_standby, password=password, callback=_callback, mgr=mgr)
        return 0
