...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_flag_dampening_flag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_flag_dampening_flag_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_ca_dampening_flag, delete_dampening_flag, delete_dampening, delete_af_common_cmds_holder, delete_default_vrf, delete_rbridge_id, delete_router, delete_ch_dampening_source, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_flag_dampening_flag(delete_af_common_cmds_holder=delete_af_common_cmds_holder, delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_dampening_flag=delete_dampening_flag, host=host, password=password, delete_address_family=delete_address_family, delete_ca_dampening_flag=delete_ca_dampening_flag, delete_default_vrf=delete_default_vrf, delete_ch_dampening_source=delete_ch_dampening_source, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
