...
def protocol_spanning_tree_rpvst_hello_time(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rpvst_hello_time_act(Action):
    def run(self, delete_rpvst, delete_hello_time, delete_spanning_tree, hello_time, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rpvst_hello_time(hello_time=hello_time, delete_rpvst=delete_rpvst, delete_spanning_tree=delete_spanning_tree, delete_hello_time=delete_hello_time, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
