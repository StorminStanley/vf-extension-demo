...
def interface_fortygigabitethernet_vrrp_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_preempt_mode_act(Action):
    def run(self, vrid, name, delete_vrid, delete_fortygigabitethernet, delete_preempt_mode, delete_version, version, delete_interface, delete_name, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_vrrp_preempt_mode(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, delete_name=delete_name, version=version, host=host, vrid=vrid, delete_version=delete_version, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
