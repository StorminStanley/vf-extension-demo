...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_database_filter_all_out(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_database_filter_all_out_act(Action):
    def run(self, name, delete_ip, delete_interface_fo_ospf_conf, delete_database_filter, delete_fortygigabitethernet, delete_interface, delete_name, delete_all_out, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_database_filter_all_out(delete_database_filter=delete_database_filter, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_all_out=delete_all_out, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
