...
def interface_fortygigabitethernet_vlan_classifier_activate_group_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vlan_classifier_activate_group_vlan_act(Action):
    def run(self, delete_vlan, delete_classifier, vlan, name, delete_group, delete_fortygigabitethernet, delete_activate, delete_interface, delete_name, delete_groupid, groupid, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_vlan_classifier_activate_group_vlan(delete_activate=delete_activate, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, vlan=vlan, delete_vlan=delete_vlan, delete_groupid=delete_groupid, delete_classifier=delete_classifier, groupid=groupid, host=host, delete_group=delete_group, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
