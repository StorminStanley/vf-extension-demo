...
def interface_vlan_interface_ve_ip_ip_anycast_gateway_ip_gw_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ip_ip_anycast_gateway_ip_gw_id_act(Action):
