...
def interface_gigabitethernet_switchport_access_mac_group_vlan_classification_access_vlan_access_mac_group(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_access_mac_group_vlan_classification_access_vlan_access_mac_group_act(Action):
    def run(self, delete_switchport, delete_vlan, access_mac_group, delete_access_vlan_id, name, delete_access_mac_group, delete_access_mac_group_vlan_classification, delete_access, access_vlan_id, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
