...
def interface_hundredgigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_remove(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_remove_act(Action):
    def run(self, delete_vlan, delete_mac_learning_vlan_remove, name, delete_mac_learn_disable, delete_mac_learning, delete_interface, delete_name, mac_learning_vlan_remove, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_remove(delete_mac_learning=delete_mac_learning, name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_mac_learning_vlan_remove=delete_mac_learning_vlan_remove, delete_mac_learn_disable=delete_mac_learn_disable, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_interface=delete_interface, username=username, mac_learning_vlan_remove=mac_learning_vlan_remove, password=password, callback=_callback, mgr=mgr)
        return 0
