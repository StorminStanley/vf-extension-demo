...
def interface_gigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_revert_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_revert_priority_act(Action):
    def run(self, name, revert_priority, delete_vrid, vrid, delete_short_path_forwarding, delete_interface, delete_name, delete_revert_priority, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_vrrpv3e_group_short_path_forwarding_revert_priority(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_short_path_forwarding=delete_short_path_forwarding, delete_gigabitethernet=delete_gigabitethernet, host=host, vrid=vrid, revert_priority=revert_priority, delete_interface=delete_interface, username=username, delete_revert_priority=delete_revert_priority, password=password, callback=_callback, mgr=mgr)
        return 0
