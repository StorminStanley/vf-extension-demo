...
def interface_port_channel_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan_act(Action):
    def run(self, delete_switchport, delete_mac_address, name, delete_port_secutiry_mac_address, port_sec_vlan, delete_port_channel, delete_interface, delete_name, mac_address, delete_sticky, delete_port_security, delete_port_sec_vlan, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_port_security_sticky_port_secutiry_mac_address_port_sec_vlan(delete_sticky=delete_sticky, port_sec_vlan=port_sec_vlan, name=name, delete_name=delete_name, delete_port_channel=delete_port_channel, delete_switchport=delete_switchport, delete_port_sec_vlan=delete_port_sec_vlan, mac_address=mac_address, delete_mac_address=delete_mac_address, host=host, password=password, delete_port_security=delete_port_security, delete_interface=delete_interface, username=username, delete_port_secutiry_mac_address=delete_port_secutiry_mac_address, callback=_callback, mgr=mgr)
        return 0
