...
def interface_fortygigabitethernet_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_bfd_interval_multiplier_act(Action):
    def run(self, delete_multiplier, name, delete_fortygigabitethernet, delete_interval, delete_interface, delete_name, multiplier, delete_bfd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_bfd_interval_multiplier(delete_interval=delete_interval, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_multiplier=delete_multiplier, delete_bfd=delete_bfd, host=host, password=password, delete_name=delete_name, delete_interface=delete_interface, username=username, multiplier=multiplier, callback=_callback, mgr=mgr)
        return 0
