...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_route_attributes_tag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_route_attributes_tag_act(Action):
    def run(self, delete_link_local_static_route_nh, delete_address_family, link_local_route_oif_name, rbridge_id, delete_tag, delete_route, delete_vrf, delete_link_local_static_route_dest, delete_link_local_route_oif_name, link_local_nexthop, delete_route_attributes, delete_link_local_route_oif_type, tag, vrf_name, link_local_route_oif_type, delete_link_local_nexthop, delete_rbridge_id, delete_unicast, link_local_static_route_dest, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_route_attributes_tag(delete_route_attributes=delete_route_attributes, delete_tag=delete_tag, link_local_route_oif_type=link_local_route_oif_type, link_local_nexthop=link_local_nexthop, delete_vrf_name=delete_vrf_name, delete_link_local_static_route_dest=delete_link_local_static_route_dest, delete_address_family=delete_address_family, tag=tag, rbridge_id=rbridge_id, vrf_name=vrf_name, delete_link_local_nexthop=delete_link_local_nexthop, delete_rbridge_id=delete_rbridge_id, password=password, delete_link_local_route_oif_type=delete_link_local_route_oif_type, delete_route=delete_route, delete_vrf=delete_vrf, delete_link_local_route_oif_name=delete_link_local_route_oif_name, link_local_route_oif_name=link_local_route_oif_name, username=username, host=host, delete_link_local_static_route_nh=delete_link_local_static_route_nh, link_local_static_route_dest=link_local_static_route_dest, delete_unicast=delete_unicast, callback=_callback, mgr=mgr)
        return 0
