...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count(**kwargs):
    """Auto Generated Code
    """
    ...
    ebgp_multihop = ET.SubElement(af_ipv4_neighbor_addr, "ebgp-multihop")
    ...
    if kwargs.pop('delete_ca_ebgp_multihop_count', False) is True:
        delete_ca_ebgp_multihop_count = config.find('.//*ca-ebgp-multihop-count')
        delete_ca_ebgp_multihop_count.set('operation', 'delete')
        
    ebgp_multihop_count = ET.SubElement(ca_ebgp_multihop_count, "ebgp-multihop-count")
    if kwargs.pop('delete_ebgp_multihop_count', False) is True:
        delete_ebgp_multihop_count = config.find('.//*ebgp-multihop-count')
        delete_ebgp_multihop_count.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, ebgp_multihop_count, delete_af_vrf_name, af_vrf_name, delete_ch_ebgp_multihop_type, delete_ca_ebgp_multihop_count, delete_ebgp_multihop, delete_rbridge_id, delete_neighbor, delete_router, delete_ebgp_multihop_count, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count(delete_router_bgp=delete_router_bgp, delete_ebgp_multihop=delete_ebgp_multihop, username=username, af_vrf_name=af_vrf_name, delete_ch_ebgp_multihop_type=delete_ch_ebgp_multihop_type, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_ca_ebgp_multihop_count=delete_ca_ebgp_multihop_count, ebgp_multihop_count=ebgp_multihop_count, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_ebgp_multihop_count=delete_ebgp_multihop_count, password=password, callback=_callback, mgr=mgr)
        return 0
