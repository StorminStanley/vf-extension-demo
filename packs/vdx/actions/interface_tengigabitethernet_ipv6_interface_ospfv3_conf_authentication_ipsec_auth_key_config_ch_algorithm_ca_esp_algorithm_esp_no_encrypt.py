...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_no_encrypt(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_no_encrypt_act(Action):
    def run(self, name, delete_ipsec_auth_key_config, delete_ca_esp_algorithm, delete_authentication, delete_name, delete_esp_no_encrypt, delete_tengigabitethernet, delete_ch_algorithm, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_no_encrypt(delete_ca_esp_algorithm=delete_ca_esp_algorithm, name=name, delete_name=delete_name, delete_esp_no_encrypt=delete_esp_no_encrypt, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_authentication=delete_authentication, host=host, delete_ch_algorithm=delete_ch_algorithm, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
