...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_mtu_ignore(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_mtu_ignore_act(Action):
    def run(self, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_interface, delete_name, delete_mtu_ignore, delete_ospf_interface_config, host, username, password):
