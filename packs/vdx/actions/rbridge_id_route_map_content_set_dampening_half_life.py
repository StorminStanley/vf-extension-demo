...
def rbridge_id_route_map_content_set_dampening_half_life(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_dampening_half_life_act(Action):
    def run(self, rbridge_id, delete_set, half_life, delete_dampening, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_half_life, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_dampening_half_life(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_half_life=delete_half_life, username=username, rbridge_id=rbridge_id, half_life=half_life, password=password, delete_route_map=delete_route_map, delete_action_rm=delete_action_rm, delete_content=delete_content, delete_set=delete_set, instance=instance, delete_name=delete_name, host=host, delete_rbridge_id=delete_rbridge_id, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
