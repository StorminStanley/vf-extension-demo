...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_static_static_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_static_static_route_map_act(Action):
    def run(self, delete_static_route_map, delete_address_family, delete_static, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_redistribute, delete_rbridge_id, static_route_map, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_af_ipv4_uc_and_vrf_cmds_call_point_holder_redistribute_static_static_route_map(delete_static_route_map=delete_static_route_map, delete_static=delete_static, username=username, af_vrf_name=af_vrf_name, delete_redistribute=delete_redistribute, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, static_route_map=static_route_map, delete_router=delete_router, host=host, password=password, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
