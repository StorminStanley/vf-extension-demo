...
def interface_gigabitethernet_ipv6_vrrpv3_group_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_vrrpv3_group_hold_time_act(Action):
