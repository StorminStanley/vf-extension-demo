...
def rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_pim_dr_priority(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_pim_dr_priority_act(Action):
    def run(self, delete_pim, name, delete_ip, delete_dr_priority, dr_priority, delete_ve, delete_interface, delete_name, delete_pim_intf_vlan_cont, delete_rbridge_id, delete_pim_int_cmd, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_pim_dr_priority(dr_priority=dr_priority, name=name, delete_name=delete_name, delete_pim=delete_pim, username=username, delete_dr_priority=delete_dr_priority, delete_ip=delete_ip, delete_pim_int_cmd=delete_pim_int_cmd, delete_ve=delete_ve, host=host, delete_pim_intf_vlan_cont=delete_pim_intf_vlan_cont, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
