...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_dampening_ch_dampening_source_ca_dampening_specify_values_values_start_suppress_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_dampening_ch_dampening_source_ca_dampening_specify_values_values_start_suppress_time_act(Action):
    def run(self, delete_address_family, delete_ca_dampening_specify_values, delete_router_bgp, rbridge_id, delete_af_vrf, delete_dampening, delete_af_vrf_name, af_vrf_name, delete_start_suppress_time, start_suppress_time, delete_rbridge_id, delete_values, delete_router, delete_ch_dampening_source, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_dampening_ch_dampening_source_ca_dampening_specify_values_values_start_suppress_time(delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_start_suppress_time=delete_start_suppress_time, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, password=password, start_suppress_time=start_suppress_time, delete_router=delete_router, host=host, delete_values=delete_values, delete_ca_dampening_specify_values=delete_ca_dampening_specify_values, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_ch_dampening_source=delete_ch_dampening_source, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
