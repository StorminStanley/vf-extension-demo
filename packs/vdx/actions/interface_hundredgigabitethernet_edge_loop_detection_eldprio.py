...
def interface_hundredgigabitethernet_edge_loop_detection_eldprio(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_edge_loop_detection_eldprio_act(Action):
    def run(self, name, delete_eldprio, eldprio, delete_edge_loop_detection, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
