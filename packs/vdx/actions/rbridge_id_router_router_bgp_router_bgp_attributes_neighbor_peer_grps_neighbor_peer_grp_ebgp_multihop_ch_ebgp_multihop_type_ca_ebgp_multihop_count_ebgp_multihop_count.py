...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count_act(Action):
    def run(self, delete_ch_ebgp_multihop_type, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, delete_ca_ebgp_multihop_count, ebgp_multihop_count, router_bgp_neighbor_peer_grp, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_ebgp_multihop, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, delete_ebgp_multihop_count, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_ebgp_multihop_ch_ebgp_multihop_type_ca_ebgp_multihop_count_ebgp_multihop_count(delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router=delete_router, delete_router_bgp=delete_router_bgp, delete_ebgp_multihop=delete_ebgp_multihop, username=username, delete_neighbor=delete_neighbor, delete_ca_ebgp_multihop_count=delete_ca_ebgp_multihop_count, rbridge_id=rbridge_id, delete_ch_ebgp_multihop_type=delete_ch_ebgp_multihop_type, ebgp_multihop_count=ebgp_multihop_count, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_rbridge_id=delete_rbridge_id, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_ebgp_multihop_count=delete_ebgp_multihop_count, delete_peer_grps=delete_peer_grps, callback=_callback, mgr=mgr)
        return 0
