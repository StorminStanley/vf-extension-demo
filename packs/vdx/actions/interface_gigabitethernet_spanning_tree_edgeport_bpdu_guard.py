...
def interface_gigabitethernet_spanning_tree_edgeport_bpdu_guard(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_edgeport_bpdu_guard_act(Action):
    def run(self, name, delete_bpdu_guard, delete_interface, delete_name, delete_edgeport, delete_spanning_tree, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_spanning_tree_edgeport_bpdu_guard(delete_edgeport=delete_edgeport, name=name, delete_name=delete_name, username=username, delete_spanning_tree=delete_spanning_tree, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, delete_bpdu_guard=delete_bpdu_guard, password=password, callback=_callback, mgr=mgr)
        return 0
