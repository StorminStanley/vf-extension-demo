...
def interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_no_encrypt(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_no_encrypt_act(Action):
    def run(self, name, delete_ipsec_auth_key_config, delete_ah_no_encrypt, delete_ca_ah_algorithm, delete_port_channel, delete_authentication, delete_name, delete_ch_algorithm, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_auth_key_config_ch_algorithm_ca_ah_algorithm_ah_no_encrypt(delete_ca_ah_algorithm=delete_ca_ah_algorithm, delete_port_channel=delete_port_channel, name=name, delete_name=delete_name, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_authentication=delete_authentication, delete_ah_no_encrypt=delete_ah_no_encrypt, delete_ch_algorithm=delete_ch_algorithm, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
