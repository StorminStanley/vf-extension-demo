...
def interface_gigabitethernet_vrrp_use_v2_checksum(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_use_v2_checksum_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_use_v2_checksum(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, version=version, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
