...
def rbridge_id_route_map_content_set_ipv6_next_vrf_next_vrf_list_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ipv6_next_vrf_next_vrf_list_next_hop_act(Action):
    def run(self, next_hop, delete_next_hop, rbridge_id, delete_set, delete_next_vrf, delete_vrf, delete_route_map, delete_content, instance, delete_instance, action_rm, vrf, delete_name, delete_rbridge_id, delete_next_vrf_list, delete_action_rm, name, host, username, password):
