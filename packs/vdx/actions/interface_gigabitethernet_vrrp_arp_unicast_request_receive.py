...
def interface_gigabitethernet_vrrp_arp_unicast_request_receive(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_arp_unicast_request_receive_act(Action):
    def run(self, delete_unicast_request, name, delete_vrid, delete_receive, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_gigabitethernet, delete_arp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_arp_unicast_request_receive(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_arp=delete_arp, delete_receive=delete_receive, version=version, host=host, password=password, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_unicast_request=delete_unicast_request, callback=_callback, mgr=mgr)
        return 0
