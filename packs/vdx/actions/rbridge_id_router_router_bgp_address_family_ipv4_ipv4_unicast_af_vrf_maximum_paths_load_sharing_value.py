...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_maximum_paths_load_sharing_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_maximum_paths_load_sharing_value_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_maximum_paths, delete_load_sharing_value, load_sharing_value, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_maximum_paths_load_sharing_value(delete_router_bgp=delete_router_bgp, delete_maximum_paths=delete_maximum_paths, username=username, af_vrf_name=af_vrf_name, delete_load_sharing_value=delete_load_sharing_value, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_router=delete_router, host=host, delete_address_family=delete_address_family, load_sharing_value=load_sharing_value, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
