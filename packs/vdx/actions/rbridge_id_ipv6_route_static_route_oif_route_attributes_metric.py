...
def rbridge_id_ipv6_route_static_route_oif_route_attributes_metric(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_route_oif_route_attributes_metric_act(Action):
    def run(self, delete_static_route_oif, delete_route_attributes, static_route_oif_type, rbridge_id, delete_static_route_oif_type, delete_route, metric, delete_static_route_oif_name, delete_static_route_dest, static_route_dest, static_route_oif_name, delete_rbridge_id, delete_metric, host, username, password):
