...
def interface_tengigabitethernet_spanning_tree_vlan_cost(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_spanning_tree_vlan_cost_act(Action):
    def run(self, delete_vlan, name, id, delete_cost, delete_id, cost, delete_interface, delete_name, delete_tengigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_spanning_tree_vlan_cost(delete_cost=delete_cost, name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_tengigabitethernet=delete_tengigabitethernet, cost=cost, host=host, id=id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
