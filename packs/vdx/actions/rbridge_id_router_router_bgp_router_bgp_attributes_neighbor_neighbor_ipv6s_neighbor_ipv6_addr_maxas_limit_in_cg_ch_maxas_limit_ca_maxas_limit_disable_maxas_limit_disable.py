...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_maxas_limit_in_cg_ch_maxas_limit_ca_maxas_limit_disable_maxas_limit_disable(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_maxas_limit_in_cg_ch_maxas_limit_ca_maxas_limit_disable_maxas_limit_disable_act(Action):
    def run(self, delete_ca_maxas_limit_disable, delete_router_bgp, rbridge_id, delete_router_bgp_attributes, delete_maxas_limit, delete_in_cg, delete_rbridge_id, delete_ch_maxas_limit, delete_neighbor, delete_router, delete_maxas_limit_disable, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_maxas_limit_in_cg_ch_maxas_limit_ca_maxas_limit_disable_maxas_limit_disable(delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, delete_ca_maxas_limit_disable=delete_ca_maxas_limit_disable, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_maxas_limit=delete_maxas_limit, delete_in_cg=delete_in_cg, delete_maxas_limit_disable=delete_maxas_limit_disable, password=password, delete_ch_maxas_limit=delete_ch_maxas_limit, callback=_callback, mgr=mgr)
        return 0
