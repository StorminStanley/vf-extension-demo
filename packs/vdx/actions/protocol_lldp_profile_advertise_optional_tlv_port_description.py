...
def protocol_lldp_profile_advertise_optional_tlv_port_description(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_port_description', False) is True:
        delete_port_description = config.find('.//*port-description')
        delete_port_description.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class protocol_lldp_profile_advertise_optional_tlv_port_description_act(Action):
    def run(self, delete_profile_name, delete_port_description, delete_protocol, delete_lldp, delete_optional_tlv, profile_name, delete_advertise, delete_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_profile_advertise_optional_tlv_port_description(delete_profile_name=delete_profile_name, delete_port_description=delete_port_description, profile_name=profile_name, delete_optional_tlv=delete_optional_tlv, delete_lldp=delete_lldp, delete_profile=delete_profile, delete_protocol=delete_protocol, password=password, host=host, username=username, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
