...
def interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_auth_change_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_auth_change_wait_time_act(Action):
    def run(self, auth_change_wait_time, delete_ip, delete_interface_PO_ospf_conf, delete_auth_change_wait_time, delete_port_channel, delete_interface, delete_name, delete_ospf_interface_config, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ip_interface_PO_ospf_conf_ospf_interface_config_auth_change_wait_time(delete_ospf_interface_config=delete_ospf_interface_config, delete_name=delete_name, delete_ip=delete_ip, delete_interface_PO_ospf_conf=delete_interface_PO_ospf_conf, name=name, delete_port_channel=delete_port_channel, auth_change_wait_time=auth_change_wait_time, host=host, password=password, delete_interface=delete_interface, username=username, delete_auth_change_wait_time=delete_auth_change_wait_time, callback=_callback, mgr=mgr)
        return 0
