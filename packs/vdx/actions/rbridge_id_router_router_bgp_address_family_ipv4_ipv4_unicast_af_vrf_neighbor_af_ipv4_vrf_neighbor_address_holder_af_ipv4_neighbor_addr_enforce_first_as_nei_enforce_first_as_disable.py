...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_enforce_first_as_nei_enforce_first_as_disable(**kwargs):
    """Auto Generated Code
    """
    ...
    enforce_first_as = ET.SubElement(af_ipv4_neighbor_addr, "enforce-first-as")
    if kwargs.pop('delete_enforce_first_as', False) is True:
        delete_enforce_first_as = config.find('.//*enforce-first-as')
        delete_enforce_first_as.set('operation', 'delete')
        
    nei_enforce_first_as_disable = ET.SubElement(enforce_first_as, "nei-enforce-first-as-disable")
    if kwargs.pop('delete_nei_enforce_first_as_disable', False) is True:
        delete_nei_enforce_first_as_disable = config.find('.//*nei-enforce-first-as-disable')
        delete_nei_enforce_first_as_disable.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_enforce_first_as_nei_enforce_first_as_disable_act(Action):
    def run(self, delete_address_family, delete_enforce_first_as, delete_router_bgp, rbridge_id, delete_af_vrf, delete_nei_enforce_first_as_disable, delete_af_vrf_name, af_vrf_name, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_enforce_first_as_nei_enforce_first_as_disable(delete_enforce_first_as=delete_enforce_first_as, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_af_vrf_name=delete_af_vrf_name, rbridge_id=rbridge_id, delete_nei_enforce_first_as_disable=delete_nei_enforce_first_as_disable, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
