...
def interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_all(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_all_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_pvlan_all, delete_private_vlan, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_private_vlan_trunk_allowed_vlan_pvlan_all(name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, delete_allowed=delete_allowed, password=password, delete_vlan=delete_vlan, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_private_vlan=delete_private_vlan, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_pvlan_all=delete_pvlan_all, callback=_callback, mgr=mgr)
        return 0
