...
def rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_static_route_oif_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_static_route_oif_name_act(Action):
    def run(self, delete_next_hop_vrf, rbridge_id, delete_static_route_oif_type, delete_static_route_next_vrf_dest, delete_route, next_hop_vrf, static_route_oif_type, delete_static_route_oif_name, static_route_next_vrf_dest, delete_rbridge_id, static_route_oif_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_ipv6_static_route_oif_vrf_static_route_oif_name(next_hop_vrf=next_hop_vrf, delete_static_route_oif_name=delete_static_route_oif_name, delete_route=delete_route, static_route_next_vrf_dest=static_route_next_vrf_dest, username=username, rbridge_id=rbridge_id, static_route_oif_type=static_route_oif_type, delete_static_route_oif_type=delete_static_route_oif_type, host=host, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, delete_next_hop_vrf=delete_next_hop_vrf, static_route_oif_name=static_route_oif_name, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
