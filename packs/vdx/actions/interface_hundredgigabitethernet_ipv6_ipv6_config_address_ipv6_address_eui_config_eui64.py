...
def interface_hundredgigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui64(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui64_act(Action):
    def run(self, name, delete_interface, delete_name, address, delete_hundredgigabitethernet, delete_address, delete_eui_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui64(name=name, delete_address=delete_address, address=address, delete_eui_config=delete_eui_config, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
