...
def interface_hundredgigabitethernet_ip_icmp_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_icmp_redirect_act(Action):
    def run(self, name, delete_ip, delete_icmp, delete_redirect, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_icmp_redirect(name=name, delete_redirect=delete_redirect, delete_icmp=delete_icmp, delete_ip=delete_ip, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
