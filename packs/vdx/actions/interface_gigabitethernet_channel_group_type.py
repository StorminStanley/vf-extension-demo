...
def interface_gigabitethernet_channel_group_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_channel_group_type_act(Action):
    def run(self, name, delete_channel_group, delete_name, delete_type, type, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_channel_group_type(name=name, type=type, delete_type=delete_type, delete_channel_group=delete_channel_group, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
