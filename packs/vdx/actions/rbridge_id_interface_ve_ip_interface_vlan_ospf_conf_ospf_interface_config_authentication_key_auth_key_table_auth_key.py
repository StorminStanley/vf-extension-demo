...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_auth_key(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_auth_key_act(Action):
    def run(self, auth_key, name, delete_ip, delete_auth_key, delete_authentication_key, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, delete_auth_key_table, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_auth_key(name=name, auth_key=auth_key, delete_auth_key=delete_auth_key, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, delete_auth_key_table=delete_auth_key_table, delete_authentication_key=delete_authentication_key, delete_ve=delete_ve, host=host, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
