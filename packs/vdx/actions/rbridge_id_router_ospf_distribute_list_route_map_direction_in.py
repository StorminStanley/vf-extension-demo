...
def rbridge_id_router_ospf_distribute_list_route_map_direction_in(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_distribute_list_route_map_direction_in_act(Action):
    def run(self, delete_direction_in, rbridge_id, delete_ospf, delete_vrf, delete_route_map, vrf, delete_distribute_list, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_distribute_list_route_map_direction_in(username=username, delete_direction_in=delete_direction_in, delete_router=delete_router, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_route_map=delete_route_map, delete_distribute_list=delete_distribute_list, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
