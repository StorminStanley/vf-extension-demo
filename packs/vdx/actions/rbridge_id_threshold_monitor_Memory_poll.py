...
def rbridge_id_threshold_monitor_Memory_poll(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_Memory_poll_act(Action):
    def run(self, delete_poll, rbridge_id, delete_Memory, delete_threshold_monitor, poll, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_Memory_poll(username=username, delete_threshold_monitor=delete_threshold_monitor, delete_Memory=delete_Memory, rbridge_id=rbridge_id, host=host, poll=poll, delete_poll=delete_poll, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
