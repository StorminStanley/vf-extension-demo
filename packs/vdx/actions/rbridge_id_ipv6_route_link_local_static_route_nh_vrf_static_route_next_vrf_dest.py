...
def rbridge_id_ipv6_route_link_local_static_route_nh_vrf_static_route_next_vrf_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_link_local_static_route_nh_vrf_static_route_next_vrf_dest_act(Action):
    def run(self, link_local_route_oif_name, rbridge_id, delete_route, delete_link_local_route_oif_name, delete_next_hop_vrf, delete_static_route_next_vrf_dest, delete_link_local_route_oif_type, static_route_next_vrf_dest, link_local_next_hop, delete_link_local_next_hop, next_hop_vrf, delete_rbridge_id, delete_link_local_static_route_nh_vrf, link_local_route_oif_type, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_link_local_static_route_nh_vrf_static_route_next_vrf_dest(delete_link_local_route_oif_type=delete_link_local_route_oif_type, next_hop_vrf=next_hop_vrf, delete_route=delete_route, delete_link_local_static_route_nh_vrf=delete_link_local_static_route_nh_vrf, link_local_route_oif_type=link_local_route_oif_type, username=username, rbridge_id=rbridge_id, delete_link_local_route_oif_name=delete_link_local_route_oif_name, delete_link_local_next_hop=delete_link_local_next_hop, static_route_next_vrf_dest=static_route_next_vrf_dest, link_local_next_hop=link_local_next_hop, delete_next_hop_vrf=delete_next_hop_vrf, host=host, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, link_local_route_oif_name=link_local_route_oif_name, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
