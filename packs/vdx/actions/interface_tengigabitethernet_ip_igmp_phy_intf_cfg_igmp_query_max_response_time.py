...
def interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time_act(Action):
    def run(self, name, delete_ip, delete_igmp_phy_intf_cfg, delete_query_max_response_time, delete_igmp, delete_interface, delete_name, query_max_response_time, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, query_max_response_time=query_max_response_time, name=name, delete_name=delete_name, delete_igmp=delete_igmp, delete_ip=delete_ip, delete_query_max_response_time=delete_query_max_response_time, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
