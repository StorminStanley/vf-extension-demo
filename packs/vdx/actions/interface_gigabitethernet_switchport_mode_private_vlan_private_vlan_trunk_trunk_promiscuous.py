...
def interface_gigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_promiscuous(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_promiscuous_act(Action):
    def run(self, delete_switchport, name, delete_gigabitethernet, delete_private_vlan, delete_interface, delete_name, delete_trunk_promiscuous, delete_mode, delete_private_vlan_trunk, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_promiscuous(delete_trunk_promiscuous=delete_trunk_promiscuous, name=name, delete_name=delete_name, delete_switchport=delete_switchport, username=username, delete_mode=delete_mode, delete_private_vlan=delete_private_vlan, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, delete_private_vlan_trunk=delete_private_vlan_trunk, password=password, callback=_callback, mgr=mgr)
        return 0
