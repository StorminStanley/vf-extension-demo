...
def interface_hundredgigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_dr_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_dr_priority_act(Action):
    def run(self, delete_pim, delete_pim_intf_phy_cont, delete_ip, delete_dr_priority, dr_priority, delete_interface, delete_name, delete_hundredgigabitethernet, delete_pim_int_cmd, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_dr_priority(dr_priority=dr_priority, name=name, delete_name=delete_name, delete_pim=delete_pim, delete_dr_priority=delete_dr_priority, delete_ip=delete_ip, delete_pim_int_cmd=delete_pim_int_cmd, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_pim_intf_phy_cont=delete_pim_intf_phy_cont, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
