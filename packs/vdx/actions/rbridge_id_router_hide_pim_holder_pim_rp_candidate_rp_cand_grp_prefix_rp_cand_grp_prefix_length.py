...
def rbridge_id_router_hide_pim_holder_pim_rp_candidate_rp_cand_grp_prefix_rp_cand_grp_prefix_length(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_hide_pim_holder_pim_rp_candidate_rp_cand_grp_prefix_rp_cand_grp_prefix_length_act(Action):
