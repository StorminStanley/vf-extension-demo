...
def interface_fortygigabitethernet_vrrp_version(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_version_act(Action):
