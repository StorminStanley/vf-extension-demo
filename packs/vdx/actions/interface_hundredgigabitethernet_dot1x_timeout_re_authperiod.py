...
def interface_hundredgigabitethernet_dot1x_agtimeout_re_authperiod(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_dot1x_agtimeout_re_authperiod_act(Action):
    def run(self, delete_re_authperiod, name, re_authperiod, delete_agtimeout, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_dot1x_agtimeout_re_authperiod(name=name, delete_name=delete_name, delete_re_authperiod=delete_re_authperiod, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_agtimeout=delete_agtimeout, re_authperiod=re_authperiod, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
