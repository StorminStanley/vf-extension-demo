...
def interface_vlan_interface_vlan_ip_igmp_static_group_value(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_static_group_value_act(Action):
