...
def interface_fortygigabitethernet_edge_loop_detection_eldvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_edge_loop_detection_eldvlan_act(Action):
    def run(self, name, delete_fortygigabitethernet, delete_edge_loop_detection, delete_interface, delete_name, delete_eldvlan, eldvlan, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_edge_loop_detection_eldvlan(name=name, delete_eldvlan=delete_eldvlan, eldvlan=eldvlan, delete_name=delete_name, delete_edge_loop_detection=delete_edge_loop_detection, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
