...
def interface_fortygigabitethernet_sflow_polling_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_sflow_polling_interval_act(Action):
    def run(self, delete_sflow, delete_polling_interval, name, delete_fortygigabitethernet, delete_interface, delete_name, polling_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_sflow_polling_interval(name=name, delete_name=delete_name, delete_sflow=delete_sflow, delete_polling_interval=delete_polling_interval, host=host, password=password, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, polling_interval=polling_interval, callback=_callback, mgr=mgr)
        return 0
