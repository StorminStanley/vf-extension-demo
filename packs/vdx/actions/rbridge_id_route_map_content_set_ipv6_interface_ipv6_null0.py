...
def rbridge_id_route_map_content_set_ipv6_interface_ipv6_null0(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_ipv6_interface_ipv6_null0_act(Action):
    def run(self, rbridge_id, delete_set, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_interface, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
