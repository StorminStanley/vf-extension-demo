...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_maximum_prefix_threshold_holder_teardown(**kwargs):
    """Auto Generated Code
    """
    ...
    maximum_prefix = ET.SubElement(af_ipv6_neighbor_addr, "maximum-prefix")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_maximum_prefix_threshold_holder_teardown_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_teardown, delete_threshold_holder, delete_rbridge_id, delete_maximum_prefix, delete_neighbor, delete_router, host, username, password):
