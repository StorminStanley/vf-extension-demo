...
def interface_gigabitethernet_spanning_tree_link_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_spanning_tree_link_type_act(Action):
    def run(self, name, link_type, delete_link_type, delete_interface, delete_name, delete_spanning_tree, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_spanning_tree_link_type(name=name, delete_name=delete_name, link_type=link_type, delete_spanning_tree=delete_spanning_tree, host=host, delete_link_type=delete_link_type, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
