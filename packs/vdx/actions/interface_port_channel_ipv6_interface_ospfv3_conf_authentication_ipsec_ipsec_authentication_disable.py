...
def interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_ipsec_authentication_disable(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_ipsec_authentication_disable_act(Action):
    def run(self, delete_ipsec_authentication_disable, name, delete_ipsec, delete_port_channel, delete_authentication, delete_name, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_ipsec_authentication_disable(name=name, delete_ipsec=delete_ipsec, delete_ipsec_authentication_disable=delete_ipsec_authentication_disable, delete_port_channel=delete_port_channel, delete_authentication=delete_authentication, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
