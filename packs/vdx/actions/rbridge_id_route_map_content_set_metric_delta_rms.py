...
def rbridge_id_route_map_content_set_metric_delta_rms(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_metric_delta_rms_act(Action):
    def run(self, rbridge_id, delete_set, delete_route_map, delete_content, delete_delta_rms, instance, delete_instance, action_rm, delete_metric, delete_name, delta_rms, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_metric_delta_rms(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_name=delete_name, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_delta_rms=delete_delta_rms, delta_rms=delta_rms, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_metric=delete_metric, password=password, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
