...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_update_source_ch_update_source_ca_ipv6_sip_ipv6_address(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ca_ipv6', False) is True:
        delete_ca_ipv6 = config.find('.//*ca-ipv6')
        delete_ca_ipv6.set('operation', 'delete')
        
    sip_ipv6_address = ET.SubElement(ca_ipv6, "sip-ipv6-address")
    if kwargs.pop('delete_sip_ipv6_address', False) is True:
        delete_sip_ipv6_address = config.find('.//*sip-ipv6-address')
        delete_sip_ipv6_address.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_update_source_ch_update_source_ca_ipv6_sip_ipv6_address_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_update_source, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_update_source_ch_update_source_ca_ipv6_sip_ipv6_address(delete_ch_update_source=delete_ch_update_source, delete_neighbor=delete_neighbor, username=username, rbridge_id=rbridge_id, delete_router=delete_router, host=host, password=password, delete_address_family=delete_address_family, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
