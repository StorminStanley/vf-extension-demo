...
def interface_gigabitethernet_mac_access_group_mac_access_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_mac_access_group_mac_access_list_act(Action):
