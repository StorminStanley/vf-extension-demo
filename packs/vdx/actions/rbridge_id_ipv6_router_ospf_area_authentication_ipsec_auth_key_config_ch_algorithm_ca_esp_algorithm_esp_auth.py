...
def rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_auth(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_auth_act(Action):
    def run(self, area_id, rbridge_id, delete_ospf, delete_vrf, esp_auth, delete_area_id, delete_ca_esp_algorithm, delete_ipsec_auth_key_config, delete_area, vrf, delete_rbridge_id, delete_ch_algorithm, delete_esp_auth, delete_router, delete_authentication, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_auth(delete_ca_esp_algorithm=delete_ca_esp_algorithm, delete_esp_auth=delete_esp_auth, username=username, delete_area=delete_area, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, esp_auth=esp_auth, password=password, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_ch_algorithm=delete_ch_algorithm, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_authentication=delete_authentication, area_id=area_id, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
