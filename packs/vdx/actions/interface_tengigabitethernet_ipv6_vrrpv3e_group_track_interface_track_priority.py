...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_track_interface_track_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_track_interface_track_priority_act(Action):
