...
def interface_port_channel_vrrp_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_preempt_mode_act(Action):
    def run(self, name, delete_vrid, vrid, delete_preempt_mode, delete_version, delete_port_channel, version, delete_interface, delete_name, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_vrrp_preempt_mode(delete_vrid=delete_vrid, version=version, name=name, delete_version=delete_version, username=username, delete_vrrp=delete_vrrp, delete_port_channel=delete_port_channel, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
