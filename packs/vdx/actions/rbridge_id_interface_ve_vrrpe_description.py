...
def rbridge_id_interface_ve_vrrpe_description(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_description_act(Action):
    def run(self, delete_description, name, delete_vrid, description, vrid, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_description(delete_vrid=delete_vrid, name=name, description=description, delete_vrrpe=delete_vrrpe, username=username, rbridge_id=rbridge_id, delete_description=delete_description, delete_ve=delete_ve, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
