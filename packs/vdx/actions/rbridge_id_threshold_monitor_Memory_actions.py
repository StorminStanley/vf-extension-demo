...
def rbridge_id_threshold_monitor_Memory_actions(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_Memory_actions_act(Action):
    def run(self, rbridge_id, delete_Memory, actions, delete_actions, delete_threshold_monitor, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_Memory_actions(delete_Memory=delete_Memory, username=username, delete_threshold_monitor=delete_threshold_monitor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_actions=delete_actions, host=host, actions=actions, password=password, callback=_callback, mgr=mgr)
        return 0
