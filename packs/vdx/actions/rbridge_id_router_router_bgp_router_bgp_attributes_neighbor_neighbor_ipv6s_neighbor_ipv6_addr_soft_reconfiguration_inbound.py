...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_soft_reconfiguration_inbound(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_soft_reconfiguration_inbound_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_inbound, delete_router_bgp_attributes, delete_soft_reconfiguration, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
