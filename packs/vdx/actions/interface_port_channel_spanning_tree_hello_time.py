...
def interface_port_channel_spanning_tree_hello_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_spanning_tree_hello_time_act(Action):
    def run(self, delete_hello_time, name, hello_time, delete_port_channel, delete_interface, delete_name, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_spanning_tree_hello_time(delete_port_channel=delete_port_channel, name=name, hello_time=hello_time, delete_spanning_tree=delete_spanning_tree, delete_hello_time=delete_hello_time, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
