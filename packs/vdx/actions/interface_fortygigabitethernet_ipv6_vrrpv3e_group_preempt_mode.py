...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_preempt_mode_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_vrid, vrid, delete_preempt_mode, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_preempt_mode(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, username=username, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
