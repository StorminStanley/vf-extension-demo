...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_off_link(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_off_link_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_interface, delete_name, delete_prefix_flags, delete_off_link, delete_lifetime, delete_nd, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_off_link(delete_prefix_flags=delete_prefix_flags, name=name, delete_name=delete_name, delete_off_link=delete_off_link, delete_lifetime=delete_lifetime, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_preferred=delete_preferred, delete_nd=delete_nd, delete_prefix=delete_prefix, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
