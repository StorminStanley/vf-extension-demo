...
def interface_port_channel_switchport_port_security_port_sec_max(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_port_security_port_sec_max_act(Action):
    def run(self, delete_switchport, name, port_sec_max, delete_port_sec_max, delete_port_channel, delete_interface, delete_name, delete_port_security, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_switchport_port_security_port_sec_max(name=name, delete_name=delete_name, delete_switchport=delete_switchport, username=username, delete_port_channel=delete_port_channel, host=host, port_sec_max=port_sec_max, delete_port_security=delete_port_security, delete_interface=delete_interface, delete_port_sec_max=delete_port_sec_max, password=password, callback=_callback, mgr=mgr)
        return 0
