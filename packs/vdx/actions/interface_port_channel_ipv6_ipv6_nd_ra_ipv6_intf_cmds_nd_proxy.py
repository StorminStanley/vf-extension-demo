...
def interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_proxy(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_proxy_act(Action):
    def run(self, name, delete_proxy, delete_port_channel, delete_interface, delete_name, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_proxy(name=name, delete_name=delete_name, delete_port_channel=delete_port_channel, delete_nd=delete_nd, host=host, delete_proxy=delete_proxy, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
