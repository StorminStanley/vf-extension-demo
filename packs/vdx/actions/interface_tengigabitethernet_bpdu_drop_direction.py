...
def interface_tengigabitethernet_bpdu_drop_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_bpdu_drop_direction_act(Action):
    def run(self, direction, name, delete_interface, delete_bpdu_drop, delete_name, delete_tengigabitethernet, delete_direction, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_bpdu_drop_direction(name=name, delete_name=delete_name, password=password, delete_tengigabitethernet=delete_tengigabitethernet, host=host, direction=direction, delete_bpdu_drop=delete_bpdu_drop, username=username, delete_interface=delete_interface, delete_direction=delete_direction, callback=_callback, mgr=mgr)
        return 0
