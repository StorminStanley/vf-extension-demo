...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_database_filter_all_out(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_database_filter_all_out_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, delete_database_filter, delete_interface, delete_name, delete_all_out, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_database_filter_all_out(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, delete_database_filter=delete_database_filter, name=name, delete_name=delete_name, delete_all_out=delete_all_out, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
