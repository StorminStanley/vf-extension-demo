...
def rbridge_id_router_ospf_area_virtual_link_virt_link_neighbor(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_area_virtual_link_virt_link_neighbor_act(Action):
    def run(self, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_area, vrf, delete_virt_link_neighbor, delete_rbridge_id, virt_link_neighbor, delete_router, host, username, password):
