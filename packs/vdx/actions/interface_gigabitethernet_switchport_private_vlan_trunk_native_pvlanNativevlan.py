...
def interface_gigabitethernet_switchport_private_vlan_trunk_native_pvlanNativevlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_private_vlan_trunk_native_pvlanNativevlan_act(Action):
    def run(self, delete_switchport, delete_native, pvlanNativevlan, name, delete_trunk, delete_pvlanNativevlan, delete_private_vlan, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_private_vlan_trunk_native_pvlanNativevlan(name=name, pvlanNativevlan=pvlanNativevlan, delete_switchport=delete_switchport, delete_name=delete_name, delete_pvlanNativevlan=delete_pvlanNativevlan, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_private_vlan=delete_private_vlan, delete_native=delete_native, delete_interface=delete_interface, username=username, password=password, delete_trunk=delete_trunk, callback=_callback, mgr=mgr)
        return 0
