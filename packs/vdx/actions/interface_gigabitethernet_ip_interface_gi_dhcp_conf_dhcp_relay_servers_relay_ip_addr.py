...
def interface_gigabitethernet_ip_interface_gi_dhcp_conf_dhcp_relay_servers_relay_ip_addr(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_dhcp_conf_dhcp_relay_servers_relay_ip_addr_act(Action):
    def run(self, name, delete_ip, delete_servers, server_vrf_name, relay_ip_addr, delete_dhcp, delete_relay, delete_interface, delete_name, delete_interface_gi_dhcp_conf, delete_server_vrf_name, delete_gigabitethernet, delete_relay_ip_addr, host, username, password):
