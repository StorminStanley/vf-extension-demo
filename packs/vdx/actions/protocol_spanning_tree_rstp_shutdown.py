...
def protocol_spanning_tree_rstp_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rstp_shutdown_act(Action):
    def run(self, delete_shutdown, delete_spanning_tree, delete_rstp, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rstp_shutdown(delete_shutdown=delete_shutdown, delete_spanning_tree=delete_spanning_tree, delete_rstp=delete_rstp, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
