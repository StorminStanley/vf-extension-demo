...
def interface_tengigabitethernet_fcoeport_fcoeport_map(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_fcoeport_fcoeport_map_act(Action):
    def run(self, name, delete_fcoeport, delete_fcoeport_map, delete_interface, delete_name, delete_tengigabitethernet, fcoeport_map, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_fcoeport_fcoeport_map(name=name, delete_name=delete_name, delete_fcoeport_map=delete_fcoeport_map, delete_tengigabitethernet=delete_tengigabitethernet, host=host, fcoeport_map=fcoeport_map, delete_fcoeport=delete_fcoeport, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
