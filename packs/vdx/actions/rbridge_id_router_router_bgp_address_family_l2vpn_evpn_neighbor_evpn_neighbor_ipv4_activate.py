...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_activate(**kwargs):
    """Auto Generated Code
    """
    ...
    activate = ET.SubElement(evpn_neighbor_ipv4, "activate")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_activate_act(Action):
    def run(self, delete_activate, delete_address_family, delete_router_bgp, rbridge_id, delete_evpn, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
