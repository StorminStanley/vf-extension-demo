...
def rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_maximum_prefix(**kwargs):
    """Auto Generated Code
    """
    ...
    maximum_prefix = ET.SubElement(evpn_neighbor_ipv4, "maximum-prefix")
...
class rbridge_id_router_router_bgp_address_family_l2vpn_evpn_neighbor_evpn_neighbor_ipv4_maximum_prefix_act(Action):
