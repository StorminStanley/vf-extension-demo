...
def interface_gigabitethernet_ipv6_access_group_traffic_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_access_group_traffic_type_act(Action):
    def run(self, name, delete_ip_direction, delete_access_group, delete_name, delete_traffic_type, ip_direction, traffic_type, delete_gigabitethernet, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_access_group_traffic_type(delete_traffic_type=delete_traffic_type, traffic_type=traffic_type, name=name, delete_name=delete_name, delete_access_group=delete_access_group, delete_ip_direction=delete_ip_direction, delete_gigabitethernet=delete_gigabitethernet, host=host, ip_direction=ip_direction, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
