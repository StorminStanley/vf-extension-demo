...
def interface_gigabitethernet_track_remove_remove_all_track_interfaces(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_track_remove_remove_all_track_interfaces_act(Action):
    def run(self, name, delete_remove_all_track_interfaces, delete_interface, delete_name, delete_remove, delete_track, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_track_remove_remove_all_track_interfaces(name=name, delete_name=delete_name, delete_track=delete_track, username=username, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, delete_remove=delete_remove, delete_remove_all_track_interfaces=delete_remove_all_track_interfaces, password=password, callback=_callback, mgr=mgr)
        return 0
