...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_priority_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, priority, delete_priority, delete_interface, delete_name, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
