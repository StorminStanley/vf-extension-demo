...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_af_neighbor_capability_orf_prefixlist_prefixlist_status(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_neighbor_af_ipv4_neighbor_peergroup_holder_af_ipv4_neighbor_peergroup_af_neighbor_capability_orf_prefixlist_prefixlist_status_act(Action):
    def run(self, delete_prefixlist, delete_address_family, delete_router_bgp, rbridge_id, delete_af_neighbor_capability, delete_orf, delete_prefixlist_status, delete_default_vrf, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
