...
def interface_tengigabitethernet_ip_icmp_echo_reply(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_icmp_echo_reply_act(Action):
    def run(self, name, delete_ip, delete_icmp, delete_interface, delete_name, delete_tengigabitethernet, delete_echo_reply, host, username, password):
