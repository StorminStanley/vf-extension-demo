...
def interface_hundredgigabitethernet_vrrp_arp_unicast_request_receive(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_arp_unicast_request_receive_act(Action):
    def run(self, delete_unicast_request, name, delete_vrid, delete_receive, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_hundredgigabitethernet, delete_arp, host, username, password):
