...
def interface_gigabitethernet_ipv6_ipv6_config_address_use_link_local_only(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_config_address_use_link_local_only_act(Action):
    def run(self, name, delete_interface, delete_name, delete_use_link_local_only, delete_address, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_config_address_use_link_local_only(name=name, delete_address=delete_address, delete_use_link_local_only=delete_use_link_local_only, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
