...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_md5_authentication_key_table_md5_authentication_key_act(Action):
    def run(self, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_key_table, delete_interface, delete_name, delete_ospf_interface_config, host, username, password):
