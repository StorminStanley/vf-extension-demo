...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_network(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_network_act(Action):
    def run(self, name, delete_ip, delete_network, network, delete_ve, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_network(name=name, network=network, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_ve=delete_ve, host=host, delete_network=delete_network, delete_name=delete_name, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
