...
def interface_gigabitethernet_ipv6_icmpv6_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_icmpv6_redirect_act(Action):
    def run(self, delete_redirect, delete_name, delete_interface, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_icmpv6_redirect(name=name, delete_name=delete_name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_redirect=delete_redirect, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
