...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_interval_act(Action):
    def run(self, delete_retry, name, delete_nud, interval, delete_interval, delete_interface, delete_name, delete_nd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_interval(delete_interval=delete_interval, name=name, delete_name=delete_name, delete_nud=delete_nud, interval=interval, delete_nd=delete_nd, host=host, delete_retry=delete_retry, delete_interface=delete_interface, delete_gigabitethernet=delete_gigabitethernet, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
