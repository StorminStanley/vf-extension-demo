...
def rbridge_id_telnet_server_telnet_vrf_cont_use_vrf_telnet_vrf_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_telnet_server_telnet_vrf_cont_use_vrf_telnet_vrf_shutdown_act(Action):
    def run(self, delete_use_vrf, use_vrf_name, rbridge_id, delete_use_vrf_name, delete_server, delete_telnet, delete_telnet_vrf_shutdown, delete_rbridge_id, delete_telnet_vrf_cont, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_telnet_server_telnet_vrf_cont_use_vrf_telnet_vrf_shutdown(use_vrf_name=use_vrf_name, delete_telnet=delete_telnet, username=username, delete_telnet_vrf_cont=delete_telnet_vrf_cont, rbridge_id=rbridge_id, delete_use_vrf_name=delete_use_vrf_name, delete_telnet_vrf_shutdown=delete_telnet_vrf_shutdown, host=host, delete_use_vrf=delete_use_vrf, delete_rbridge_id=delete_rbridge_id, delete_server=delete_server, password=password, callback=_callback, mgr=mgr)
        return 0
