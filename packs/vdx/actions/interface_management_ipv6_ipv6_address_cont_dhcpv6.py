...
def interface_management_ipv6_ipv6_address_cont_dhcpv6(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_dhcpv6', False) is True:
        delete_dhcpv6 = config.find('.//*dhcpv6')
        delete_dhcpv6.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_management_ipv6_ipv6_address_cont_dhcpv6_act(Action):
    def run(self, delete_management, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_ipv6_ipv6_address_cont_dhcpv6(name=name, delete_name=delete_name, delete_management=delete_management, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
