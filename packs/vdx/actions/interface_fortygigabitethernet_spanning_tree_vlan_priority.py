...
def interface_fortygigabitethernet_spanning_tree_vlan_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_spanning_tree_vlan_priority_act(Action):
    def run(self, delete_vlan, name, delete_fortygigabitethernet, id, priority, delete_id, delete_priority, delete_interface, delete_name, delete_spanning_tree, host, username, password):
