...
def rbridge_id_router_ospf_max_metric_router_lsa_on_startup_link_onstartup_ptp_link_onstartup(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ptp_link_onstartup', False) is True:
        delete_ptp_link_onstartup = config.find('.//*ptp-link-onstartup')
        delete_ptp_link_onstartup.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_router_ospf_max_metric_router_lsa_on_startup_link_onstartup_ptp_link_onstartup_act(Action):
    def run(self, delete_on_startup, rbridge_id, delete_ospf, delete_vrf, delete_router_lsa, delete_max_metric, delete_link_onstartup, vrf, delete_rbridge_id, delete_router, delete_ptp_link_onstartup, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_max_metric_router_lsa_on_startup_link_onstartup_ptp_link_onstartup(delete_max_metric=delete_max_metric, delete_router_lsa=delete_router_lsa, delete_link_onstartup=delete_link_onstartup, username=username, delete_router=delete_router, rbridge_id=rbridge_id, delete_ptp_link_onstartup=delete_ptp_link_onstartup, delete_vrf=delete_vrf, delete_on_startup=delete_on_startup, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
