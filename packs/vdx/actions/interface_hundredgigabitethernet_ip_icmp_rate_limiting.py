...
def interface_hundredgigabitethernet_ip_icmp_rate_limiting(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_icmp_rate_limiting_act(Action):
    def run(self, delete_rate_limiting, name, delete_ip, delete_icmp, delete_interface, delete_name, rate_limiting, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_icmp_rate_limiting(delete_rate_limiting=delete_rate_limiting, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_icmp=delete_icmp, delete_ip=delete_ip, rate_limiting=rate_limiting, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
