...
def rbridge_id_route_map_content_match_vrf(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_vrf_act(Action):
    def run(self, rbridge_id, delete_vrf, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, vrf, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_vrf(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_route_map=delete_route_map, delete_content=delete_content, host=host, password=password, delete_match=delete_match, vrf=vrf, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
