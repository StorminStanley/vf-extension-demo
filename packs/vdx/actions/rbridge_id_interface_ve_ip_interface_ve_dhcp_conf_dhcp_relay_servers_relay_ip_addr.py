...
def rbridge_id_interface_ve_ip_interface_ve_dhcp_conf_dhcp_relay_servers_relay_ip_addr(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_ve_dhcp_conf_dhcp_relay_servers_relay_ip_addr_act(Action):
    def run(self, relay_ip_addr, name, delete_ip, delete_interface_ve_dhcp_conf, delete_dhcp, delete_relay_ip_addr, server_vrf_name, delete_servers, delete_ve, delete_relay, delete_interface, delete_name, delete_rbridge_id, delete_server_vrf_name, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_ve_dhcp_conf_dhcp_relay_servers_relay_ip_addr(relay_ip_addr=relay_ip_addr, name=name, delete_name=delete_name, delete_relay=delete_relay, username=username, delete_dhcp=delete_dhcp, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_interface_ve_dhcp_conf=delete_interface_ve_dhcp_conf, server_vrf_name=server_vrf_name, host=host, delete_ve=delete_ve, delete_relay_ip_addr=delete_relay_ip_addr, delete_rbridge_id=delete_rbridge_id, delete_servers=delete_servers, delete_interface=delete_interface, password=password, delete_server_vrf_name=delete_server_vrf_name, callback=_callback, mgr=mgr)
        return 0
