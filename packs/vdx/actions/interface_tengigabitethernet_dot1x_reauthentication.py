...
def interface_tengigabitethernet_dot1x_reauthentication(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_dot1x_reauthentication_act(Action):
    def run(self, delete_tengigabitethernet, delete_reauthentication, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_dot1x_reauthentication(name=name, delete_name=delete_name, delete_reauthentication=delete_reauthentication, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
