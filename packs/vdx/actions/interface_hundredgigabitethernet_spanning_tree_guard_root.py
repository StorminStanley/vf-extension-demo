...
def interface_hundredgigabitethernet_spanning_tree_guard_root(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_guard_root_act(Action):
    def run(self, name, delete_interface, delete_name, delete_guard, delete_hundredgigabitethernet, delete_spanning_tree, delete_root, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_guard_root(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_spanning_tree=delete_spanning_tree, delete_root=delete_root, host=host, delete_guard=delete_guard, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
