...
def rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_interface_interface_priority(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_interface_priority', False) is True:
        delete_interface_priority = config.find('.//*interface-priority')
        delete_interface_priority.set('operation', 'delete')
...
class rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_interface_interface_priority_act(Action):
    def run(self, interface_name, delete_interface_name, name, delete_ip, interface_type, delete_ip_local_anycast_gateway, delete_track, interface_priority, delete_interface_priority, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_interface_type, local_ip_gw_id, delete_local_ip_gw_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_local_anycast_gateway_track_interface_interface_priority(local_ip_gw_id=local_ip_gw_id, interface_priority=interface_priority, name=name, rbridge_id=rbridge_id, delete_interface_priority=delete_interface_priority, delete_name=delete_name, delete_track=delete_track, username=username, interface_name=interface_name, delete_ip=delete_ip, delete_ip_local_anycast_gateway=delete_ip_local_anycast_gateway, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, interface_type=interface_type, delete_ve=delete_ve, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, delete_local_ip_gw_id=delete_local_ip_gw_id, password=password, callback=_callback, mgr=mgr)
        return 0
