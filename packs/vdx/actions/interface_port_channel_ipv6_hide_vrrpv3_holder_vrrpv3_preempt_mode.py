...
def interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_preempt_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_preempt_mode_act(Action):
    def run(self, name, delete_vrid, vrid, delete_preempt_mode, delete_port_channel, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_hide_vrrpv3_holder_vrrpv3_preempt_mode(delete_vrid=delete_vrid, name=name, delete_name=delete_name, username=username, delete_port_channel=delete_port_channel, host=host, vrid=vrid, delete_interface=delete_interface, delete_preempt_mode=delete_preempt_mode, password=password, callback=_callback, mgr=mgr)
        return 0
