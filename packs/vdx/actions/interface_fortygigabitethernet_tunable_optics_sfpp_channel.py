...
def interface_fortygigabitethernet_tunable_optics_sfpp_channel(**kwargs):
    """Auto Generated Code
    """
    ...
    tunable_optics = ET.SubElement(fortygigabitethernet, "tunable-optics")
...
class interface_fortygigabitethernet_tunable_optics_sfpp_channel_act(Action):
    def run(self, name, delete_sfpp, delete_fortygigabitethernet, delete_interface, delete_name, delete_tunable_optics, delete_channel, channel, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_tunable_optics_sfpp_channel(delete_tunable_optics=delete_tunable_optics, name=name, delete_name=delete_name, delete_channel=delete_channel, channel=channel, host=host, delete_sfpp=delete_sfpp, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
