...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_lifetime(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_lifetime_act(Action):
    def run(self, ra_lifetime, name, delete_ra_lifetime, delete_interface, delete_name, delete_hundredgigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_ra_lifetime(name=name, delete_name=delete_name, ra_lifetime=ra_lifetime, delete_ra_lifetime=delete_ra_lifetime, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_nd=delete_nd, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
