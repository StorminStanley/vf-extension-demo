...
def interface_gigabitethernet_switchport_trunk_allowed_vlan_none(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_allowed_vlan_none_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_none, delete_trunk, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
