...
def rbridge_id_ssh_server_ssh_vrf_cont_use_vrf_ssh_vrf_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ssh_server_ssh_vrf_cont_use_vrf_ssh_vrf_shutdown_act(Action):
    def run(self, delete_use_vrf, use_vrf_name, rbridge_id, delete_use_vrf_name, delete_server, delete_ssh_vrf_cont, delete_ssh_vrf_shutdown, delete_ssh, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ssh_server_ssh_vrf_cont_use_vrf_ssh_vrf_shutdown(use_vrf_name=use_vrf_name, username=username, delete_ssh=delete_ssh, rbridge_id=rbridge_id, delete_use_vrf_name=delete_use_vrf_name, delete_ssh_vrf_shutdown=delete_ssh_vrf_shutdown, delete_ssh_vrf_cont=delete_ssh_vrf_cont, host=host, delete_use_vrf=delete_use_vrf, delete_rbridge_id=delete_rbridge_id, delete_server=delete_server, password=password, callback=_callback, mgr=mgr)
        return 0
