...
def interface_hundredgigabitethernet_qos_dscp_cos(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_qos_dscp_cos_act(Action):
    def run(self, delete_qos, name, delete_dscp_cos, delete_name, delete_hundredgigabitethernet, dscp_cos, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_qos_dscp_cos(delete_qos=delete_qos, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, name=name, dscp_cos=dscp_cos, delete_dscp_cos=delete_dscp_cos, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
