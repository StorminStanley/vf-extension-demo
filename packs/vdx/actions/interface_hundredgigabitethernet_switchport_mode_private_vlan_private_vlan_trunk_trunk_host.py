...
def interface_hundredgigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_host(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_host_act(Action):
    def run(self, delete_switchport, name, delete_private_vlan, delete_interface, delete_name, delete_hundredgigabitethernet, delete_trunk_host, delete_mode, delete_private_vlan_trunk, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_mode_private_vlan_private_vlan_trunk_trunk_host(name=name, delete_name=delete_name, delete_switchport=delete_switchport, username=username, delete_mode=delete_mode, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_trunk_host=delete_trunk_host, delete_private_vlan=delete_private_vlan, host=host, delete_interface=delete_interface, delete_private_vlan_trunk=delete_private_vlan_trunk, password=password, callback=_callback, mgr=mgr)
        return 0
