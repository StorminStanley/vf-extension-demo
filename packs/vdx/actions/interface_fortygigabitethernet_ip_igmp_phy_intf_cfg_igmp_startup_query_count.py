...
def interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_count(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_count_act(Action):
    def run(self, name, delete_ip, delete_fortygigabitethernet, startup_query_count, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_startup_query_count, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_startup_query_count(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, delete_startup_query_count=delete_startup_query_count, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, startup_query_count=startup_query_count, delete_ip=delete_ip, delete_igmp=delete_igmp, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
