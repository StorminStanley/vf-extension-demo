...
def interface_hundredgigabitethernet_ip_arp_node_config_arp_inspection_trust(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_arp_node_config_arp_inspection_trust_act(Action):
    def run(self, delete_arp_node_config, delete_inspection, name, delete_ip, delete_trust, delete_interface, delete_name, delete_hundredgigabitethernet, delete_arp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ip_arp_node_config_arp_inspection_trust(name=name, delete_name=delete_name, delete_inspection=delete_inspection, delete_trust=delete_trust, delete_arp=delete_arp, delete_ip=delete_ip, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_arp_node_config=delete_arp_node_config, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
