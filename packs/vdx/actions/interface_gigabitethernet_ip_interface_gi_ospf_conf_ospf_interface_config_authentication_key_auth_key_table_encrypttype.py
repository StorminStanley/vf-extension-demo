...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_encrypttype(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_encrypttype_act(Action):
    def run(self, encrypttype, name, delete_ip, delete_interface_gi_ospf_conf, delete_interface, delete_name, delete_auth_key_table, delete_authentication_key, delete_encrypttype, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_authentication_key_auth_key_table_encrypttype(encrypttype=encrypttype, delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, name=name, delete_name=delete_name, delete_authentication_key=delete_authentication_key, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_auth_key_table=delete_auth_key_table, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, delete_encrypttype=delete_encrypttype, password=password, callback=_callback, mgr=mgr)
        return 0
