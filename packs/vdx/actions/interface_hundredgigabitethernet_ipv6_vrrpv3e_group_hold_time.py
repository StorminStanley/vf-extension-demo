...
def interface_hundredgigabitethernet_ipv6_vrrpv3e_group_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_vrrpv3e_group_hold_time_act(Action):
