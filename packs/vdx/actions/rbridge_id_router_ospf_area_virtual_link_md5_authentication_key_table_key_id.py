...
def rbridge_id_router_ospf_area_virtual_link_md5_authentication_key_table_key_id(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_area_virtual_link_md5_authentication_key_table_key_id_act(Action):
    def run(self, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_key_table, delete_area, vrf, delete_key_id, key_id, delete_virt_link_neighbor, delete_rbridge_id, virt_link_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_area_virtual_link_md5_authentication_key_table_key_id(delete_virt_link_neighbor=delete_virt_link_neighbor, delete_router=delete_router, delete_key_table=delete_key_table, virt_link_neighbor=virt_link_neighbor, username=username, delete_area=delete_area, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, key_id=key_id, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_key_id=delete_key_id, delete_rbridge_id=delete_rbridge_id, delete_virtual_link=delete_virtual_link, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
