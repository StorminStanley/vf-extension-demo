...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_md5_authentication_key_table_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_md5_authentication_key_table_key_act(Action):
    def run(self, key, delete_interface_te_ospf_conf, name, delete_ip, delete_key_table, delete_key, delete_interface, delete_name, delete_tengigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_md5_authentication_key_table_key(name=name, delete_key_table=delete_key_table, username=username, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_tengigabitethernet=delete_tengigabitethernet, host=host, key=key, delete_name=delete_name, delete_key=delete_key, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
