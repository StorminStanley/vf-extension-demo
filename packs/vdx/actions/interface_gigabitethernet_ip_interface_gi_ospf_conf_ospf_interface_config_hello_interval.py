...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_hello_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_hello_interval_act(Action):
    def run(self, name, delete_ip, delete_interface_gi_ospf_conf, delete_interface, delete_name, delete_hello_interval, hello_interval, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_hello_interval(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, name=name, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_hello_interval=delete_hello_interval, host=host, delete_gigabitethernet=delete_gigabitethernet, hello_interval=hello_interval, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
