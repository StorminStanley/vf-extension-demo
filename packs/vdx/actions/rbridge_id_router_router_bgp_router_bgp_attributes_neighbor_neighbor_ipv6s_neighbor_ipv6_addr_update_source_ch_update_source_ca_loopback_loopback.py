...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_loopback_loopback(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_loopback_loopback_act(Action):
    def run(self, delete_router_bgp, rbridge_id, loopback, delete_update_source, delete_router_bgp_attributes, delete_ca_loopback, delete_loopback, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_update_source_ch_update_source_ca_loopback_loopback(delete_router_bgp=delete_router_bgp, delete_ca_loopback=delete_ca_loopback, username=username, rbridge_id=rbridge_id, delete_router=delete_router, loopback=loopback, delete_loopback=delete_loopback, delete_neighbor=delete_neighbor, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_ch_update_source=delete_ch_update_source, delete_rbridge_id=delete_rbridge_id, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
