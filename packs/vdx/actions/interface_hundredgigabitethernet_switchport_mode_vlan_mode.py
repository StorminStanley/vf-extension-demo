...
def interface_hundredgigabitethernet_switchport_mode_vlan_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_mode_vlan_mode_act(Action):
    def run(self, delete_switchport, name, vlan_mode, delete_interface, delete_name, delete_hundredgigabitethernet, delete_vlan_mode, delete_mode, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_switchport_mode_vlan_mode(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_mode=delete_mode, vlan_mode=vlan_mode, delete_vlan_mode=delete_vlan_mode, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
