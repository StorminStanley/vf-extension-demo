...
def protocol_spanning_tree_pvst_max_age(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_pvst_max_age_act(Action):
    def run(self, delete_pvst, max_age, delete_max_age, delete_spanning_tree, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_pvst_max_age(delete_pvst=delete_pvst, delete_spanning_tree=delete_spanning_tree, delete_max_age=delete_max_age, host=host, max_age=max_age, delete_protocol=delete_protocol, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
