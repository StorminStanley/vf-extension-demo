...
def interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval_act(Action):
    def run(self, name, ifc_key_add_remove_interval, delete_ifc_key_add_remove_interval, delete_ipsec, delete_port_channel, delete_authentication, delete_name, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval(delete_port_channel=delete_port_channel, name=name, delete_ipsec=delete_ipsec, ifc_key_add_remove_interval=ifc_key_add_remove_interval, delete_authentication=delete_authentication, host=host, delete_name=delete_name, delete_ifc_key_add_remove_interval=delete_ifc_key_add_remove_interval, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
