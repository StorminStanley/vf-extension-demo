...
def interface_gigabitethernet_switchport_basic_basic(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_basic_basic_act(Action):
    def run(self, delete_basic, name, delete_switchport_basic, delete_interface, delete_name, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_basic_basic(name=name, delete_name=delete_name, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_switchport_basic=delete_switchport_basic, delete_basic=delete_basic, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
