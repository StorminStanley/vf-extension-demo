...
def rbridge_id_threshold_monitor_Cpu_poll(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_Cpu_poll_act(Action):
    def run(self, delete_poll, rbridge_id, delete_Cpu, delete_threshold_monitor, poll, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_threshold_monitor_Cpu_poll(delete_threshold_monitor=delete_threshold_monitor, username=username, rbridge_id=rbridge_id, delete_Cpu=delete_Cpu, host=host, poll=poll, delete_poll=delete_poll, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
