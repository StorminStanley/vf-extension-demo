...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_retransmit_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_retransmit_interval_act(Action):
    def run(self, retransmit_interval, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, delete_interface, delete_name, delete_retransmit_interval, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_retransmit_interval(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, retransmit_interval=retransmit_interval, host=host, delete_retransmit_interval=delete_retransmit_interval, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
