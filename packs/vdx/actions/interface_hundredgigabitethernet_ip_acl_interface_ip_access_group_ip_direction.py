...
def interface_hundredgigabitethernet_ip_acl_interface_ip_access_group_ip_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_acl_interface_ip_access_group_ip_direction_act(Action):
    def run(self, name, delete_ip, ip_access_list, delete_ip_direction, delete_ip_acl_interface, delete_interface, delete_name, ip_direction, delete_hundredgigabitethernet, delete_ip_access_list, delete_access_group, host, username, password):
