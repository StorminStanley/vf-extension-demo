...
def interface_tengigabitethernet_ipv6_icmpv6_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_icmpv6_redirect_act(Action):
    def run(self, delete_tengigabitethernet, delete_redirect, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_icmpv6_redirect(name=name, delete_redirect=delete_redirect, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
