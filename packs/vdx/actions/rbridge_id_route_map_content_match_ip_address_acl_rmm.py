...
def rbridge_id_route_map_content_match_ip_address_acl_rmm(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_ip_address_acl_rmm_act(Action):
    def run(self, rbridge_id, delete_ip, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, acl_rmm, delete_name, delete_rbridge_id, delete_acl_rmm, delete_address, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_ip_address_acl_rmm(delete_instance=delete_instance, delete_acl_rmm=delete_acl_rmm, action_rm=action_rm, acl_rmm=acl_rmm, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, name=name, delete_route_map=delete_route_map, delete_action_rm=delete_action_rm, delete_content=delete_content, delete_address=delete_address, host=host, password=password, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
