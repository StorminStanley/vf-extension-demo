...
def rbridge_id_ip_community_list_extended_ip_action(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ip_action', False) is True:
        delete_ip_action = config.find('.//*ip-action')
        delete_ip_action.set('operation', 'delete')
...
class rbridge_id_ip_community_list_extended_ip_action_act(Action):
    def run(self, ip_action, delete_ip_action, name, delete_ip, delete_community_list, instance, delete_instance, delete_name, delete_extended, delete_rbridge_id, delete_seq_keyword, seq_keyword, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_community_list_extended_ip_action(delete_instance=delete_instance, delete_ip_action=delete_ip_action, name=name, delete_community_list=delete_community_list, delete_seq_keyword=delete_seq_keyword, username=username, seq_keyword=seq_keyword, rbridge_id=rbridge_id, delete_ip=delete_ip, ip_action=ip_action, host=host, password=password, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, delete_extended=delete_extended, callback=_callback, mgr=mgr)
        return 0
