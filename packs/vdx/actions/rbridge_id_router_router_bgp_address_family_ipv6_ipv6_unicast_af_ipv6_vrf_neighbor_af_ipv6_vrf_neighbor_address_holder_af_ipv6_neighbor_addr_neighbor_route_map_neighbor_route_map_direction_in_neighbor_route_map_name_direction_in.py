...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_neighbor_route_map_neighbor_route_map_direction_in_neighbor_route_map_name_direction_in(**kwargs):
    """Auto Generated Code
    """
    ...
    neighbor_route_map = ET.SubElement(af_ipv6_neighbor_addr, "neighbor-route-map")
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_neighbor_route_map_neighbor_route_map_direction_in_neighbor_route_map_name_direction_in_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, neighbor_route_map_name_direction_in, delete_neighbor_route_map, delete_neighbor_route_map_direction_in, delete_neighbor_route_map_name_direction_in, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
