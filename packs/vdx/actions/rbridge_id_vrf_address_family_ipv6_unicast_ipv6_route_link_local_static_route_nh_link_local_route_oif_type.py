...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_link_local_route_oif_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_link_local_route_oif_type_act(Action):
    def run(self, delete_link_local_static_route_nh, delete_address_family, link_local_route_oif_name, rbridge_id, delete_route, delete_vrf, delete_link_local_static_route_dest, link_local_nexthop, link_local_route_oif_type, delete_link_local_route_oif_type, vrf_name, delete_link_local_route_oif_name, delete_link_local_nexthop, delete_rbridge_id, delete_unicast, link_local_static_route_dest, delete_vrf_name, host, username, password):
