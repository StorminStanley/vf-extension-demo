...
def rbridge_id_router_ospf_permit_redistribute_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_permit_redistribute_address_act(Action):
    def run(self, delete_permit, redist_value, rbridge_id, delete_route_option, delete_ospf, delete_vrf, delete_redistribute, delete_redist_value, vrf, address, delete_rbridge_id, delete_address, delete_router, route_option, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_permit_redistribute_address(delete_route_option=delete_route_option, address=address, route_option=route_option, username=username, delete_permit=delete_permit, delete_redistribute=delete_redistribute, rbridge_id=rbridge_id, delete_vrf=delete_vrf, vrf=vrf, delete_router=delete_router, delete_ospf=delete_ospf, host=host, redist_value=redist_value, delete_redist_value=delete_redist_value, delete_address=delete_address, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
