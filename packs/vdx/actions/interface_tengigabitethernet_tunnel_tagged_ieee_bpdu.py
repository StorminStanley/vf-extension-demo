...
def interface_tengigabitethernet_tunnel_tagged_ieee_bpdu(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_tunnel_tagged_ieee_bpdu_act(Action):
    def run(self, delete_tagged_ieee_bpdu, name, delete_tunnel, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_tunnel_tagged_ieee_bpdu(name=name, delete_tunnel=delete_tunnel, delete_name=delete_name, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_tagged_ieee_bpdu=delete_tagged_ieee_bpdu, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
