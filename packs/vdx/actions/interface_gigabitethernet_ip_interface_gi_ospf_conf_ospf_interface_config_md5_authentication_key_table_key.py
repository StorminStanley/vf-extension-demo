...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_key_table_key(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_key_table_key_act(Action):
    def run(self, key, name, delete_ip, delete_interface_gi_ospf_conf, delete_key_table, delete_key, delete_interface, delete_name, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_key_table_key(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, name=name, delete_key_table=delete_key_table, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_gigabitethernet=delete_gigabitethernet, host=host, key=key, delete_name=delete_name, delete_key=delete_key, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
