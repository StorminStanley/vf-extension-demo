...
def interface_gigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_neighbor_filter(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_pim_neighbor_filter_act(Action):
    def run(self, delete_pim, delete_pim_intf_phy_cont, delete_ip, delete_neighbor_filter, delete_interface, delete_name, delete_pim_int_cmd, neighbor_filter, delete_gigabitethernet, name, host, username, password):
