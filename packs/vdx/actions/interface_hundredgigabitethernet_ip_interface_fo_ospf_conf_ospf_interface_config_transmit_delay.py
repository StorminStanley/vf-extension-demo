...
def interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_transmit_delay(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_transmit_delay_act(Action):
    def run(self, delete_transmit_delay, name, delete_ip, delete_interface_fo_ospf_conf, delete_interface, delete_name, delete_hundredgigabitethernet, transmit_delay, delete_ospf_interface_config, host, username, password):
