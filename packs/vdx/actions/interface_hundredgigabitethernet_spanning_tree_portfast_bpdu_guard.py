...
def interface_hundredgigabitethernet_spanning_tree_portfast_bpdu_guard(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_portfast_bpdu_guard_act(Action):
    def run(self, delete_portfast, name, delete_bpdu_guard, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_portfast_bpdu_guard(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, delete_spanning_tree=delete_spanning_tree, host=host, delete_portfast=delete_portfast, delete_interface=delete_interface, delete_bpdu_guard=delete_bpdu_guard, password=password, callback=_callback, mgr=mgr)
        return 0
