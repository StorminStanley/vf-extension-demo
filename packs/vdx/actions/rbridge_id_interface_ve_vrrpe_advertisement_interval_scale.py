...
def rbridge_id_interface_ve_vrrpe_advertisement_interval_scale(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_advertisement_interval_scale_act(Action):
    def run(self, name, delete_vrid, advertisement_interval_scale, vrid, delete_ve, delete_interface, delete_name, delete_advertisement_interval_scale, delete_rbridge_id, delete_vrrpe, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_advertisement_interval_scale(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_vrrpe=delete_vrrpe, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_ve=delete_ve, host=host, vrid=vrid, advertisement_interval_scale=advertisement_interval_scale, delete_interface=delete_interface, delete_advertisement_interval_scale=delete_advertisement_interval_scale, password=password, callback=_callback, mgr=mgr)
        return 0
