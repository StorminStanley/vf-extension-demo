...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_holdover_interval(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_holdover_interval_act(Action):
    def run(self, delete_bfd, delete_router_bgp, rbridge_id, holdover_interval, delete_router_bgp_attributes, delete_rbridge_id, delete_neighbor, delete_router, delete_holdover_interval, host, username, password):
