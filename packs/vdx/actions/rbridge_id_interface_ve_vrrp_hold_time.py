...
def rbridge_id_interface_ve_vrrp_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrp_hold_time_act(Action):
    def run(self, name, delete_vrid, delete_hold_time, vrid, delete_version, delete_ve, version, delete_interface, delete_name, delete_vrrp, delete_rbridge_id, hold_time, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrp_hold_time(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, rbridge_id=rbridge_id, version=version, delete_ve=delete_ve, host=host, vrid=vrid, hold_time=hold_time, delete_name=delete_name, delete_hold_time=delete_hold_time, delete_rbridge_id=delete_rbridge_id, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
