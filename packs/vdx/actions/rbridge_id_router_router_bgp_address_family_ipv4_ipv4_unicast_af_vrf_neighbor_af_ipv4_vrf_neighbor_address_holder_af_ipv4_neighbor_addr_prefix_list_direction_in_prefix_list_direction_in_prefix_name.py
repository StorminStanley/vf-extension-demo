...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_prefix_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_prefix_name_act(Action):
    def run(self, delete_direction_in, delete_address_family, delete_router_bgp, rbridge_id, prefix_list_direction_in_prefix_name, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_prefix_list_direction_in_prefix_name, delete_prefix_list, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_prefix_list_direction_in_prefix_list_direction_in_prefix_name(prefix_list_direction_in_prefix_name=prefix_list_direction_in_prefix_name, delete_prefix_list=delete_prefix_list, delete_router_bgp=delete_router_bgp, username=username, delete_direction_in=delete_direction_in, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, af_vrf_name=af_vrf_name, host=host, password=password, delete_address_family=delete_address_family, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, delete_prefix_list_direction_in_prefix_name=delete_prefix_list_direction_in_prefix_name, callback=_callback, mgr=mgr)
        return 0
