...
def interface_vlan_interface_ve_ip_ip_anycast_gateway_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_ve_ip_ip_anycast_gateway_enable_act(Action):
    def run(self, gve_name, delete_ip, delete_interface_vlan, delete_ip_anycast_gateway, ip_gw_id, delete_ve, delete_enable, delete_interface, delete_ip_gw_id, delete_gve_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_ve_ip_ip_anycast_gateway_enable(delete_ip_anycast_gateway=delete_ip_anycast_gateway, delete_ip_gw_id=delete_ip_gw_id, delete_gve_name=delete_gve_name, delete_enable=delete_enable, delete_ip=delete_ip, gve_name=gve_name, delete_interface_vlan=delete_interface_vlan, host=host, ip_gw_id=ip_gw_id, delete_interface=delete_interface, username=username, password=password, delete_ve=delete_ve, callback=_callback, mgr=mgr)
        return 0
