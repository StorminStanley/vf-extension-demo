...
def rbridge_id_router_ospf_area_range_range_mask(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_area_range_range_mask_act(Action):
    def run(self, range_mask, area_id, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_range_address, delete_area, vrf, delete_range, delete_rbridge_id, delete_range_mask, delete_router, range_address, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_area_range_range_mask(range_address=range_address, username=username, delete_area=delete_area, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_range=delete_range, password=password, range_mask=range_mask, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_range_address=delete_range_address, delete_range_mask=delete_range_mask, area_id=area_id, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
