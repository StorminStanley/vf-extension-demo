...
def interface_tengigabitethernet_ipv6_vrrpv3_group_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3_group_enable_act(Action):
