...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_ospf_match_ospf_external2(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_ospf_match_ospf_external2_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_ospf, delete_match, delete_redistribute, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_ospf_match_ospf_external2(delete_router_bgp=delete_router_bgp, username=username, delete_router=delete_router, rbridge_id=rbridge_id, delete_redistribute=delete_redistribute, delete_ospf=delete_ospf, host=host, delete_match=delete_match, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
