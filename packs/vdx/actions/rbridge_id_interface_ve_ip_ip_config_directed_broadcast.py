...
def rbridge_id_interface_ve_ip_ip_config_directed_broadcast(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_ip_config_directed_broadcast_act(Action):
    def run(self, delete_ip_config, delete_directed_broadcast, name, delete_ip, delete_ve, delete_interface, delete_name, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_ip_config_directed_broadcast(name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, rbridge_id=rbridge_id, delete_ip_config=delete_ip_config, delete_directed_broadcast=delete_directed_broadcast, host=host, delete_ve=delete_ve, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
