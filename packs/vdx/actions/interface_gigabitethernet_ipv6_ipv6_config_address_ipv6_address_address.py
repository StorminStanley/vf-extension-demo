...
def interface_gigabitethernet_ipv6_ipv6_config_address_ipv6_address_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_config_address_ipv6_address_address_act(Action):
    def run(self, name, delete_interface, delete_name, address, delete_address, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_ipv6_config_address_ipv6_address_address(name=name, delete_address=delete_address, address=address, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
