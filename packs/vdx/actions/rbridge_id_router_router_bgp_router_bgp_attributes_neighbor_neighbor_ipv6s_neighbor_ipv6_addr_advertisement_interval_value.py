...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_advertisement_interval_value(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_advertisement_interval_value_act(Action):
    def run(self, delete_router_bgp, rbridge_id, delete_advertisement_interval, value, delete_router_bgp_attributes, delete_rbridge_id, delete_value, delete_neighbor, delete_router, host, username, password):
