...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_out_prefix_list_direction_out(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_out_prefix_list_direction_out_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_direction_out, delete_prefix_list, delete_rbridge_id, delete_prefix_list_direction_out, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_prefix_list_direction_out_prefix_list_direction_out(delete_prefix_list_direction_out=delete_prefix_list_direction_out, delete_prefix_list=delete_prefix_list, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_router=delete_router, rbridge_id=rbridge_id, delete_direction_out=delete_direction_out, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
