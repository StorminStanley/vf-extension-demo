...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_nh_vrf_static_route_next_hop(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_route_nh_vrf_static_route_next_hop_act(Action):
    def run(self, delete_static_route_next_hop, delete_address_family, delete_next_hop_vrf, rbridge_id, delete_route, delete_vrf, delete_static_route_next_vrf_dest, next_hop_vrf, vrf_name, static_route_next_vrf_dest, delete_static_route_nh_vrf, delete_rbridge_id, delete_unicast, static_route_next_hop, delete_vrf_name, host, username, password):
