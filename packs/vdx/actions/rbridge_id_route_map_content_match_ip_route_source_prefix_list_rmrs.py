...
def rbridge_id_route_map_content_match_ip_route_source_prefix_list_rmrs(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_ip_route_source_prefix_list_rmrs_act(Action):
    def run(self, delete_prefix_list_rmrs, rbridge_id, delete_ip, prefix_list_rmrs, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_route_source, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_ip_route_source_prefix_list_rmrs(prefix_list_rmrs=prefix_list_rmrs, delete_instance=delete_instance, name=name, action_rm=action_rm, username=username, delete_action_rm=delete_action_rm, delete_prefix_list_rmrs=delete_prefix_list_rmrs, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_route_map=delete_route_map, delete_content=delete_content, host=host, password=password, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, delete_route_source=delete_route_source, instance=instance, callback=_callback, mgr=mgr)
        return 0
