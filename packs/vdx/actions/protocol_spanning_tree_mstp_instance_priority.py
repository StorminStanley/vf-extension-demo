...
def protocol_spanning_tree_mstp_instance_priority(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_instance_priority_act(Action):
    def run(self, delete_mstp, delete_protocol, delete_instance, delete_spanning_tree, priority, delete_id, delete_priority, id, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_instance_priority(delete_instance=delete_instance, username=username, priority=priority, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, delete_mstp=delete_mstp, host=host, id=id, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
