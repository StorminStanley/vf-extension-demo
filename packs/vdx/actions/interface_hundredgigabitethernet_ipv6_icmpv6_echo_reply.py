...
def interface_hundredgigabitethernet_ipv6_icmpv6_echo_reply(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_icmpv6_echo_reply_act(Action):
    def run(self, delete_hundredgigabitethernet, delete_echo_reply, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_icmpv6_echo_reply(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_echo_reply=delete_echo_reply, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
