...
def rbridge_id_router_ospf_max_metric_router_lsa_on_startup_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_max_metric_router_lsa_on_startup_time_act(Action):
    def run(self, delete_on_startup, rbridge_id, delete_ospf, delete_vrf, delete_router_lsa, delete_max_metric, delete_time, vrf, time, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_max_metric_router_lsa_on_startup_time(delete_max_metric=delete_max_metric, delete_router_lsa=delete_router_lsa, username=username, time=time, delete_time=delete_time, delete_router=delete_router, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_on_startup=delete_on_startup, delete_ospf=delete_ospf, vrf=vrf, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
