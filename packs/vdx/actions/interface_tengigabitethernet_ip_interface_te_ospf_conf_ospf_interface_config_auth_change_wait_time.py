...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_auth_change_wait_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_auth_change_wait_time_act(Action):
    def run(self, delete_interface_te_ospf_conf, name, delete_ip, delete_auth_change_wait_time, delete_interface, delete_name, auth_change_wait_time, delete_tengigabitethernet, delete_ospf_interface_config, host, username, password):
