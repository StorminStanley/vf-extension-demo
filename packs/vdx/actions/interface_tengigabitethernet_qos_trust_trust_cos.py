...
def interface_tengigabitethernet_qos_trust_trust_cos(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_qos_trust_trust_cos_act(Action):
    def run(self, delete_qos, name, delete_trust_cos, delete_trust, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_qos_trust_trust_cos(delete_qos=delete_qos, delete_name=delete_name, delete_trust=delete_trust, name=name, delete_trust_cos=delete_trust_cos, host=host, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
