...
def protocol_spanning_tree_mstp_forward_delay(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_forward_delay_act(Action):
    def run(self, delete_forward_delay, delete_mstp, delete_spanning_tree, forward_delay, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_forward_delay(forward_delay=forward_delay, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, delete_forward_delay=delete_forward_delay, delete_mstp=delete_mstp, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
