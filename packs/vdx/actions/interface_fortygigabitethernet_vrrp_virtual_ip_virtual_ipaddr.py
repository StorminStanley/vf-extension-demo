...
def interface_fortygigabitethernet_vrrp_virtual_ip_virtual_ipaddr(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_virtual_ip_virtual_ipaddr_act(Action):
    def run(self, virtual_ipaddr, vrid, name, delete_vrid, delete_fortygigabitethernet, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_virtual_ip, delete_virtual_ipaddr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_vrrp_virtual_ip_virtual_ipaddr(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_virtual_ip=delete_virtual_ip, delete_name=delete_name, virtual_ipaddr=virtual_ipaddr, version=version, delete_virtual_ipaddr=delete_virtual_ipaddr, host=host, vrid=vrid, delete_version=delete_version, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
