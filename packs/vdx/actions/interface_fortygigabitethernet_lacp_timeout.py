...
def interface_fortygigabitethernet_lacp_agtimeout(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_lacp_agtimeout_act(Action):
    def run(self, delete_fortygigabitethernet, name, delete_lacp, delete_agtimeout, delete_interface, delete_name, host, username, password, agtimeout_ag):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_lacp_agtimeout(agtimeout_ag=agtimeout_ag, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_agtimeout=delete_agtimeout, delete_lacp=delete_lacp, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
