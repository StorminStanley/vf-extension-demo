...
def interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_dead_interval(**kwargs):
    """Auto Generated Code
    """
    ...
    dead_interval = ET.SubElement(ospf_interface_config, "dead-interval")
...
class interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_dead_interval_act(Action):
    def run(self, delete_dead_interval, name, delete_ip, delete_interface_fo_ospf_conf, delete_fortygigabitethernet, dead_interval, delete_interface, delete_name, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_interface_fo_ospf_conf_ospf_interface_config_dead_interval(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, dead_interval=dead_interval, delete_interface_fo_ospf_conf=delete_interface_fo_ospf_conf, host=host, delete_dead_interval=delete_dead_interval, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
