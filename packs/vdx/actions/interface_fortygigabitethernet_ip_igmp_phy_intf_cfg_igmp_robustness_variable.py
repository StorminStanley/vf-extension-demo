...
def interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_robustness_variable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_robustness_variable_act(Action):
    def run(self, name, delete_ip, robustness_variable, delete_fortygigabitethernet, delete_igmp_phy_intf_cfg, delete_igmp, delete_interface, delete_name, delete_robustness_variable, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ip_igmp_phy_intf_cfg_igmp_robustness_variable(delete_igmp_phy_intf_cfg=delete_igmp_phy_intf_cfg, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, robustness_variable=robustness_variable, delete_ip=delete_ip, delete_igmp=delete_igmp, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_robustness_variable=delete_robustness_variable, password=password, callback=_callback, mgr=mgr)
        return 0
