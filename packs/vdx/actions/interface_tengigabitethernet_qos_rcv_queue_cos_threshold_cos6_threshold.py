...
def interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos6_threshold(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_cos6_threshold', False) is True:
        delete_cos6_threshold = config.find('.//*cos6-threshold')
        delete_cos6_threshold.set('operation', 'delete')
...
class interface_tengigabitethernet_qos_rcv_queue_cos_threshold_cos6_threshold_act(Action):
