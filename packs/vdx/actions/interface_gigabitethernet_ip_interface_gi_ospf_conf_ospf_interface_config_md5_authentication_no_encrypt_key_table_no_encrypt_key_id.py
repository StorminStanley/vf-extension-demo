...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_no_encrypt_key_id', False) is True:
        delete_no_encrypt_key_id = config.find('.//*no-encrypt-key-id')
        delete_no_encrypt_key_id.set('operation', 'delete')
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id_act(Action):
    def run(self, no_encrypt_key_id, name, delete_ip, delete_interface_gi_ospf_conf, delete_no_encrypt_key_table, delete_interface, delete_name, delete_no_encrypt_key_id, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_md5_authentication_no_encrypt_key_table_no_encrypt_key_id(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, name=name, delete_no_encrypt_key_table=delete_no_encrypt_key_table, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_no_encrypt_key_id=delete_no_encrypt_key_id, host=host, delete_gigabitethernet=delete_gigabitethernet, no_encrypt_key_id=no_encrypt_key_id, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
