...
def protocol_spanning_tree_pvst_vlan_max_age(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_pvst_vlan_max_age_act(Action):
    def run(self, delete_vlan, max_age, delete_protocol, delete_spanning_tree, delete_pvst, delete_id, delete_max_age, id, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_pvst_vlan_max_age(delete_pvst=delete_pvst, delete_vlan=delete_vlan, delete_id=delete_id, delete_spanning_tree=delete_spanning_tree, delete_max_age=delete_max_age, delete_protocol=delete_protocol, max_age=max_age, host=host, id=id, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
