...
def rbridge_id_threshold_monitor_interface_policy_area_alert_below_below_highthresh_action(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_threshold_monitor_interface_policy_area_alert_below_below_highthresh_action_act(Action):
    def run(self, delete_policy_name, area_value, rbridge_id, delete_area_value, policy_name, delete_alert, delete_below_highthresh_action, delete_area, delete_interface, below_highthresh_action, delete_type, delete_threshold_monitor, delete_policy, type, delete_rbridge_id, delete_below, host, username, password):
