...
def interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable_act(Action):
    def run(self, delete_intf_bfd_enable, delete_interface_te_ospf_conf, name, delete_ip, delete_interface, delete_name, delete_tengigabitethernet, delete_bfd, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_interface_te_ospf_conf_ospf_interface_config_bfd_intf_bfd_enable(name=name, delete_name=delete_name, username=username, delete_ip=delete_ip, delete_intf_bfd_enable=delete_intf_bfd_enable, delete_ospf_interface_config=delete_ospf_interface_config, delete_tengigabitethernet=delete_tengigabitethernet, password=password, host=host, delete_interface=delete_interface, delete_interface_te_ospf_conf=delete_interface_te_ospf_conf, delete_bfd=delete_bfd, callback=_callback, mgr=mgr)
        return 0
