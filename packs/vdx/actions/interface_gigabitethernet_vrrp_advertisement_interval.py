...
def interface_gigabitethernet_vrrp_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_advertisement_interval_act(Action):
    def run(self, name, delete_vrid, vrid, delete_advertisement_interval, delete_version, advertisement_interval, version, delete_interface, delete_name, delete_vrrp, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_advertisement_interval(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_advertisement_interval=delete_advertisement_interval, version=version, advertisement_interval=advertisement_interval, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
