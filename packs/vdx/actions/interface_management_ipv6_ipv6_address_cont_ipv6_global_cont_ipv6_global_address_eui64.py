...
def interface_management_ipv6_ipv6_address_cont_ipv6_global_cont_ipv6_global_address_eui64(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_ipv6_global_address_eui64', False) is True:
        delete_ipv6_global_address_eui64 = config.find('.//*ipv6-global-address-eui64')
        delete_ipv6_global_address_eui64.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_management_ipv6_ipv6_address_cont_ipv6_global_cont_ipv6_global_address_eui64_act(Action):
    def run(self, delete_management, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_ipv6_ipv6_address_cont_ipv6_global_cont_ipv6_global_address_eui64(name=name, delete_name=delete_name, delete_management=delete_management, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
