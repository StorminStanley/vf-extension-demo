...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_maxas_limit_in_cg_ch_maxas_limit_ca_maxas_limit_enable_num_as_in_as_path(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_maxas_limit_in_cg_ch_maxas_limit_ca_maxas_limit_enable_num_as_in_as_path_act(Action):
    def run(self, router_bgp_neighbor_address, delete_num_as_in_as_path, delete_router_bgp, rbridge_id, delete_neighbor_addr, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, delete_maxas_limit, delete_neighbor_ips, delete_ca_maxas_limit_enable, delete_in_cg, delete_rbridge_id, delete_ch_maxas_limit, delete_neighbor, delete_router, num_as_in_as_path, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_maxas_limit_in_cg_ch_maxas_limit_ca_maxas_limit_enable_num_as_in_as_path(router_bgp_neighbor_address=router_bgp_neighbor_address, delete_router_bgp=delete_router_bgp, delete_ca_maxas_limit_enable=delete_ca_maxas_limit_enable, username=username, delete_neighbor=delete_neighbor, delete_neighbor_ips=delete_neighbor_ips, rbridge_id=rbridge_id, delete_num_as_in_as_path=delete_num_as_in_as_path, delete_router=delete_router, delete_in_cg=delete_in_cg, host=host, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_maxas_limit=delete_maxas_limit, delete_router_bgp_neighbor_address=delete_router_bgp_neighbor_address, delete_rbridge_id=delete_rbridge_id, delete_neighbor_addr=delete_neighbor_addr, num_as_in_as_path=num_as_in_as_path, password=password, delete_ch_maxas_limit=delete_ch_maxas_limit, callback=_callback, mgr=mgr)
        return 0
