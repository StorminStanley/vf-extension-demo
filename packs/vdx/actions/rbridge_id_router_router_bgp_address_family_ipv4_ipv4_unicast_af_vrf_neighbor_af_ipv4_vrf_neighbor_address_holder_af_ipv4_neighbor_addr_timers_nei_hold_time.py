...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_timers_nei_hold_time(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_nei_hold_time', False) is True:
        delete_nei_hold_time = config.find('.//*nei-hold-time')
        delete_nei_hold_time.set('operation', 'delete')
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_timers_nei_hold_time_act(Action):
    def run(self, delete_nei_hold_time, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_timers, nei_hold_time, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_timers_nei_hold_time(delete_address_family=delete_address_family, username=username, af_vrf_name=af_vrf_name, nei_hold_time=nei_hold_time, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, password=password, delete_neighbor=delete_neighbor, delete_router=delete_router, delete_nei_hold_time=delete_nei_hold_time, host=host, delete_af_vrf=delete_af_vrf, delete_rbridge_id=delete_rbridge_id, delete_timers=delete_timers, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
