...
def interface_gigabitethernet_switchport_trunk_allowed_vlanoper_vlan_remove(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_allowed_vlanoper_vlan_remove_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, remove, delete_interface, delete_name, delete_remove, delete_vlanoper, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_trunk_allowed_vlanoper_vlan_remove(delete_vlanoper=delete_vlanoper, name=name, delete_trunk=delete_trunk, username=username, delete_switchport=delete_switchport, remove=remove, delete_allowed=delete_allowed, delete_vlan=delete_vlan, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, delete_remove=delete_remove, password=password, callback=_callback, mgr=mgr)
        return 0
