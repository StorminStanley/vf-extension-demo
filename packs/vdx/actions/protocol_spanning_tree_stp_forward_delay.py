...
def protocol_spanning_tree_stp_forward_delay(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_stp_forward_delay_act(Action):
    def run(self, delete_stp, delete_forward_delay, delete_spanning_tree, forward_delay, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_stp_forward_delay(delete_stp=delete_stp, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, host=host, delete_forward_delay=delete_forward_delay, forward_delay=forward_delay, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
