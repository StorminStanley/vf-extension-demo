...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_src(**kwargs):
    """Auto Generated Code
    """
    ...
    bfd_ipv6_static_route_src = ET.SubElement(bfd_ipv6_static_route, "bfd-ipv6-static-route-src")
    ...
    bfd_ipv6_static_route_src.text = kwargs.pop('bfd_ipv6_static_route_src')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_static_route_bfd_ipv6_static_route_src_act(Action):
