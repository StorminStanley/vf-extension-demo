...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_static_network_edge(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_static_network_edge_act(Action):
    def run(self, delete_static_network_edge, delete_router_bgp, rbridge_id, delete_router_bgp_neighbor_peer_grp, router_bgp_neighbor_peer_grp, delete_router_bgp_attributes, delete_neighbor_peer_grp, delete_rbridge_id, delete_peer_grps, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_peer_grps_neighbor_peer_grp_static_network_edge(delete_neighbor_peer_grp=delete_neighbor_peer_grp, delete_router_bgp=delete_router_bgp, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, router_bgp_neighbor_peer_grp=router_bgp_neighbor_peer_grp, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_static_network_edge=delete_static_network_edge, delete_router_bgp_neighbor_peer_grp=delete_router_bgp_neighbor_peer_grp, delete_peer_grps=delete_peer_grps, callback=_callback, mgr=mgr)
        return 0
