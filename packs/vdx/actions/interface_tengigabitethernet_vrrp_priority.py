...
def interface_tengigabitethernet_vrrp_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_vrrp_priority_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, priority, version, delete_interface, delete_name, delete_priority, delete_vrrp, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_vrrp_priority(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, priority=priority, version=version, delete_tengigabitethernet=delete_tengigabitethernet, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
