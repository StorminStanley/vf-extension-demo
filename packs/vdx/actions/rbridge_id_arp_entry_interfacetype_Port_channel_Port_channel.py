...
def rbridge_id_arp_entry_interfacetype_Port_channel_Port_channel(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_arp_entry_interfacetype_Port_channel_Port_channel_act(Action):
    def run(self, rbridge_id, delete_interfacetype, delete_Port_channel, delete_arp_ip_address, arp_ip_address, Port_channel, delete_arp_entry, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_arp_entry_interfacetype_Port_channel_Port_channel(delete_arp_entry=delete_arp_entry, username=username, rbridge_id=rbridge_id, delete_Port_channel=delete_Port_channel, delete_interfacetype=delete_interfacetype, arp_ip_address=arp_ip_address, Port_channel=Port_channel, delete_arp_ip_address=delete_arp_ip_address, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
