...
def interface_gigabitethernet_rmon_collection_history_control_entry_history_control_index(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_rmon_collection_history_control_entry_history_control_index_act(Action):
    def run(self, delete_collection, delete_history_control_index, name, history_control_index, delete_rmon, delete_interface, delete_name, delete_history_control_entry, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_rmon_collection_history_control_entry_history_control_index(delete_rmon=delete_rmon, name=name, history_control_index=history_control_index, delete_history_control_entry=delete_history_control_entry, delete_history_control_index=delete_history_control_index, delete_name=delete_name, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_collection=delete_collection, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
