...
def rbridge_id_interface_ve_vrrpe_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_hold_time_act(Action):
    def run(self, name, delete_vrid, delete_hold_time, vrid, delete_ve, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, hold_time, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_hold_time(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_vrrpe=delete_vrrpe, username=username, rbridge_id=rbridge_id, delete_ve=delete_ve, vrid=vrid, hold_time=hold_time, host=host, delete_hold_time=delete_hold_time, delete_rbridge_id=delete_rbridge_id, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
