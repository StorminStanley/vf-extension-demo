...
def interface_gigabitethernet_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_bfd_interval_multiplier_act(Action):
    def run(self, delete_multiplier, name, delete_interval, delete_interface, delete_name, multiplier, delete_bfd, delete_gigabitethernet, host, username, password):
