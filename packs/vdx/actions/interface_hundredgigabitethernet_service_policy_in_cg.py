...
def interface_hundredgigabitethernet_service_policy_in_cg(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_service_policy_in_cg_act(Action):
    def run(self, in_cg, name, delete_service_policy, delete_interface, delete_name, delete_hundredgigabitethernet, delete_in_cg, host, username, password):
