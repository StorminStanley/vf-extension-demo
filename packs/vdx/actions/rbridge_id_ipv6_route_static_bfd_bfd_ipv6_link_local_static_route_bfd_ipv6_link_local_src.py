...
def rbridge_id_ipv6_route_static_bfd_bfd_ipv6_link_local_static_route_bfd_ipv6_link_local_src(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_route_static_bfd_bfd_ipv6_link_local_static_route_bfd_ipv6_link_local_src_act(Action):
    def run(self, rbridge_id, delete_route, delete_static, bfd_interface_name, bfd_interface_type, delete_bfd_interface_type, delete_bfd, delete_bfd_interface_name, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_route_static_bfd_bfd_ipv6_link_local_static_route_bfd_ipv6_link_local_src(delete_static=delete_static, delete_route=delete_route, username=username, delete_bfd=delete_bfd, rbridge_id=rbridge_id, delete_bfd_interface_type=delete_bfd_interface_type, delete_bfd_interface_name=delete_bfd_interface_name, host=host, bfd_interface_name=bfd_interface_name, delete_rbridge_id=delete_rbridge_id, bfd_interface_type=bfd_interface_type, password=password, callback=_callback, mgr=mgr)
        return 0
