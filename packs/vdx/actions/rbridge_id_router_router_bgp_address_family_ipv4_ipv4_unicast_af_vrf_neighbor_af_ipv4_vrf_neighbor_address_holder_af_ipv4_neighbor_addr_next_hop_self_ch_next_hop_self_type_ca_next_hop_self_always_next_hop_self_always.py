...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_always_next_hop_self_always(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_always_next_hop_self_always_act(Action):
    def run(self, delete_address_family, delete_next_hop_self_always, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_next_hop_self, delete_ch_next_hop_self_type, delete_rbridge_id, delete_neighbor, delete_router, delete_ca_next_hop_self_always, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_next_hop_self_ch_next_hop_self_type_ca_next_hop_self_always_next_hop_self_always(delete_next_hop_self=delete_next_hop_self, delete_router_bgp=delete_router_bgp, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, delete_ch_next_hop_self_type=delete_ch_next_hop_self_type, delete_next_hop_self_always=delete_next_hop_self_always, delete_neighbor=delete_neighbor, host=host, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, delete_ca_next_hop_self_always=delete_ca_next_hop_self_always, password=password, callback=_callback, mgr=mgr)
        return 0
