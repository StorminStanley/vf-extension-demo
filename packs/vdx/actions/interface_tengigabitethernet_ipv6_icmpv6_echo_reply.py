...
def interface_tengigabitethernet_ipv6_icmpv6_echo_reply(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_icmpv6_echo_reply_act(Action):
    def run(self, delete_tengigabitethernet, delete_echo_reply, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_icmpv6_echo_reply(name=name, delete_name=delete_name, delete_echo_reply=delete_echo_reply, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
