...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_link_local_route_oif_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_link_local_route_oif_name_act(Action):
    def run(self, delete_link_local_static_route_nh, delete_address_family, link_local_route_oif_name, rbridge_id, delete_route, delete_vrf, delete_link_local_static_route_dest, delete_link_local_route_oif_name, link_local_nexthop, delete_link_local_route_oif_type, vrf_name, link_local_route_oif_type, delete_link_local_nexthop, delete_rbridge_id, delete_unicast, link_local_static_route_dest, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_link_local_static_route_nh_link_local_route_oif_name(delete_link_local_route_oif_type=delete_link_local_route_oif_type, delete_link_local_nexthop=delete_link_local_nexthop, delete_address_family=delete_address_family, delete_route=delete_route, username=username, link_local_route_oif_type=link_local_route_oif_type, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_link_local_route_oif_name=delete_link_local_route_oif_name, link_local_route_oif_name=link_local_route_oif_name, host=host, link_local_static_route_dest=link_local_static_route_dest, delete_link_local_static_route_nh=delete_link_local_static_route_nh, delete_link_local_static_route_dest=delete_link_local_static_route_dest, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, link_local_nexthop=link_local_nexthop, password=password, delete_vrf_name=delete_vrf_name, callback=_callback, mgr=mgr)
        return 0
