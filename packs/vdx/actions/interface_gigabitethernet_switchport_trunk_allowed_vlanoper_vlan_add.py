...
def interface_gigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, add, delete_interface, delete_name, delete_add, delete_vlanoper, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_trunk_allowed_vlanoper_vlan_add(delete_vlanoper=delete_vlanoper, name=name, delete_trunk=delete_trunk, delete_add=delete_add, delete_switchport=delete_switchport, delete_allowed=delete_allowed, add=add, delete_vlan=delete_vlan, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
