...
def interface_hundredgigabitethernet_vrrp_track_interface_track_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_track_interface_track_priority_act(Action):
    def run(self, delete_track_priority, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_version, delete_interface_type, version, delete_interface, delete_name, delete_vrrp, delete_hundredgigabitethernet, interface_name, delete_track, track_priority, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_vrrp_track_interface_track_priority(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_track=delete_track, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, interface_name=interface_name, delete_track_priority=delete_track_priority, version=version, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, vrid=vrid, interface_type=interface_type, delete_name=delete_name, delete_interface=delete_interface, track_priority=track_priority, password=password, callback=_callback, mgr=mgr)
        return 0
