...
def interface_gigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_add(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_add_act(Action):
    def run(self, delete_vlan, name, delete_mac_learning_vlan_add, delete_mac_learn_disable, delete_mac_learning, delete_interface, delete_name, mac_learning_vlan_add, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_mac_learning_mac_learn_disable_vlan_mac_learning_vlan_add(delete_mac_learning=delete_mac_learning, name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_mac_learn_disable=delete_mac_learn_disable, mac_learning_vlan_add=mac_learning_vlan_add, delete_mac_learning_vlan_add=delete_mac_learning_vlan_add, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
