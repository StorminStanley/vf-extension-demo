...
def rbridge_id_vrf_address_family_ipv6_unicast_route_target_evpn(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ipv6_unicast_route_target_evpn_act(Action):
    def run(self, delete_address_family, rbridge_id, delete_vrf, target_community, delete_target_community, delete_evpn, vrf_name, delete_action, action, delete_rbridge_id, delete_unicast, delete_route_target, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ipv6_unicast_route_target_evpn(delete_target_community=delete_target_community, delete_address_family=delete_address_family, username=username, delete_evpn=delete_evpn, vrf_name=vrf_name, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_action=delete_action, action=action, host=host, target_community=target_community, delete_route_target=delete_route_target, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, password=password, delete_vrf_name=delete_vrf_name, callback=_callback, mgr=mgr)
        return 0
