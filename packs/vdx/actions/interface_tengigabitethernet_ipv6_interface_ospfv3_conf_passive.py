...
def interface_tengigabitethernet_ipv6_interface_ospfv3_conf_passive(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_interface_ospfv3_conf_passive_act(Action):
    def run(self, delete_passive, delete_tengigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_interface_ospfv3_conf_passive(name=name, delete_name=delete_name, delete_passive=delete_passive, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
