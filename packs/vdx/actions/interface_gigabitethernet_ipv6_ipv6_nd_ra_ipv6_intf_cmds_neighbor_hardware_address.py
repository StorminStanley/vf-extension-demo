...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_hardware_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_neighbor_hardware_address_act(Action):
    def run(self, hardware_address, name, delete_hardware_address, delete_interface, delete_name, delete_neighbor, delete_gigabitethernet, host, username, password):
