...
def protocol_lldp_profile_hello(**kwargs):
    """Auto Generated Code
    """
...
class protocol_lldp_profile_hello_act(Action):
    def run(self, delete_profile_name, delete_protocol, delete_hello, delete_lldp, hello, profile_name, delete_profile, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_lldp_profile_hello(delete_profile_name=delete_profile_name, profile_name=profile_name, delete_hello=delete_hello, username=username, delete_lldp=delete_lldp, delete_profile=delete_profile, delete_protocol=delete_protocol, host=host, hello=hello, password=password, callback=_callback, mgr=mgr)
        return 0
