...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_bfd_enable(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_bfd_enable_act(Action):
    def run(self, delete_bfd, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_bfd_enable, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_bfd_enable(delete_address_family=delete_address_family, username=username, af_vrf_name=af_vrf_name, delete_bfd=delete_bfd, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_bfd_enable=delete_bfd_enable, delete_router=delete_router, host=host, password=password, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
