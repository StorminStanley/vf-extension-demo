...
def rbridge_id_ipv6_router_ospf_auto_cost_reference_bandwidth(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_auto_cost_reference_bandwidth_act(Action):
    def run(self, rbridge_id, delete_ospf, delete_vrf, delete_auto_cost, reference_bandwidth, delete_reference_bandwidth, vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_auto_cost_reference_bandwidth(delete_reference_bandwidth=delete_reference_bandwidth, username=username, delete_router=delete_router, rbridge_id=rbridge_id, delete_vrf=delete_vrf, vrf=vrf, delete_ospf=delete_ospf, password=password, reference_bandwidth=reference_bandwidth, host=host, delete_rbridge_id=delete_rbridge_id, delete_auto_cost=delete_auto_cost, callback=_callback, mgr=mgr)
        return 0
