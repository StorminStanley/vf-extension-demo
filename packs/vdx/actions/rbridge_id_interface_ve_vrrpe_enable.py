...
def rbridge_id_interface_ve_vrrpe_enable(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrpe_enable_act(Action):
    def run(self, name, delete_vrid, vrid, delete_ve, delete_enable, delete_interface, delete_name, delete_rbridge_id, delete_vrrpe, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrpe_enable(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_vrrpe=delete_vrrpe, username=username, rbridge_id=rbridge_id, delete_enable=delete_enable, delete_ve=delete_ve, vrid=vrid, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
