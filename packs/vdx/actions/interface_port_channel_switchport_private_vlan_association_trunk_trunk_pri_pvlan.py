...
def interface_port_channel_switchport_private_vlan_association_trunk_trunk_pri_pvlan(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_private_vlan_association_trunk_trunk_pri_pvlan_act(Action):
