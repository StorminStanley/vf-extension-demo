...
def interface_gigabitethernet_bfd_bfd_shutdown(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_bfd_bfd_shutdown_act(Action):
    def run(self, delete_bfd_shutdown, name, delete_interface, delete_name, delete_bfd, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_bfd_bfd_shutdown(name=name, delete_name=delete_name, delete_bfd=delete_bfd, delete_bfd_shutdown=delete_bfd_shutdown, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
