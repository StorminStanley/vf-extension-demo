...
def interface_fortygigabitethernet_switchport_trunk_allowed_vlan_all(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_switchport_trunk_allowed_vlan_all_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_trunk, delete_fortygigabitethernet, delete_interface, delete_name, delete_all, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_switchport_trunk_allowed_vlan_all(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_all=delete_all, delete_switchport=delete_switchport, delete_name=delete_name, delete_allowed=delete_allowed, delete_vlan=delete_vlan, host=host, delete_trunk=delete_trunk, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
