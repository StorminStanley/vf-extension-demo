...
def interface_port_channel_switchport_private_vlan_trunk_allowed_vlan_pvlan_except(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_private_vlan_trunk_allowed_vlan_pvlan_except_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_allowed, name, delete_pvlan_except, delete_trunk, delete_port_channel, delete_private_vlan, delete_interface, delete_name, pvlan_except, host, username, password):
