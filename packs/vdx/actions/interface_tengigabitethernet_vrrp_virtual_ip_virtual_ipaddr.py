...
def interface_tengigabitethernet_vrrp_virtual_ip_virtual_ipaddr(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_vrrp_virtual_ip_virtual_ipaddr_act(Action):
    def run(self, virtual_ipaddr, name, delete_vrid, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_tengigabitethernet, delete_virtual_ip, delete_virtual_ipaddr, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_vrrp_virtual_ip_virtual_ipaddr(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_virtual_ip=delete_virtual_ip, virtual_ipaddr=virtual_ipaddr, version=version, delete_virtual_ipaddr=delete_virtual_ipaddr, delete_tengigabitethernet=delete_tengigabitethernet, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
