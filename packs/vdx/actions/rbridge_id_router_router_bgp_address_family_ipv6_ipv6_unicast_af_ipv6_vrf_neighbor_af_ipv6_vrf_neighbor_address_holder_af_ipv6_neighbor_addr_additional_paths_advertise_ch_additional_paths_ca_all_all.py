...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_all_all(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_all_all_act(Action):
    def run(self, delete_ca_all, delete_address_family, delete_router_bgp, rbridge_id, delete_all, delete_advertise, delete_ch_additional_paths, delete_rbridge_id, delete_neighbor, delete_router, delete_additional_paths, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_additional_paths_advertise_ch_additional_paths_ca_all_all(delete_ch_additional_paths=delete_ch_additional_paths, delete_additional_paths=delete_additional_paths, delete_address_family=delete_address_family, delete_all=delete_all, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, host=host, password=password, delete_router_bgp=delete_router_bgp, delete_ca_all=delete_ca_all, delete_advertise=delete_advertise, callback=_callback, mgr=mgr)
        return 0
