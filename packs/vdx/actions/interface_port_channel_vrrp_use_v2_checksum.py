...
def interface_port_channel_vrrp_use_v2_checksum(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_use_v2_checksum_act(Action):
