...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_update_source_ch_update_source_ca_port_channel_port_channel(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_update_source_ch_update_source_ca_port_channel_port_channel_act(Action):
    def run(self, router_bgp_neighbor_address, delete_router_bgp, rbridge_id, delete_neighbor_addr, delete_update_source, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, delete_neighbor_ips, delete_ca_port_channel, delete_port_channel, port_channel, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_update_source_ch_update_source_ca_port_channel_port_channel(router_bgp_neighbor_address=router_bgp_neighbor_address, delete_port_channel=delete_port_channel, delete_router_bgp=delete_router_bgp, port_channel=port_channel, username=username, delete_neighbor=delete_neighbor, delete_neighbor_ips=delete_neighbor_ips, rbridge_id=rbridge_id, delete_router=delete_router, delete_ca_port_channel=delete_ca_port_channel, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_ch_update_source=delete_ch_update_source, delete_router_bgp_neighbor_address=delete_router_bgp_neighbor_address, delete_rbridge_id=delete_rbridge_id, delete_neighbor_addr=delete_neighbor_addr, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
