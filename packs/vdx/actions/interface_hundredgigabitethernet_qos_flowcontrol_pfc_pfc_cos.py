...
def interface_hundredgigabitethernet_qos_flowcontrol_pfc_pfc_cos(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_qos_flowcontrol_pfc_pfc_cos_act(Action):
    def run(self, delete_qos, name, pfc_cos, delete_pfc, delete_flowcontrol, delete_interface, delete_name, delete_hundredgigabitethernet, delete_pfc_cos, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_qos_flowcontrol_pfc_pfc_cos(delete_qos=delete_qos, pfc_cos=pfc_cos, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_flowcontrol=delete_flowcontrol, host=host, password=password, delete_pfc_cos=delete_pfc_cos, delete_name=delete_name, delete_interface=delete_interface, username=username, delete_pfc=delete_pfc, name=name, callback=_callback, mgr=mgr)
        return 0
