...
def interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_active(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_active_act(Action):
    def run(self, delete_hundredgigabitethernet, delete_active, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_active(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, host=host, delete_active=delete_active, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
