...
def interface_gigabitethernet_storm_control_ingress_rate_bps(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_storm_control_ingress_rate_bps_act(Action):
    def run(self, protocol_type, delete_storm_control, rate_bps, delete_ingress, delete_protocol_type, delete_rate_bps, delete_interface, delete_name, delete_gigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_storm_control_ingress_rate_bps(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, delete_rate_bps=delete_rate_bps, delete_gigabitethernet=delete_gigabitethernet, delete_ingress=delete_ingress, protocol_type=protocol_type, delete_protocol_type=delete_protocol_type, rate_bps=rate_bps, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
