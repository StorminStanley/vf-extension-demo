...
def rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_tag(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_rtm_config_route_static_route_oif_route_attributes_tag_act(Action):
    def run(self, delete_static_route_oif, delete_route_attributes, static_route_oif_type, rbridge_id, delete_ip, delete_route, delete_static_route_oif_name, tag, delete_static_route_dest, static_route_dest, static_route_oif_name, delete_rtm_config, delete_rbridge_id, delete_static_route_oif_type, delete_tag, host, username, password):
