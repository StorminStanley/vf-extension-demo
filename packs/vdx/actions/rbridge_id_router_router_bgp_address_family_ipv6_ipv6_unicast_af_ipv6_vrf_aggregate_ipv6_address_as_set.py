...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_as_set(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_as_set_act(Action):
    def run(self, delete_address_family, delete_router_bgp, aggregate_ip_prefix, delete_as_set, delete_aggregate_ip_prefix, delete_rbridge_id, delete_router, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_aggregate_ipv6_address_as_set(aggregate_ip_prefix=aggregate_ip_prefix, delete_router_bgp=delete_router_bgp, delete_as_set=delete_as_set, username=username, rbridge_id=rbridge_id, delete_router=delete_router, host=host, delete_aggregate_ip_prefix=delete_aggregate_ip_prefix, delete_address_family=delete_address_family, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
