...
def interface_gigabitethernet_switchport_port_security_port_secutiry_mac_address_mac_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_port_security_port_secutiry_mac_address_mac_address_act(Action):
