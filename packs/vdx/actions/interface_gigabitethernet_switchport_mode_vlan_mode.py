...
def interface_gigabitethernet_switchport_mode_vlan_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_mode_vlan_mode_act(Action):
    def run(self, delete_switchport, name, delete_gigabitethernet, vlan_mode, delete_interface, delete_name, delete_vlan_mode, delete_mode, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_switchport_mode_vlan_mode(name=name, delete_name=delete_name, delete_switchport=delete_switchport, delete_mode=delete_mode, vlan_mode=vlan_mode, delete_vlan_mode=delete_vlan_mode, host=host, delete_gigabitethernet=delete_gigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
