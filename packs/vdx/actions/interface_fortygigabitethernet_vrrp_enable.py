...
def interface_fortygigabitethernet_vrrp_enable(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_vrrp_enable_act(Action):
    def run(self, vrid, name, delete_vrid, delete_fortygigabitethernet, delete_version, version, delete_enable, delete_interface, delete_name, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_vrrp_enable(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, delete_name=delete_name, delete_enable=delete_enable, version=version, host=host, vrid=vrid, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
