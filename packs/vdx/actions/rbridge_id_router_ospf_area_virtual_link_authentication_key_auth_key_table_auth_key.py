...
def rbridge_id_router_ospf_area_virtual_link_authentication_key_auth_key_table_auth_key(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_area_virtual_link_authentication_key_auth_key_table_auth_key_act(Action):
    def run(self, area_id, delete_virtual_link, rbridge_id, auth_key, delete_ospf, delete_vrf, delete_area_id, delete_auth_key, delete_area, vrf, delete_virt_link_neighbor, delete_rbridge_id, virt_link_neighbor, delete_auth_key_table, delete_router, delete_authentication_key, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_area_virtual_link_authentication_key_auth_key_table_auth_key(delete_virt_link_neighbor=delete_virt_link_neighbor, delete_authentication_key=delete_authentication_key, auth_key=auth_key, virt_link_neighbor=virt_link_neighbor, username=username, delete_auth_key=delete_auth_key, area_id=area_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, password=password, delete_area=delete_area, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_auth_key_table=delete_auth_key_table, delete_rbridge_id=delete_rbridge_id, delete_virtual_link=delete_virtual_link, delete_area_id=delete_area_id, callback=_callback, mgr=mgr)
        return 0
