...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_interval_multiplier_act(Action):
    def run(self, delete_bfd, delete_address_family, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_interval, multiplier, delete_rbridge_id, delete_multiplier, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_bfd_interval_multiplier(delete_interval=delete_interval, delete_address_family=delete_address_family, username=username, af_vrf_name=af_vrf_name, delete_bfd=delete_bfd, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, password=password, delete_multiplier=delete_multiplier, delete_router=delete_router, host=host, multiplier=multiplier, delete_af_vrf=delete_af_vrf, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, delete_router_bgp=delete_router_bgp, callback=_callback, mgr=mgr)
        return 0
