...
def rbridge_id_route_map_content_match_community_community_access_list_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_community_community_access_list_name_act(Action):
    def run(self, community_access_list_name, rbridge_id, delete_community_access_list_name, delete_community, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_community_community_access_list_name(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, community_access_list_name=community_access_list_name, delete_community_access_list_name=delete_community_access_list_name, delete_community=delete_community, delete_route_map=delete_route_map, delete_content=delete_content, host=host, password=password, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
