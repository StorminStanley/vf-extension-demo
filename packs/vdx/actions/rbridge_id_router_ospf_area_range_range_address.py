...
def rbridge_id_router_ospf_area_range_range_address(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_area_range_range_address_act(Action):
