...
def interface_port_channel_vrrp_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_vrrp_advertisement_interval_act(Action):
    def run(self, name, delete_vrid, vrid, delete_advertisement_interval, delete_version, advertisement_interval, delete_port_channel, version, delete_interface, delete_name, delete_vrrp, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_vrrp_advertisement_interval(delete_vrid=delete_vrid, version=version, name=name, delete_version=delete_version, delete_advertisement_interval=delete_advertisement_interval, delete_vrrp=delete_vrrp, delete_port_channel=delete_port_channel, advertisement_interval=advertisement_interval, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
