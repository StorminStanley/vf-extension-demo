...
def rbridge_id_route_map_content_set_tag_tag_rms(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_tag_tag_rms_act(Action):
    def run(self, tag_rms, rbridge_id, delete_set, delete_tag_rms, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_tag, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_tag_tag_rms(delete_instance=delete_instance, delete_route_map=delete_route_map, delete_tag_rms=delete_tag_rms, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, delete_tag=delete_tag, name=name, password=password, tag_rms=tag_rms, delete_content=delete_content, delete_set=delete_set, host=host, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
