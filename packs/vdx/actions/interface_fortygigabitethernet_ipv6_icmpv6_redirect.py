...
def interface_fortygigabitethernet_ipv6_icmpv6_redirect(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_icmpv6_redirect_act(Action):
    def run(self, delete_redirect, delete_fortygigabitethernet, delete_interface, delete_name, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_icmpv6_redirect(name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_name=delete_name, host=host, delete_redirect=delete_redirect, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
