...
def rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_vrf_static_route_next_vrf_dest(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_vrf_static_route_next_vrf_dest_act(Action):
    def run(self, delete_static_route_next_hop, delete_address_family, rbridge_id, delete_ip, delete_route, delete_vrf, delete_next_hop_vrf, delete_static_route_next_vrf_dest, static_route_next_vrf_dest, vrf_name, next_hop_vrf, delete_static_route_nh_vrf, delete_rbridge_id, delete_unicast, static_route_next_hop, delete_vrf_name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_vrf_address_family_ip_unicast_ip_route_static_route_nh_vrf_static_route_next_vrf_dest(delete_address_family=delete_address_family, delete_route=delete_route, vrf_name=vrf_name, username=username, delete_ip=delete_ip, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_static_route_nh_vrf=delete_static_route_nh_vrf, static_route_next_vrf_dest=static_route_next_vrf_dest, static_route_next_hop=static_route_next_hop, delete_static_route_next_hop=delete_static_route_next_hop, host=host, delete_vrf_name=delete_vrf_name, delete_static_route_next_vrf_dest=delete_static_route_next_vrf_dest, delete_next_hop_vrf=delete_next_hop_vrf, delete_unicast=delete_unicast, delete_rbridge_id=delete_rbridge_id, next_hop_vrf=next_hop_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
