...
def interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_infinite_preferred_infinite_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_ca_preferred_infinite, delete_preferred_infinite, delete_ch_preferred_type, delete_interface, delete_name, delete_lifetime, delete_nd, delete_gigabitethernet, name, host, username, password):
