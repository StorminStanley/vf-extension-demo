...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_min_tx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ipv6s_neighbor_ipv6_addr_bfd_interval_min_tx_act(Action):
    def run(self, delete_bfd, delete_router_bgp, rbridge_id, delete_min_tx, delete_router_bgp_attributes, delete_interval, min_tx, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
