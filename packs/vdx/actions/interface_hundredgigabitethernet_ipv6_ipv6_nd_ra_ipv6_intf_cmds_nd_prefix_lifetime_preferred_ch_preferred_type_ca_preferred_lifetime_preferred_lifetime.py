...
def interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_lifetime_preferred_lifetime(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_ch_preferred_type_ca_preferred_lifetime_preferred_lifetime_act(Action):
    def run(self, delete_ca_preferred_lifetime, delete_preferred, delete_prefix, preferred_lifetime, delete_ch_preferred_type, delete_interface, delete_name, delete_hundredgigabitethernet, delete_lifetime, delete_nd, delete_preferred_lifetime, name, host, username, password):
