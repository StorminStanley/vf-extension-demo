...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_filter_list_direction_out_filter_list_name_direction_out(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_filter_list_direction_out_filter_list_name_direction_out_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_filter_list_name_direction_out, delete_filter_list, delete_direction_out, delete_rbridge_id, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_filter_list_direction_out_filter_list_name_direction_out(delete_router_bgp=delete_router_bgp, delete_filter_list=delete_filter_list, username=username, delete_neighbor=delete_neighbor, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_direction_out=delete_direction_out, delete_router=delete_router, host=host, delete_address_family=delete_address_family, delete_filter_list_name_direction_out=delete_filter_list_name_direction_out, password=password, callback=_callback, mgr=mgr)
        return 0
