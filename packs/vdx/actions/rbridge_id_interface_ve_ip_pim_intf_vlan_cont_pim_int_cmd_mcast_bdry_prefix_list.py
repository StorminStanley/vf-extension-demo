...
def rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_mcast_bdry_prefix_list(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_mcast_bdry_prefix_list_act(Action):
    def run(self, name, delete_ip, delete_mcast_bdry_prefix_list, delete_ve, mcast_bdry_prefix_list, delete_interface, delete_name, delete_pim_intf_vlan_cont, delete_rbridge_id, delete_pim_int_cmd, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_pim_intf_vlan_cont_pim_int_cmd_mcast_bdry_prefix_list(mcast_bdry_prefix_list=mcast_bdry_prefix_list, name=name, delete_name=delete_name, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_pim_int_cmd=delete_pim_int_cmd, delete_ve=delete_ve, host=host, delete_pim_intf_vlan_cont=delete_pim_intf_vlan_cont, delete_interface=delete_interface, delete_mcast_bdry_prefix_list=delete_mcast_bdry_prefix_list, password=password, callback=_callback, mgr=mgr)
        return 0
