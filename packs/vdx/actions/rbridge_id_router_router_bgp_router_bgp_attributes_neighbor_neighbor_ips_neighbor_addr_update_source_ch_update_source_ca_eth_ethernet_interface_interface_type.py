...
def rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_interface_type_act(Action):
    def run(self, router_bgp_neighbor_address, delete_interface_type, delete_router_bgp, rbridge_id, delete_neighbor_addr, interface_type, delete_update_source, delete_router_bgp_neighbor_address, delete_router_bgp_attributes, delete_ethernet_interface, delete_neighbor_ips, delete_rbridge_id, delete_ch_update_source, delete_ca_eth, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_router_bgp_attributes_neighbor_neighbor_ips_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_interface_type(router_bgp_neighbor_address=router_bgp_neighbor_address, delete_ethernet_interface=delete_ethernet_interface, delete_router_bgp=delete_router_bgp, username=username, delete_ca_eth=delete_ca_eth, delete_neighbor_ips=delete_neighbor_ips, rbridge_id=rbridge_id, delete_neighbor=delete_neighbor, interface_type=interface_type, delete_router=delete_router, host=host, password=password, delete_router_bgp_attributes=delete_router_bgp_attributes, delete_interface_type=delete_interface_type, delete_ch_update_source=delete_ch_update_source, delete_router_bgp_neighbor_address=delete_router_bgp_neighbor_address, delete_rbridge_id=delete_rbridge_id, delete_neighbor_addr=delete_neighbor_addr, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
