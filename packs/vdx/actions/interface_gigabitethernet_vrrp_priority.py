...
def interface_gigabitethernet_vrrp_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_priority_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, priority, version, delete_interface, delete_name, delete_priority, delete_vrrp, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_priority(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, priority=priority, version=version, host=host, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
