...
def interface_tengigabitethernet_lldp_disable(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_lldp_disable_act(Action):
    def run(self, delete_name, delete_lldp, delete_interface, delete_disable, delete_tengigabitethernet, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_lldp_disable(delete_disable=delete_disable, name=name, delete_name=delete_name, delete_lldp=delete_lldp, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
