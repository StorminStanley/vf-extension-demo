...
def interface_port_channel_switchport_access_mac_vlan_classification_access_vlan_access_vlan_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_switchport_access_mac_vlan_classification_access_vlan_access_vlan_id_act(Action):
    def run(self, delete_switchport, delete_vlan, delete_access_vlan_id, name, access_mac_address, delete_access, delete_port_channel, access_vlan_id, delete_interface, delete_name, delete_access_mac_vlan_classification, delete_access_mac_address, host, username, password):
