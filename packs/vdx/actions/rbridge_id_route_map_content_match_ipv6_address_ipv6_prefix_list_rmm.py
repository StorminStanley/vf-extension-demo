...
def rbridge_id_route_map_content_match_ipv6_address_ipv6_prefix_list_rmm(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_match_ipv6_address_ipv6_prefix_list_rmm_act(Action):
    def run(self, rbridge_id, delete_match, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_address, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_match_ipv6_address_ipv6_prefix_list_rmm(delete_instance=delete_instance, delete_address=delete_address, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, name=name, delete_route_map=delete_route_map, delete_content=delete_content, host=host, password=password, delete_match=delete_match, delete_name=delete_name, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
