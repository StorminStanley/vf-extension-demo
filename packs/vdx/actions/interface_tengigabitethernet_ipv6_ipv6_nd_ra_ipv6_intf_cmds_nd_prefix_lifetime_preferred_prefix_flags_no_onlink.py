...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_onlink(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_no_onlink', False) is True:
        delete_no_onlink = config.find('.//*no-onlink')
        delete_no_onlink.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_onlink_act(Action):
    def run(self, delete_preferred, delete_prefix, delete_no_onlink, delete_interface, delete_name, delete_prefix_flags, delete_tengigabitethernet, delete_nd, delete_lifetime, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_prefix_lifetime_preferred_prefix_flags_no_onlink(delete_prefix_flags=delete_prefix_flags, name=name, delete_name=delete_name, delete_no_onlink=delete_no_onlink, delete_lifetime=delete_lifetime, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_preferred=delete_preferred, delete_nd=delete_nd, delete_prefix=delete_prefix, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
