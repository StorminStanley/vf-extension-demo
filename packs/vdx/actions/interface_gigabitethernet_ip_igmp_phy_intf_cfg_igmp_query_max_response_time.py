...
def interface_gigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_igmp_phy_intf_cfg_igmp_query_max_response_time_act(Action):
    def run(self, name, delete_ip, delete_igmp_phy_intf_cfg, delete_query_max_response_time, delete_igmp, delete_interface, delete_name, query_max_response_time, delete_gigabitethernet, host, username, password):
