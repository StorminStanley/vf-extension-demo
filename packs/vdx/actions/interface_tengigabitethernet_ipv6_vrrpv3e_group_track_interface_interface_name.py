...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_track_interface_interface_name(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_track_interface_interface_name_act(Action):
    def run(self, delete_interface_name, name, delete_vrid, interface_type, vrid, delete_interface_type, delete_interface, delete_name, delete_tengigabitethernet, interface_name, delete_track, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_vrrpv3e_group_track_interface_interface_name(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_track=delete_track, interface_name=interface_name, delete_interface_type=delete_interface_type, delete_interface_name=delete_interface_name, host=host, vrid=vrid, interface_type=interface_type, delete_tengigabitethernet=delete_tengigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
