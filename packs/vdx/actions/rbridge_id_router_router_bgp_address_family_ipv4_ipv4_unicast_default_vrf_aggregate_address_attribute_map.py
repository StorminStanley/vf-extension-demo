...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_aggregate_address_attribute_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_aggregate_address_attribute_map_act(Action):
    def run(self, delete_address_family, delete_attribute_map, delete_router_bgp, rbridge_id, attribute_map, delete_aggregate_address, delete_default_vrf, delete_aggregate_ip_prefix, delete_rbridge_id, delete_router, aggregate_ip_prefix, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_aggregate_address_attribute_map(aggregate_ip_prefix=aggregate_ip_prefix, delete_router_bgp=delete_router_bgp, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, attribute_map=attribute_map, delete_router=delete_router, delete_aggregate_address=delete_aggregate_address, host=host, delete_attribute_map=delete_attribute_map, delete_aggregate_ip_prefix=delete_aggregate_ip_prefix, delete_address_family=delete_address_family, delete_default_vrf=delete_default_vrf, password=password, callback=_callback, mgr=mgr)
        return 0
