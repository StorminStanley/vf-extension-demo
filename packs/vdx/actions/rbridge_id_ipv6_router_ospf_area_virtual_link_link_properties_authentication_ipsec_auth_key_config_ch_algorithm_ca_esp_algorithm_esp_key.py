...
def rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_key(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_key_act(Action):
    def run(self, delete_ca_esp_algorithm, area_id, delete_virtual_link, rbridge_id, delete_ospf, delete_vrf, delete_area_id, delete_virtual_link_neighbor, virtual_link_neighbor, delete_ipsec_auth_key_config, delete_area, vrf, delete_link_properties, esp_key, delete_rbridge_id, delete_ch_algorithm, delete_esp_key, delete_router, delete_authentication, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ipv6_router_ospf_area_virtual_link_link_properties_authentication_ipsec_auth_key_config_ch_algorithm_ca_esp_algorithm_esp_key(delete_router=delete_router, delete_link_properties=delete_link_properties, delete_esp_key=delete_esp_key, vrf=vrf, area_id=area_id, rbridge_id=rbridge_id, delete_ipsec_auth_key_config=delete_ipsec_auth_key_config, delete_ospf=delete_ospf, delete_ch_algorithm=delete_ch_algorithm, delete_rbridge_id=delete_rbridge_id, password=password, delete_ca_esp_algorithm=delete_ca_esp_algorithm, delete_vrf=delete_vrf, esp_key=esp_key, delete_authentication=delete_authentication, username=username, delete_area=delete_area, delete_virtual_link=delete_virtual_link, host=host, delete_area_id=delete_area_id, delete_virtual_link_neighbor=delete_virtual_link_neighbor, virtual_link_neighbor=virtual_link_neighbor, callback=_callback, mgr=mgr)
        return 0
