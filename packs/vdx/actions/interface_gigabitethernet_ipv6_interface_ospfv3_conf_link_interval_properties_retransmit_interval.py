...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_retransmit_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_retransmit_interval_act(Action):
    def run(self, retransmit_interval, name, delete_interface, delete_name, delete_link_interval_properties, delete_gigabitethernet, delete_retransmit_interval, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_retransmit_interval(name=name, delete_name=delete_name, delete_link_interval_properties=delete_link_interval_properties, retransmit_interval=retransmit_interval, delete_retransmit_interval=delete_retransmit_interval, delete_gigabitethernet=delete_gigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
