...
def interface_tengigabitethernet_ipv6_vrrpv3e_group_hold_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_vrrpv3e_group_hold_time_act(Action):
    def run(self, name, delete_vrid, delete_hold_time, vrid, delete_interface, delete_name, delete_tengigabitethernet, hold_time, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_vrrpv3e_group_hold_time(delete_vrid=delete_vrid, name=name, delete_name=delete_name, delete_tengigabitethernet=delete_tengigabitethernet, vrid=vrid, hold_time=hold_time, host=host, delete_interface=delete_interface, username=username, delete_hold_time=delete_hold_time, password=password, callback=_callback, mgr=mgr)
        return 0
