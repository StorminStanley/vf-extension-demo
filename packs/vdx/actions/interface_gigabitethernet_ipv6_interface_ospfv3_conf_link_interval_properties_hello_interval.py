...
def interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_interval_act(Action):
    def run(self, name, hello_interval, delete_interface, delete_name, delete_link_interval_properties, delete_hello_interval, delete_gigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ipv6_interface_ospfv3_conf_link_interval_properties_hello_interval(name=name, delete_name=delete_name, delete_link_interval_properties=delete_link_interval_properties, delete_hello_interval=delete_hello_interval, host=host, delete_gigabitethernet=delete_gigabitethernet, hello_interval=hello_interval, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
