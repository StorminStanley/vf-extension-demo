...
def rbridge_id_maps_rule_monitor(**kwargs):
    """Auto Generated Code
    """
    ...
    monitor = ET.SubElement(rule, "monitor")
...
class rbridge_id_maps_rule_monitor_act(Action):
    def run(self, rbridge_id, delete_maps, delete_rulename, rulename, delete_monitor, delete_rbridge_id, delete_rule, monitor, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_maps_rule_monitor(username=username, rbridge_id=rbridge_id, delete_maps=delete_maps, rulename=rulename, delete_monitor=delete_monitor, monitor=monitor, delete_rule=delete_rule, delete_rulename=delete_rulename, host=host, delete_rbridge_id=delete_rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
