...
def interface_port_channel_qos_dscp_mutation(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_qos_dscp_mutation_act(Action):
    def run(self, delete_qos, name, delete_dscp_mutation, dscp_mutation, delete_port_channel, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_qos_dscp_mutation(delete_qos=delete_qos, dscp_mutation=dscp_mutation, delete_dscp_mutation=delete_dscp_mutation, name=name, delete_port_channel=delete_port_channel, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
