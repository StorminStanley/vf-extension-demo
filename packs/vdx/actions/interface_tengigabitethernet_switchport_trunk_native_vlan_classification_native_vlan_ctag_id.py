...
def interface_tengigabitethernet_switchport_trunk_native_vlan_classification_native_vlan_ctag_id(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_switchport_trunk_native_vlan_classification_native_vlan_ctag_id_act(Action):
    def run(self, delete_switchport, name, native_vlan_ctag_id, delete_native_vlan_classification, delete_trunk, delete_native_vlan_ctag_id, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_switchport_trunk_native_vlan_classification_native_vlan_ctag_id(name=name, delete_trunk=delete_trunk, delete_switchport=delete_switchport, delete_native_vlan_classification=delete_native_vlan_classification, native_vlan_ctag_id=native_vlan_ctag_id, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_native_vlan_ctag_id=delete_native_vlan_ctag_id, username=username, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
