...
def rbridge_id_route_map_content_set_dampening_suppress(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_dampening_suppress_act(Action):
    def run(self, rbridge_id, delete_set, delete_dampening, delete_suppress, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_name, suppress, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_dampening_suppress(delete_suppress=delete_suppress, delete_instance=delete_instance, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, suppress=suppress, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, instance=instance, delete_name=delete_name, host=host, delete_rbridge_id=delete_rbridge_id, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
