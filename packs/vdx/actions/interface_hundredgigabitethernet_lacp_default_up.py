...
def interface_hundredgigabitethernet_lacp_default_up(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_lacp_default_up_act(Action):
    def run(self, name, delete_lacp, delete_default_up, delete_interface, delete_name, delete_hundredgigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_lacp_default_up(name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, username=username, delete_lacp=delete_lacp, host=host, delete_interface=delete_interface, delete_default_up=delete_default_up, password=password, callback=_callback, mgr=mgr)
        return 0
