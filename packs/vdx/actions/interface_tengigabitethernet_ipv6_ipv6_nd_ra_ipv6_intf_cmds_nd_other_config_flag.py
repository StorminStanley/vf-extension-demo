...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_other_config_flag(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_other_config_flag_act(Action):
    def run(self, delete_other_config_flag, name, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_other_config_flag(name=name, delete_name=delete_name, delete_other_config_flag=delete_other_config_flag, delete_tengigabitethernet=delete_tengigabitethernet, delete_nd=delete_nd, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
