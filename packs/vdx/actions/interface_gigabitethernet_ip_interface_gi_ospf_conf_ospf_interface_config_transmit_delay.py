...
def interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_transmit_delay(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_transmit_delay_act(Action):
    def run(self, transmit_delay, delete_transmit_delay, name, delete_ip, delete_interface_gi_ospf_conf, delete_interface, delete_name, delete_gigabitethernet, delete_ospf_interface_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_ip_interface_gi_ospf_conf_ospf_interface_config_transmit_delay(delete_interface_gi_ospf_conf=delete_interface_gi_ospf_conf, name=name, delete_name=delete_name, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_gigabitethernet=delete_gigabitethernet, delete_transmit_delay=delete_transmit_delay, transmit_delay=transmit_delay, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
