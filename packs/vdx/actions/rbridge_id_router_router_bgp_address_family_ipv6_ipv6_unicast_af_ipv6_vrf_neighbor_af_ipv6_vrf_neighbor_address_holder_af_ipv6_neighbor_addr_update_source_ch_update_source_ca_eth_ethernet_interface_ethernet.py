...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_ethernet_interface, delete_update_source, delete_ca_eth, delete_ethernet, ethernet, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_update_source_ch_update_source_ca_eth_ethernet_interface_ethernet(delete_ethernet_interface=delete_ethernet_interface, delete_router_bgp=delete_router_bgp, ethernet=ethernet, username=username, delete_ethernet=delete_ethernet, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_router=delete_router, password=password, delete_neighbor=delete_neighbor, delete_ch_update_source=delete_ch_update_source, host=host, delete_address_family=delete_address_family, delete_ca_eth=delete_ca_eth, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
