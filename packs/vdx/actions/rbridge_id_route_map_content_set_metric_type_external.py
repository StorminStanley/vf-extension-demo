...
def rbridge_id_route_map_content_set_metric_type_external(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_metric_type_external_act(Action):
    def run(self, delete_external, rbridge_id, delete_set, delete_route_map, delete_content, delete_metric_type, instance, delete_instance, action_rm, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
