...
def interface_port_channel_qos_flowcontrol_link_level_flowcontrol_flowcontrol_tx(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_qos_flowcontrol_link_level_flowcontrol_flowcontrol_tx_act(Action):
    def run(self, flowcontrol_tx, delete_qos, name, delete_flowcontrol_tx, delete_flowcontrol, delete_port_channel, delete_link_level_flowcontrol, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_qos_flowcontrol_link_level_flowcontrol_flowcontrol_tx(flowcontrol_tx=flowcontrol_tx, delete_link_level_flowcontrol=delete_link_level_flowcontrol, delete_qos=delete_qos, delete_name=delete_name, delete_flowcontrol=delete_flowcontrol, delete_port_channel=delete_port_channel, host=host, delete_flowcontrol_tx=delete_flowcontrol_tx, delete_interface=delete_interface, username=username, password=password, name=name, callback=_callback, mgr=mgr)
        return 0
