...
def rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_link_local_static_route_bfd_interface_name(**kwargs):
    """Auto Generated Code
    """
    ...
    bfd_interface_name = ET.SubElement(bfd_ipv6_link_local_static_route, "bfd-interface-name")
    ...
    bfd_interface_name.text = kwargs.pop('bfd_interface_name')

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class rbridge_id_vrf_address_family_ipv6_unicast_ipv6_route_static_bfd_bfd_ipv6_link_local_static_route_bfd_interface_name_act(Action):
