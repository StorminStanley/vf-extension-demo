...
def interface_tengigabitethernet_ip_ip_config_proxy_arp(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ip_ip_config_proxy_arp_act(Action):
    def run(self, delete_ip_config, name, delete_ip, delete_proxy_arp, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ip_ip_config_proxy_arp(name=name, delete_name=delete_name, delete_ip_config=delete_ip_config, delete_ip=delete_ip, delete_proxy_arp=delete_proxy_arp, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
