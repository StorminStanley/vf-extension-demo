...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_interval_min_rx(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_interval_min_rx_act(Action):
    def run(self, delete_bfd, delete_address_family, delete_router_bgp, rbridge_id, delete_interval, delete_min_rx, delete_rbridge_id, delete_neighbor, delete_router, min_rx, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_af_ipv6_vrf_neighbor_af_ipv6_vrf_neighbor_address_holder_af_ipv6_neighbor_addr_bfd_interval_min_rx(delete_interval=delete_interval, delete_min_rx=delete_min_rx, delete_address_family=delete_address_family, username=username, delete_neighbor=delete_neighbor, delete_router=delete_router, rbridge_id=rbridge_id, delete_bfd=delete_bfd, host=host, password=password, delete_router_bgp=delete_router_bgp, delete_rbridge_id=delete_rbridge_id, min_rx=min_rx, callback=_callback, mgr=mgr)
        return 0
