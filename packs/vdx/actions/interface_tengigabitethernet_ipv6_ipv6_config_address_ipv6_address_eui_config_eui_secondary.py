...
def interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_eui_secondary', False) is True:
        delete_eui_secondary = config.find('.//*eui-secondary')
        delete_eui_secondary.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary_act(Action):
    def run(self, delete_eui_secondary, name, delete_interface, delete_name, address, delete_address, delete_tengigabitethernet, delete_eui_config, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_config_address_ipv6_address_eui_config_eui_secondary(name=name, delete_address=delete_address, address=address, delete_eui_config=delete_eui_config, delete_eui_secondary=delete_eui_secondary, delete_tengigabitethernet=delete_tengigabitethernet, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
