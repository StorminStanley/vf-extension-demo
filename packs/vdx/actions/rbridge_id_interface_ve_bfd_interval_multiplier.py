...
def rbridge_id_interface_ve_bfd_interval_multiplier(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_bfd_interval_multiplier_act(Action):
    def run(self, delete_multiplier, name, delete_interval, delete_ve, delete_interface, delete_name, multiplier, delete_rbridge_id, delete_bfd, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_bfd_interval_multiplier(delete_interval=delete_interval, name=name, delete_name=delete_name, delete_multiplier=delete_multiplier, username=username, rbridge_id=rbridge_id, delete_bfd=delete_bfd, delete_ve=delete_ve, password=password, host=host, delete_interface=delete_interface, delete_rbridge_id=delete_rbridge_id, multiplier=multiplier, callback=_callback, mgr=mgr)
        return 0
