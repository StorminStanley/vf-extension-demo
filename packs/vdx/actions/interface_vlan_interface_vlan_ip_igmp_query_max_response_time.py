...
def interface_vlan_interface_vlan_ip_igmp_query_max_response_time(**kwargs):
    """Auto Generated Code
    """
...
class interface_vlan_interface_vlan_ip_igmp_query_max_response_time_act(Action):
    def run(self, delete_vlan, name, delete_ip, delete_interface_vlan, query_max_response_time, delete_query_max_response_time, delete_igmp, delete_interface, delete_name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_vlan_interface_vlan_ip_igmp_query_max_response_time(query_max_response_time=query_max_response_time, name=name, delete_name=delete_name, delete_vlan=delete_vlan, delete_ip=delete_ip, delete_igmp=delete_igmp, delete_query_max_response_time=delete_query_max_response_time, delete_interface_vlan=delete_interface_vlan, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
