...
def interface_gigabitethernet_switchport_port_security_allowed_ouis_oui(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_switchport_port_security_allowed_ouis_oui_act(Action):
    def run(self, delete_switchport, oui, name, delete_gigabitethernet, delete_oui, delete_allowed_ouis, delete_interface, delete_name, delete_port_security, host, username, password):
