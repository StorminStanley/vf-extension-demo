...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_update_source_ch_update_source_ca_ve_ve_interface(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_update_source_ch_update_source_ca_ve_ve_interface_act(Action):
    def run(self, delete_address_family, ve_interface, delete_router_bgp, rbridge_id, delete_af_vrf, delete_af_vrf_name, af_vrf_name, delete_ca_ve, delete_update_source, delete_ve_interface, delete_rbridge_id, delete_ch_update_source, delete_neighbor, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_af_vrf_neighbor_af_ipv4_vrf_neighbor_address_holder_af_ipv4_neighbor_addr_update_source_ch_update_source_ca_ve_ve_interface(delete_ve_interface=delete_ve_interface, delete_router_bgp=delete_router_bgp, ve_interface=ve_interface, username=username, af_vrf_name=af_vrf_name, delete_router=delete_router, rbridge_id=rbridge_id, delete_af_vrf_name=delete_af_vrf_name, delete_af_vrf=delete_af_vrf, password=password, delete_neighbor=delete_neighbor, delete_ch_update_source=delete_ch_update_source, host=host, delete_address_family=delete_address_family, delete_ca_ve=delete_ca_ve, delete_rbridge_id=delete_rbridge_id, delete_update_source=delete_update_source, callback=_callback, mgr=mgr)
        return 0
