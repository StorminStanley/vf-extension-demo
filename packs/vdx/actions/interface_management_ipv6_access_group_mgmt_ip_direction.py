...
def interface_management_ipv6_access_group_mgmt_ip_direction(**kwargs):
    """Auto Generated Code
    """
...
class interface_management_ipv6_access_group_mgmt_ip_direction_act(Action):
    def run(self, name, delete_mgmt_ip_direction, delete_access_group, delete_name, mgmt_ip_direction, delete_management, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_management_ipv6_access_group_mgmt_ip_direction(name=name, delete_name=delete_name, delete_mgmt_ip_direction=delete_mgmt_ip_direction, delete_access_group=delete_access_group, mgmt_ip_direction=mgmt_ip_direction, delete_management=delete_management, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
