...
def interface_fortygigabitethernet_ipv6_vrrpv3e_group_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_ipv6_vrrpv3e_group_description_act(Action):
    def run(self, delete_description, delete_fortygigabitethernet, name, delete_vrid, vrid, delete_interface, delete_name, description, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_ipv6_vrrpv3e_group_description(delete_vrid=delete_vrid, name=name, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_description=delete_description, host=host, description=description, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
