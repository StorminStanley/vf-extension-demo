...
def rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_key_table_key(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_key_table_key_act(Action):
    def run(self, key, name, delete_ip, delete_key_table, delete_ve, delete_key, delete_interface_vlan_ospf_conf, delete_interface, delete_name, delete_rbridge_id, delete_ospf_interface_config, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_ip_interface_vlan_ospf_conf_ospf_interface_config_md5_authentication_key_table_key(name=name, delete_key_table=delete_key_table, delete_interface_vlan_ospf_conf=delete_interface_vlan_ospf_conf, username=username, rbridge_id=rbridge_id, delete_ip=delete_ip, delete_ospf_interface_config=delete_ospf_interface_config, delete_ve=delete_ve, host=host, key=key, delete_name=delete_name, delete_key=delete_key, delete_rbridge_id=delete_rbridge_id, delete_interface=delete_interface, password=password, callback=_callback, mgr=mgr)
        return 0
