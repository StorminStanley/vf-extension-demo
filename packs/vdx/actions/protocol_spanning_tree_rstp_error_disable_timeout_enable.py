...
def protocol_spanning_tree_rstp_error_disable_agtimeout_enable(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_rstp_error_disable_agtimeout_enable_act(Action):
    def run(self, delete_error_disable_agtimeout, delete_enable, delete_spanning_tree, delete_rstp, delete_protocol, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_rstp_error_disable_agtimeout_enable(delete_error_disable_agtimeout=delete_error_disable_agtimeout, delete_enable=delete_enable, delete_spanning_tree=delete_spanning_tree, delete_rstp=delete_rstp, delete_protocol=delete_protocol, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
