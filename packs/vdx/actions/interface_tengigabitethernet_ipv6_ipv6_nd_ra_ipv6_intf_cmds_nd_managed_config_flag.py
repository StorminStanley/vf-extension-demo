...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_managed_config_flag(**kwargs):
    """Auto Generated Code
    """
    ...
    if kwargs.pop('delete_managed_config_flag', False) is True:
        delete_managed_config_flag = config.find('.//*managed-config-flag')
        delete_managed_config_flag.set('operation', 'delete')
        

    callback = kwargs.pop('callback', _callback)
    return callback(config, mgr=kwargs.pop('mgr'))

class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_managed_config_flag_act(Action):
    def run(self, name, delete_managed_config_flag, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_managed_config_flag(name=name, delete_name=delete_name, delete_tengigabitethernet=delete_tengigabitethernet, delete_nd=delete_nd, host=host, delete_interface=delete_interface, username=username, delete_managed_config_flag=delete_managed_config_flag, password=password, callback=_callback, mgr=mgr)
        return 0
