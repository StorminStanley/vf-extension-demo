...
def protocol_spanning_tree_mstp_error_disable_agtimeout_interval(**kwargs):
    """Auto Generated Code
    """
...
class protocol_spanning_tree_mstp_error_disable_agtimeout_interval_act(Action):
    def run(self, delete_error_disable_agtimeout, delete_mstp, interval, delete_interval, delete_protocol, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        protocol_spanning_tree_mstp_error_disable_agtimeout_interval(delete_interval=delete_interval, delete_error_disable_agtimeout=delete_error_disable_agtimeout, delete_spanning_tree=delete_spanning_tree, delete_protocol=delete_protocol, interval=interval, delete_mstp=delete_mstp, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
