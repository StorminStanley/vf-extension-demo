...
def interface_hundredgigabitethernet_spanning_tree_bpdu_mac(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_spanning_tree_bpdu_mac_act(Action):
    def run(self, bpdu_mac, name, delete_bpdu_mac, delete_interface, delete_name, delete_hundredgigabitethernet, delete_spanning_tree, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_hundredgigabitethernet_spanning_tree_bpdu_mac(delete_bpdu_mac=delete_bpdu_mac, name=name, delete_name=delete_name, delete_hundredgigabitethernet=delete_hundredgigabitethernet, delete_spanning_tree=delete_spanning_tree, host=host, bpdu_mac=bpdu_mac, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
