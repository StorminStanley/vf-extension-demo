...
def rbridge_id_route_map_content_set_dampening_reuse(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_dampening_reuse_act(Action):
    def run(self, rbridge_id, delete_set, delete_dampening, delete_route_map, delete_content, reuse, instance, delete_instance, action_rm, delete_name, delete_reuse, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_dampening_reuse(delete_instance=delete_instance, delete_reuse=delete_reuse, name=name, action_rm=action_rm, delete_action_rm=delete_action_rm, username=username, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, instance=instance, reuse=reuse, delete_name=delete_name, host=host, delete_rbridge_id=delete_rbridge_id, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
