...
def rbridge_id_ip_community_list_extended_name(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_community_list_extended_name_act(Action):
    def run(self, rbridge_id, delete_ip, delete_community_list, instance, delete_instance, delete_name, delete_extended, delete_rbridge_id, delete_seq_keyword, seq_keyword, name, host, username, password):
