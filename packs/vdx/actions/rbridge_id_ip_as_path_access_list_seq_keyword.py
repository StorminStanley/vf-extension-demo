...
def rbridge_id_ip_as_path_access_list_seq_keyword(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_ip_as_path_access_list_seq_keyword_act(Action):
    def run(self, rbridge_id, delete_ip, delete_as_path, delete_seq_keyword, instance, delete_instance, delete_access_list, delete_name, delete_rbridge_id, seq_keyword, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_ip_as_path_access_list_seq_keyword(delete_instance=delete_instance, name=name, seq_keyword=seq_keyword, delete_name=delete_name, delete_seq_keyword=delete_seq_keyword, username=username, delete_ip=delete_ip, rbridge_id=rbridge_id, delete_as_path=delete_as_path, password=password, host=host, delete_access_list=delete_access_list, delete_rbridge_id=delete_rbridge_id, instance=instance, callback=_callback, mgr=mgr)
        return 0
