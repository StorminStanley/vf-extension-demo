...
def rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_connected_redistribute_route_map(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv6_ipv6_unicast_default_vrf_af_ipv6_uc_and_vrf_cmds_call_point_holder_redistribute_connected_redistribute_route_map_act(Action):
    def run(self, delete_address_family, delete_router_bgp, rbridge_id, delete_redistribute_route_map, delete_connected, redistribute_route_map, delete_redistribute, delete_default_vrf, delete_rbridge_id, delete_router, host, username, password):
