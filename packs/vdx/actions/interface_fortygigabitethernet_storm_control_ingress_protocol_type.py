...
def interface_fortygigabitethernet_storm_control_ingress_protocol_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_storm_control_ingress_protocol_type_act(Action):
    def run(self, delete_protocol_type, delete_storm_control, delete_ingress, delete_fortygigabitethernet, delete_interface, delete_name, protocol_type, name, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_storm_control_ingress_protocol_type(name=name, delete_name=delete_name, delete_storm_control=delete_storm_control, delete_ingress=delete_ingress, protocol_type=protocol_type, host=host, delete_protocol_type=delete_protocol_type, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
