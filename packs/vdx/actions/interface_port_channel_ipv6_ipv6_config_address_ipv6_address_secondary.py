...
def interface_port_channel_ipv6_ipv6_config_address_ipv6_address_secondary(**kwargs):
    """Auto Generated Code
    """
...
class interface_port_channel_ipv6_ipv6_config_address_ipv6_address_secondary_act(Action):
    def run(self, name, delete_secondary, delete_port_channel, delete_interface, delete_name, address, delete_address, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_port_channel_ipv6_ipv6_config_address_ipv6_address_secondary(name=name, delete_name=delete_name, address=address, delete_port_channel=delete_port_channel, delete_address=delete_address, host=host, delete_secondary=delete_secondary, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
