...
def interface_hundredgigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local_address(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_ipv6_config_address_link_local_config_link_local_address_act(Action):
    def run(self, delete_link_local_config, name, link_local_address, delete_link_local_address, delete_interface, delete_name, delete_hundredgigabitethernet, delete_address, host, username, password):
