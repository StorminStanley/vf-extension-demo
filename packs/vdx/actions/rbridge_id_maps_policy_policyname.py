...
def rbridge_id_maps_policy_policyname(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_maps_policy_policyname_act(Action):
    def run(self, policyname, rbridge_id, delete_policyname, delete_maps, delete_policy, delete_rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_maps_policy_policyname(username=username, delete_policyname=delete_policyname, policyname=policyname, delete_maps=delete_maps, delete_policy=delete_policy, host=host, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, callback=_callback, mgr=mgr)
        return 0
