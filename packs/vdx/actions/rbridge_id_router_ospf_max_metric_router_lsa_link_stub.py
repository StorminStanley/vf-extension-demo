...
def rbridge_id_router_ospf_max_metric_router_lsa_link_stub(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_ospf_max_metric_router_lsa_link_stub_act(Action):
    def run(self, rbridge_id, delete_ospf, delete_vrf, delete_router_lsa, delete_link, delete_max_metric, delete_stub, vrf, delete_rbridge_id, delete_router, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_ospf_max_metric_router_lsa_link_stub(delete_max_metric=delete_max_metric, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_vrf=delete_vrf, delete_router_lsa=delete_router_lsa, delete_router=delete_router, delete_ospf=delete_ospf, host=host, vrf=vrf, delete_stub=delete_stub, delete_link=delete_link, password=password, callback=_callback, mgr=mgr)
        return 0
