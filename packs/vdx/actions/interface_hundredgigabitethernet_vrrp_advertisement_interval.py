...
def interface_hundredgigabitethernet_vrrp_advertisement_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_vrrp_advertisement_interval_act(Action):
    def run(self, name, delete_vrid, vrid, delete_advertisement_interval, delete_version, advertisement_interval, version, delete_interface, delete_name, delete_vrrp, delete_hundredgigabitethernet, host, username, password):
