...
def rbridge_id_route_map_content_set_metric_metric_rms(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_route_map_content_set_metric_metric_rms_act(Action):
    def run(self, rbridge_id, delete_set, delete_metric_rms, delete_route_map, delete_content, instance, delete_instance, action_rm, delete_metric, metric_rms, delete_name, delete_rbridge_id, delete_action_rm, name, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_route_map_content_set_metric_metric_rms(delete_instance=delete_instance, name=name, action_rm=action_rm, delete_name=delete_name, username=username, delete_action_rm=delete_action_rm, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, password=password, delete_route_map=delete_route_map, delete_content=delete_content, delete_set=delete_set, host=host, delete_metric=delete_metric, delete_metric_rms=delete_metric_rms, metric_rms=metric_rms, instance=instance, callback=_callback, mgr=mgr)
        return 0
