...
def rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_specify_values_values_max_suppress_time(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_specify_values_values_max_suppress_time_act(Action):
    def run(self, max_suppress_time, delete_address_family, delete_ca_dampening_specify_values, delete_router_bgp, rbridge_id, delete_dampening, delete_max_suppress_time, delete_af_common_cmds_holder, delete_default_vrf, delete_rbridge_id, delete_values, delete_router, delete_ch_dampening_source, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_router_router_bgp_address_family_ipv4_ipv4_unicast_default_vrf_af_common_cmds_holder_dampening_ch_dampening_source_ca_dampening_specify_values_values_max_suppress_time(delete_address_family=delete_address_family, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_max_suppress_time=delete_max_suppress_time, password=password, delete_af_common_cmds_holder=delete_af_common_cmds_holder, delete_router=delete_router, max_suppress_time=max_suppress_time, delete_values=delete_values, delete_ca_dampening_specify_values=delete_ca_dampening_specify_values, delete_router_bgp=delete_router_bgp, host=host, delete_default_vrf=delete_default_vrf, delete_ch_dampening_source=delete_ch_dampening_source, delete_dampening=delete_dampening, callback=_callback, mgr=mgr)
        return 0
