...
def interface_gigabitethernet_vrrp_description(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_vrrp_description_act(Action):
    def run(self, delete_description, name, delete_vrid, vrid, delete_version, version, delete_interface, delete_name, delete_vrrp, delete_gigabitethernet, description, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_gigabitethernet_vrrp_description(delete_vrid=delete_vrid, version=version, name=name, delete_version=delete_version, delete_vrrp=delete_vrrp, delete_description=delete_description, host=host, description=description, vrid=vrid, delete_gigabitethernet=delete_gigabitethernet, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
