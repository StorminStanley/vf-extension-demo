...
def interface_hundredgigabitethernet_switchport_port_security_port_sec_max(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_switchport_port_security_port_sec_max_act(Action):
    def run(self, delete_switchport, name, port_sec_max, delete_port_sec_max, delete_interface, delete_name, delete_hundredgigabitethernet, delete_port_security, host, username, password):
