...
def interface_gigabitethernet_ipv6_access_group_ipv6_access_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ipv6_access_group_ipv6_access_list_act(Action):
    def run(self, name, delete_ip_direction, delete_access_group, delete_name, ip_direction, delete_gigabitethernet, delete_interface, host, username, password):
