...
def interface_gigabitethernet_track_interface_track_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_track_interface_track_interface_type_act(Action):
    def run(self, delete_track_interface_name, name, track_interface_type, track_interface_name, delete_interface, delete_name, delete_track_interface_type, delete_track, delete_gigabitethernet, host, username, password):
