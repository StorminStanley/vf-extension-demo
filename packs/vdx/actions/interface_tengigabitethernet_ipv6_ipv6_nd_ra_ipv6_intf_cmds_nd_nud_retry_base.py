...
def interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base_act(Action):
    def run(self, name, delete_nud, delete_base, base, delete_interface, delete_name, delete_tengigabitethernet, delete_nd, delete_retry, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_ipv6_ipv6_nd_ra_ipv6_intf_cmds_nd_nud_retry_base(delete_retry=delete_retry, name=name, delete_name=delete_name, base=base, delete_nud=delete_nud, delete_nd=delete_nd, delete_tengigabitethernet=delete_tengigabitethernet, delete_base=delete_base, host=host, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
