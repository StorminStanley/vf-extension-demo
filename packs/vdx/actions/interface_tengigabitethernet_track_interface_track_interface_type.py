...
def interface_tengigabitethernet_track_interface_track_interface_type(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_track_interface_track_interface_type_act(Action):
