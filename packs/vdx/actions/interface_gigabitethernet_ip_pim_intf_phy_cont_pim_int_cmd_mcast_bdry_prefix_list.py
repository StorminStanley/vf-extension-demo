...
def interface_gigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_mcast_bdry_prefix_list(**kwargs):
    """Auto Generated Code
    """
...
class interface_gigabitethernet_ip_pim_intf_phy_cont_pim_int_cmd_mcast_bdry_prefix_list_act(Action):
    def run(self, delete_pim_intf_phy_cont, delete_ip, delete_mcast_bdry_prefix_list, delete_interface, delete_name, mcast_bdry_prefix_list, delete_pim_int_cmd, delete_gigabitethernet, name, host, username, password):
