...
def interface_tengigabitethernet_openflow_interface_cfg_openflow_enable_match_profile(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_openflow_interface_cfg_openflow_enable_match_profile_act(Action):
    def run(self, name, match_profile, delete_openflow_interface_cfg, delete_interface, delete_name, delete_openflow_enable, delete_tengigabitethernet, delete_match_profile, host, username, password):
