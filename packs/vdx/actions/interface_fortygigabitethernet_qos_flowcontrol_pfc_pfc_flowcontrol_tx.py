...
def interface_fortygigabitethernet_qos_flowcontrol_pfc_pfc_flowcontrol_tx(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_qos_flowcontrol_pfc_pfc_flowcontrol_tx_act(Action):
    def run(self, delete_qos, name, delete_pfc_flowcontrol_tx, pfc_cos, delete_fortygigabitethernet, delete_pfc, pfc_flowcontrol_tx, delete_flowcontrol, delete_interface, delete_name, delete_pfc_cos, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_qos_flowcontrol_pfc_pfc_flowcontrol_tx(delete_qos=delete_qos, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_flowcontrol=delete_flowcontrol, delete_pfc_flowcontrol_tx=delete_pfc_flowcontrol_tx, username=username, delete_name=delete_name, name=name, host=host, password=password, delete_pfc_cos=delete_pfc_cos, pfc_cos=pfc_cos, delete_interface=delete_interface, pfc_flowcontrol_tx=pfc_flowcontrol_tx, delete_pfc=delete_pfc, callback=_callback, mgr=mgr)
        return 0
