...
def rbridge_id_interface_ve_vrrp_priority(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_interface_ve_vrrp_priority_act(Action):
    def run(self, name, delete_vrid, vrid, delete_version, priority, delete_ve, version, delete_interface, delete_name, delete_priority, delete_vrrp, delete_rbridge_id, rbridge_id, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_interface_ve_vrrp_priority(delete_vrid=delete_vrid, delete_vrrp=delete_vrrp, name=name, delete_version=delete_version, username=username, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, priority=priority, version=version, delete_ve=delete_ve, host=host, vrid=vrid, delete_name=delete_name, delete_interface=delete_interface, delete_priority=delete_priority, password=password, callback=_callback, mgr=mgr)
        return 0
