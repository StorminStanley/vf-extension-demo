...
def interface_fortygigabitethernet_channel_group_mode(**kwargs):
    """Auto Generated Code
    """
...
class interface_fortygigabitethernet_channel_group_mode_act(Action):
    def run(self, name, delete_fortygigabitethernet, mode, delete_channel_group, delete_name, delete_mode, delete_interface, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_fortygigabitethernet_channel_group_mode(name=name, delete_name=delete_name, delete_mode=delete_mode, delete_channel_group=delete_channel_group, mode=mode, host=host, delete_fortygigabitethernet=delete_fortygigabitethernet, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
