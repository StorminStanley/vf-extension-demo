...
def rbridge_id_snmp_server_v3host_engineid(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_v3host_engineid_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, delete_engineid, hostip, delete_hostip, delete_rbridge_id, engineid, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_v3host_engineid(engineid=engineid, delete_snmp_server=delete_snmp_server, delete_engineid=delete_engineid, rbridge_id=rbridge_id, delete_hostip=delete_hostip, delete_username=delete_username, host=host, hostip=hostip, delete_rbridge_id=delete_rbridge_id, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
