...
def rbridge_id_snmp_server_user_priv(**kwargs):
    """Auto Generated Code
    """
...
class rbridge_id_snmp_server_user_priv_act(Action):
    def run(self, delete_snmp_server, username, rbridge_id, delete_username, delete_user, delete_rbridge_id, delete_priv, priv, host, username, password):
        ...
        mgr.agtimeout = 600
        rbridge_id_snmp_server_user_priv(delete_snmp_server=delete_snmp_server, delete_rbridge_id=delete_rbridge_id, rbridge_id=rbridge_id, delete_priv=delete_priv, delete_username=delete_username, priv=priv, delete_user=delete_user, host=host, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
