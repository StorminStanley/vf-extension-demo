...
def interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval(**kwargs):
    """Auto Generated Code
    """
...
class interface_hundredgigabitethernet_ipv6_interface_ospfv3_conf_authentication_ipsec_ifc_key_add_remove_interval_act(Action):
    def run(self, name, ifc_key_add_remove_interval, delete_ifc_key_add_remove_interval, delete_ipsec, delete_authentication, delete_name, delete_hundredgigabitethernet, delete_interface, host, username, password):
