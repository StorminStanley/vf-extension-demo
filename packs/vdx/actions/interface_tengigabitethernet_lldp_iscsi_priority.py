...
def interface_tengigabitethernet_lldp_iscsi_priority(**kwargs):
    """Auto Generated Code
    """
...
class interface_tengigabitethernet_lldp_iscsi_priority_act(Action):
    def run(self, iscsi_priority, name, delete_lldp, delete_iscsi_priority, delete_interface, delete_name, delete_tengigabitethernet, host, username, password):
        ...
        mgr.agtimeout = 600
        interface_tengigabitethernet_lldp_iscsi_priority(name=name, delete_iscsi_priority=delete_iscsi_priority, delete_lldp=delete_lldp, delete_tengigabitethernet=delete_tengigabitethernet, iscsi_priority=iscsi_priority, host=host, delete_name=delete_name, delete_interface=delete_interface, username=username, password=password, callback=_callback, mgr=mgr)
        return 0
